var Ku=e=>{throw TypeError(e)};var pc=(e,t,n)=>t.has(e)||Ku("Cannot "+n);var N=(e,t,n)=>(pc(e,t,"read from private field"),n?n.call(e):t.get(e)),ie=(e,t,n)=>t.has(e)?Ku("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),K=(e,t,n,r)=>(pc(e,t,"write to private field"),r?r.call(e,n):t.set(e,n),n),_e=(e,t,n)=>(pc(e,t,"access private method"),n);var to=(e,t,n,r)=>({set _(i){K(e,t,i,n)},get _(){return N(e,t,r)}});import{r as m,g as Zv,R as Ih,j as o,a as sr,u as tr,m as Ee,L as eb,d as tb,A as nb}from"./motion-DrBT6qPh.js";import{S as rb,P as ib,W as ab,a as ob,A as sb,b as cb,D as lb,c as Qu,G as Sg,M as ma,T as hb,d as Nh,I as ub,L as fa,E as Wo,e as $o,B as db,f as pb,g as Yu,h as gb,C as mb,i as Xu,j as fb,k as yb,O as vb,l as bb,m as wb,V as xb}from"./three-DfGjiPv-.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();var Pg={exports:{}},pt={},Ag={exports:{}},Ig={};/**
 * @license React
 ...
 */(function(e){function t(A,M){var F=A.length;A.push(M);e:for(;0<F;){var V=F-1>>>1,z=A[V];if(0<i(z,M))A[V]=M,A[F]=z,F=V;else break e}}function n(A){return A.length===0?null:A[0]}function r(A){if(A.length===0)return null;var M=A[0],F=A.pop();if(F!==M){A[0]=F;e:for(var V=0,z=A.length,Ge=z>>>1;V<Ge;){var ge=2*(V+1)-1,Je=A[ge],We=ge+1,ft=A[We];if(0>i(Je,F))We<z&&0>i(ft,Je)?(A[V]=ft,A[We]=F,V=We):(A[V]=Je,A[ge]=F,V=ge);else if(We<z&&0>i(ft,F))A[V]=ft,A[We]=F,V=We;else break e}}return M}function i(A,M){var F=A.sortIndex-M.sortIndex;return F!==0?F:A.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;e.unstable_now=function(){return a.now()}}else{var s=Date,c=s.now();e.unstable_now=function(){return s.now()-c}}var l=[],h=[],u=1,d=null,p=3,v=!1,x=!1,y=!1,k=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(A){for(var M=n(h);M!==null;){if(M.callback===null)r(h);else if(M.startTime<=A)r(h),M.sortIndex=M.expirationTime,t(l,M);else break;M=n(h)}}function w(A){if(y=!1,b(A),!x)if(n(l)!==null)x=!0,G(T);else{var M=n(h);M!==null&&W(w,M.startTime-A)}}function T(A,M){x=!1,y&&(y=!1,f(S),S=-1),v=!0;var F=p;try{for(b(M),d=n(l);d!==null&&(!(d.expirationTime>M)||A&&!q());){var V=d.callback;if(typeof V=="function"){d.callback=null,p=d.priorityLevel;var z=V(d.expirationTime<=M);M=e.unstable_now(),typeof z=="function"?d.callback=z:d===n(l)&&r(l),b(M)}else r(l);d=n(l)}if(d!==null)var Ge=!0;else{var ge=n(h);ge!==null&&W(w,ge.startTime-M),Ge=!1}return Ge}finally{d=null,p=F,v=!1}}var C=!1,P=null,S=-1,I=5,j=-1;function q(){return!(e.unstable_now()-j<I)}function D(){if(P!==null){var A=e.unstable_now();j=A;var M=!0;try{M=P(!0,A)}finally{M?J():(C=!1,P=null)}}else C=!1}var J;if(typeof g=="function")J=function(){g(D)};else if(typeof MessageChannel<"u"){var O=new MessageChannel,Q=O.port2;O.port1.onmessage=D,J=function(){Q.postMessage(null)}}else J=function(){k(D,0)};function G(A){P=A,C||(C=!0,J())}function W(A,M){S=k(function(){A(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(A){A.callback=null},e.unstable_continueExecution=function(){x||v||(x=!0,G(T))},e.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<A?Math.floor(1e3/A):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(A){switch(p){case 1:case 2:case 3:var M=3;break;default:M=p}var F=p;p=M;try{return A()}finally{p=F}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(A,M){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var F=p;p=A;try{return M()}finally{p=F}},e.unstable_scheduleCallback=function(A,M,F){var V=e.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?V+F:V):F=V,A){case 1:var z=-1;break;case 2:z=250;break;case 5:z=1073741823;break;case 4:z=1e4;break;default:z=5e3}return z=F+z,A={id:u++,callback:M,priorityLevel:A,startTime:F,expirationTime:z,sortIndex:-1},F>V?(A.sortIndex=F,t(h,A),n(l)===null&&A===n(h)&&(y?(f(S),S=-1):y=!0,W(w,F-V))):(A.sortIndex=z,t(l,A),x||v||(x=!0,G(T))),A},e.unstable_shouldYield=q,e.unstable_wrapCallback=function(A){var M=p;return function(){var F=p;p=M;try{return A.apply(this,arguments)}finally{p=F}}}})(Ig);Ag.exports=Ig;var kb=Ag.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tb=m,dt=kb;function L(e){for(var t="https://reactjs.org/docs/error-decoder.html?invariant="+e,n=1;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n]);return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var Ng=new Set,ya={};function Rr(e,t){wi(e,t),wi(e+"Capture",t)}function wi(e,t){for(ya[e]=t,e=0;e<t.length;e++)Ng.add(t[e])}var un=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),cl=Object.prototype.hasOwnProperty,Cb=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,Ju={},Zu={};function Sb(e){return cl.call(Zu,e)?!0:cl.call(Ju,e)?!1:Cb.test(e)?Zu[e]=!0:(Ju[e]=!0,!1)}function Pb(e,t,n,r){if(n!==null&&n.type===0)return!1;switch(typeof t){case"function":case"symbol":return!0;case"boolean":return r?!1:n!==null?!n.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function Ab(e,t,n,r){if(t===null||typeof t>"u"||Pb(e,t,n,r))return!0;if(r)return!1;if(n!==null)switch(n.type){case 3:return!t;case 4:return t===!1;case 5:return isNaN(t);case 6:return isNaN(t)||1>t}return!1}function Xe(e,t,n,r,i,a,s){this.acceptsBooleans=t===2||t===3||t===4,this.attributeName=r,this.attributeNamespace=i,this.mustUseProperty=n,this.propertyName=e,this.type=t,this.sanitizeURL=a,this.removeEmptyString=s}var Oe={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){Oe[e]=new Xe(e,0,!1,e,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var t=e[0];Oe[t]=new Xe(t,1,!1,e[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(e){Oe[e]=new Xe(e,2,!1,e.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){Oe[e]=new Xe(e,2,!1,e,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){Oe[e]=new Xe(e,3,!1,e.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(e){Oe[e]=new Xe(e,3,!0,e,null,!1,!1)});["capture","download"].forEach(function(e){Oe[e]=new Xe(e,4,!1,e,null,!1,!1)});["cols","rows","size","span"].forEach(function(e){Oe[e]=new Xe(e,6,!1,e,null,!1,!1)});["rowSpan","start"].forEach(function(e){Oe[e]=new Xe(e,5,!1,e.toLowerCase(),null,!1,!1)});var jh=/[\-:]([a-z])/g;function Eh(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var t=e.replace(jh,Eh);Oe[t]=new Xe(t,1,!1,e,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var t=e.replace(jh,Eh);Oe[t]=new Xe(t,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(e){var t=e.replace(jh,Eh);Oe[t]=new Xe(t,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(e){Oe[e]=new Xe(e,1,!1,e.toLowerCase(),null,!1,!1)});Oe.xlinkHref=new Xe("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(e){Oe[e]=new Xe(e,1,!1,e.toLowerCase(),null,!0,!0)});function Rh(e,t,n,r){var i=Oe.hasOwnProperty(t)?Oe[t]:null;(i!==null?i.type!==0:r||!(2<t.length)||t[0]!=="o"&&t[0]!=="O"||t[1]!=="n"&&t[1]!=="N")&&(Ab(t,n,i,r)&&(n=null),r||i===null?Sb(t)&&(n===null?e.removeAttribute(t):e.setAttribute(t,""+n)):i.mustUseProperty?e[i.propertyName]=n===null?i.type===3?!1:"":n:(t=i.attributeName,r=i.attributeNamespace,n===null?e.removeAttribute(t):(i=i.type,n=i===3||i===4&&n===!0?"":""+n,r?e.setAttributeNS(r,t,n):e.setAttribute(t,n))))}var vn=Tb.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,no=Symbol.for("react.element"),Hr=Symbol.for("react.portal"),Gr=Symbol.for("react.fragment"),Lh=Symbol.for("react.strict_mode"),ll=Symbol.for("react.profiler"),jg=Symbol.for("react.provider"),Eg=Symbol.for("react.context"),Dh=Symbol.for("react.forward_ref"),hl=Symbol.for("react.suspense"),ul=Symbol.for("react.suspense_list"),Mh=Symbol.for("react.memo"),In=Symbol.for("react.lazy"),Rg=Symbol.for("react.offscreen"),ed=Symbol.iterator;function zi(e){return e===null||typeof e!="object"?null:(e=ed&&e[ed]||e["@@iterator"],typeof e=="function"?e:null)}var ye=Object.assign,gc;function ta(e){if(gc===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);gc=t&&t[1]||""}return`
`+gc+e}var mc=!1;function fc(e,t){if(!e||mc)return"";mc=!0;var n=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{if(t)if(t=function(){throw Error()},Object.defineProperty(t.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(t,[])}catch(h){var r=h}Reflect.construct(e,[],t)}else{try{t.call()}catch(h){r=h}e.call(t.prototype)}else{try{throw Error()}catch(h){r=h}e()}}catch(h){if(h&&r&&typeof h.stack=="string"){for(var i=h.stack.split(`
`),a=r.stack.split(`
`),s=i.length-1,c=a.length-1;1<=s&&0<=c&&i[s]!==a[c];)c--;for(;1<=s&&0<=c;s--,c--)if(i[s]!==a[c]){if(s!==1||c!==1)do if(s--,c--,0>c||i[s]!==a[c]){var l=`
`+i[s].replace(" at new "," at ");return e.displayName&&l.includes("<anonymous>")&&(l=l.replace("<anonymous>",e.displayName)),l}while(1<=s&&0<=c);break}}}finally{mc=!1,Error.prepareStackTrace=n}return(e=e?e.displayName||e.name:"")?ta(e):""}function Ib(e){switch(e.tag){case 5:return ta(e.type);case 16:return ta("Lazy");case 13:return ta("Suspense");case 19:return ta("SuspenseList");case 0:case 2:case 15:return e=fc(e.type,!1),e;case 11:return e=fc(e.type.render,!1),e;case 1:return e=fc(e.type,!0),e;default:return""}}function dl(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case Gr:return"Fragment";case Hr:return"Portal";case ll:return"Profiler";case Lh:return"StrictMode";case hl:return"Suspense";case ul:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case Eg:return(e.displayName||"Context")+".Consumer";case jg:return(e._context.displayName||"Context")+".Provider";case Dh:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case Mh:return t=e.displayName||null,t!==null?t:dl(e.type)||"Memo";case In:t=e._payload,e=e._init;try{return dl(e(t))}catch{}}return null}function Nb(e){var t=e.type;switch(e.tag){case 24:return"Cache";case 9:return(t.displayName||"Context")+".Consumer";case 10:return(t._context.displayName||"Context")+".Provider";case 18:return"DehydratedFragment";case 11:return e=t.render,e=e.displayName||e.name||"",t.displayName||(e!==""?"ForwardRef("+e+")":"ForwardRef");case 7:return"Fragment";case 5:return t;case 4:return"Portal";case 3:return"Root";case 6:return"Text";case 16:return dl(t);case 8:return t===Lh?"StrictMode":"Mode";case 22:return"Offscreen";case 12:return"Profiler";case 21:return"Scope";case 13:return"Suspense";case 19:return"SuspenseList";case 25:return"TracingMarker";case 1:case 0:case 17:case 2:case 14:case 15:if(typeof t=="function")return t.displayName||t.name||null;if(typeof t=="string")return t}return null}function Xn(e){switch(typeof e){case"boolean":case"number":case"string":case"undefined":return e;case"object":return e;default:return""}}function Lg(e){var t=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(t==="checkbox"||t==="radio")}function jb(e){var t=Lg(e)?"checked":"value",n=Object.getOwnPropertyDescriptor(e.constructor.prototype,t),r=""+e[t];if(!e.hasOwnProperty(t)&&typeof n<"u"&&typeof n.get=="function"&&typeof n.set=="function"){var i=n.get,a=n.set;return Object.defineProperty(e,t,{configurable:!0,get:function(){return i.call(this)},set:function(s){r=""+s,a.call(this,s)}}),Object.defineProperty(e,t,{enumerable:n.enumerable}),{getValue:function(){return r},setValue:function(s){r=""+s},stopTracking:function(){e._valueTracker=null,delete e[t]}}}}function ro(e){e._valueTracker||(e._valueTracker=jb(e))}function Dg(e){if(!e)return!1;var t=e._valueTracker;if(!t)return!0;var n=t.getValue(),r="";return e&&(r=Lg(e)?e.checked?"true":"false":e.value),e=r,e!==n?(t.setValue(e),!0):!1}function Ko(e){if(e=e||(typeof document<"u"?document:void 0),typeof e>"u")return null;try{return e.activeElement||e.body}catch{return e.body}}function pl(e,t){var n=t.checked;return ye({},t,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:n??e._wrapperState.initialChecked})}function td(e,t){var n=t.defaultValue==null?"":t.defaultValue,r=t.checked!=null?t.checked:t.defaultChecked;n=Xn(t.value!=null?t.value:n),e._wrapperState={initialChecked:r,initialValue:n,controlled:t.type==="checkbox"||t.type==="radio"?t.checked!=null:t.value!=null}}function Mg(e,t){t=t.checked,t!=null&&Rh(e,"checked",t,!1)}function gl(e,t){Mg(e,t);var n=Xn(t.value),r=t.type;if(n!=null)r==="number"?(n===0&&e.value===""||e.value!=n)&&(e.value=""+n):e.value!==""+n&&(e.value=""+n);else if(r==="submit"||r==="reset"){e.removeAttribute("value");return}t.hasOwnProperty("value")?ml(e,t.type,n):t.hasOwnProperty("defaultValue")&&ml(e,t.type,Xn(t.defaultValue)),t.checked==null&&t.defaultChecked!=null&&(e.defaultChecked=!!t.defaultChecked)}function nd(e,t,n){if(t.hasOwnProperty("value")||t.hasOwnProperty("defaultValue")){var r=t.type;if(!(r!=="submit"&&r!=="reset"||t.value!==void 0&&t.value!==null))return;t=""+e._wrapperState.initialValue,n||t===e.value||(e.value=t),e.defaultValue=t}n=e.name,n!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,n!==""&&(e.name=n)}function ml(e,t,n){(t!=="number"||Ko(e.ownerDocument)!==e)&&(n==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+n&&(e.defaultValue=""+n))}var na=Array.isArray;function ri(e,t,n,r){if(e=e.options,t){t={};for(var i=0;i<n.length;i++)t["$"+n[i]]=!0;for(n=0;n<e.length;n++)i=t.hasOwnProperty("$"+e[n].value),e[n].selected!==i&&(e[n].selected=i),i&&r&&(e[n].defaultSelected=!0)}else{for(n=""+Xn(n),t=null,i=0;i<e.length;i++){if(e[i].value===n){e[i].selected=!0,r&&(e[i].defaultSelected=!0);return}t!==null||e[i].disabled||(t=e[i])}t!==null&&(t.selected=!0)}}function fl(e,t){if(t.dangerouslySetInnerHTML!=null)throw Error(L(91));return ye({},t,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function rd(e,t){var n=t.value;if(n==null){if(n=t.children,t=t.defaultValue,n!=null){if(t!=null)throw Error(L(92));if(na(n)){if(1<n.length)throw Error(L(93));n=n[0]}t=n}t==null&&(t=""),n=t}e._wrapperState={initialValue:Xn(n)}}function qg(e,t){var n=Xn(t.value),r=Xn(t.defaultValue);n!=null&&(n=""+n,n!==e.value&&(e.value=n),t.defaultValue==null&&e.defaultValue!==n&&(e.defaultValue=n)),r!=null&&(e.defaultValue=""+r)}function id(e){var t=e.textContent;t===e._wrapperState.initialValue&&t!==""&&t!==null&&(e.value=t)}function Og(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function yl(e,t){return e==null||e==="http://www.w3.org/1999/xhtml"?Og(t):e==="http://www.w3.org/2000/svg"&&t==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var io,Ug=function(e){return typeof MSApp<"u"&&MSApp.execUnsafeLocalFunction?function(t,n,r,i){MSApp.execUnsafeLocalFunction(function(){return e(t,n,r,i)})}:e}(function(e,t){if(e.namespaceURI!=="http://www.w3.org/2000/svg"||"innerHTML"in e)e.innerHTML=t;else{for(io=io||document.createElement("div"),io.innerHTML="<svg>"+t.valueOf().toString()+"</svg>",t=io.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;t.firstChild;)e.appendChild(t.firstChild)}});function va(e,t){if(t){var n=e.firstChild;if(n&&n===e.lastChild&&n.nodeType===3){n.nodeValue=t;return}}e.textContent=t}var aa={animationIterationCount:!0,aspectRatio:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Eb=["Webkit","ms","Moz","O"];Object.keys(aa).forEach(function(e){Eb.forEach(function(t){t=t+e.charAt(0).toUpperCase()+e.substring(1),aa[t]=aa[e]})});function _g(e,t,n){return t==null||typeof t=="boolean"||t===""?"":n||typeof t!="number"||t===0||aa.hasOwnProperty(e)&&aa[e]?(""+t).trim():t+"px"}function Fg(e,t){e=e.style;for(var n in t)if(t.hasOwnProperty(n)){var r=n.indexOf("--")===0,i=_g(n,t[n],r);n==="float"&&(n="cssFloat"),r?e.setProperty(n,i):e[n]=i}}var Rb=ye({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function vl(e,t){if(t){if(Rb[e]&&(t.children!=null||t.dangerouslySetInnerHTML!=null))throw Error(L(137,e));if(t.dangerouslySetInnerHTML!=null){if(t.children!=null)throw Error(L(60));if(typeof t.dangerouslySetInnerHTML!="object"||!("__html"in t.dangerouslySetInnerHTML))throw Error(L(61))}if(t.style!=null&&typeof t.style!="object")throw Error(L(62))}}function bl(e,t){if(e.indexOf("-")===-1)return typeof t.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var wl=null;function qh(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var xl=null,ii=null,ai=null;function ad(e){if(e=Wa(e)){if(typeof xl!="function")throw Error(L(280));var t=e.stateNode;t&&(t=Ds(t),xl(e.stateNode,e.type,t))}}function Bg(e){ii?ai?ai.push(e):ai=[e]:ii=e}function Vg(){if(ii){var e=ii,t=ai;if(ai=ii=null,ad(e),t)for(e=0;e<t.length;e++)ad(t[e])}}function zg(e,t){return e(t)}function Hg(){}var yc=!1;function Gg(e,t,n){if(yc)return e(t,n);yc=!0;try{return zg(e,t,n)}finally{yc=!1,(ii!==null||ai!==null)&&(Hg(),Vg())}}function ba(e,t){var n=e.stateNode;if(n===null)return null;var r=Ds(n);if(r===null)return null;n=r[t];e:switch(t){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(r=!r.disabled)||(e=e.type,r=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!r;break e;default:e=!1}if(e)return null;if(n&&typeof n!="function")throw Error(L(231,t,typeof n));return n}var kl=!1;if(un)try{var Hi={};Object.defineProperty(Hi,"passive",{get:function(){kl=!0}}),window.addEventListener("test",Hi,Hi),window.removeEventListener("test",Hi,Hi)}catch{kl=!1}function Lb(e,t,n,r,i,a,s,c,l){var h=Array.prototype.slice.call(arguments,3);try{t.apply(n,h)}catch(u){this.onError(u)}}var oa=!1,Qo=null,Yo=!1,Tl=null,Db={onError:function(e){oa=!0,Qo=e}};function Mb(e,t,n,r,i,a,s,c,l){oa=!1,Qo=null,Lb.apply(Db,arguments)}function qb(e,t,n,r,i,a,s,c,l){if(Mb.apply(this,arguments),oa){if(oa){var h=Qo;oa=!1,Qo=null}else throw Error(L(198));Yo||(Yo=!0,Tl=h)}}function Lr(e){var t=e,n=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,t.flags&4098&&(n=t.return),e=t.return;while(e)}return t.tag===3?n:null}function Wg(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function od(e){if(Lr(e)!==e)throw Error(L(188))}function Ob(e){var t=e.alternate;if(!t){if(t=Lr(e),t===null)throw Error(L(188));return t!==e?null:e}for(var n=e,r=t;;){var i=n.return;if(i===null)break;var a=i.alternate;if(a===null){if(r=i.return,r!==null){n=r;continue}break}if(i.child===a.child){for(a=i.child;a;){if(a===n)return od(i),e;if(a===r)return od(i),t;a=a.sibling}throw Error(L(188))}if(n.return!==r.return)n=i,r=a;else{for(var s=!1,c=i.child;c;){if(c===n){s=!0,n=i,r=a;break}if(c===r){s=!0,r=i,n=a;break}c=c.sibling}if(!s){for(c=a.child;c;){if(c===n){s=!0,n=a,r=i;break}if(c===r){s=!0,r=a,n=i;break}c=c.sibling}if(!s)throw Error(L(189))}}if(n.alternate!==r)throw Error(L(190))}if(n.tag!==3)throw Error(L(188));return n.stateNode.current===n?e:t}function $g(e){return e=Ob(e),e!==null?Kg(e):null}function Kg(e){if(e.tag===5||e.tag===6)return e;for(e=e.child;e!==null;){var t=Kg(e);if(t!==null)return t;e=e.sibling}return null}var Qg=dt.unstable_scheduleCallback,sd=dt.unstable_cancelCallback,Ub=dt.unstable_shouldYield,_b=dt.unstable_requestPaint,xe=dt.unstable_now,Fb=dt.unstable_getCurrentPriorityLevel,Oh=dt.unstable_ImmediatePriority,Yg=dt.unstable_UserBlockingPriority,Xo=dt.unstable_NormalPriority,Bb=dt.unstable_LowPriority,Xg=dt.unstable_IdlePriority,js=null,Qt=null;function Vb(e){if(Qt&&typeof Qt.onCommitFiberRoot=="function")try{Qt.onCommitFiberRoot(js,e,void 0,(e.current.flags&128)===128)}catch{}}var Lt=Math.clz32?Math.clz32:Gb,zb=Math.log,Hb=Math.LN2;function Gb(e){return e>>>=0,e===0?32:31-(zb(e)/Hb|0)|0}var ao=64,oo=4194304;function ra(e){switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return e&4194240;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return e&130023424;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 1073741824;default:return e}}function Jo(e,t){var n=e.pendingLanes;if(n===0)return 0;var r=0,i=e.suspendedLanes,a=e.pingedLanes,s=n&268435455;if(s!==0){var c=s&~i;c!==0?r=ra(c):(a&=s,a!==0&&(r=ra(a)))}else s=n&~i,s!==0?r=ra(s):a!==0&&(r=ra(a));if(r===0)return 0;if(t!==0&&t!==r&&!(t&i)&&(i=r&-r,a=t&-t,i>=a||i===16&&(a&4194240)!==0))return t;if(r&4&&(r|=n&16),t=e.entangledLanes,t!==0)for(e=e.entanglements,t&=r;0<t;)n=31-Lt(t),i=1<<n,r|=e[n],t&=~i;return r}function Wb(e,t){switch(e){case 1:case 2:case 4:return t+250;case 8:case 16:case 32:case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return t+5e3;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return-1;case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function $b(e,t){for(var n=e.suspendedLanes,r=e.pingedLanes,i=e.expirationTimes,a=e.pendingLanes;0<a;){var s=31-Lt(a),c=1<<s,l=i[s];l===-1?(!(c&n)||c&r)&&(i[s]=Wb(c,t)):l<=t&&(e.expiredLanes|=c),a&=~c}}function Cl(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function Jg(){var e=ao;return ao<<=1,!(ao&4194240)&&(ao=64),e}function vc(e){for(var t=[],n=0;31>n;n++)t.push(e);return t}function Ha(e,t,n){e.pendingLanes|=t,t!==536870912&&(e.suspendedLanes=0,e.pingedLanes=0),e=e.eventTimes,t=31-Lt(t),e[t]=n}function Kb(e,t){var n=e.pendingLanes&~t;e.pendingLanes=t,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=t,e.mutableReadLanes&=t,e.entangledLanes&=t,t=e.entanglements;var r=e.eventTimes;for(e=e.expirationTimes;0<n;){var i=31-Lt(n),a=1<<i;t[i]=0,r[i]=-1,e[i]=-1,n&=~a}}function Uh(e,t){var n=e.entangledLanes|=t;for(e=e.entanglements;n;){var r=31-Lt(n),i=1<<r;i&t|e[r]&t&&(e[r]|=t),n&=~i}}var oe=0;function Zg(e){return e&=-e,1<e?4<e?e&268435455?16:536870912:4:1}var em,_h,tm,nm,rm,Sl=!1,so=[],Bn=null,Vn=null,zn=null,wa=new Map,xa=new Map,jn=[],Qb="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function cd(e,t){switch(e){case"focusin":case"focusout":Bn=null;break;case"dragenter":case"dragleave":Vn=null;break;case"mouseover":case"mouseout":zn=null;break;case"pointerover":case"pointerout":wa.delete(t.pointerId);break;case"gotpointercapture":case"lostpointercapture":xa.delete(t.pointerId)}}function Gi(e,t,n,r,i,a){return e===null||e.nativeEvent!==a?(e={blockedOn:t,domEventName:n,eventSystemFlags:r,nativeEvent:a,targetContainers:[i]},t!==null&&(t=Wa(t),t!==null&&_h(t)),e):(e.eventSystemFlags|=r,t=e.targetContainers,i!==null&&t.indexOf(i)===-1&&t.push(i),e)}function Yb(e,t,n,r,i){switch(t){case"focusin":return Bn=Gi(Bn,e,t,n,r,i),!0;case"dragenter":return Vn=Gi(Vn,e,t,n,r,i),!0;case"mouseover":return zn=Gi(zn,e,t,n,r,i),!0;case"pointerover":var a=i.pointerId;return wa.set(a,Gi(wa.get(a)||null,e,t,n,r,i)),!0;case"gotpointercapture":return a=i.pointerId,xa.set(a,Gi(xa.get(a)||null,e,t,n,r,i)),!0}return!1}function im(e){var t=dr(e.target);if(t!==null){var n=Lr(t);if(n!==null){if(t=n.tag,t===13){if(t=Wg(n),t!==null){e.blockedOn=t,rm(e.priority,function(){tm(n)});return}}else if(t===3&&n.stateNode.current.memoizedState.isDehydrated){e.blockedOn=n.tag===3?n.stateNode.containerInfo:null;return}}}e.blockedOn=null}function No(e){if(e.blockedOn!==null)return!1;for(var t=e.targetContainers;0<t.length;){var n=Pl(e.domEventName,e.eventSystemFlags,t[0],e.nativeEvent);if(n===null){n=e.nativeEvent;var r=new n.constructor(n.type,n);wl=r,n.target.dispatchEvent(r),wl=null}else return t=Wa(n),t!==null&&_h(t),e.blockedOn=n,!1;t.shift()}return!0}function ld(e,t,n){No(e)&&n.delete(t)}function Xb(){Sl=!1,Bn!==null&&No(Bn)&&(Bn=null),Vn!==null&&No(Vn)&&(Vn=null),zn!==null&&No(zn)&&(zn=null),wa.forEach(ld),xa.forEach(ld)}function Wi(e,t){e.blockedOn===t&&(e.blockedOn=null,Sl||(Sl=!0,dt.unstable_scheduleCallback(dt.unstable_NormalPriority,Xb)))}function ka(e){function t(i){return Wi(i,e)}if(0<so.length){Wi(so[0],e);for(var n=1;n<so.length;n++){var r=so[n];r.blockedOn===e&&(r.blockedOn=null)}}for(Bn!==null&&Wi(Bn,e),Vn!==null&&Wi(Vn,e),zn!==null&&Wi(zn,e),wa.forEach(t),xa.forEach(t),n=0;n<jn.length;n++)r=jn[n],r.blockedOn===e&&(r.blockedOn=null);for(;0<jn.length&&(n=jn[0],n.blockedOn===null);)im(n),n.blockedOn===null&&jn.shift()}var oi=vn.ReactCurrentBatchConfig,Zo=!0;function Jb(e,t,n,r){var i=oe,a=oi.transition;oi.transition=null;try{oe=1,Fh(e,t,n,r)}finally{oe=i,oi.transition=a}}function Zb(e,t,n,r){var i=oe,a=oi.transition;oi.transition=null;try{oe=4,Fh(e,t,n,r)}finally{oe=i,oi.transition=a}}function Fh(e,t,n,r){if(Zo){var i=Pl(e,t,n,r);if(i===null)Ic(e,t,r,es,n),cd(e,r);else if(Yb(i,e,t,n,r))r.stopPropagation();else if(cd(e,r),t&4&&-1<Qb.indexOf(e)){for(;i!==null;){var a=Wa(i);if(a!==null&&em(a),a=Pl(e,t,n,r),a===null&&Ic(e,t,r,es,n),a===i)break;i=a}i!==null&&r.stopPropagation()}else Ic(e,t,r,null,n)}}var es=null;function Pl(e,t,n,r){if(es=null,e=qh(r),e=dr(e),e!==null)if(t=Lr(e),t===null)e=null;else if(n=t.tag,n===13){if(e=Wg(t),e!==null)return e;e=null}else if(n===3){if(t.stateNode.current.memoizedState.isDehydrated)return t.tag===3?t.stateNode.containerInfo:null;e=null}else t!==e&&(e=null);return es=e,null}function am(e){switch(e){case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 1;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"toggle":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 4;case"message":switch(Fb()){case Oh:return 1;case Yg:return 4;case Xo:case Bb:return 16;case Xg:return 536870912;default:return 16}default:return 16}}var On=null,Bh=null,jo=null;function om(){if(jo)return jo;var e,t=Bh,n=t.length,r,i="value"in On?On.value:On.textContent,a=i.length;for(e=0;e<n&&t[e]===i[e];e++);var s=n-e;for(r=1;r<=s&&t[n-r]===i[a-r];r++);return jo=i.slice(e,1<r?1-r:void 0)}function Eo(e){var t=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&t===13&&(e=13)):e=t,e===10&&(e=13),32<=e||e===13?e:0}function co(){return!0}function hd(){return!1}function gt(e){function t(n,r,i,a,s){this._reactName=n,this._targetInst=i,this.type=r,this.nativeEvent=a,this.target=s,this.currentTarget=null;for(var c in e)e.hasOwnProperty(c)&&(n=e[c],this[c]=n?n(a):a[c]);return this.isDefaultPrevented=(a.defaultPrevented!=null?a.defaultPrevented:a.returnValue===!1)?co:hd,this.isPropagationStopped=hd,this}return ye(t.prototype,{preventDefault:function(){this.defaultPrevented=!0;var n=this.nativeEvent;n&&(n.preventDefault?n.preventDefault():typeof n.returnValue!="unknown"&&(n.returnValue=!1),this.isDefaultPrevented=co)},stopPropagation:function(){var n=this.nativeEvent;n&&(n.stopPropagation?n.stopPropagation():typeof n.cancelBubble!="unknown"&&(n.cancelBubble=!0),this.isPropagationStopped=co)},persist:function(){},isPersistent:co}),t}var Mi={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Vh=gt(Mi),Ga=ye({},Mi,{view:0,detail:0}),ew=gt(Ga),bc,wc,$i,Es=ye({},Ga,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:zh,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==$i&&($i&&e.type==="mousemove"?(bc=e.screenX-$i.screenX,wc=e.screenY-$i.screenY):wc=bc=0,$i=e),bc)},movementY:function(e){return"movementY"in e?e.movementY:wc}}),ud=gt(Es),tw=ye({},Es,{dataTransfer:0}),nw=gt(tw),rw=ye({},Ga,{relatedTarget:0}),xc=gt(rw),iw=ye({},Mi,{animationName:0,elapsedTime:0,pseudoElement:0}),aw=gt(iw),ow=ye({},Mi,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),sw=gt(ow),cw=ye({},Mi,{data:0}),dd=gt(cw),lw={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},hw={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},uw={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function dw(e){var t=this.nativeEvent;return t.getModifierState?t.getModifierState(e):(e=uw[e])?!!t[e]:!1}function zh(){return dw}var pw=ye({},Ga,{key:function(e){if(e.key){var t=lw[e.key]||e.key;if(t!=="Unidentified")return t}return e.type==="keypress"?(e=Eo(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?hw[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:zh,charCode:function(e){return e.type==="keypress"?Eo(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?Eo(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),gw=gt(pw),mw=ye({},Es,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),pd=gt(mw),fw=ye({},Ga,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:zh}),yw=gt(fw),vw=ye({},Mi,{propertyName:0,elapsedTime:0,pseudoElement:0}),bw=gt(vw),ww=ye({},Es,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),xw=gt(ww),kw=[9,13,27,32],Hh=un&&"CompositionEvent"in window,sa=null;un&&"documentMode"in document&&(sa=document.documentMode);var Tw=un&&"TextEvent"in window&&!sa,sm=un&&(!Hh||sa&&8<sa&&11>=sa),gd=" ",md=!1;function cm(e,t){switch(e){case"keyup":return kw.indexOf(t.keyCode)!==-1;case"keydown":return t.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function lm(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var Wr=!1;function Cw(e,t){switch(e){case"compositionend":return lm(t);case"keypress":return t.which!==32?null:(md=!0,gd);case"textInput":return e=t.data,e===gd&&md?null:e;default:return null}}function Sw(e,t){if(Wr)return e==="compositionend"||!Hh&&cm(e,t)?(e=om(),jo=Bh=On=null,Wr=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(t.ctrlKey||t.altKey||t.metaKey)||t.ctrlKey&&t.altKey){if(t.char&&1<t.char.length)return t.char;if(t.which)return String.fromCharCode(t.which)}return null;case"compositionend":return sm&&t.locale!=="ko"?null:t.data;default:return null}}var Pw={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function fd(e){var t=e&&e.nodeName&&e.nodeName.toLowerCase();return t==="input"?!!Pw[e.type]:t==="textarea"}function hm(e,t,n,r){Bg(r),t=ts(t,"onChange"),0<t.length&&(n=new Vh("onChange","change",null,n,r),e.push({event:n,listeners:t}))}var ca=null,Ta=null;function Aw(e){xm(e,0)}function Rs(e){var t=Qr(e);if(Dg(t))return e}function Iw(e,t){if(e==="change")return t}var um=!1;if(un){var kc;if(un){var Tc="oninput"in document;if(!Tc){var yd=document.createElement("div");yd.setAttribute("oninput","return;"),Tc=typeof yd.oninput=="function"}kc=Tc}else kc=!1;um=kc&&(!document.documentMode||9<document.documentMode)}function vd(){ca&&(ca.detachEvent("onpropertychange",dm),Ta=ca=null)}function dm(e){if(e.propertyName==="value"&&Rs(Ta)){var t=[];hm(t,Ta,e,qh(e)),Gg(Aw,t)}}function Nw(e,t,n){e==="focusin"?(vd(),ca=t,Ta=n,ca.attachEvent("onpropertychange",dm)):e==="focusout"&&vd()}function jw(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return Rs(Ta)}function Ew(e,t){if(e==="click")return Rs(t)}function Rw(e,t){if(e==="input"||e==="change")return Rs(t)}function Lw(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}var Mt=typeof Object.is=="function"?Object.is:Lw;function Ca(e,t){if(Mt(e,t))return!0;if(typeof e!="object"||e===null||typeof t!="object"||t===null)return!1;var n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(r=0;r<n.length;r++){var i=n[r];if(!cl.call(t,i)||!Mt(e[i],t[i]))return!1}return!0}function bd(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function wd(e,t){var n=bd(e);e=0;for(var r;n;){if(n.nodeType===3){if(r=e+n.textContent.length,e<=t&&r>=t)return{node:n,offset:t-e};e=r}e:{for(;n;){if(n.nextSibling){n=n.nextSibling;break e}n=n.parentNode}n=void 0}n=bd(n)}}function pm(e,t){return e&&t?e===t?!0:e&&e.nodeType===3?!1:t&&t.nodeType===3?pm(e,t.parentNode):"contains"in e?e.contains(t):e.compareDocumentPosition?!!(e.compareDocumentPosition(t)&16):!1:!1}function gm(){for(var e=window,t=Ko();t instanceof e.HTMLIFrameElement;){try{var n=typeof t.contentWindow.location.href=="string"}catch{n=!1}if(n)e=t.contentWindow;else break;t=Ko(e.document)}return t}function Gh(e){var t=e&&e.nodeName&&e.nodeName.toLowerCase();return t&&(t==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||t==="textarea"||e.contentEditable==="true")}function Dw(e){var t=gm(),n=e.focusedElem,r=e.selectionRange;if(t!==n&&n&&n.ownerDocument&&pm(n.ownerDocument.documentElement,n)){if(r!==null&&Gh(n)){if(t=r.start,e=r.end,e===void 0&&(e=t),"selectionStart"in n)n.selectionStart=t,n.selectionEnd=Math.min(e,n.value.length);else if(e=(t=n.ownerDocument||document)&&t.defaultView||window,e.getSelection){e=e.getSelection();var i=n.textContent.length,a=Math.min(r.start,i);r=r.end===void 0?a:Math.min(r.end,i),!e.extend&&a>r&&(i=r,r=a,a=i),i=wd(n,a);var s=wd(n,r);i&&s&&(e.rangeCount!==1||e.anchorNode!==i.node||e.anchorOffset!==i.offset||e.focusNode!==s.node||e.focusOffset!==s.offset)&&(t=t.createRange(),t.setStart(i.node,i.offset),e.removeAllRanges(),a>r?(e.addRange(t),e.extend(s.node,s.offset)):(t.setEnd(s.node,s.offset),e.addRange(t)))}}for(t=[],e=n;e=e.parentNode;)e.nodeType===1&&t.push({element:e,left:e.scrollLeft,top:e.scrollTop});for(typeof n.focus=="function"&&n.focus(),n=0;n<t.length;n++)e=t[n],e.element.scrollLeft=e.left,e.element.scrollTop=e.top}}var Mw=un&&"documentMode"in document&&11>=document.documentMode,$r=null,Al=null,la=null,Il=!1;function xd(e,t,n){var r=n.window===n?n.document:n.nodeType===9?n:n.ownerDocument;Il||$r==null||$r!==Ko(r)||(r=$r,"selectionStart"in r&&Gh(r)?r={start:r.selectionStart,end:r.selectionEnd}:(r=(r.ownerDocument&&r.ownerDocument.defaultView||window).getSelection(),r={anchorNode:r.anchorNode,anchorOffset:r.anchorOffset,focusNode:r.focusNode,focusOffset:r.focusOffset}),la&&Ca(la,r)||(la=r,r=ts(Al,"onSelect"),0<r.length&&(t=new Vh("onSelect","select",null,t,n),e.push({event:t,listeners:r}),t.target=$r)))}function lo(e,t){var n={};return n[e.toLowerCase()]=t.toLowerCase(),n["Webkit"+e]="webkit"+t,n["Moz"+e]="moz"+t,n}var Kr={animationend:lo("Animation","AnimationEnd"),animationiteration:lo("Animation","AnimationIteration"),animationstart:lo("Animation","AnimationStart"),transitionend:lo("Transition","TransitionEnd")},Cc={},mm={};un&&(mm=document.createElement("div").style,"AnimationEvent"in window||(delete Kr.animationend.animation,delete Kr.animationiteration.animation,delete Kr.animationstart.animation),"TransitionEvent"in window||delete Kr.transitionend.transition);function Ls(e){if(Cc[e])return Cc[e];if(!Kr[e])return e;var t=Kr[e],n;for(n in t)if(t.hasOwnProperty(n)&&n in mm)return Cc[e]=t[n];return e}var fm=Ls("animationend"),ym=Ls("animationiteration"),vm=Ls("animationstart"),bm=Ls("transitionend"),wm=new Map,kd="abort auxClick cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");function nr(e,t){wm.set(e,t),Rr(t,[e])}for(var Sc=0;Sc<kd.length;Sc++){var Pc=kd[Sc],qw=Pc.toLowerCase(),Ow=Pc[0].toUpperCase()+Pc.slice(1);nr(qw,"on"+Ow)}nr(fm,"onAnimationEnd");nr(ym,"onAnimationIteration");nr(vm,"onAnimationStart");nr("dblclick","onDoubleClick");nr("focusin","onFocus");nr("focusout","onBlur");nr(bm,"onTransitionEnd");wi("onMouseEnter",["mouseout","mouseover"]);wi("onMouseLeave",["mouseout","mouseover"]);wi("onPointerEnter",["pointerout","pointerover"]);wi("onPointerLeave",["pointerout","pointerover"]);Rr("onChange","change click focusin focusout input keydown keyup selectionchange".split(" "));Rr("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" "));Rr("onBeforeInput",["compositionend","keypress","textInput","paste"]);Rr("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" "));Rr("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" "));Rr("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var ia="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),Uw=new Set("cancel close invalid load scroll toggle".split(" ").concat(ia));function Td(e,t,n){var r=e.type||"unknown-event";e.currentTarget=n,qb(r,t,void 0,e),e.currentTarget=null}function xm(e,t){t=(t&4)!==0;for(var n=0;n<e.length;n++){var r=e[n],i=r.event;r=r.listeners;e:{var a=void 0;if(t)for(var s=r.length-1;0<=s;s--){var c=r[s],l=c.instance,h=c.currentTarget;if(c=c.listener,l!==a&&i.isPropagationStopped())break e;Td(i,c,h),a=l}else for(s=0;s<r.length;s++){if(c=r[s],l=c.instance,h=c.currentTarget,c=c.listener,l!==a&&i.isPropagationStopped())break e;Td(i,c,h),a=l}}}if(Yo)throw e=Tl,Yo=!1,Tl=null,e}function le(e,t){var n=t[Ll];n===void 0&&(n=t[Ll]=new Set);var r=e+"__bubble";n.has(r)||(km(t,e,2,!1),n.add(r))}function Ac(e,t,n){var r=0;t&&(r|=4),km(n,e,r,t)}var ho="_reactListening"+Math.random().toString(36).slice(2);function Sa(e){if(!e[ho]){e[ho]=!0,Ng.forEach(function(n){n!=="selectionchange"&&(Uw.has(n)||Ac(n,!1,e),Ac(n,!0,e))});var t=e.nodeType===9?e:e.ownerDocument;t===null||t[ho]||(t[ho]=!0,Ac("selectionchange",!1,t))}}function km(e,t,n,r){switch(am(t)){case 1:var i=Jb;break;case 4:i=Zb;break;default:i=Fh}n=i.bind(null,t,n,e),i=void 0,!kl||t!=="touchstart"&&t!=="touchmove"&&t!=="wheel"||(i=!0),r?i!==void 0?e.addEventListener(t,n,{capture:!0,passive:i}):e.addEventListener(t,n,!0):i!==void 0?e.addEventListener(t,n,{passive:i}):e.addEventListener(t,n,!1)}function Ic(e,t,n,r,i){var a=r;if(!(t&1)&&!(t&2)&&r!==null)e:for(;;){if(r===null)return;var s=r.tag;if(s===3||s===4){var c=r.stateNode.containerInfo;if(c===i||c.nodeType===8&&c.parentNode===i)break;if(s===4)for(s=r.return;s!==null;){var l=s.tag;if((l===3||l===4)&&(l=s.stateNode.containerInfo,l===i||l.nodeType===8&&l.parentNode===i))return;s=s.return}for(;c!==null;){if(s=dr(c),s===null)return;if(l=s.tag,l===5||l===6){r=a=s;continue e}c=c.parentNode}}r=r.return}Gg(function(){var h=a,u=qh(n),d=[];e:{var p=wm.get(e);if(p!==void 0){var v=Vh,x=e;switch(e){case"keypress":if(Eo(n)===0)break e;case"keydown":case"keyup":v=gw;break;case"focusin":x="focus",v=xc;break;case"focusout":x="blur",v=xc;break;case"beforeblur":case"afterblur":v=xc;break;case"click":if(n.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":v=ud;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":v=nw;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":v=yw;break;case fm:case ym:case vm:v=aw;break;case bm:v=bw;break;case"scroll":v=ew;break;case"wheel":v=xw;break;case"copy":case"cut":case"paste":v=sw;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":v=pd}var y=(t&4)!==0,k=!y&&e==="scroll",f=y?p!==null?p+"Capture":null:p;y=[];for(var g=h,b;g!==null;){b=g;var w=b.stateNode;if(b.tag===5&&w!==null&&(b=w,f!==null&&(w=ba(g,f),w!=null&&y.push(Pa(g,w,b)))),k)break;g=g.return}0<y.length&&(p=new v(p,x,null,n,u),d.push({event:p,listeners:y}))}}if(!(t&7)){e:{if(p=e==="mouseover"||e==="pointerover",v=e==="mouseout"||e==="pointerout",p&&n!==wl&&(x=n.relatedTarget||n.fromElement)&&(dr(x)||x[dn]))break e;if((v||p)&&(p=u.window===u?u:(p=u.ownerDocument)?p.defaultView||p.parentWindow:window,v?(x=n.relatedTarget||n.toElement,v=h,x=x?dr(x):null,x!==null&&(k=Lr(x),x!==k||x.tag!==5&&x.tag!==6)&&(x=null)):(v=null,x=h),v!==x)){if(y=ud,w="onMouseLeave",f="onMouseEnter",g="mouse",(e==="pointerout"||e==="pointerover")&&(y=pd,w="onPointerLeave",f="onPointerEnter",g="pointer"),k=v==null?p:Qr(v),b=x==null?p:Qr(x),p=new y(w,g+"leave",v,n,u),p.target=k,p.relatedTarget=b,w=null,dr(u)===h&&(y=new y(f,g+"enter",x,n,u),y.target=b,y.relatedTarget=k,w=y),k=w,v&&x)t:{for(y=v,f=x,g=0,b=y;b;b=Ur(b))g++;for(b=0,w=f;w;w=Ur(w))b++;for(;0<g-b;)y=Ur(y),g--;for(;0<b-g;)f=Ur(f),b--;for(;g--;){if(y===f||f!==null&&y===f.alternate)break t;y=Ur(y),f=Ur(f)}y=null}else y=null;v!==null&&Cd(d,p,v,y,!1),x!==null&&k!==null&&Cd(d,k,x,y,!0)}}e:{if(p=h?Qr(h):window,v=p.nodeName&&p.nodeName.toLowerCase(),v==="select"||v==="input"&&p.type==="file")var T=Iw;else if(fd(p))if(um)T=Rw;else{T=jw;var C=Nw}else(v=p.nodeName)&&v.toLowerCase()==="input"&&(p.type==="checkbox"||p.type==="radio")&&(T=Ew);if(T&&(T=T(e,h))){hm(d,T,n,u);break e}C&&C(e,p,h),e==="focusout"&&(C=p._wrapperState)&&C.controlled&&p.type==="number"&&ml(p,"number",p.value)}switch(C=h?Qr(h):window,e){case"focusin":(fd(C)||C.contentEditable==="true")&&($r=C,Al=h,la=null);break;case"focusout":la=Al=$r=null;break;case"mousedown":Il=!0;break;case"contextmenu":case"mouseup":case"dragend":Il=!1,xd(d,n,u);break;case"selectionchange":if(Mw)break;case"keydown":case"keyup":xd(d,n,u)}var P;if(Hh)e:{switch(e){case"compositionstart":var S="onCompositionStart";break e;case"compositionend":S="onCompositionEnd";break e;case"compositionupdate":S="onCompositionUpdate";break e}S=void 0}else Wr?cm(e,n)&&(S="onCompositionEnd"):e==="keydown"&&n.keyCode===229&&(S="onCompositionStart");S&&(sm&&n.locale!=="ko"&&(Wr||S!=="onCompositionStart"?S==="onCompositionEnd"&&Wr&&(P=om()):(On=u,Bh="value"in On?On.value:On.textContent,Wr=!0)),C=ts(h,S),0<C.length&&(S=new dd(S,e,null,n,u),d.push({event:S,listeners:C}),P?S.data=P:(P=lm(n),P!==null&&(S.data=P)))),(P=Tw?Cw(e,n):Sw(e,n))&&(h=ts(h,"onBeforeInput"),0<h.length&&(u=new dd("onBeforeInput","beforeinput",null,n,u),d.push({event:u,listeners:h}),u.data=P))}xm(d,t)})}function Pa(e,t,n){return{instance:e,listener:t,currentTarget:n}}function ts(e,t){for(var n=t+"Capture",r=[];e!==null;){var i=e,a=i.stateNode;i.tag===5&&a!==null&&(i=a,a=ba(e,n),a!=null&&r.unshift(Pa(e,a,i)),a=ba(e,t),a!=null&&r.push(Pa(e,a,i))),e=e.return}return r}function Ur(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function Cd(e,t,n,r,i){for(var a=t._reactName,s=[];n!==null&&n!==r;){var c=n,l=c.alternate,h=c.stateNode;if(l!==null&&l===r)break;c.tag===5&&h!==null&&(c=h,i?(l=ba(n,a),l!=null&&s.unshift(Pa(n,l,c))):i||(l=ba(n,a),l!=null&&s.push(Pa(n,l,c)))),n=n.return}s.length!==0&&e.push({event:t,listeners:s})}var _w=/\r\n?/g,Fw=/\u0000|\uFFFD/g;function Sd(e){return(typeof e=="string"?e:""+e).replace(_w,`
`).replace(Fw,"")}function uo(e,t,n){if(t=Sd(t),Sd(e)!==t&&n)throw Error(L(425))}function ns(){}var Nl=null,jl=null;function El(e,t){return e==="textarea"||e==="noscript"||typeof t.children=="string"||typeof t.children=="number"||typeof t.dangerouslySetInnerHTML=="object"&&t.dangerouslySetInnerHTML!==null&&t.dangerouslySetInnerHTML.__html!=null}var Rl=typeof setTimeout=="function"?setTimeout:void 0,Bw=typeof clearTimeout=="function"?clearTimeout:void 0,Pd=typeof Promise=="function"?Promise:void 0,Vw=typeof queueMicrotask=="function"?queueMicrotask:typeof Pd<"u"?function(e){return Pd.resolve(null).then(e).catch(zw)}:Rl;function zw(e){setTimeout(function(){throw e})}function Nc(e,t){var n=t,r=0;do{var i=n.nextSibling;if(e.removeChild(n),i&&i.nodeType===8)if(n=i.data,n==="/$"){if(r===0){e.removeChild(i),ka(t);return}r--}else n!=="$"&&n!=="$?"&&n!=="$!"||r++;n=i}while(n);ka(t)}function Hn(e){for(;e!=null;e=e.nextSibling){var t=e.nodeType;if(t===1||t===3)break;if(t===8){if(t=e.data,t==="$"||t==="$!"||t==="$?")break;if(t==="/$")return null}}return e}function Ad(e){e=e.previousSibling;for(var t=0;e;){if(e.nodeType===8){var n=e.data;if(n==="$"||n==="$!"||n==="$?"){if(t===0)return e;t--}else n==="/$"&&t++}e=e.previousSibling}return null}var qi=Math.random().toString(36).slice(2),Gt="__reactFiber$"+qi,Aa="__reactProps$"+qi,dn="__reactContainer$"+qi,Ll="__reactEvents$"+qi,Hw="__reactListeners$"+qi,Gw="__reactHandles$"+qi;function dr(e){var t=e[Gt];if(t)return t;for(var n=e.parentNode;n;){if(t=n[dn]||n[Gt]){if(n=t.alternate,t.child!==null||n!==null&&n.child!==null)for(e=Ad(e);e!==null;){if(n=e[Gt])return n;e=Ad(e)}return t}e=n,n=e.parentNode}return null}function Wa(e){return e=e[Gt]||e[dn],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function Qr(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(L(33))}function Ds(e){return e[Aa]||null}var Dl=[],Yr=-1;function rr(e){return{current:e}}function he(e){0>Yr||(e.current=Dl[Yr],Dl[Yr]=null,Yr--)}function se(e,t){Yr++,Dl[Yr]=e.current,e.current=t}var Jn={},He=rr(Jn),tt=rr(!1),Pr=Jn;function xi(e,t){var n=e.type.contextTypes;if(!n)return Jn;var r=e.stateNode;if(r&&r.__reactInternalMemoizedUnmaskedChildContext===t)return r.__reactInternalMemoizedMaskedChildContext;var i={},a;for(a in n)i[a]=t[a];return r&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=t,e.__reactInternalMemoizedMaskedChildContext=i),i}function nt(e){return e=e.childContextTypes,e!=null}function rs(){he(tt),he(He)}function Id(e,t,n){if(He.current!==Jn)throw Error(L(168));se(He,t),se(tt,n)}function Tm(e,t,n){var r=e.stateNode;if(t=t.childContextTypes,typeof r.getChildContext!="function")return n;r=r.getChildContext();for(var i in r)if(!(i in t))throw Error(L(108,Nb(e)||"Unknown",i));return ye({},n,r)}function is(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||Jn,Pr=He.current,se(He,e),se(tt,tt.current),!0}function Nd(e,t,n){var r=e.stateNode;if(!r)throw Error(L(169));n?(e=Tm(e,t,Pr),r.__reactInternalMemoizedMergedChildContext=e,he(tt),he(He),se(He,e)):he(tt),se(tt,n)}var on=null,Ms=!1,jc=!1;function Cm(e){on===null?on=[e]:on.push(e)}function Ww(e){Ms=!0,Cm(e)}function ir(){if(!jc&&on!==null){jc=!0;var e=0,t=oe;try{var n=on;for(oe=1;e<n.length;e++){var r=n[e];do r=r(!0);while(r!==null)}on=null,Ms=!1}catch(i){throw on!==null&&(on=on.slice(e+1)),Qg(Oh,ir),i}finally{oe=t,jc=!1}}return null}var Xr=[],Jr=0,as=null,os=0,vt=[],bt=0,Ar=null,cn=1,ln="";function lr(e,t){Xr[Jr++]=os,Xr[Jr++]=as,as=e,os=t}function Sm(e,t,n){vt[bt++]=cn,vt[bt++]=ln,vt[bt++]=Ar,Ar=e;var r=cn;e=ln;var i=32-Lt(r)-1;r&=~(1<<i),n+=1;var a=32-Lt(t)+i;if(30<a){var s=i-i%5;a=(r&(1<<s)-1).toString(32),r>>=s,i-=s,cn=1<<32-Lt(t)+i|n<<i|r,ln=a+e}else cn=1<<a|n<<i|r,ln=e}function Wh(e){e.return!==null&&(lr(e,1),Sm(e,1,0))}function $h(e){for(;e===as;)as=Xr[--Jr],Xr[Jr]=null,os=Xr[--Jr],Xr[Jr]=null;for(;e===Ar;)Ar=vt[--bt],vt[bt]=null,ln=vt[--bt],vt[bt]=null,cn=vt[--bt],vt[bt]=null}var ht=null,ct=null,de=!1,Et=null;function Pm(e,t){var n=wt(5,null,null,0);n.elementType="DELETED",n.stateNode=t,n.return=e,t=e.deletions,t===null?(e.deletions=[n],e.flags|=16):t.push(n)}function jd(e,t){switch(e.tag){case 5:var n=e.type;return t=t.nodeType!==1||n.toLowerCase()!==t.nodeName.toLowerCase()?null:t,t!==null?(e.stateNode=t,ht=e,ct=Hn(t.firstChild),!0):!1;case 6:return t=e.pendingProps===""||t.nodeType!==3?null:t,t!==null?(e.stateNode=t,ht=e,ct=null,!0):!1;case 13:return t=t.nodeType!==8?null:t,t!==null?(n=Ar!==null?{id:cn,overflow:ln}:null,e.memoizedState={dehydrated:t,treeContext:n,retryLane:1073741824},n=wt(18,null,null,0),n.stateNode=t,n.return=e,e.child=n,ht=e,ct=null,!0):!1;default:return!1}}function Ml(e){return(e.mode&1)!==0&&(e.flags&128)===0}function ql(e){if(de){var t=ct;if(t){var n=t;if(!jd(e,t)){if(Ml(e))throw Error(L(418));t=Hn(n.nextSibling);var r=ht;t&&jd(e,t)?Pm(r,n):(e.flags=e.flags&-4097|2,de=!1,ht=e)}}else{if(Ml(e))throw Error(L(418));e.flags=e.flags&-4097|2,de=!1,ht=e}}}function Ed(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;ht=e}function po(e){if(e!==ht)return!1;if(!de)return Ed(e),de=!0,!1;var t;if((t=e.tag!==3)&&!(t=e.tag!==5)&&(t=e.type,t=t!=="head"&&t!=="body"&&!El(e.type,e.memoizedProps)),t&&(t=ct)){if(Ml(e))throw Am(),Error(L(418));for(;t;)Pm(e,t),t=Hn(t.nextSibling)}if(Ed(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(L(317));e:{for(e=e.nextSibling,t=0;e;){if(e.nodeType===8){var n=e.data;if(n==="/$"){if(t===0){ct=Hn(e.nextSibling);break e}t--}else n!=="$"&&n!=="$!"&&n!=="$?"||t++}e=e.nextSibling}ct=null}}else ct=ht?Hn(e.stateNode.nextSibling):null;return!0}function Am(){for(var e=ct;e;)e=Hn(e.nextSibling)}function ki(){ct=ht=null,de=!1}function Kh(e){Et===null?Et=[e]:Et.push(e)}var $w=vn.ReactCurrentBatchConfig;function Ki(e,t,n){if(e=n.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(n._owner){if(n=n._owner,n){if(n.tag!==1)throw Error(L(309));var r=n.stateNode}if(!r)throw Error(L(147,e));var i=r,a=""+e;return t!==null&&t.ref!==null&&typeof t.ref=="function"&&t.ref._stringRef===a?t.ref:(t=function(s){var c=i.refs;s===null?delete c[a]:c[a]=s},t._stringRef=a,t)}if(typeof e!="string")throw Error(L(284));if(!n._owner)throw Error(L(290,e))}return e}function go(e,t){throw e=Object.prototype.toString.call(t),Error(L(31,e==="[object Object]"?"object with keys {"+Object.keys(t).join(", ")+"}":e))}function Rd(e){var t=e._init;return t(e._payload)}function Im(e){function t(f,g){if(e){var b=f.deletions;b===null?(f.deletions=[g],f.flags|=16):b.push(g)}}function n(f,g){if(!e)return null;for(;g!==null;)t(f,g),g=g.sibling;return null}function r(f,g){for(f=new Map;g!==null;)g.key!==null?f.set(g.key,g):f.set(g.index,g),g=g.sibling;return f}function i(f,g){return f=Kn(f,g),f.index=0,f.sibling=null,f}function a(f,g,b){return f.index=b,e?(b=f.alternate,b!==null?(b=b.index,b<g?(f.flags|=2,g):b):(f.flags|=2,g)):(f.flags|=1048576,g)}function s(f){return e&&f.alternate===null&&(f.flags|=2),f}function c(f,g,b,w){return g===null||g.tag!==6?(g=Oc(b,f.mode,w),g.return=f,g):(g=i(g,b),g.return=f,g)}function l(f,g,b,w){var T=b.type;return T===Gr?u(f,g,b.props.children,w,b.key):g!==null&&(g.elementType===T||typeof T=="object"&&T!==null&&T.$$typeof===In&&Rd(T)===g.type)?(w=i(g,b.props),w.ref=Ki(f,g,b),w.return=f,w):(w=Uo(b.type,b.key,b.props,null,f.mode,w),w.ref=Ki(f,g,b),w.return=f,w)}function h(f,g,b,w){return g===null||g.tag!==4||g.stateNode.containerInfo!==b.containerInfo||g.stateNode.implementation!==b.implementation?(g=Uc(b,f.mode,w),g.return=f,g):(g=i(g,b.children||[]),g.return=f,g)}function u(f,g,b,w,T){return g===null||g.tag!==7?(g=Tr(b,f.mode,w,T),g.return=f,g):(g=i(g,b),g.return=f,g)}function d(f,g,b){if(typeof g=="string"&&g!==""||typeof g=="number")return g=Oc(""+g,f.mode,b),g.return=f,g;if(typeof g=="object"&&g!==null){switch(g.$$typeof){case no:return b=Uo(g.type,g.key,g.props,null,f.mode,b),b.ref=Ki(f,null,g),b.return=f,b;case Hr:return g=Uc(g,f.mode,b),g.return=f,g;case In:var w=g._init;return d(f,w(g._payload),b)}if(na(g)||zi(g))return g=Tr(g,f.mode,b,null),g.return=f,g;go(f,g)}return null}function p(f,g,b,w){var T=g!==null?g.key:null;if(typeof b=="string"&&b!==""||typeof b=="number")return T!==null?null:c(f,g,""+b,w);if(typeof b=="object"&&b!==null){switch(b.$$typeof){case no:return b.key===T?l(f,g,b,w):null;case Hr:return b.key===T?h(f,g,b,w):null;case In:return T=b._init,p(f,g,T(b._payload),w)}if(na(b)||zi(b))return T!==null?null:u(f,g,b,w,null);go(f,b)}return null}function v(f,g,b,w,T){if(typeof w=="string"&&w!==""||typeof w=="number")return f=f.get(b)||null,c(g,f,""+w,T);if(typeof w=="object"&&w!==null){switch(w.$$typeof){case no:return f=f.get(w.key===null?b:w.key)||null,l(g,f,w,T);case Hr:return f=f.get(w.key===null?b:w.key)||null,h(g,f,w,T);case In:var C=w._init;return v(f,g,b,C(w._payload),T)}if(na(w)||zi(w))return f=f.get(b)||null,u(g,f,w,T,null);go(g,w)}return null}function x(f,g,b,w){for(var T=null,C=null,P=g,S=g=0,I=null;P!==null&&S<b.length;S++){P.index>S?(I=P,P=null):I=P.sibling;var j=p(f,P,b[S],w);if(j===null){P===null&&(P=I);break}e&&P&&j.alternate===null&&t(f,P),g=a(j,g,S),C===null?T=j:C.sibling=j,C=j,P=I}if(S===b.length)return n(f,P),de&&lr(f,S),T;if(P===null){for(;S<b.length;S++)P=d(f,b[S],w),P!==null&&(g=a(P,g,S),C===null?T=P:C.sibling=P,C=P);return de&&lr(f,S),T}for(P=r(f,P);S<b.length;S++)I=v(P,f,S,b[S],w),I!==null&&(e&&I.alternate!==null&&P.delete(I.key===null?S:I.key),g=a(I,g,S),C===null?T=I:C.sibling=I,C=I);return e&&P.forEach(function(q){return t(f,q)}),de&&lr(f,S),T}function y(f,g,b,w){var T=zi(b);if(typeof T!="function")throw Error(L(150));if(b=T.call(b),b==null)throw Error(L(151));for(var C=T=null,P=g,S=g=0,I=null,j=b.next();P!==null&&!j.done;S++,j=b.next()){P.index>S?(I=P,P=null):I=P.sibling;var q=p(f,P,j.value,w);if(q===null){P===null&&(P=I);break}e&&P&&q.alternate===null&&t(f,P),g=a(q,g,S),C===null?T=q:C.sibling=q,C=q,P=I}if(j.done)return n(f,P),de&&lr(f,S),T;if(P===null){for(;!j.done;S++,j=b.next())j=d(f,j.value,w),j!==null&&(g=a(j,g,S),C===null?T=j:C.sibling=j,C=j);return de&&lr(f,S),T}for(P=r(f,P);!j.done;S++,j=b.next())j=v(P,f,S,j.value,w),j!==null&&(e&&j.alternate!==null&&P.delete(j.key===null?S:j.key),g=a(j,g,S),C===null?T=j:C.sibling=j,C=j);return e&&P.forEach(function(D){return t(f,D)}),de&&lr(f,S),T}function k(f,g,b,w){if(typeof b=="object"&&b!==null&&b.type===Gr&&b.key===null&&(b=b.props.children),typeof b=="object"&&b!==null){switch(b.$$typeof){case no:e:{for(var T=b.key,C=g;C!==null;){if(C.key===T){if(T=b.type,T===Gr){if(C.tag===7){n(f,C.sibling),g=i(C,b.props.children),g.return=f,f=g;break e}}else if(C.elementType===T||typeof T=="object"&&T!==null&&T.$$typeof===In&&Rd(T)===C.type){n(f,C.sibling),g=i(C,b.props),g.ref=Ki(f,C,b),g.return=f,f=g;break e}n(f,C);break}else t(f,C);C=C.sibling}b.type===Gr?(g=Tr(b.props.children,f.mode,w,b.key),g.return=f,f=g):(w=Uo(b.type,b.key,b.props,null,f.mode,w),w.ref=Ki(f,g,b),w.return=f,f=w)}return s(f);case Hr:e:{for(C=b.key;g!==null;){if(g.key===C)if(g.tag===4&&g.stateNode.containerInfo===b.containerInfo&&g.stateNode.implementation===b.implementation){n(f,g.sibling),g=i(g,b.children||[]),g.return=f,f=g;break e}else{n(f,g);break}else t(f,g);g=g.sibling}g=Uc(b,f.mode,w),g.return=f,f=g}return s(f);case In:return C=b._init,k(f,g,C(b._payload),w)}if(na(b))return x(f,g,b,w);if(zi(b))return y(f,g,b,w);go(f,b)}return typeof b=="string"&&b!==""||typeof b=="number"?(b=""+b,g!==null&&g.tag===6?(n(f,g.sibling),g=i(g,b),g.return=f,f=g):(n(f,g),g=Oc(b,f.mode,w),g.return=f,f=g),s(f)):n(f,g)}return k}var Ti=Im(!0),Nm=Im(!1),ss=rr(null),cs=null,Zr=null,Qh=null;function Yh(){Qh=Zr=cs=null}function Xh(e){var t=ss.current;he(ss),e._currentValue=t}function Ol(e,t,n){for(;e!==null;){var r=e.alternate;if((e.childLanes&t)!==t?(e.childLanes|=t,r!==null&&(r.childLanes|=t)):r!==null&&(r.childLanes&t)!==t&&(r.childLanes|=t),e===n)break;e=e.return}}function si(e,t){cs=e,Qh=Zr=null,e=e.dependencies,e!==null&&e.firstContext!==null&&(e.lanes&t&&(et=!0),e.firstContext=null)}function Tt(e){var t=e._currentValue;if(Qh!==e)if(e={context:e,memoizedValue:t,next:null},Zr===null){if(cs===null)throw Error(L(308));Zr=e,cs.dependencies={lanes:0,firstContext:e}}else Zr=Zr.next=e;return t}var pr=null;function Jh(e){pr===null?pr=[e]:pr.push(e)}function jm(e,t,n,r){var i=t.interleaved;return i===null?(n.next=n,Jh(t)):(n.next=i.next,i.next=n),t.interleaved=n,pn(e,r)}function pn(e,t){e.lanes|=t;var n=e.alternate;for(n!==null&&(n.lanes|=t),n=e,e=e.return;e!==null;)e.childLanes|=t,n=e.alternate,n!==null&&(n.childLanes|=t),n=e,e=e.return;return n.tag===3?n.stateNode:null}var Nn=!1;function Zh(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,interleaved:null,lanes:0},effects:null}}function Em(e,t){e=e.updateQueue,t.updateQueue===e&&(t.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function hn(e,t){return{eventTime:e,lane:t,tag:0,payload:null,callback:null,next:null}}function Gn(e,t,n){var r=e.updateQueue;if(r===null)return null;if(r=r.shared,re&2){var i=r.pending;return i===null?t.next=t:(t.next=i.next,i.next=t),r.pending=t,pn(e,n)}return i=r.interleaved,i===null?(t.next=t,Jh(r)):(t.next=i.next,i.next=t),r.interleaved=t,pn(e,n)}function Ro(e,t,n){if(t=t.updateQueue,t!==null&&(t=t.shared,(n&4194240)!==0)){var r=t.lanes;r&=e.pendingLanes,n|=r,t.lanes=n,Uh(e,n)}}function Ld(e,t){var n=e.updateQueue,r=e.alternate;if(r!==null&&(r=r.updateQueue,n===r)){var i=null,a=null;if(n=n.firstBaseUpdate,n!==null){do{var s={eventTime:n.eventTime,lane:n.lane,tag:n.tag,payload:n.payload,callback:n.callback,next:null};a===null?i=a=s:a=a.next=s,n=n.next}while(n!==null);a===null?i=a=t:a=a.next=t}else i=a=t;n={baseState:r.baseState,firstBaseUpdate:i,lastBaseUpdate:a,shared:r.shared,effects:r.effects},e.updateQueue=n;return}e=n.lastBaseUpdate,e===null?n.firstBaseUpdate=t:e.next=t,n.lastBaseUpdate=t}function ls(e,t,n,r){var i=e.updateQueue;Nn=!1;var a=i.firstBaseUpdate,s=i.lastBaseUpdate,c=i.shared.pending;if(c!==null){i.shared.pending=null;var l=c,h=l.next;l.next=null,s===null?a=h:s.next=h,s=l;var u=e.alternate;u!==null&&(u=u.updateQueue,c=u.lastBaseUpdate,c!==s&&(c===null?u.firstBaseUpdate=h:c.next=h,u.lastBaseUpdate=l))}if(a!==null){var d=i.baseState;s=0,u=h=l=null,c=a;do{var p=c.lane,v=c.eventTime;if((r&p)===p){u!==null&&(u=u.next={eventTime:v,lane:0,tag:c.tag,payload:c.payload,callback:c.callback,next:null});e:{var x=e,y=c;switch(p=t,v=n,y.tag){case 1:if(x=y.payload,typeof x=="function"){d=x.call(v,d,p);break e}d=x;break e;case 3:x.flags=x.flags&-65537|128;case 0:if(x=y.payload,p=typeof x=="function"?x.call(v,d,p):x,p==null)break e;d=ye({},d,p);break e;case 2:Nn=!0}}c.callback!==null&&c.lane!==0&&(e.flags|=64,p=i.effects,p===null?i.effects=[c]:p.push(c))}else v={eventTime:v,lane:p,tag:c.tag,payload:c.payload,callback:c.callback,next:null},u===null?(h=u=v,l=d):u=u.next=v,s|=p;if(c=c.next,c===null){if(c=i.shared.pending,c===null)break;p=c,c=p.next,p.next=null,i.lastBaseUpdate=p,i.shared.pending=null}}while(!0);if(u===null&&(l=d),i.baseState=l,i.firstBaseUpdate=h,i.lastBaseUpdate=u,t=i.shared.interleaved,t!==null){i=t;do s|=i.lane,i=i.next;while(i!==t)}else a===null&&(i.shared.lanes=0);Nr|=s,e.lanes=s,e.memoizedState=d}}function Dd(e,t,n){if(e=t.effects,t.effects=null,e!==null)for(t=0;t<e.length;t++){var r=e[t],i=r.callback;if(i!==null){if(r.callback=null,r=n,typeof i!="function")throw Error(L(191,i));i.call(r)}}}var $a={},Yt=rr($a),Ia=rr($a),Na=rr($a);function gr(e){if(e===$a)throw Error(L(174));return e}function eu(e,t){switch(se(Na,t),se(Ia,e),se(Yt,$a),e=t.nodeType,e){case 9:case 11:t=(t=t.documentElement)?t.namespaceURI:yl(null,"");break;default:e=e===8?t.parentNode:t,t=e.namespaceURI||null,e=e.tagName,t=yl(t,e)}he(Yt),se(Yt,t)}function Ci(){he(Yt),he(Ia),he(Na)}function Rm(e){gr(Na.current);var t=gr(Yt.current),n=yl(t,e.type);t!==n&&(se(Ia,e),se(Yt,n))}function tu(e){Ia.current===e&&(he(Yt),he(Ia))}var me=rr(0);function hs(e){for(var t=e;t!==null;){if(t.tag===13){var n=t.memoizedState;if(n!==null&&(n=n.dehydrated,n===null||n.data==="$?"||n.data==="$!"))return t}else if(t.tag===19&&t.memoizedProps.revealOrder!==void 0){if(t.flags&128)return t}else if(t.child!==null){t.child.return=t,t=t.child;continue}if(t===e)break;for(;t.sibling===null;){if(t.return===null||t.return===e)return null;t=t.return}t.sibling.return=t.return,t=t.sibling}return null}var Ec=[];function nu(){for(var e=0;e<Ec.length;e++)Ec[e]._workInProgressVersionPrimary=null;Ec.length=0}var Lo=vn.ReactCurrentDispatcher,Rc=vn.ReactCurrentBatchConfig,Ir=0,fe=null,Se=null,je=null,us=!1,ha=!1,ja=0,Kw=0;function Fe(){throw Error(L(321))}function ru(e,t){if(t===null)return!1;for(var n=0;n<t.length&&n<e.length;n++)if(!Mt(e[n],t[n]))return!1;return!0}function iu(e,t,n,r,i,a){if(Ir=a,fe=t,t.memoizedState=null,t.updateQueue=null,t.lanes=0,Lo.current=e===null||e.memoizedState===null?Jw:Zw,e=n(r,i),ha){a=0;do{if(ha=!1,ja=0,25<=a)throw Error(L(301));a+=1,je=Se=null,t.updateQueue=null,Lo.current=ex,e=n(r,i)}while(ha)}if(Lo.current=ds,t=Se!==null&&Se.next!==null,Ir=0,je=Se=fe=null,us=!1,t)throw Error(L(300));return e}function au(){var e=ja!==0;return ja=0,e}function Bt(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return je===null?fe.memoizedState=je=e:je=je.next=e,je}function Ct(){if(Se===null){var e=fe.alternate;e=e!==null?e.memoizedState:null}else e=Se.next;var t=je===null?fe.memoizedState:je.next;if(t!==null)je=t,Se=e;else{if(e===null)throw Error(L(310));Se=e,e={memoizedState:Se.memoizedState,baseState:Se.baseState,baseQueue:Se.baseQueue,queue:Se.queue,next:null},je===null?fe.memoizedState=je=e:je=je.next=e}return je}function Ea(e,t){return typeof t=="function"?t(e):t}function Lc(e){var t=Ct(),n=t.queue;if(n===null)throw Error(L(311));n.lastRenderedReducer=e;var r=Se,i=r.baseQueue,a=n.pending;if(a!==null){if(i!==null){var s=i.next;i.next=a.next,a.next=s}r.baseQueue=i=a,n.pending=null}if(i!==null){a=i.next,r=r.baseState;var c=s=null,l=null,h=a;do{var u=h.lane;if((Ir&u)===u)l!==null&&(l=l.next={lane:0,action:h.action,hasEagerState:h.hasEagerState,eagerState:h.eagerState,next:null}),r=h.hasEagerState?h.eagerState:e(r,h.action);else{var d={lane:u,action:h.action,hasEagerState:h.hasEagerState,eagerState:h.eagerState,next:null};l===null?(c=l=d,s=r):l=l.next=d,fe.lanes|=u,Nr|=u}h=h.next}while(h!==null&&h!==a);l===null?s=r:l.next=c,Mt(r,t.memoizedState)||(et=!0),t.memoizedState=r,t.baseState=s,t.baseQueue=l,n.lastRenderedState=r}if(e=n.interleaved,e!==null){i=e;do a=i.lane,fe.lanes|=a,Nr|=a,i=i.next;while(i!==e)}else i===null&&(n.lanes=0);return[t.memoizedState,n.dispatch]}function Dc(e){var t=Ct(),n=t.queue;if(n===null)throw Error(L(311));n.lastRenderedReducer=e;var r=n.dispatch,i=n.pending,a=t.memoizedState;if(i!==null){n.pending=null;var s=i=i.next;do a=e(a,s.action),s=s.next;while(s!==i);Mt(a,t.memoizedState)||(et=!0),t.memoizedState=a,t.baseQueue===null&&(t.baseState=a),n.lastRenderedState=a}return[a,r]}function Lm(){}function Dm(e,t){var n=fe,r=Ct(),i=t(),a=!Mt(r.memoizedState,i);if(a&&(r.memoizedState=i,et=!0),r=r.queue,ou(Om.bind(null,n,r,e),[e]),r.getSnapshot!==t||a||je!==null&&je.memoizedState.tag&1){if(n.flags|=2048,Ra(9,qm.bind(null,n,r,i,t),void 0,null),Re===null)throw Error(L(349));Ir&30||Mm(n,t,i)}return i}function Mm(e,t,n){e.flags|=16384,e={getSnapshot:t,value:n},t=fe.updateQueue,t===null?(t={lastEffect:null,stores:null},fe.updateQueue=t,t.stores=[e]):(n=t.stores,n===null?t.stores=[e]:n.push(e))}function qm(e,t,n,r){t.value=n,t.getSnapshot=r,Um(t)&&_m(e)}function Om(e,t,n){return n(function(){Um(t)&&_m(e)})}function Um(e){var t=e.getSnapshot;e=e.value;try{var n=t();return!Mt(e,n)}catch{return!0}}function _m(e){var t=pn(e,1);t!==null&&Dt(t,e,1,-1)}function Md(e){var t=Bt();return typeof e=="function"&&(e=e()),t.memoizedState=t.baseState=e,e={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:Ea,lastRenderedState:e},t.queue=e,e=e.dispatch=Xw.bind(null,fe,e),[t.memoizedState,e]}function Ra(e,t,n,r){return e={tag:e,create:t,destroy:n,deps:r,next:null},t=fe.updateQueue,t===null?(t={lastEffect:null,stores:null},fe.updateQueue=t,t.lastEffect=e.next=e):(n=t.lastEffect,n===null?t.lastEffect=e.next=e:(r=n.next,n.next=e,e.next=r,t.lastEffect=e)),e}function Fm(){return Ct().memoizedState}function Do(e,t,n,r){var i=Bt();fe.flags|=e,i.memoizedState=Ra(1|t,n,void 0,r===void 0?null:r)}function qs(e,t,n,r){var i=Ct();r=r===void 0?null:r;var a=void 0;if(Se!==null){var s=Se.memoizedState;if(a=s.destroy,r!==null&&ru(r,s.deps)){i.memoizedState=Ra(t,n,a,r);return}}fe.flags|=e,i.memoizedState=Ra(1|t,n,a,r)}function qd(e,t){return Do(8390656,8,e,t)}function ou(e,t){return qs(2048,8,e,t)}function Bm(e,t){return qs(4,2,e,t)}function Vm(e,t){return qs(4,4,e,t)}function zm(e,t){if(typeof t=="function")return e=e(),t(e),function(){t(null)};if(t!=null)return e=e(),t.current=e,function(){t.current=null}}function Hm(e,t,n){return n=n!=null?n.concat([e]):null,qs(4,4,zm.bind(null,t,e),n)}function su(){}function Gm(e,t){var n=Ct();t=t===void 0?null:t;var r=n.memoizedState;return r!==null&&t!==null&&ru(t,r[1])?r[0]:(n.memoizedState=[e,t],e)}function Wm(e,t){var n=Ct();t=t===void 0?null:t;var r=n.memoizedState;return r!==null&&t!==null&&ru(t,r[1])?r[0]:(e=e(),n.memoizedState=[e,t],e)}function $m(e,t,n){return Ir&21?(Mt(n,t)||(n=Jg(),fe.lanes|=n,Nr|=n,e.baseState=!0),t):(e.baseState&&(e.baseState=!1,et=!0),e.memoizedState=n)}function Qw(e,t){var n=oe;oe=n!==0&&4>n?n:4,e(!0);var r=Rc.transition;Rc.transition={};try{e(!1),t()}finally{oe=n,Rc.transition=r}}function Km(){return Ct().memoizedState}function Yw(e,t,n){var r=$n(e);if(n={lane:r,action:n,hasEagerState:!1,eagerState:null,next:null},Qm(e))Ym(t,n);else if(n=jm(e,t,n,r),n!==null){var i=Ye();Dt(n,e,r,i),Xm(n,t,r)}}function Xw(e,t,n){var r=$n(e),i={lane:r,action:n,hasEagerState:!1,eagerState:null,next:null};if(Qm(e))Ym(t,i);else{var a=e.alternate;if(e.lanes===0&&(a===null||a.lanes===0)&&(a=t.lastRenderedReducer,a!==null))try{var s=t.lastRenderedState,c=a(s,n);if(i.hasEagerState=!0,i.eagerState=c,Mt(c,s)){var l=t.interleaved;l===null?(i.next=i,Jh(t)):(i.next=l.next,l.next=i),t.interleaved=i;return}}catch{}finally{}n=jm(e,t,i,r),n!==null&&(i=Ye(),Dt(n,e,r,i),Xm(n,t,r))}}function Qm(e){var t=e.alternate;return e===fe||t!==null&&t===fe}function Ym(e,t){ha=us=!0;var n=e.pending;n===null?t.next=t:(t.next=n.next,n.next=t),e.pending=t}function Xm(e,t,n){if(n&4194240){var r=t.lanes;r&=e.pendingLanes,n|=r,t.lanes=n,Uh(e,n)}}var ds={readContext:Tt,useCallback:Fe,useContext:Fe,useEffect:Fe,useImperativeHandle:Fe,useInsertionEffect:Fe,useLayoutEffect:Fe,useMemo:Fe,useReducer:Fe,useRef:Fe,useState:Fe,useDebugValue:Fe,useDeferredValue:Fe,useTransition:Fe,useMutableSource:Fe,useSyncExternalStore:Fe,useId:Fe,unstable_isNewReconciler:!1},Jw={readContext:Tt,useCallback:function(e,t){return Bt().memoizedState=[e,t===void 0?null:t],e},useContext:Tt,useEffect:qd,useImperativeHandle:function(e,t,n){return n=n!=null?n.concat([e]):null,Do(4194308,4,zm.bind(null,t,e),n)},useLayoutEffect:function(e,t){return Do(4194308,4,e,t)},useInsertionEffect:function(e,t){return Do(4,2,e,t)},useMemo:function(e,t){var n=Bt();return t=t===void 0?null:t,e=e(),n.memoizedState=[e,t],e},useReducer:function(e,t,n){var r=Bt();return t=n!==void 0?n(t):t,r.memoizedState=r.baseState=t,e={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:e,lastRenderedState:t},r.queue=e,e=e.dispatch=Yw.bind(null,fe,e),[r.memoizedState,e]},useRef:function(e){var t=Bt();return e={current:e},t.memoizedState=e},useState:Md,useDebugValue:su,useDeferredValue:function(e){return Bt().memoizedState=e},useTransition:function(){var e=Md(!1),t=e[0];return e=Qw.bind(null,e[1]),Bt().memoizedState=e,[t,e]},useMutableSource:function(){},useSyncExternalStore:function(e,t,n){var r=fe,i=Bt();if(de){if(n===void 0)throw Error(L(407));n=n()}else{if(n=t(),Re===null)throw Error(L(349));Ir&30||Mm(r,t,n)}i.memoizedState=n;var a={value:n,getSnapshot:t};return i.queue=a,qd(Om.bind(null,r,a,e),[e]),r.flags|=2048,Ra(9,qm.bind(null,r,a,n,t),void 0,null),n},useId:function(){var e=Bt(),t=Re.identifierPrefix;if(de){var n=ln,r=cn;n=(r&~(1<<32-Lt(r)-1)).toString(32)+n,t=":"+t+"R"+n,n=ja++,0<n&&(t+="H"+n.toString(32)),t+=":"}else n=Kw++,t=":"+t+"r"+n.toString(32)+":";return e.memoizedState=t},unstable_isNewReconciler:!1},Zw={readContext:Tt,useCallback:Gm,useContext:Tt,useEffect:ou,useImperativeHandle:Hm,useInsertionEffect:Bm,useLayoutEffect:Vm,useMemo:Wm,useReducer:Lc,useRef:Fm,useState:function(){return Lc(Ea)},useDebugValue:su,useDeferredValue:function(e){var t=Ct();return $m(t,Se.memoizedState,e)},useTransition:function(){var e=Lc(Ea)[0],t=Ct().memoizedState;return[e,t]},useMutableSource:Lm,useSyncExternalStore:Dm,useId:Km,unstable_isNewReconciler:!1},ex={readContext:Tt,useCallback:Gm,useContext:Tt,useEffect:ou,useImperativeHandle:Hm,useInsertionEffect:Bm,useLayoutEffect:Vm,useMemo:Wm,useReducer:Dc,useRef:Fm,useState:function(){return Dc(Ea)},useDebugValue:su,useDeferredValue:function(e){var t=Ct();return Se===null?t.memoizedState=e:$m(t,Se.memoizedState,e)},useTransition:function(){var e=Dc(Ea)[0],t=Ct().memoizedState;return[e,t]},useMutableSource:Lm,useSyncExternalStore:Dm,useId:Km,unstable_isNewReconciler:!1};function Pt(e,t){if(e&&e.defaultProps){t=ye({},t),e=e.defaultProps;for(var n in e)t[n]===void 0&&(t[n]=e[n]);return t}return t}function Ul(e,t,n,r){t=e.memoizedState,n=n(r,t),n=n==null?t:ye({},t,n),e.memoizedState=n,e.lanes===0&&(e.updateQueue.baseState=n)}var Os={isMounted:function(e){return(e=e._reactInternals)?Lr(e)===e:!1},enqueueSetState:function(e,t,n){e=e._reactInternals;var r=Ye(),i=$n(e),a=hn(r,i);a.payload=t,n!=null&&(a.callback=n),t=Gn(e,a,i),t!==null&&(Dt(t,e,i,r),Ro(t,e,i))},enqueueReplaceState:function(e,t,n){e=e._reactInternals;var r=Ye(),i=$n(e),a=hn(r,i);a.tag=1,a.payload=t,n!=null&&(a.callback=n),t=Gn(e,a,i),t!==null&&(Dt(t,e,i,r),Ro(t,e,i))},enqueueForceUpdate:function(e,t){e=e._reactInternals;var n=Ye(),r=$n(e),i=hn(n,r);i.tag=2,t!=null&&(i.callback=t),t=Gn(e,i,r),t!==null&&(Dt(t,e,r,n),Ro(t,e,r))}};function Od(e,t,n,r,i,a,s){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(r,a,s):t.prototype&&t.prototype.isPureReactComponent?!Ca(n,r)||!Ca(i,a):!0}function Jm(e,t,n){var r=!1,i=Jn,a=t.contextType;return typeof a=="object"&&a!==null?a=Tt(a):(i=nt(t)?Pr:He.current,r=t.contextTypes,a=(r=r!=null)?xi(e,i):Jn),t=new t(n,a),e.memoizedState=t.state!==null&&t.state!==void 0?t.state:null,t.updater=Os,e.stateNode=t,t._reactInternals=e,r&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=i,e.__reactInternalMemoizedMaskedChildContext=a),t}function Ud(e,t,n,r){e=t.state,typeof t.componentWillReceiveProps=="function"&&t.componentWillReceiveProps(n,r),typeof t.UNSAFE_componentWillReceiveProps=="function"&&t.UNSAFE_componentWillReceiveProps(n,r),t.state!==e&&Os.enqueueReplaceState(t,t.state,null)}function _l(e,t,n,r){var i=e.stateNode;i.props=n,i.state=e.memoizedState,i.refs={},Zh(e);var a=t.contextType;typeof a=="object"&&a!==null?i.context=Tt(a):(a=nt(t)?Pr:He.current,i.context=xi(e,a)),i.state=e.memoizedState,a=t.getDerivedStateFromProps,typeof a=="function"&&(Ul(e,t,a,n),i.state=e.memoizedState),typeof t.getDerivedStateFromProps=="function"||typeof i.getSnapshotBeforeUpdate=="function"||typeof i.UNSAFE_componentWillMount!="function"&&typeof i.componentWillMount!="function"||(t=i.state,typeof i.componentWillMount=="function"&&i.componentWillMount(),typeof i.UNSAFE_componentWillMount=="function"&&i.UNSAFE_componentWillMount(),t!==i.state&&Os.enqueueReplaceState(i,i.state,null),ls(e,n,i,r),i.state=e.memoizedState),typeof i.componentDidMount=="function"&&(e.flags|=4194308)}function Si(e,t){try{var n="",r=t;do n+=Ib(r),r=r.return;while(r);var i=n}catch(a){i=`
Error generating stack: `+a.message+`
`+a.stack}return{value:e,source:t,stack:i,digest:null}}function Mc(e,t,n){return{value:e,source:null,stack:n??null,digest:t??null}}function Fl(e,t){try{console.error(t.value)}catch(n){setTimeout(function(){throw n})}}var tx=typeof WeakMap=="function"?WeakMap:Map;function Zm(e,t,n){n=hn(-1,n),n.tag=3,n.payload={element:null};var r=t.value;return n.callback=function(){gs||(gs=!0,Yl=r),Fl(e,t)},n}function ef(e,t,n){n=hn(-1,n),n.tag=3;var r=e.type.getDerivedStateFromError;if(typeof r=="function"){var i=t.value;n.payload=function(){return r(i)},n.callback=function(){Fl(e,t)}}var a=e.stateNode;return a!==null&&typeof a.componentDidCatch=="function"&&(n.callback=function(){Fl(e,t),typeof r!="function"&&(Wn===null?Wn=new Set([this]):Wn.add(this));var s=t.stack;this.componentDidCatch(t.value,{componentStack:s!==null?s:""})}),n}function _d(e,t,n){var r=e.pingCache;if(r===null){r=e.pingCache=new tx;var i=new Set;r.set(t,i)}else i=r.get(t),i===void 0&&(i=new Set,r.set(t,i));i.has(n)||(i.add(n),e=mx.bind(null,e,t,n),t.then(e,e))}function Fd(e){do{var t;if((t=e.tag===13)&&(t=e.memoizedState,t=t!==null?t.dehydrated!==null:!0),t)return e;e=e.return}while(e!==null);return null}function Bd(e,t,n,r,i){return e.mode&1?(e.flags|=65536,e.lanes=i,e):(e===t?e.flags|=65536:(e.flags|=128,n.flags|=131072,n.flags&=-52805,n.tag===1&&(n.alternate===null?n.tag=17:(t=hn(-1,1),t.tag=2,Gn(n,t,1))),n.lanes|=1),e)}var nx=vn.ReactCurrentOwner,et=!1;function Ke(e,t,n,r){t.child=e===null?Nm(t,null,n,r):Ti(t,e.child,n,r)}function Vd(e,t,n,r,i){n=n.render;var a=t.ref;return si(t,i),r=iu(e,t,n,r,a,i),n=au(),e!==null&&!et?(t.updateQueue=e.updateQueue,t.flags&=-2053,e.lanes&=~i,gn(e,t,i)):(de&&n&&Wh(t),t.flags|=1,Ke(e,t,r,i),t.child)}function zd(e,t,n,r,i){if(e===null){var a=n.type;return typeof a=="function"&&!mu(a)&&a.defaultProps===void 0&&n.compare===null&&n.defaultProps===void 0?(t.tag=15,t.type=a,tf(e,t,a,r,i)):(e=Uo(n.type,null,r,t,t.mode,i),e.ref=t.ref,e.return=t,t.child=e)}if(a=e.child,!(e.lanes&i)){var s=a.memoizedProps;if(n=n.compare,n=n!==null?n:Ca,n(s,r)&&e.ref===t.ref)return gn(e,t,i)}return t.flags|=1,e=Kn(a,r),e.ref=t.ref,e.return=t,t.child=e}function tf(e,t,n,r,i){if(e!==null){var a=e.memoizedProps;if(Ca(a,r)&&e.ref===t.ref)if(et=!1,t.pendingProps=r=a,(e.lanes&i)!==0)e.flags&131072&&(et=!0);else return t.lanes=e.lanes,gn(e,t,i)}return Bl(e,t,n,r,i)}function nf(e,t,n){var r=t.pendingProps,i=r.children,a=e!==null?e.memoizedState:null;if(r.mode==="hidden")if(!(t.mode&1))t.memoizedState={baseLanes:0,cachePool:null,transitions:null},se(ti,ot),ot|=n;else{if(!(n&1073741824))return e=a!==null?a.baseLanes|n:n,t.lanes=t.childLanes=1073741824,t.memoizedState={baseLanes:e,cachePool:null,transitions:null},t.updateQueue=null,se(ti,ot),ot|=e,null;t.memoizedState={baseLanes:0,cachePool:null,transitions:null},r=a!==null?a.baseLanes:n,se(ti,ot),ot|=r}else a!==null?(r=a.baseLanes|n,t.memoizedState=null):r=n,se(ti,ot),ot|=r;return Ke(e,t,i,n),t.child}function rf(e,t){var n=t.ref;(e===null&&n!==null||e!==null&&e.ref!==n)&&(t.flags|=512,t.flags|=2097152)}function Bl(e,t,n,r,i){var a=nt(n)?Pr:He.current;return a=xi(t,a),si(t,i),n=iu(e,t,n,r,a,i),r=au(),e!==null&&!et?(t.updateQueue=e.updateQueue,t.flags&=-2053,e.lanes&=~i,gn(e,t,i)):(de&&r&&Wh(t),t.flags|=1,Ke(e,t,n,i),t.child)}function Hd(e,t,n,r,i){if(nt(n)){var a=!0;is(t)}else a=!1;if(si(t,i),t.stateNode===null)Mo(e,t),Jm(t,n,r),_l(t,n,r,i),r=!0;else if(e===null){var s=t.stateNode,c=t.memoizedProps;s.props=c;var l=s.context,h=n.contextType;typeof h=="object"&&h!==null?h=Tt(h):(h=nt(n)?Pr:He.current,h=xi(t,h));var u=n.getDerivedStateFromProps,d=typeof u=="function"||typeof s.getSnapshotBeforeUpdate=="function";d||typeof s.UNSAFE_componentWillReceiveProps!="function"&&typeof s.componentWillReceiveProps!="function"||(c!==r||l!==h)&&Ud(t,s,r,h),Nn=!1;var p=t.memoizedState;s.state=p,ls(t,r,s,i),l=t.memoizedState,c!==r||p!==l||tt.current||Nn?(typeof u=="function"&&(Ul(t,n,u,r),l=t.memoizedState),(c=Nn||Od(t,n,c,r,p,l,h))?(d||typeof s.UNSAFE_componentWillMount!="function"&&typeof s.componentWillMount!="function"||(typeof s.componentWillMount=="function"&&s.componentWillMount(),typeof s.UNSAFE_componentWillMount=="function"&&s.UNSAFE_componentWillMount()),typeof s.componentDidMount=="function"&&(t.flags|=4194308)):(typeof s.componentDidMount=="function"&&(t.flags|=4194308),t.memoizedProps=r,t.memoizedState=l),s.props=r,s.state=l,s.context=h,r=c):(typeof s.componentDidMount=="function"&&(t.flags|=4194308),r=!1)}else{s=t.stateNode,Em(e,t),c=t.memoizedProps,h=t.type===t.elementType?c:Pt(t.type,c),s.props=h,d=t.pendingProps,p=s.context,l=n.contextType,typeof l=="object"&&l!==null?l=Tt(l):(l=nt(n)?Pr:He.current,l=xi(t,l));var v=n.getDerivedStateFromProps;(u=typeof v=="function"||typeof s.getSnapshotBeforeUpdate=="function")||typeof s.UNSAFE_componentWillReceiveProps!="function"&&typeof s.componentWillReceiveProps!="function"||(c!==d||p!==l)&&Ud(t,s,r,l),Nn=!1,p=t.memoizedState,s.state=p,ls(t,r,s,i);var x=t.memoizedState;c!==d||p!==x||tt.current||Nn?(typeof v=="function"&&(Ul(t,n,v,r),x=t.memoizedState),(h=Nn||Od(t,n,h,r,p,x,l)||!1)?(u||typeof s.UNSAFE_componentWillUpdate!="function"&&typeof s.componentWillUpdate!="function"||(typeof s.componentWillUpdate=="function"&&s.componentWillUpdate(r,x,l),typeof s.UNSAFE_componentWillUpdate=="function"&&s.UNSAFE_componentWillUpdate(r,x,l)),typeof s.componentDidUpdate=="function"&&(t.flags|=4),typeof s.getSnapshotBeforeUpdate=="function"&&(t.flags|=1024)):(typeof s.componentDidUpdate!="function"||c===e.memoizedProps&&p===e.memoizedState||(t.flags|=4),typeof s.getSnapshotBeforeUpdate!="function"||c===e.memoizedProps&&p===e.memoizedState||(t.flags|=1024),t.memoizedProps=r,t.memoizedState=x),s.props=r,s.state=x,s.context=l,r=h):(typeof s.componentDidUpdate!="function"||c===e.memoizedProps&&p===e.memoizedState||(t.flags|=4),typeof s.getSnapshotBeforeUpdate!="function"||c===e.memoizedProps&&p===e.memoizedState||(t.flags|=1024),r=!1)}return Vl(e,t,n,r,a,i)}function Vl(e,t,n,r,i,a){rf(e,t);var s=(t.flags&128)!==0;if(!r&&!s)return i&&Nd(t,n,!1),gn(e,t,a);r=t.stateNode,nx.current=t;var c=s&&typeof n.getDerivedStateFromError!="function"?null:r.render();return t.flags|=1,e!==null&&s?(t.child=Ti(t,e.child,null,a),t.child=Ti(t,null,c,a)):Ke(e,t,c,a),t.memoizedState=r.state,i&&Nd(t,n,!0),t.child}function af(e){var t=e.stateNode;t.pendingContext?Id(e,t.pendingContext,t.pendingContext!==t.context):t.context&&Id(e,t.context,!1),eu(e,t.containerInfo)}function Gd(e,t,n,r,i){return ki(),Kh(i),t.flags|=256,Ke(e,t,n,r),t.child}var zl={dehydrated:null,treeContext:null,retryLane:0};function Hl(e){return{baseLanes:e,cachePool:null,transitions:null}}function of(e,t,n){var r=t.pendingProps,i=me.current,a=!1,s=(t.flags&128)!==0,c;if((c=s)||(c=e!==null&&e.memoizedState===null?!1:(i&2)!==0),c?(a=!0,t.flags&=-129):(e===null||e.memoizedState!==null)&&(i|=1),se(me,i&1),e===null)return ql(t),e=t.memoizedState,e!==null&&(e=e.dehydrated,e!==null)?(t.mode&1?e.data==="$!"?t.lanes=8:t.lanes=1073741824:t.lanes=1,null):(s=r.children,e=r.fallback,a?(r=t.mode,a=t.child,s={mode:"hidden",children:s},!(r&1)&&a!==null?(a.childLanes=0,a.pendingProps=s):a=Fs(s,r,0,null),e=Tr(e,r,n,null),a.return=t,e.return=t,a.sibling=e,t.child=a,t.child.memoizedState=Hl(n),t.memoizedState=zl,e):cu(t,s));if(i=e.memoizedState,i!==null&&(c=i.dehydrated,c!==null))return rx(e,t,s,r,c,i,n);if(a){a=r.fallback,s=t.mode,i=e.child,c=i.sibling;var l={mode:"hidden",children:r.children};return!(s&1)&&t.child!==i?(r=t.child,r.childLanes=0,r.pendingProps=l,t.deletions=null):(r=Kn(i,l),r.subtreeFlags=i.subtreeFlags&14680064),c!==null?a=Kn(c,a):(a=Tr(a,s,n,null),a.flags|=2),a.return=t,r.return=t,r.sibling=a,t.child=r,r=a,a=t.child,s=e.child.memoizedState,s=s===null?Hl(n):{baseLanes:s.baseLanes|n,cachePool:null,transitions:s.transitions},a.memoizedState=s,a.childLanes=e.childLanes&~n,t.memoizedState=zl,r}return a=e.child,e=a.sibling,r=Kn(a,{mode:"visible",children:r.children}),!(t.mode&1)&&(r.lanes=n),r.return=t,r.sibling=null,e!==null&&(n=t.deletions,n===null?(t.deletions=[e],t.flags|=16):n.push(e)),t.child=r,t.memoizedState=null,r}function cu(e,t){return t=Fs({mode:"visible",children:t},e.mode,0,null),t.return=e,e.child=t}function mo(e,t,n,r){return r!==null&&Kh(r),Ti(t,e.child,null,n),e=cu(t,t.pendingProps.children),e.flags|=2,t.memoizedState=null,e}function rx(e,t,n,r,i,a,s){if(n)return t.flags&256?(t.flags&=-257,r=Mc(Error(L(422))),mo(e,t,s,r)):t.memoizedState!==null?(t.child=e.child,t.flags|=128,null):(a=r.fallback,i=t.mode,r=Fs({mode:"visible",children:r.children},i,0,null),a=Tr(a,i,s,null),a.flags|=2,r.return=t,a.return=t,r.sibling=a,t.child=r,t.mode&1&&Ti(t,e.child,null,s),t.child.memoizedState=Hl(s),t.memoizedState=zl,a);if(!(t.mode&1))return mo(e,t,s,null);if(i.data==="$!"){if(r=i.nextSibling&&i.nextSibling.dataset,r)var c=r.dgst;return r=c,a=Error(L(419)),r=Mc(a,r,void 0),mo(e,t,s,r)}if(c=(s&e.childLanes)!==0,et||c){if(r=Re,r!==null){switch(s&-s){case 4:i=2;break;case 16:i=8;break;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:i=32;break;case 536870912:i=268435456;break;default:i=0}i=i&(r.suspendedLanes|s)?0:i,i!==0&&i!==a.retryLane&&(a.retryLane=i,pn(e,i),Dt(r,e,i,-1))}return gu(),r=Mc(Error(L(421))),mo(e,t,s,r)}return i.data==="$?"?(t.flags|=128,t.child=e.child,t=fx.bind(null,e),i._reactRetry=t,null):(e=a.treeContext,ct=Hn(i.nextSibling),ht=t,de=!0,Et=null,e!==null&&(vt[bt++]=cn,vt[bt++]=ln,vt[bt++]=Ar,cn=e.id,ln=e.overflow,Ar=t),t=cu(t,r.children),t.flags|=4096,t)}function Wd(e,t,n){e.lanes|=t;var r=e.alternate;r!==null&&(r.lanes|=t),Ol(e.return,t,n)}function qc(e,t,n,r,i){var a=e.memoizedState;a===null?e.memoizedState={isBackwards:t,rendering:null,renderingStartTime:0,last:r,tail:n,tailMode:i}:(a.isBackwards=t,a.rendering=null,a.renderingStartTime=0,a.last=r,a.tail=n,a.tailMode=i)}function sf(e,t,n){var r=t.pendingProps,i=r.revealOrder,a=r.tail;if(Ke(e,t,r.children,n),r=me.current,r&2)r=r&1|2,t.flags|=128;else{if(e!==null&&e.flags&128)e:for(e=t.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&Wd(e,n,t);else if(e.tag===19)Wd(e,n,t);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===t)break e;for(;e.sibling===null;){if(e.return===null||e.return===t)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}r&=1}if(se(me,r),!(t.mode&1))t.memoizedState=null;else switch(i){case"forwards":for(n=t.child,i=null;n!==null;)e=n.alternate,e!==null&&hs(e)===null&&(i=n),n=n.sibling;n=i,n===null?(i=t.child,t.child=null):(i=n.sibling,n.sibling=null),qc(t,!1,i,n,a);break;case"backwards":for(n=null,i=t.child,t.child=null;i!==null;){if(e=i.alternate,e!==null&&hs(e)===null){t.child=i;break}e=i.sibling,i.sibling=n,n=i,i=e}qc(t,!0,n,null,a);break;case"together":qc(t,!1,null,null,void 0);break;default:t.memoizedState=null}return t.child}function Mo(e,t){!(t.mode&1)&&e!==null&&(e.alternate=null,t.alternate=null,t.flags|=2)}function gn(e,t,n){if(e!==null&&(t.dependencies=e.dependencies),Nr|=t.lanes,!(n&t.childLanes))return null;if(e!==null&&t.child!==e.child)throw Error(L(153));if(t.child!==null){for(e=t.child,n=Kn(e,e.pendingProps),t.child=n,n.return=t;e.sibling!==null;)e=e.sibling,n=n.sibling=Kn(e,e.pendingProps),n.return=t;n.sibling=null}return t.child}function ix(e,t,n){switch(t.tag){case 3:af(t),ki();break;case 5:Rm(t);break;case 1:nt(t.type)&&is(t);break;case 4:eu(t,t.stateNode.containerInfo);break;case 10:var r=t.type._context,i=t.memoizedProps.value;se(ss,r._currentValue),r._currentValue=i;break;case 13:if(r=t.memoizedState,r!==null)return r.dehydrated!==null?(se(me,me.current&1),t.flags|=128,null):n&t.child.childLanes?of(e,t,n):(se(me,me.current&1),e=gn(e,t,n),e!==null?e.sibling:null);se(me,me.current&1);break;case 19:if(r=(n&t.childLanes)!==0,e.flags&128){if(r)return sf(e,t,n);t.flags|=128}if(i=t.memoizedState,i!==null&&(i.rendering=null,i.tail=null,i.lastEffect=null),se(me,me.current),r)break;return null;case 22:case 23:return t.lanes=0,nf(e,t,n)}return gn(e,t,n)}var cf,Gl,lf,hf;cf=function(e,t){for(var n=t.child;n!==null;){if(n.tag===5||n.tag===6)e.appendChild(n.stateNode);else if(n.tag!==4&&n.child!==null){n.child.return=n,n=n.child;continue}if(n===t)break;for(;n.sibling===null;){if(n.return===null||n.return===t)return;n=n.return}n.sibling.return=n.return,n=n.sibling}};Gl=function(){};lf=function(e,t,n,r){var i=e.memoizedProps;if(i!==r){e=t.stateNode,gr(Yt.current);var a=null;switch(n){case"input":i=pl(e,i),r=pl(e,r),a=[];break;case"select":i=ye({},i,{value:void 0}),r=ye({},r,{value:void 0}),a=[];break;case"textarea":i=fl(e,i),r=fl(e,r),a=[];break;default:typeof i.onClick!="function"&&typeof r.onClick=="function"&&(e.onclick=ns)}vl(n,r);var s;n=null;for(h in i)if(!r.hasOwnProperty(h)&&i.hasOwnProperty(h)&&i[h]!=null)if(h==="style"){var c=i[h];for(s in c)c.hasOwnProperty(s)&&(n||(n={}),n[s]="")}else h!=="dangerouslySetInnerHTML"&&h!=="children"&&h!=="suppressContentEditableWarning"&&h!=="suppressHydrationWarning"&&h!=="autoFocus"&&(ya.hasOwnProperty(h)?a||(a=[]):(a=a||[]).push(h,null));for(h in r){var l=r[h];if(c=i!=null?i[h]:void 0,r.hasOwnProperty(h)&&l!==c&&(l!=null||c!=null))if(h==="style")if(c){for(s in c)!c.hasOwnProperty(s)||l&&l.hasOwnProperty(s)||(n||(n={}),n[s]="");for(s in l)l.hasOwnProperty(s)&&c[s]!==l[s]&&(n||(n={}),n[s]=l[s])}else n||(a||(a=[]),a.push(h,n)),n=l;else h==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,c=c?c.__html:void 0,l!=null&&c!==l&&(a=a||[]).push(h,l)):h==="children"?typeof l!="string"&&typeof l!="number"||(a=a||[]).push(h,""+l):h!=="suppressContentEditableWarning"&&h!=="suppressHydrationWarning"&&(ya.hasOwnProperty(h)?(l!=null&&h==="onScroll"&&le("scroll",e),a||c===l||(a=[])):(a=a||[]).push(h,l))}n&&(a=a||[]).push("style",n);var h=a;(t.updateQueue=h)&&(t.flags|=4)}};hf=function(e,t,n,r){n!==r&&(t.flags|=4)};function Qi(e,t){if(!de)switch(e.tailMode){case"hidden":t=e.tail;for(var n=null;t!==null;)t.alternate!==null&&(n=t),t=t.sibling;n===null?e.tail=null:n.sibling=null;break;case"collapsed":n=e.tail;for(var r=null;n!==null;)n.alternate!==null&&(r=n),n=n.sibling;r===null?t||e.tail===null?e.tail=null:e.tail.sibling=null:r.sibling=null}}function Be(e){var t=e.alternate!==null&&e.alternate.child===e.child,n=0,r=0;if(t)for(var i=e.child;i!==null;)n|=i.lanes|i.childLanes,r|=i.subtreeFlags&14680064,r|=i.flags&14680064,i.return=e,i=i.sibling;else for(i=e.child;i!==null;)n|=i.lanes|i.childLanes,r|=i.subtreeFlags,r|=i.flags,i.return=e,i=i.sibling;return e.subtreeFlags|=r,e.childLanes=n,t}function ax(e,t,n){var r=t.pendingProps;switch($h(t),t.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return Be(t),null;case 1:return nt(t.type)&&rs(),Be(t),null;case 3:return r=t.stateNode,Ci(),he(tt),he(He),nu(),r.pendingContext&&(r.context=r.pendingContext,r.pendingContext=null),(e===null||e.child===null)&&(po(t)?t.flags|=4:e===null||e.memoizedState.isDehydrated&&!(t.flags&256)||(t.flags|=1024,Et!==null&&(Zl(Et),Et=null))),Gl(e,t),Be(t),null;case 5:tu(t);var i=gr(Na.current);if(n=t.type,e!==null&&t.stateNode!=null)lf(e,t,n,r,i),e.ref!==t.ref&&(t.flags|=512,t.flags|=2097152);else{if(!r){if(t.stateNode===null)throw Error(L(166));return Be(t),null}if(e=gr(Yt.current),po(t)){r=t.stateNode,n=t.type;var a=t.memoizedProps;switch(r[Gt]=t,r[Aa]=a,e=(t.mode&1)!==0,n){case"dialog":le("cancel",r),le("close",r);break;case"iframe":case"object":case"embed":le("load",r);break;case"video":case"audio":for(i=0;i<ia.length;i++)le(ia[i],r);break;case"source":le("error",r);break;case"img":case"image":case"link":le("error",r),le("load",r);break;case"details":le("toggle",r);break;case"input":td(r,a),le("invalid",r);break;case"select":r._wrapperState={wasMultiple:!!a.multiple},le("invalid",r);break;case"textarea":rd(r,a),le("invalid",r)}vl(n,a),i=null;for(var s in a)if(a.hasOwnProperty(s)){var c=a[s];s==="children"?typeof c=="string"?r.textContent!==c&&(a.suppressHydrationWarning!==!0&&uo(r.textContent,c,e),i=["children",c]):typeof c=="number"&&r.textContent!==""+c&&(a.suppressHydrationWarning!==!0&&uo(r.textContent,c,e),i=["children",""+c]):ya.hasOwnProperty(s)&&c!=null&&s==="onScroll"&&le("scroll",r)}switch(n){case"input":ro(r),nd(r,a,!0);break;case"textarea":ro(r),id(r);break;case"select":case"option":break;default:typeof a.onClick=="function"&&(r.onclick=ns)}r=i,t.updateQueue=r,r!==null&&(t.flags|=4)}else{s=i.nodeType===9?i:i.ownerDocument,e==="http://www.w3.org/1999/xhtml"&&(e=Og(n)),e==="http://www.w3.org/1999/xhtml"?n==="script"?(e=s.createElement("div"),e.innerHTML="<script><\/script>",e=e.removeChild(e.firstChild)):typeof r.is=="string"?e=s.createElement(n,{is:r.is}):(e=s.createElement(n),n==="select"&&(s=e,r.multiple?s.multiple=!0:r.size&&(s.size=r.size))):e=s.createElementNS(e,n),e[Gt]=t,e[Aa]=r,cf(e,t,!1,!1),t.stateNode=e;e:{switch(s=bl(n,r),n){case"dialog":le("cancel",e),le("close",e),i=r;break;case"iframe":case"object":case"embed":le("load",e),i=r;break;case"video":case"audio":for(i=0;i<ia.length;i++)le(ia[i],e);i=r;break;case"source":le("error",e),i=r;break;case"img":case"image":case"link":le("error",e),le("load",e),i=r;break;case"details":le("toggle",e),i=r;break;case"input":td(e,r),i=pl(e,r),le("invalid",e);break;case"option":i=r;break;case"select":e._wrapperState={wasMultiple:!!r.multiple},i=ye({},r,{value:void 0}),le("invalid",e);break;case"textarea":rd(e,r),i=fl(e,r),le("invalid",e);break;default:i=r}vl(n,i),c=i;for(a in c)if(c.hasOwnProperty(a)){var l=c[a];a==="style"?Fg(e,l):a==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,l!=null&&Ug(e,l)):a==="children"?typeof l=="string"?(n!=="textarea"||l!=="")&&va(e,l):typeof l=="number"&&va(e,""+l):a!=="suppressContentEditableWarning"&&a!=="suppressHydrationWarning"&&a!=="autoFocus"&&(ya.hasOwnProperty(a)?l!=null&&a==="onScroll"&&le("scroll",e):l!=null&&Rh(e,a,l,s))}switch(n){case"input":ro(e),nd(e,r,!1);break;case"textarea":ro(e),id(e);break;case"option":r.value!=null&&e.setAttribute("value",""+Xn(r.value));break;case"select":e.multiple=!!r.multiple,a=r.value,a!=null?ri(e,!!r.multiple,a,!1):r.defaultValue!=null&&ri(e,!!r.multiple,r.defaultValue,!0);break;default:typeof i.onClick=="function"&&(e.onclick=ns)}switch(n){case"button":case"input":case"select":case"textarea":r=!!r.autoFocus;break e;case"img":r=!0;break e;default:r=!1}}r&&(t.flags|=4)}t.ref!==null&&(t.flags|=512,t.flags|=2097152)}return Be(t),null;case 6:if(e&&t.stateNode!=null)hf(e,t,e.memoizedProps,r);else{if(typeof r!="string"&&t.stateNode===null)throw Error(L(166));if(n=gr(Na.current),gr(Yt.current),po(t)){if(r=t.stateNode,n=t.memoizedProps,r[Gt]=t,(a=r.nodeValue!==n)&&(e=ht,e!==null))switch(e.tag){case 3:uo(r.nodeValue,n,(e.mode&1)!==0);break;case 5:e.memoizedProps.suppressHydrationWarning!==!0&&uo(r.nodeValue,n,(e.mode&1)!==0)}a&&(t.flags|=4)}else r=(n.nodeType===9?n:n.ownerDocument).createTextNode(r),r[Gt]=t,t.stateNode=r}return Be(t),null;case 13:if(he(me),r=t.memoizedState,e===null||e.memoizedState!==null&&e.memoizedState.dehydrated!==null){if(de&&ct!==null&&t.mode&1&&!(t.flags&128))Am(),ki(),t.flags|=98560,a=!1;else if(a=po(t),r!==null&&r.dehydrated!==null){if(e===null){if(!a)throw Error(L(318));if(a=t.memoizedState,a=a!==null?a.dehydrated:null,!a)throw Error(L(317));a[Gt]=t}else ki(),!(t.flags&128)&&(t.memoizedState=null),t.flags|=4;Be(t),a=!1}else Et!==null&&(Zl(Et),Et=null),a=!0;if(!a)return t.flags&65536?t:null}return t.flags&128?(t.lanes=n,t):(r=r!==null,r!==(e!==null&&e.memoizedState!==null)&&r&&(t.child.flags|=8192,t.mode&1&&(e===null||me.current&1?Ae===0&&(Ae=3):gu())),t.updateQueue!==null&&(t.flags|=4),Be(t),null);case 4:return Ci(),Gl(e,t),e===null&&Sa(t.stateNode.containerInfo),Be(t),null;case 10:return Xh(t.type._context),Be(t),null;case 17:return nt(t.type)&&rs(),Be(t),null;case 19:if(he(me),a=t.memoizedState,a===null)return Be(t),null;if(r=(t.flags&128)!==0,s=a.rendering,s===null)if(r)Qi(a,!1);else{if(Ae!==0||e!==null&&e.flags&128)for(e=t.child;e!==null;){if(s=hs(e),s!==null){for(t.flags|=128,Qi(a,!1),r=s.updateQueue,r!==null&&(t.updateQueue=r,t.flags|=4),t.subtreeFlags=0,r=n,n=t.child;n!==null;)a=n,e=r,a.flags&=14680066,s=a.alternate,s===null?(a.childLanes=0,a.lanes=e,a.child=null,a.subtreeFlags=0,a.memoizedProps=null,a.memoizedState=null,a.updateQueue=null,a.dependencies=null,a.stateNode=null):(a.childLanes=s.childLanes,a.lanes=s.lanes,a.child=s.child,a.subtreeFlags=0,a.deletions=null,a.memoizedProps=s.memoizedProps,a.memoizedState=s.memoizedState,a.updateQueue=s.updateQueue,a.type=s.type,e=s.dependencies,a.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),n=n.sibling;return se(me,me.current&1|2),t.child}e=e.sibling}a.tail!==null&&xe()>Pi&&(t.flags|=128,r=!0,Qi(a,!1),t.lanes=4194304)}else{if(!r)if(e=hs(s),e!==null){if(t.flags|=128,r=!0,n=e.updateQueue,n!==null&&(t.updateQueue=n,t.flags|=4),Qi(a,!0),a.tail===null&&a.tailMode==="hidden"&&!s.alternate&&!de)return Be(t),null}else 2*xe()-a.renderingStartTime>Pi&&n!==1073741824&&(t.flags|=128,r=!0,Qi(a,!1),t.lanes=4194304);a.isBackwards?(s.sibling=t.child,t.child=s):(n=a.last,n!==null?n.sibling=s:t.child=s,a.last=s)}return a.tail!==null?(t=a.tail,a.rendering=t,a.tail=t.sibling,a.renderingStartTime=xe(),t.sibling=null,n=me.current,se(me,r?n&1|2:n&1),t):(Be(t),null);case 22:case 23:return pu(),r=t.memoizedState!==null,e!==null&&e.memoizedState!==null!==r&&(t.flags|=8192),r&&t.mode&1?ot&1073741824&&(Be(t),t.subtreeFlags&6&&(t.flags|=8192)):Be(t),null;case 24:return null;case 25:return null}throw Error(L(156,t.tag))}function ox(e,t){switch($h(t),t.tag){case 1:return nt(t.type)&&rs(),e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 3:return Ci(),he(tt),he(He),nu(),e=t.flags,e&65536&&!(e&128)?(t.flags=e&-65537|128,t):null;case 5:return tu(t),null;case 13:if(he(me),e=t.memoizedState,e!==null&&e.dehydrated!==null){if(t.alternate===null)throw Error(L(340));ki()}return e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 19:return he(me),null;case 4:return Ci(),null;case 10:return Xh(t.type._context),null;case 22:case 23:return pu(),null;case 24:return null;default:return null}}var fo=!1,ze=!1,sx=typeof WeakSet=="function"?WeakSet:Set,U=null;function ei(e,t){var n=e.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(r){be(e,t,r)}else n.current=null}function Wl(e,t,n){try{n()}catch(r){be(e,t,r)}}var $d=!1;function cx(e,t){if(Nl=Zo,e=gm(),Gh(e)){if("selectionStart"in e)var n={start:e.selectionStart,end:e.selectionEnd};else e:{n=(n=e.ownerDocument)&&n.defaultView||window;var r=n.getSelection&&n.getSelection();if(r&&r.rangeCount!==0){n=r.anchorNode;var i=r.anchorOffset,a=r.focusNode;r=r.focusOffset;try{n.nodeType,a.nodeType}catch{n=null;break e}var s=0,c=-1,l=-1,h=0,u=0,d=e,p=null;t:for(;;){for(var v;d!==n||i!==0&&d.nodeType!==3||(c=s+i),d!==a||r!==0&&d.nodeType!==3||(l=s+r),d.nodeType===3&&(s+=d.nodeValue.length),(v=d.firstChild)!==null;)p=d,d=v;for(;;){if(d===e)break t;if(p===n&&++h===i&&(c=s),p===a&&++u===r&&(l=s),(v=d.nextSibling)!==null)break;d=p,p=d.parentNode}d=v}n=c===-1||l===-1?null:{start:c,end:l}}else n=null}n=n||{start:0,end:0}}else n=null;for(jl={focusedElem:e,selectionRange:n},Zo=!1,U=t;U!==null;)if(t=U,e=t.child,(t.subtreeFlags&1028)!==0&&e!==null)e.return=t,U=e;else for(;U!==null;){t=U;try{var x=t.alternate;if(t.flags&1024)switch(t.tag){case 0:case 11:case 15:break;case 1:if(x!==null){var y=x.memoizedProps,k=x.memoizedState,f=t.stateNode,g=f.getSnapshotBeforeUpdate(t.elementType===t.type?y:Pt(t.type,y),k);f.__reactInternalSnapshotBeforeUpdate=g}break;case 3:var b=t.stateNode.containerInfo;b.nodeType===1?b.textContent="":b.nodeType===9&&b.documentElement&&b.removeChild(b.documentElement);break;case 5:case 6:case 4:case 17:break;default:throw Error(L(163))}}catch(w){be(t,t.return,w)}if(e=t.sibling,e!==null){e.return=t.return,U=e;break}U=t.return}return x=$d,$d=!1,x}function ua(e,t,n){var r=t.updateQueue;if(r=r!==null?r.lastEffect:null,r!==null){var i=r=r.next;do{if((i.tag&e)===e){var a=i.destroy;i.destroy=void 0,a!==void 0&&Wl(t,n,a)}i=i.next}while(i!==r)}}function Us(e,t){if(t=t.updateQueue,t=t!==null?t.lastEffect:null,t!==null){var n=t=t.next;do{if((n.tag&e)===e){var r=n.create;n.destroy=r()}n=n.next}while(n!==t)}}function $l(e){var t=e.ref;if(t!==null){var n=e.stateNode;switch(e.tag){case 5:e=n;break;default:e=n}typeof t=="function"?t(e):t.current=e}}function uf(e){var t=e.alternate;t!==null&&(e.alternate=null,uf(t)),e.child=null,e.deletions=null,e.sibling=null,e.tag===5&&(t=e.stateNode,t!==null&&(delete t[Gt],delete t[Aa],delete t[Ll],delete t[Hw],delete t[Gw])),e.stateNode=null,e.return=null,e.dependencies=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.stateNode=null,e.updateQueue=null}function df(e){return e.tag===5||e.tag===3||e.tag===4}function Kd(e){e:for(;;){for(;e.sibling===null;){if(e.return===null||df(e.return))return null;e=e.return}for(e.sibling.return=e.return,e=e.sibling;e.tag!==5&&e.tag!==6&&e.tag!==18;){if(e.flags&2||e.child===null||e.tag===4)continue e;e.child.return=e,e=e.child}if(!(e.flags&2))return e.stateNode}}function Kl(e,t,n){var r=e.tag;if(r===5||r===6)e=e.stateNode,t?n.nodeType===8?n.parentNode.insertBefore(e,t):n.insertBefore(e,t):(n.nodeType===8?(t=n.parentNode,t.insertBefore(e,n)):(t=n,t.appendChild(e)),n=n._reactRootContainer,n!=null||t.onclick!==null||(t.onclick=ns));else if(r!==4&&(e=e.child,e!==null))for(Kl(e,t,n),e=e.sibling;e!==null;)Kl(e,t,n),e=e.sibling}function Ql(e,t,n){var r=e.tag;if(r===5||r===6)e=e.stateNode,t?n.insertBefore(e,t):n.appendChild(e);else if(r!==4&&(e=e.child,e!==null))for(Ql(e,t,n),e=e.sibling;e!==null;)Ql(e,t,n),e=e.sibling}var Me=null,jt=!1;function kn(e,t,n){for(n=n.child;n!==null;)pf(e,t,n),n=n.sibling}function pf(e,t,n){if(Qt&&typeof Qt.onCommitFiberUnmount=="function")try{Qt.onCommitFiberUnmount(js,n)}catch{}switch(n.tag){case 5:ze||ei(n,t);case 6:var r=Me,i=jt;Me=null,kn(e,t,n),Me=r,jt=i,Me!==null&&(jt?(e=Me,n=n.stateNode,e.nodeType===8?e.parentNode.removeChild(n):e.removeChild(n)):Me.removeChild(n.stateNode));break;case 18:Me!==null&&(jt?(e=Me,n=n.stateNode,e.nodeType===8?Nc(e.parentNode,n):e.nodeType===1&&Nc(e,n),ka(e)):Nc(Me,n.stateNode));break;case 4:r=Me,i=jt,Me=n.stateNode.containerInfo,jt=!0,kn(e,t,n),Me=r,jt=i;break;case 0:case 11:case 14:case 15:if(!ze&&(r=n.updateQueue,r!==null&&(r=r.lastEffect,r!==null))){i=r=r.next;do{var a=i,s=a.destroy;a=a.tag,s!==void 0&&(a&2||a&4)&&Wl(n,t,s),i=i.next}while(i!==r)}kn(e,t,n);break;case 1:if(!ze&&(ei(n,t),r=n.stateNode,typeof r.componentWillUnmount=="function"))try{r.props=n.memoizedProps,r.state=n.memoizedState,r.componentWillUnmount()}catch(c){be(n,t,c)}kn(e,t,n);break;case 21:kn(e,t,n);break;case 22:n.mode&1?(ze=(r=ze)||n.memoizedState!==null,kn(e,t,n),ze=r):kn(e,t,n);break;default:kn(e,t,n)}}function Qd(e){var t=e.updateQueue;if(t!==null){e.updateQueue=null;var n=e.stateNode;n===null&&(n=e.stateNode=new sx),t.forEach(function(r){var i=yx.bind(null,e,r);n.has(r)||(n.add(r),r.then(i,i))})}}function St(e,t){var n=t.deletions;if(n!==null)for(var r=0;r<n.length;r++){var i=n[r];try{var a=e,s=t,c=s;e:for(;c!==null;){switch(c.tag){case 5:Me=c.stateNode,jt=!1;break e;case 3:Me=c.stateNode.containerInfo,jt=!0;break e;case 4:Me=c.stateNode.containerInfo,jt=!0;break e}c=c.return}if(Me===null)throw Error(L(160));pf(a,s,i),Me=null,jt=!1;var l=i.alternate;l!==null&&(l.return=null),i.return=null}catch(h){be(i,t,h)}}if(t.subtreeFlags&12854)for(t=t.child;t!==null;)gf(t,e),t=t.sibling}function gf(e,t){var n=e.alternate,r=e.flags;switch(e.tag){case 0:case 11:case 14:case 15:if(St(t,e),Ft(e),r&4){try{ua(3,e,e.return),Us(3,e)}catch(y){be(e,e.return,y)}try{ua(5,e,e.return)}catch(y){be(e,e.return,y)}}break;case 1:St(t,e),Ft(e),r&512&&n!==null&&ei(n,n.return);break;case 5:if(St(t,e),Ft(e),r&512&&n!==null&&ei(n,n.return),e.flags&32){var i=e.stateNode;try{va(i,"")}catch(y){be(e,e.return,y)}}if(r&4&&(i=e.stateNode,i!=null)){var a=e.memoizedProps,s=n!==null?n.memoizedProps:a,c=e.type,l=e.updateQueue;if(e.updateQueue=null,l!==null)try{c==="input"&&a.type==="radio"&&a.name!=null&&Mg(i,a),bl(c,s);var h=bl(c,a);for(s=0;s<l.length;s+=2){var u=l[s],d=l[s+1];u==="style"?Fg(i,d):u==="dangerouslySetInnerHTML"?Ug(i,d):u==="children"?va(i,d):Rh(i,u,d,h)}switch(c){case"input":gl(i,a);break;case"textarea":qg(i,a);break;case"select":var p=i._wrapperState.wasMultiple;i._wrapperState.wasMultiple=!!a.multiple;var v=a.value;v!=null?ri(i,!!a.multiple,v,!1):p!==!!a.multiple&&(a.defaultValue!=null?ri(i,!!a.multiple,a.defaultValue,!0):ri(i,!!a.multiple,a.multiple?[]:"",!1))}i[Aa]=a}catch(y){be(e,e.return,y)}}break;case 6:if(St(t,e),Ft(e),r&4){if(e.stateNode===null)throw Error(L(162));i=e.stateNode,a=e.memoizedProps;try{i.nodeValue=a}catch(y){be(e,e.return,y)}}break;case 3:if(St(t,e),Ft(e),r&4&&n!==null&&n.memoizedState.isDehydrated)try{ka(t.containerInfo)}catch(y){be(e,e.return,y)}break;case 4:St(t,e),Ft(e);break;case 13:St(t,e),Ft(e),i=e.child,i.flags&8192&&(a=i.memoizedState!==null,i.stateNode.isHidden=a,!a||i.alternate!==null&&i.alternate.memoizedState!==null||(uu=xe())),r&4&&Qd(e);break;case 22:if(u=n!==null&&n.memoizedState!==null,e.mode&1?(ze=(h=ze)||u,St(t,e),ze=h):St(t,e),Ft(e),r&8192){if(h=e.memoizedState!==null,(e.stateNode.isHidden=h)&&!u&&e.mode&1)for(U=e,u=e.child;u!==null;){for(d=U=u;U!==null;){switch(p=U,v=p.child,p.tag){case 0:case 11:case 14:case 15:ua(4,p,p.return);break;case 1:ei(p,p.return);var x=p.stateNode;if(typeof x.componentWillUnmount=="function"){r=p,n=p.return;try{t=r,x.props=t.memoizedProps,x.state=t.memoizedState,x.componentWillUnmount()}catch(y){be(r,n,y)}}break;case 5:ei(p,p.return);break;case 22:if(p.memoizedState!==null){Xd(d);continue}}v!==null?(v.return=p,U=v):Xd(d)}u=u.sibling}e:for(u=null,d=e;;){if(d.tag===5){if(u===null){u=d;try{i=d.stateNode,h?(a=i.style,typeof a.setProperty=="function"?a.setProperty("display","none","important"):a.display="none"):(c=d.stateNode,l=d.memoizedProps.style,s=l!=null&&l.hasOwnProperty("display")?l.display:null,c.style.display=_g("display",s))}catch(y){be(e,e.return,y)}}}else if(d.tag===6){if(u===null)try{d.stateNode.nodeValue=h?"":d.memoizedProps}catch(y){be(e,e.return,y)}}else if((d.tag!==22&&d.tag!==23||d.memoizedState===null||d===e)&&d.child!==null){d.child.return=d,d=d.child;continue}if(d===e)break e;for(;d.sibling===null;){if(d.return===null||d.return===e)break e;u===d&&(u=null),d=d.return}u===d&&(u=null),d.sibling.return=d.return,d=d.sibling}}break;case 19:St(t,e),Ft(e),r&4&&Qd(e);break;case 21:break;default:St(t,e),Ft(e)}}function Ft(e){var t=e.flags;if(t&2){try{e:{for(var n=e.return;n!==null;){if(df(n)){var r=n;break e}n=n.return}throw Error(L(160))}switch(r.tag){case 5:var i=r.stateNode;r.flags&32&&(va(i,""),r.flags&=-33);var a=Kd(e);Ql(e,a,i);break;case 3:case 4:var s=r.stateNode.containerInfo,c=Kd(e);Kl(e,c,s);break;default:throw Error(L(161))}}catch(l){be(e,e.return,l)}e.flags&=-3}t&4096&&(e.flags&=-4097)}function lx(e,t,n){U=e,mf(e)}function mf(e,t,n){for(var r=(e.mode&1)!==0;U!==null;){var i=U,a=i.child;if(i.tag===22&&r){var s=i.memoizedState!==null||fo;if(!s){var c=i.alternate,l=c!==null&&c.memoizedState!==null||ze;c=fo;var h=ze;if(fo=s,(ze=l)&&!h)for(U=i;U!==null;)s=U,l=s.child,s.tag===22&&s.memoizedState!==null?Jd(i):l!==null?(l.return=s,U=l):Jd(i);for(;a!==null;)U=a,mf(a),a=a.sibling;U=i,fo=c,ze=h}Yd(e)}else i.subtreeFlags&8772&&a!==null?(a.return=i,U=a):Yd(e)}}function Yd(e){for(;U!==null;){var t=U;if(t.flags&8772){var n=t.alternate;try{if(t.flags&8772)switch(t.tag){case 0:case 11:case 15:ze||Us(5,t);break;case 1:var r=t.stateNode;if(t.flags&4&&!ze)if(n===null)r.componentDidMount();else{var i=t.elementType===t.type?n.memoizedProps:Pt(t.type,n.memoizedProps);r.componentDidUpdate(i,n.memoizedState,r.__reactInternalSnapshotBeforeUpdate)}var a=t.updateQueue;a!==null&&Dd(t,a,r);break;case 3:var s=t.updateQueue;if(s!==null){if(n=null,t.child!==null)switch(t.child.tag){case 5:n=t.child.stateNode;break;case 1:n=t.child.stateNode}Dd(t,s,n)}break;case 5:var c=t.stateNode;if(n===null&&t.flags&4){n=c;var l=t.memoizedProps;switch(t.type){case"button":case"input":case"select":case"textarea":l.autoFocus&&n.focus();break;case"img":l.src&&(n.src=l.src)}}break;case 6:break;case 4:break;case 12:break;case 13:if(t.memoizedState===null){var h=t.alternate;if(h!==null){var u=h.memoizedState;if(u!==null){var d=u.dehydrated;d!==null&&ka(d)}}}break;case 19:case 17:case 21:case 22:case 23:case 25:break;default:throw Error(L(163))}ze||t.flags&512&&$l(t)}catch(p){be(t,t.return,p)}}if(t===e){U=null;break}if(n=t.sibling,n!==null){n.return=t.return,U=n;break}U=t.return}}function Xd(e){for(;U!==null;){var t=U;if(t===e){U=null;break}var n=t.sibling;if(n!==null){n.return=t.return,U=n;break}U=t.return}}function Jd(e){for(;U!==null;){var t=U;try{switch(t.tag){case 0:case 11:case 15:var n=t.return;try{Us(4,t)}catch(l){be(t,n,l)}break;case 1:var r=t.stateNode;if(typeof r.componentDidMount=="function"){var i=t.return;try{r.componentDidMount()}catch(l){be(t,i,l)}}var a=t.return;try{$l(t)}catch(l){be(t,a,l)}break;case 5:var s=t.return;try{$l(t)}catch(l){be(t,s,l)}}}catch(l){be(t,t.return,l)}if(t===e){U=null;break}var c=t.sibling;if(c!==null){c.return=t.return,U=c;break}U=t.return}}var hx=Math.ceil,ps=vn.ReactCurrentDispatcher,lu=vn.ReactCurrentOwner,xt=vn.ReactCurrentBatchConfig,re=0,Re=null,ke=null,qe=0,ot=0,ti=rr(0),Ae=0,La=null,Nr=0,_s=0,hu=0,da=null,Ze=null,uu=0,Pi=1/0,an=null,gs=!1,Yl=null,Wn=null,yo=!1,Un=null,ms=0,pa=0,Xl=null,qo=-1,Oo=0;function Ye(){return re&6?xe():qo!==-1?qo:qo=xe()}function $n(e){return e.mode&1?re&2&&qe!==0?qe&-qe:$w.transition!==null?(Oo===0&&(Oo=Jg()),Oo):(e=oe,e!==0||(e=window.event,e=e===void 0?16:am(e.type)),e):1}function Dt(e,t,n,r){if(50<pa)throw pa=0,Xl=null,Error(L(185));Ha(e,n,r),(!(re&2)||e!==Re)&&(e===Re&&(!(re&2)&&(_s|=n),Ae===4&&En(e,qe)),rt(e,r),n===1&&re===0&&!(t.mode&1)&&(Pi=xe()+500,Ms&&ir()))}function rt(e,t){var n=e.callbackNode;$b(e,t);var r=Jo(e,e===Re?qe:0);if(r===0)n!==null&&sd(n),e.callbackNode=null,e.callbackPriority=0;else if(t=r&-r,e.callbackPriority!==t){if(n!=null&&sd(n),t===1)e.tag===0?Ww(Zd.bind(null,e)):Cm(Zd.bind(null,e)),Vw(function(){!(re&6)&&ir()}),n=null;else{switch(Zg(r)){case 1:n=Oh;break;case 4:n=Yg;break;case 16:n=Xo;break;case 536870912:n=Xg;break;default:n=Xo}n=Tf(n,ff.bind(null,e))}e.callbackPriority=t,e.callbackNode=n}}function ff(e,t){if(qo=-1,Oo=0,re&6)throw Error(L(327));var n=e.callbackNode;if(ci()&&e.callbackNode!==n)return null;var r=Jo(e,e===Re?qe:0);if(r===0)return null;if(r&30||r&e.expiredLanes||t)t=fs(e,r);else{t=r;var i=re;re|=2;var a=vf();(Re!==e||qe!==t)&&(an=null,Pi=xe()+500,kr(e,t));do try{px();break}catch(c){yf(e,c)}while(!0);Yh(),ps.current=a,re=i,ke!==null?t=0:(Re=null,qe=0,t=Ae)}if(t!==0){if(t===2&&(i=Cl(e),i!==0&&(r=i,t=Jl(e,i))),t===1)throw n=La,kr(e,0),En(e,r),rt(e,xe()),n;if(t===6)En(e,r);else{if(i=e.current.alternate,!(r&30)&&!ux(i)&&(t=fs(e,r),t===2&&(a=Cl(e),a!==0&&(r=a,t=Jl(e,a))),t===1))throw n=La,kr(e,0),En(e,r),rt(e,xe()),n;switch(e.finishedWork=i,e.finishedLanes=r,t){case 0:case 1:throw Error(L(345));case 2:hr(e,Ze,an);break;case 3:if(En(e,r),(r&130023424)===r&&(t=uu+500-xe(),10<t)){if(Jo(e,0)!==0)break;if(i=e.suspendedLanes,(i&r)!==r){Ye(),e.pingedLanes|=e.suspendedLanes&i;break}e.timeoutHandle=Rl(hr.bind(null,e,Ze,an),t);break}hr(e,Ze,an);break;case 4:if(En(e,r),(r&4194240)===r)break;for(t=e.eventTimes,i=-1;0<r;){var s=31-Lt(r);a=1<<s,s=t[s],s>i&&(i=s),r&=~a}if(r=i,r=xe()-r,r=(120>r?120:480>r?480:1080>r?1080:1920>r?1920:3e3>r?3e3:4320>r?4320:1960*hx(r/1960))-r,10<r){e.timeoutHandle=Rl(hr.bind(null,e,Ze,an),r);break}hr(e,Ze,an);break;case 5:hr(e,Ze,an);break;default:throw Error(L(329))}}}return rt(e,xe()),e.callbackNode===n?ff.bind(null,e):null}function Jl(e,t){var n=da;return e.current.memoizedState.isDehydrated&&(kr(e,t).flags|=256),e=fs(e,t),e!==2&&(t=Ze,Ze=n,t!==null&&Zl(t)),e}function Zl(e){Ze===null?Ze=e:Ze.push.apply(Ze,e)}function ux(e){for(var t=e;;){if(t.flags&16384){var n=t.updateQueue;if(n!==null&&(n=n.stores,n!==null))for(var r=0;r<n.length;r++){var i=n[r],a=i.getSnapshot;i=i.value;try{if(!Mt(a(),i))return!1}catch{return!1}}}if(n=t.child,t.subtreeFlags&16384&&n!==null)n.return=t,t=n;else{if(t===e)break;for(;t.sibling===null;){if(t.return===null||t.return===e)return!0;t=t.return}t.sibling.return=t.return,t=t.sibling}}return!0}function En(e,t){for(t&=~hu,t&=~_s,e.suspendedLanes|=t,e.pingedLanes&=~t,e=e.expirationTimes;0<t;){var n=31-Lt(t),r=1<<n;e[n]=-1,t&=~r}}function Zd(e){if(re&6)throw Error(L(327));ci();var t=Jo(e,0);if(!(t&1))return rt(e,xe()),null;var n=fs(e,t);if(e.tag!==0&&n===2){var r=Cl(e);r!==0&&(t=r,n=Jl(e,r))}if(n===1)throw n=La,kr(e,0),En(e,t),rt(e,xe()),n;if(n===6)throw Error(L(345));return e.finishedWork=e.current.alternate,e.finishedLanes=t,hr(e,Ze,an),rt(e,xe()),null}function du(e,t){var n=re;re|=1;try{return e(t)}finally{re=n,re===0&&(Pi=xe()+500,Ms&&ir())}}function jr(e){Un!==null&&Un.tag===0&&!(re&6)&&ci();var t=re;re|=1;var n=xt.transition,r=oe;try{if(xt.transition=null,oe=1,e)return e()}finally{oe=r,xt.transition=n,re=t,!(re&6)&&ir()}}function pu(){ot=ti.current,he(ti)}function kr(e,t){e.finishedWork=null,e.finishedLanes=0;var n=e.timeoutHandle;if(n!==-1&&(e.timeoutHandle=-1,Bw(n)),ke!==null)for(n=ke.return;n!==null;){var r=n;switch($h(r),r.tag){case 1:r=r.type.childContextTypes,r!=null&&rs();break;case 3:Ci(),he(tt),he(He),nu();break;case 5:tu(r);break;case 4:Ci();break;case 13:he(me);break;case 19:he(me);break;case 10:Xh(r.type._context);break;case 22:case 23:pu()}n=n.return}if(Re=e,ke=e=Kn(e.current,null),qe=ot=t,Ae=0,La=null,hu=_s=Nr=0,Ze=da=null,pr!==null){for(t=0;t<pr.length;t++)if(n=pr[t],r=n.interleaved,r!==null){n.interleaved=null;var i=r.next,a=n.pending;if(a!==null){var s=a.next;a.next=i,r.next=s}n.pending=r}pr=null}return e}function yf(e,t){do{var n=ke;try{if(Yh(),Lo.current=ds,us){for(var r=fe.memoizedState;r!==null;){var i=r.queue;i!==null&&(i.pending=null),r=r.next}us=!1}if(Ir=0,je=Se=fe=null,ha=!1,ja=0,lu.current=null,n===null||n.return===null){Ae=1,La=t,ke=null;break}e:{var a=e,s=n.return,c=n,l=t;if(t=qe,c.flags|=32768,l!==null&&typeof l=="object"&&typeof l.then=="function"){var h=l,u=c,d=u.tag;if(!(u.mode&1)&&(d===0||d===11||d===15)){var p=u.alternate;p?(u.updateQueue=p.updateQueue,u.memoizedState=p.memoizedState,u.lanes=p.lanes):(u.updateQueue=null,u.memoizedState=null)}var v=Fd(s);if(v!==null){v.flags&=-257,Bd(v,s,c,a,t),v.mode&1&&_d(a,h,t),t=v,l=h;var x=t.updateQueue;if(x===null){var y=new Set;y.add(l),t.updateQueue=y}else x.add(l);break e}else{if(!(t&1)){_d(a,h,t),gu();break e}l=Error(L(426))}}else if(de&&c.mode&1){var k=Fd(s);if(k!==null){!(k.flags&65536)&&(k.flags|=256),Bd(k,s,c,a,t),Kh(Si(l,c));break e}}a=l=Si(l,c),Ae!==4&&(Ae=2),da===null?da=[a]:da.push(a),a=s;do{switch(a.tag){case 3:a.flags|=65536,t&=-t,a.lanes|=t;var f=Zm(a,l,t);Ld(a,f);break e;case 1:c=l;var g=a.type,b=a.stateNode;if(!(a.flags&128)&&(typeof g.getDerivedStateFromError=="function"||b!==null&&typeof b.componentDidCatch=="function"&&(Wn===null||!Wn.has(b)))){a.flags|=65536,t&=-t,a.lanes|=t;var w=ef(a,c,t);Ld(a,w);break e}}a=a.return}while(a!==null)}wf(n)}catch(T){t=T,ke===n&&n!==null&&(ke=n=n.return);continue}break}while(!0)}function vf(){var e=ps.current;return ps.current=ds,e===null?ds:e}function gu(){(Ae===0||Ae===3||Ae===2)&&(Ae=4),Re===null||!(Nr&268435455)&&!(_s&268435455)||En(Re,qe)}function fs(e,t){var n=re;re|=2;var r=vf();(Re!==e||qe!==t)&&(an=null,kr(e,t));do try{dx();break}catch(i){yf(e,i)}while(!0);if(Yh(),re=n,ps.current=r,ke!==null)throw Error(L(261));return Re=null,qe=0,Ae}function dx(){for(;ke!==null;)bf(ke)}function px(){for(;ke!==null&&!Ub();)bf(ke)}function bf(e){var t=kf(e.alternate,e,ot);e.memoizedProps=e.pendingProps,t===null?wf(e):ke=t,lu.current=null}function wf(e){var t=e;do{var n=t.alternate;if(e=t.return,t.flags&32768){if(n=ox(n,t),n!==null){n.flags&=32767,ke=n;return}if(e!==null)e.flags|=32768,e.subtreeFlags=0,e.deletions=null;else{Ae=6,ke=null;return}}else if(n=ax(n,t,ot),n!==null){ke=n;return}if(t=t.sibling,t!==null){ke=t;return}ke=t=e}while(t!==null);Ae===0&&(Ae=5)}function hr(e,t,n){var r=oe,i=xt.transition;try{xt.transition=null,oe=1,gx(e,t,n,r)}finally{xt.transition=i,oe=r}return null}function gx(e,t,n,r){do ci();while(Un!==null);if(re&6)throw Error(L(327));n=e.finishedWork;var i=e.finishedLanes;if(n===null)return null;if(e.finishedWork=null,e.finishedLanes=0,n===e.current)throw Error(L(177));e.callbackNode=null,e.callbackPriority=0;var a=n.lanes|n.childLanes;if(Kb(e,a),e===Re&&(ke=Re=null,qe=0),!(n.subtreeFlags&2064)&&!(n.flags&2064)||yo||(yo=!0,Tf(Xo,function(){return ci(),null})),a=(n.flags&15990)!==0,n.subtreeFlags&15990||a){a=xt.transition,xt.transition=null;var s=oe;oe=1;var c=re;re|=4,lu.current=null,cx(e,n),gf(n,e),Dw(jl),Zo=!!Nl,jl=Nl=null,e.current=n,lx(n),_b(),re=c,oe=s,xt.transition=a}else e.current=n;if(yo&&(yo=!1,Un=e,ms=i),a=e.pendingLanes,a===0&&(Wn=null),Vb(n.stateNode),rt(e,xe()),t!==null)for(r=e.onRecoverableError,n=0;n<t.length;n++)i=t[n],r(i.value,{componentStack:i.stack,digest:i.digest});if(gs)throw gs=!1,e=Yl,Yl=null,e;return ms&1&&e.tag!==0&&ci(),a=e.pendingLanes,a&1?e===Xl?pa++:(pa=0,Xl=e):pa=0,ir(),null}function ci(){if(Un!==null){var e=Zg(ms),t=xt.transition,n=oe;try{if(xt.transition=null,oe=16>e?16:e,Un===null)var r=!1;else{if(e=Un,Un=null,ms=0,re&6)throw Error(L(331));var i=re;for(re|=4,U=e.current;U!==null;){var a=U,s=a.child;if(U.flags&16){var c=a.deletions;if(c!==null){for(var l=0;l<c.length;l++){var h=c[l];for(U=h;U!==null;){var u=U;switch(u.tag){case 0:case 11:case 15:ua(8,u,a)}var d=u.child;if(d!==null)d.return=u,U=d;else for(;U!==null;){u=U;var p=u.sibling,v=u.return;if(uf(u),u===h){U=null;break}if(p!==null){p.return=v,U=p;break}U=v}}}var x=a.alternate;if(x!==null){var y=x.child;if(y!==null){x.child=null;do{var k=y.sibling;y.sibling=null,y=k}while(y!==null)}}U=a}}if(a.subtreeFlags&2064&&s!==null)s.return=a,U=s;else e:for(;U!==null;){if(a=U,a.flags&2048)switch(a.tag){case 0:case 11:case 15:ua(9,a,a.return)}var f=a.sibling;if(f!==null){f.return=a.return,U=f;break e}U=a.return}}var g=e.current;for(U=g;U!==null;){s=U;var b=s.child;if(s.subtreeFlags&2064&&b!==null)b.return=s,U=b;else e:for(s=g;U!==null;){if(c=U,c.flags&2048)try{switch(c.tag){case 0:case 11:case 15:Us(9,c)}}catch(T){be(c,c.return,T)}if(c===s){U=null;break e}var w=c.sibling;if(w!==null){w.return=c.return,U=w;break e}U=c.return}}if(re=i,ir(),Qt&&typeof Qt.onPostCommitFiberRoot=="function")try{Qt.onPostCommitFiberRoot(js,e)}catch{}r=!0}return r}finally{oe=n,xt.transition=t}}return!1}function ep(e,t,n){t=Si(n,t),t=Zm(e,t,1),e=Gn(e,t,1),t=Ye(),e!==null&&(Ha(e,1,t),rt(e,t))}function be(e,t,n){if(e.tag===3)ep(e,e,n);else for(;t!==null;){if(t.tag===3){ep(t,e,n);break}else if(t.tag===1){var r=t.stateNode;if(typeof t.type.getDerivedStateFromError=="function"||typeof r.componentDidCatch=="function"&&(Wn===null||!Wn.has(r))){e=Si(n,e),e=ef(t,e,1),t=Gn(t,e,1),e=Ye(),t!==null&&(Ha(t,1,e),rt(t,e));break}}t=t.return}}function mx(e,t,n){var r=e.pingCache;r!==null&&r.delete(t),t=Ye(),e.pingedLanes|=e.suspendedLanes&n,Re===e&&(qe&n)===n&&(Ae===4||Ae===3&&(qe&130023424)===qe&&500>xe()-uu?kr(e,0):hu|=n),rt(e,t)}function xf(e,t){t===0&&(e.mode&1?(t=oo,oo<<=1,!(oo&130023424)&&(oo=4194304)):t=1);var n=Ye();e=pn(e,t),e!==null&&(Ha(e,t,n),rt(e,n))}function fx(e){var t=e.memoizedState,n=0;t!==null&&(n=t.retryLane),xf(e,n)}function yx(e,t){var n=0;switch(e.tag){case 13:var r=e.stateNode,i=e.memoizedState;i!==null&&(n=i.retryLane);break;case 19:r=e.stateNode;break;default:throw Error(L(314))}r!==null&&r.delete(t),xf(e,n)}var kf;kf=function(e,t,n){if(e!==null)if(e.memoizedProps!==t.pendingProps||tt.current)et=!0;else{if(!(e.lanes&n)&&!(t.flags&128))return et=!1,ix(e,t,n);et=!!(e.flags&131072)}else et=!1,de&&t.flags&1048576&&Sm(t,os,t.index);switch(t.lanes=0,t.tag){case 2:var r=t.type;Mo(e,t),e=t.pendingProps;var i=xi(t,He.current);si(t,n),i=iu(null,t,r,e,i,n);var a=au();return t.flags|=1,typeof i=="object"&&i!==null&&typeof i.render=="function"&&i.$$typeof===void 0?(t.tag=1,t.memoizedState=null,t.updateQueue=null,nt(r)?(a=!0,is(t)):a=!1,t.memoizedState=i.state!==null&&i.state!==void 0?i.state:null,Zh(t),i.updater=Os,t.stateNode=i,i._reactInternals=t,_l(t,r,e,n),t=Vl(null,t,r,!0,a,n)):(t.tag=0,de&&a&&Wh(t),Ke(null,t,i,n),t=t.child),t;case 16:r=t.elementType;e:{switch(Mo(e,t),e=t.pendingProps,i=r._init,r=i(r._payload),t.type=r,i=t.tag=bx(r),e=Pt(r,e),i){case 0:t=Bl(null,t,r,e,n);break e;case 1:t=Hd(null,t,r,e,n);break e;case 11:t=Vd(null,t,r,e,n);break e;case 14:t=zd(null,t,r,Pt(r.type,e),n);break e}throw Error(L(306,r,""))}return t;case 0:return r=t.type,i=t.pendingProps,i=t.elementType===r?i:Pt(r,i),Bl(e,t,r,i,n);case 1:return r=t.type,i=t.pendingProps,i=t.elementType===r?i:Pt(r,i),Hd(e,t,r,i,n);case 3:e:{if(af(t),e===null)throw Error(L(387));r=t.pendingProps,a=t.memoizedState,i=a.element,Em(e,t),ls(t,r,null,n);var s=t.memoizedState;if(r=s.element,a.isDehydrated)if(a={element:r,isDehydrated:!1,cache:s.cache,pendingSuspenseBoundaries:s.pendingSuspenseBoundaries,transitions:s.transitions},t.updateQueue.baseState=a,t.memoizedState=a,t.flags&256){i=Si(Error(L(423)),t),t=Gd(e,t,r,n,i);break e}else if(r!==i){i=Si(Error(L(424)),t),t=Gd(e,t,r,n,i);break e}else for(ct=Hn(t.stateNode.containerInfo.firstChild),ht=t,de=!0,Et=null,n=Nm(t,null,r,n),t.child=n;n;)n.flags=n.flags&-3|4096,n=n.sibling;else{if(ki(),r===i){t=gn(e,t,n);break e}Ke(e,t,r,n)}t=t.child}return t;case 5:return Rm(t),e===null&&ql(t),r=t.type,i=t.pendingProps,a=e!==null?e.memoizedProps:null,s=i.children,El(r,i)?s=null:a!==null&&El(r,a)&&(t.flags|=32),rf(e,t),Ke(e,t,s,n),t.child;case 6:return e===null&&ql(t),null;case 13:return of(e,t,n);case 4:return eu(t,t.stateNode.containerInfo),r=t.pendingProps,e===null?t.child=Ti(t,null,r,n):Ke(e,t,r,n),t.child;case 11:return r=t.type,i=t.pendingProps,i=t.elementType===r?i:Pt(r,i),Vd(e,t,r,i,n);case 7:return Ke(e,t,t.pendingProps,n),t.child;case 8:return Ke(e,t,t.pendingProps.children,n),t.child;case 12:return Ke(e,t,t.pendingProps.children,n),t.child;case 10:e:{if(r=t.type._context,i=t.pendingProps,a=t.memoizedProps,s=i.value,se(ss,r._currentValue),r._currentValue=s,a!==null)if(Mt(a.value,s)){if(a.children===i.children&&!tt.current){t=gn(e,t,n);break e}}else for(a=t.child,a!==null&&(a.return=t);a!==null;){var c=a.dependencies;if(c!==null){s=a.child;for(var l=c.firstContext;l!==null;){if(l.context===r){if(a.tag===1){l=hn(-1,n&-n),l.tag=2;var h=a.updateQueue;if(h!==null){h=h.shared;var u=h.pending;u===null?l.next=l:(l.next=u.next,u.next=l),h.pending=l}}a.lanes|=n,l=a.alternate,l!==null&&(l.lanes|=n),Ol(a.return,n,t),c.lanes|=n;break}l=l.next}}else if(a.tag===10)s=a.type===t.type?null:a.child;else if(a.tag===18){if(s=a.return,s===null)throw Error(L(341));s.lanes|=n,c=s.alternate,c!==null&&(c.lanes|=n),Ol(s,n,t),s=a.sibling}else s=a.child;if(s!==null)s.return=a;else for(s=a;s!==null;){if(s===t){s=null;break}if(a=s.sibling,a!==null){a.return=s.return,s=a;break}s=s.return}a=s}Ke(e,t,i.children,n),t=t.child}return t;case 9:return i=t.type,r=t.pendingProps.children,si(t,n),i=Tt(i),r=r(i),t.flags|=1,Ke(e,t,r,n),t.child;case 14:return r=t.type,i=Pt(r,t.pendingProps),i=Pt(r.type,i),zd(e,t,r,i,n);case 15:return tf(e,t,t.type,t.pendingProps,n);case 17:return r=t.type,i=t.pendingProps,i=t.elementType===r?i:Pt(r,i),Mo(e,t),t.tag=1,nt(r)?(e=!0,is(t)):e=!1,si(t,n),Jm(t,r,i),_l(t,r,i,n),Vl(null,t,r,!0,e,n);case 19:return sf(e,t,n);case 22:return nf(e,t,n)}throw Error(L(156,t.tag))};function Tf(e,t){return Qg(e,t)}function vx(e,t,n,r){this.tag=e,this.key=n,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=t,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=r,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function wt(e,t,n,r){return new vx(e,t,n,r)}function mu(e){return e=e.prototype,!(!e||!e.isReactComponent)}function bx(e){if(typeof e=="function")return mu(e)?1:0;if(e!=null){if(e=e.$$typeof,e===Dh)return 11;if(e===Mh)return 14}return 2}function Kn(e,t){var n=e.alternate;return n===null?(n=wt(e.tag,t,e.key,e.mode),n.elementType=e.elementType,n.type=e.type,n.stateNode=e.stateNode,n.alternate=e,e.alternate=n):(n.pendingProps=t,n.type=e.type,n.flags=0,n.subtreeFlags=0,n.deletions=null),n.flags=e.flags&14680064,n.childLanes=e.childLanes,n.lanes=e.lanes,n.child=e.child,n.memoizedProps=e.memoizedProps,n.memoizedState=e.memoizedState,n.updateQueue=e.updateQueue,t=e.dependencies,n.dependencies=t===null?null:{lanes:t.lanes,firstContext:t.firstContext},n.sibling=e.sibling,n.index=e.index,n.ref=e.ref,n}function Uo(e,t,n,r,i,a){var s=2;if(r=e,typeof e=="function")mu(e)&&(s=1);else if(typeof e=="string")s=5;else e:switch(e){case Gr:return Tr(n.children,i,a,t);case Lh:s=8,i|=8;break;case ll:return e=wt(12,n,t,i|2),e.elementType=ll,e.lanes=a,e;case hl:return e=wt(13,n,t,i),e.elementType=hl,e.lanes=a,e;case ul:return e=wt(19,n,t,i),e.elementType=ul,e.lanes=a,e;case Rg:return Fs(n,i,a,t);default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case jg:s=10;break e;case Eg:s=9;break e;case Dh:s=11;break e;case Mh:s=14;break e;case In:s=16,r=null;break e}throw Error(L(130,e==null?e:typeof e,""))}return t=wt(s,n,t,i),t.elementType=e,t.type=r,t.lanes=a,t}function Tr(e,t,n,r){return e=wt(7,e,r,t),e.lanes=n,e}function Fs(e,t,n,r){return e=wt(22,e,r,t),e.elementType=Rg,e.lanes=n,e.stateNode={isHidden:!1},e}function Oc(e,t,n){return e=wt(6,e,null,t),e.lanes=n,e}function Uc(e,t,n){return t=wt(4,e.children!==null?e.children:[],e.key,t),t.lanes=n,t.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},t}function wx(e,t,n,r,i){this.tag=t,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.pendingContext=this.context=null,this.callbackPriority=0,this.eventTimes=vc(0),this.expirationTimes=vc(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=vc(0),this.identifierPrefix=r,this.onRecoverableError=i,this.mutableSourceEagerHydrationData=null}function fu(e,t,n,r,i,a,s,c,l){return e=new wx(e,t,n,c,l),t===1?(t=1,a===!0&&(t|=8)):t=0,a=wt(3,null,null,t),e.current=a,a.stateNode=e,a.memoizedState={element:r,isDehydrated:n,cache:null,transitions:null,pendingSuspenseBoundaries:null},Zh(a),e}function xx(e,t,n){var r=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:Hr,key:r==null?null:""+r,children:e,containerInfo:t,implementation:n}}function Cf(e){if(!e)return Jn;e=e._reactInternals;e:{if(Lr(e)!==e||e.tag!==1)throw Error(L(170));var t=e;do{switch(t.tag){case 3:t=t.stateNode.context;break e;case 1:if(nt(t.type)){t=t.stateNode.__reactInternalMemoizedMergedChildContext;break e}}t=t.return}while(t!==null);throw Error(L(171))}if(e.tag===1){var n=e.type;if(nt(n))return Tm(e,n,t)}return t}function Sf(e,t,n,r,i,a,s,c,l){return e=fu(n,r,!0,e,i,a,s,c,l),e.context=Cf(null),n=e.current,r=Ye(),i=$n(n),a=hn(r,i),a.callback=t??null,Gn(n,a,i),e.current.lanes=i,Ha(e,i,r),rt(e,r),e}function Bs(e,t,n,r){var i=t.current,a=Ye(),s=$n(i);return n=Cf(n),t.context===null?t.context=n:t.pendingContext=n,t=hn(a,s),t.payload={element:e},r=r===void 0?null:r,r!==null&&(t.callback=r),e=Gn(i,t,s),e!==null&&(Dt(e,i,s,a),Ro(e,i,s)),s}function ys(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function tp(e,t){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var n=e.retryLane;e.retryLane=n!==0&&n<t?n:t}}function yu(e,t){tp(e,t),(e=e.alternate)&&tp(e,t)}function kx(){return null}var Pf=typeof reportError=="function"?reportError:function(e){console.error(e)};function vu(e){this._internalRoot=e}Vs.prototype.render=vu.prototype.render=function(e){var t=this._internalRoot;if(t===null)throw Error(L(409));Bs(e,t,null,null)};Vs.prototype.unmount=vu.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var t=e.containerInfo;jr(function(){Bs(null,e,null,null)}),t[dn]=null}};function Vs(e){this._internalRoot=e}Vs.prototype.unstable_scheduleHydration=function(e){if(e){var t=nm();e={blockedOn:null,target:e,priority:t};for(var n=0;n<jn.length&&t!==0&&t<jn[n].priority;n++);jn.splice(n,0,e),n===0&&im(e)}};function bu(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function zs(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function np(){}function Tx(e,t,n,r,i){if(i){if(typeof r=="function"){var a=r;r=function(){var h=ys(s);a.call(h)}}var s=Sf(t,r,e,0,null,!1,!1,"",np);return e._reactRootContainer=s,e[dn]=s.current,Sa(e.nodeType===8?e.parentNode:e),jr(),s}for(;i=e.lastChild;)e.removeChild(i);if(typeof r=="function"){var c=r;r=function(){var h=ys(l);c.call(h)}}var l=fu(e,0,!1,null,null,!1,!1,"",np);return e._reactRootContainer=l,e[dn]=l.current,Sa(e.nodeType===8?e.parentNode:e),jr(function(){Bs(t,l,n,r)}),l}function Hs(e,t,n,r,i){var a=n._reactRootContainer;if(a){var s=a;if(typeof i=="function"){var c=i;i=function(){var l=ys(s);c.call(l)}}Bs(t,s,e,i)}else s=Tx(n,t,e,i,r);return ys(s)}em=function(e){switch(e.tag){case 3:var t=e.stateNode;if(t.current.memoizedState.isDehydrated){var n=ra(t.pendingLanes);n!==0&&(Uh(t,n|1),rt(t,xe()),!(re&6)&&(Pi=xe()+500,ir()))}break;case 13:jr(function(){var r=pn(e,1);if(r!==null){var i=Ye();Dt(r,e,1,i)}}),yu(e,1)}};_h=function(e){if(e.tag===13){var t=pn(e,134217728);if(t!==null){var n=Ye();Dt(t,e,134217728,n)}yu(e,134217728)}};tm=function(e){if(e.tag===13){var t=$n(e),n=pn(e,t);if(n!==null){var r=Ye();Dt(n,e,t,r)}yu(e,t)}};nm=function(){return oe};rm=function(e,t){var n=oe;try{return oe=e,t()}finally{oe=n}};xl=function(e,t,n){switch(t){case"input":if(gl(e,n),t=n.name,n.type==="radio"&&t!=null){for(n=e;n.parentNode;)n=n.parentNode;for(n=n.querySelectorAll("input[name="+JSON.stringify(""+t)+'][type="radio"]'),t=0;t<n.length;t++){var r=n[t];if(r!==e&&r.form===e.form){var i=Ds(r);if(!i)throw Error(L(90));Dg(r),gl(r,i)}}}break;case"textarea":qg(e,n);break;case"select":t=n.value,t!=null&&ri(e,!!n.multiple,t,!1)}};zg=du;Hg=jr;var Cx={usingClientEntryPoint:!1,Events:[Wa,Qr,Ds,Bg,Vg,du]},Yi={findFiberByHostInstance:dr,bundleType:0,version:"18.3.1",rendererPackageName:"react-dom"},Sx={bundleType:Yi.bundleType,version:Yi.version,rendererPackageName:Yi.rendererPackageName,rendererConfig:Yi.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setErrorHandler:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:vn.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=$g(e),e===null?null:e.stateNode},findFiberByHostInstance:Yi.findFiberByHostInstance||kx,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null,reconcilerVersion:"18.3.1-next-f1338f8080-20240426"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var vo=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!vo.isDisabled&&vo.supportsFiber)try{js=vo.inject(Sx),Qt=vo}catch{}}pt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Cx;pt.createPortal=function(e,t){var n=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!bu(t))throw Error(L(200));return xx(e,t,null,n)};pt.createRoot=function(e,t){if(!bu(e))throw Error(L(299));var n=!1,r="",i=Pf;return t!=null&&(t.unstable_strictMode===!0&&(n=!0),t.identifierPrefix!==void 0&&(r=t.identifierPrefix),t.onRecoverableError!==void 0&&(i=t.onRecoverableError)),t=fu(e,1,!1,null,null,n,!1,r,i),e[dn]=t.current,Sa(e.nodeType===8?e.parentNode:e),new vu(t)};pt.findDOMNode=function(e){if(e==null)return null;if(e.nodeType===1)return e;var t=e._reactInternals;if(t===void 0)throw typeof e.render=="function"?Error(L(188)):(e=Object.keys(e).join(","),Error(L(268,e)));return e=$g(t),e=e===null?null:e.stateNode,e};pt.flushSync=function(e){return jr(e)};pt.hydrate=function(e,t,n){if(!zs(t))throw Error(L(200));return Hs(null,e,t,!0,n)};pt.hydrateRoot=function(e,t,n){if(!bu(e))throw Error(L(405));var r=n!=null&&n.hydratedSources||null,i=!1,a="",s=Pf;if(n!=null&&(n.unstable_strictMode===!0&&(i=!0),n.identifierPrefix!==void 0&&(a=n.identifierPrefix),n.onRecoverableError!==void 0&&(s=n.onRecoverableError)),t=Sf(t,null,e,1,n??null,i,!1,a,s),e[dn]=t.current,Sa(e),r)for(e=0;e<r.length;e++)n=r[e],i=n._getVersion,i=i(n._source),t.mutableSourceEagerHydrationData==null?t.mutableSourceEagerHydrationData=[n,i]:t.mutableSourceEagerHydrationData.push(n,i);return new Vs(t)};pt.render=function(e,t,n){if(!zs(t))throw Error(L(200));return Hs(null,e,t,!1,n)};pt.unmountComponentAtNode=function(e){if(!zs(e))throw Error(L(40));return e._reactRootContainer?(jr(function(){Hs(null,null,e,!1,function(){e._reactRootContainer=null,e[dn]=null})}),!0):!1};pt.unstable_batchedUpdates=du;pt.unstable_renderSubtreeIntoContainer=function(e,t,n,r){if(!zs(n))throw Error(L(200));if(e==null||e._reactInternals===void 0)throw Error(L(38));return Hs(e,t,n,!1,r)};pt.version="18.3.1-next-f1338f8080-20240426";function Af(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(Af)}catch(e){console.error(e)}}Af(),Pg.exports=pt;var Ka=Pg.exports;const Px=Zv(Ka);var If,rp=Ka;If=rp.createRoot,rp.hydrateRoot;/**
 ...
 *
 * @license MIT
 */function Da(){return Da=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Da.apply(this,arguments)}var _n;(function(e){e.Pop="POP",e.Push="PUSH",e.Replace="REPLACE"})(_n||(_n={}));const ip="popstate";function Ax(e){e===void 0&&(e={});function t(r,i){let{pathname:a,search:s,hash:c}=r.location;return eh("",{pathname:a,search:s,hash:c},i.state&&i.state.usr||null,i.state&&i.state.key||"default")}function n(r,i){return typeof i=="string"?i:vs(i)}return Nx(t,n,null,e)}function Te(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function Nf(e,t){if(!e){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function Ix(){return Math.random().toString(36).substr(2,8)}function ap(e,t){return{usr:e.state,key:e.key,idx:t}}function eh(e,t,n,r){return n===void 0&&(n=null),Da({pathname:typeof e=="string"?e:e.pathname,search:"",hash:""},typeof t=="string"?Oi(t):t,{state:n,key:t&&t.key||r||Ix()})}function vs(e){let{pathname:t="/",search:n="",hash:r=""}=e;return n&&n!=="?"&&(t+=n.charAt(0)==="?"?n:"?"+n),r&&r!=="#"&&(t+=r.charAt(0)==="#"?r:"#"+r),t}function Oi(e){let t={};if(e){let n=e.indexOf("#");n>=0&&(t.hash=e.substr(n),e=e.substr(0,n));let r=e.indexOf("?");r>=0&&(t.search=e.substr(r),e=e.substr(0,r)),e&&(t.pathname=e)}return t}function Nx(e,t,n,r){r===void 0&&(r={});let{window:i=document.defaultView,v5Compat:a=!1}=r,s=i.history,c=_n.Pop,l=null,h=u();h==null&&(h=0,s.replaceState(Da({},s.state,{idx:h}),""));function u(){return(s.state||{idx:null}).idx}function d(){c=_n.Pop;let k=u(),f=k==null?null:k-h;h=k,l&&l({action:c,location:y.location,delta:f})}function p(k,f){c=_n.Push;let g=eh(y.location,k,f);h=u()+1;let b=ap(g,h),w=y.createHref(g);try{s.pushState(b,"",w)}catch(T){if(T instanceof DOMException&&T.name==="DataCloneError")throw T;i.location.assign(w)}a&&l&&l({action:c,location:y.location,delta:1})}function v(k,f){c=_n.Replace;let g=eh(y.location,k,f);h=u();let b=ap(g,h),w=y.createHref(g);s.replaceState(b,"",w),a&&l&&l({action:c,location:y.location,delta:0})}function x(k){let f=i.location.origin!=="null"?i.location.origin:i.location.href,g=typeof k=="string"?k:vs(k);return g=g.replace(/ $/,"%20"),Te(f,"No window.location.(origin|href) available to create URL for href: "+g),new URL(g,f)}let y={get action(){return c},get location(){return e(i,s)},listen(k){if(l)throw new Error("A history only accepts one active listener");return i.addEventListener(ip,d),l=k,()=>{i.removeEventListener(ip,d),l=null}},createHref(k){return t(i,k)},createURL:x,encodeLocation(k){let f=x(k);return{pathname:f.pathname,search:f.search,hash:f.hash}},push:p,replace:v,go(k){return s.go(k)}};return y}var op;(function(e){e.data="data",e.deferred="deferred",e.redirect="redirect",e.error="error"})(op||(op={}));function jx(e,t,n){return n===void 0&&(n="/"),Ex(e,t,n,!1)}function Ex(e,t,n,r){let i=typeof t=="string"?Oi(t):t,a=wu(i.pathname||"/",n);if(a==null)return null;let s=jf(e);Rx(s);let c=null;for(let l=0;c==null&&l<s.length;++l){let h=zx(a);c=Bx(s[l],h,r)}return c}function jf(e,t,n,r){t===void 0&&(t=[]),n===void 0&&(n=[]),r===void 0&&(r="");let i=(a,s,c)=>{let l={relativePath:c===void 0?a.path||"":c,caseSensitive:a.caseSensitive===!0,childrenIndex:s,route:a};l.relativePath.startsWith("/")&&(Te(l.relativePath.startsWith(r),'Absolute route path "'+l.relativePath+'" nested under path '+('"'+r+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),l.relativePath=l.relativePath.slice(r.length));let h=Qn([r,l.relativePath]),u=n.concat(l);a.children&&a.children.length>0&&(Te(a.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+h+'".')),jf(a.children,t,u,h)),!(a.path==null&&!a.index)&&t.push({path:h,score:_x(h,a.index),routesMeta:u})};return e.forEach((a,s)=>{var c;if(a.path===""||!((c=a.path)!=null&&c.includes("?")))i(a,s);else for(let l of Ef(a.path))i(a,s,l)}),t}function Ef(e){let t=e.split("/");if(t.length===0)return[];let[n,...r]=t,i=n.endsWith("?"),a=n.replace(/\?$/,"");if(r.length===0)return i?[a,""]:[a];let s=Ef(r.join("/")),c=[];return c.push(...s.map(l=>l===""?a:[a,l].join("/"))),i&&c.push(...s),c.map(l=>e.startsWith("/")&&l===""?"/":l)}function Rx(e){e.sort((t,n)=>t.score!==n.score?n.score-t.score:Fx(t.routesMeta.map(r=>r.childrenIndex),n.routesMeta.map(r=>r.childrenIndex)))}const Lx=/^:[\w-]+$/,Dx=3,Mx=2,qx=1,Ox=10,Ux=-2,sp=e=>e==="*";function _x(e,t){let n=e.split("/"),r=n.length;return n.some(sp)&&(r+=Ux),t&&(r+=Mx),n.filter(i=>!sp(i)).reduce((i,a)=>i+(Lx.test(a)?Dx:a===""?qx:Ox),r)}function Fx(e,t){return e.length===t.length&&e.slice(0,-1).every((r,i)=>r===t[i])?e[e.length-1]-t[t.length-1]:0}function Bx(e,t,n){let{routesMeta:r}=e,i={},a="/",s=[];for(let c=0;c<r.length;++c){let l=r[c],h=c===r.length-1,u=a==="/"?t:t.slice(a.length)||"/",d=cp({path:l.relativePath,caseSensitive:l.caseSensitive,end:h},u),p=l.route;if(!d&&h&&n&&!r[r.length-1].route.index&&(d=cp({path:l.relativePath,caseSensitive:l.caseSensitive,end:!1},u)),!d)return null;Object.assign(i,d.params),s.push({params:i,pathname:Qn([a,d.pathname]),pathnameBase:$x(Qn([a,d.pathnameBase])),route:p}),d.pathnameBase!=="/"&&(a=Qn([a,d.pathnameBase]))}return s}function cp(e,t){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[n,r]=Vx(e.path,e.caseSensitive,e.end),i=t.match(n);if(!i)return null;let a=i[0],s=a.replace(/(.)\/+$/,"$1"),c=i.slice(1);return{params:r.reduce((h,u,d)=>{let{paramName:p,isOptional:v}=u;if(p==="*"){let y=c[d]||"";s=a.slice(0,a.length-y.length).replace(/(.)\/+$/,"$1")}const x=c[d];return v&&!x?h[p]=void 0:h[p]=(x||"").replace(/%2F/g,"/"),h},{}),pathname:a,pathnameBase:s,pattern:e}}function Vx(e,t,n){t===void 0&&(t=!1),n===void 0&&(n=!0),Nf(e==="*"||!e.endsWith("*")||e.endsWith("/*"),'Route path "'+e+'" will be treated as if it were '+('"'+e.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+e.replace(/\*$/,"/*")+'".'));let r=[],i="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(s,c,l)=>(r.push({paramName:c,isOptional:l!=null}),l?"/?([^\\/]+)?":"/([^\\/]+)"));return e.endsWith("*")?(r.push({paramName:"*"}),i+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):n?i+="\\/*$":e!==""&&e!=="/"&&(i+="(?:(?=\\/|$))"),[new RegExp(i,t?void 0:"i"),r]}function zx(e){try{return e.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return Nf(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+t+").")),e}}function wu(e,t){if(t==="/")return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;let n=t.endsWith("/")?t.length-1:t.length,r=e.charAt(n);return r&&r!=="/"?null:e.slice(n)||"/"}function Hx(e,t){t===void 0&&(t="/");let{pathname:n,search:r="",hash:i=""}=typeof e=="string"?Oi(e):e;return{pathname:n?n.startsWith("/")?n:Gx(n,t):t,search:Kx(r),hash:Qx(i)}}function Gx(e,t){let n=t.replace(/\/+$/,"").split("/");return e.split("/").forEach(i=>{i===".."?n.length>1&&n.pop():i!=="."&&n.push(i)}),n.length>1?n.join("/"):"/"}function _c(e,t,n,r){return"Cannot include a '"+e+"' character in a manually specified "+("`to."+t+"` field ["+JSON.stringify(r)+"].  Please separate it out to the ")+("`to."+n+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Wx(e){return e.filter((t,n)=>n===0||t.route.path&&t.route.path.length>0)}function Rf(e,t){let n=Wx(e);return t?n.map((r,i)=>i===n.length-1?r.pathname:r.pathnameBase):n.map(r=>r.pathnameBase)}function Lf(e,t,n,r){r===void 0&&(r=!1);let i;typeof e=="string"?i=Oi(e):(i=Da({},e),Te(!i.pathname||!i.pathname.includes("?"),_c("?","pathname","search",i)),Te(!i.pathname||!i.pathname.includes("#"),_c("#","pathname","hash",i)),Te(!i.search||!i.search.includes("#"),_c("#","search","hash",i)));let a=e===""||i.pathname==="",s=a?"/":i.pathname,c;if(s==null)c=n;else{let d=t.length-1;if(!r&&s.startsWith("..")){let p=s.split("/");for(;p[0]==="..";)p.shift(),d-=1;i.pathname=p.join("/")}c=d>=0?t[d]:"/"}let l=Hx(i,c),h=s&&s!=="/"&&s.endsWith("/"),u=(a||s===".")&&n.endsWith("/");return!l.pathname.endsWith("/")&&(h||u)&&(l.pathname+="/"),l}const Qn=e=>e.join("/").replace(/\/\/+/g,"/"),$x=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),Kx=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,Qx=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e;function Yx(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}const Df=["post","put","patch","delete"];new Set(Df);const Xx=["get",...Df];new Set(Xx);/**
 ...
 *
 * @license MIT
 */function Ma(){return Ma=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Ma.apply(this,arguments)}const xu=m.createContext(null),Jx=m.createContext(null),Dr=m.createContext(null),Gs=m.createContext(null),ar=m.createContext({outlet:null,matches:[],isDataRoute:!1}),Mf=m.createContext(null);function Zx(e,t){let{relative:n}=t===void 0?{}:t;Qa()||Te(!1);let{basename:r,navigator:i}=m.useContext(Dr),{hash:a,pathname:s,search:c}=Uf(e,{relative:n}),l=s;return r!=="/"&&(l=s==="/"?r:Qn([r,s])),i.createHref({pathname:l,search:c,hash:a})}function Qa(){return m.useContext(Gs)!=null}function Ut(){return Qa()||Te(!1),m.useContext(Gs).location}function qf(e){m.useContext(Dr).static||m.useLayoutEffect(e)}function Of(){let{isDataRoute:e}=m.useContext(ar);return e?pk():ek()}function ek(){Qa()||Te(!1);let e=m.useContext(xu),{basename:t,future:n,navigator:r}=m.useContext(Dr),{matches:i}=m.useContext(ar),{pathname:a}=Ut(),s=JSON.stringify(Rf(i,n.v7_relativeSplatPath)),c=m.useRef(!1);return qf(()=>{c.current=!0}),m.useCallback(function(h,u){if(u===void 0&&(u={}),!c.current)return;if(typeof h=="number"){r.go(h);return}let d=Lf(h,JSON.parse(s),a,u.relative==="path");e==null&&t!=="/"&&(d.pathname=d.pathname==="/"?t:Qn([t,d.pathname])),(u.replace?r.replace:r.push)(d,u.state,u)},[t,r,s,a,e])}function tk(){let{matches:e}=m.useContext(ar),t=e[e.length-1];return t?t.params:{}}function Uf(e,t){let{relative:n}=t===void 0?{}:t,{future:r}=m.useContext(Dr),{matches:i}=m.useContext(ar),{pathname:a}=Ut(),s=JSON.stringify(Rf(i,r.v7_relativeSplatPath));return m.useMemo(()=>Lf(e,JSON.parse(s),a,n==="path"),[e,s,a,n])}function nk(e,t){return rk(e,t)}function rk(e,t,n,r){Qa()||Te(!1);let{navigator:i}=m.useContext(Dr),{matches:a}=m.useContext(ar),s=a[a.length-1],c=s?s.params:{};s&&s.pathname;let l=s?s.pathnameBase:"/";s&&s.route;let h=Ut(),u;if(t){var d;let k=typeof t=="string"?Oi(t):t;l==="/"||(d=k.pathname)!=null&&d.startsWith(l)||Te(!1),u=k}else u=h;let p=u.pathname||"/",v=p;if(l!=="/"){let k=l.replace(/^\//,"").split("/");v="/"+p.replace(/^\//,"").split("/").slice(k.length).join("/")}let x=jx(e,{pathname:v}),y=ck(x&&x.map(k=>Object.assign({},k,{params:Object.assign({},c,k.params),pathname:Qn([l,i.encodeLocation?i.encodeLocation(k.pathname).pathname:k.pathname]),pathnameBase:k.pathnameBase==="/"?l:Qn([l,i.encodeLocation?i.encodeLocation(k.pathnameBase).pathname:k.pathnameBase])})),a,n,r);return t&&y?m.createElement(Gs.Provider,{value:{location:Ma({pathname:"/",search:"",hash:"",state:null,key:"default"},u),navigationType:_n.Pop}},y):y}function ik(){let e=dk(),t=Yx(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return m.createElement(m.Fragment,null,m.createElement("h2",null,"Unexpected Application Error!"),m.createElement("h3",{style:{fontStyle:"italic"}},t),n?m.createElement("pre",{style:i},n):null,null)}const ak=m.createElement(ik,null);class ok extends m.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,n){return n.location!==t.location||n.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:n.error,location:n.location,revalidation:t.revalidation||n.revalidation}}componentDidCatch(t,n){console.error("React Router caught the following error during render",t,n)}render(){return this.state.error!==void 0?m.createElement(ar.Provider,{value:this.props.routeContext},m.createElement(Mf.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function sk(e){let{routeContext:t,match:n,children:r}=e,i=m.useContext(xu);return i&&i.static&&i.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=n.route.id),m.createElement(ar.Provider,{value:t},r)}function ck(e,t,n,r){var i;if(t===void 0&&(t=[]),n===void 0&&(n=null),r===void 0&&(r=null),e==null){var a;if(!n)return null;if(n.errors)e=n.matches;else if((a=r)!=null&&a.v7_partialHydration&&t.length===0&&!n.initialized&&n.matches.length>0)e=n.matches;else return null}let s=e,c=(i=n)==null?void 0:i.errors;if(c!=null){let u=s.findIndex(d=>d.route.id&&(c==null?void 0:c[d.route.id])!==void 0);u>=0||Te(!1),s=s.slice(0,Math.min(s.length,u+1))}let l=!1,h=-1;if(n&&r&&r.v7_partialHydration)for(let u=0;u<s.length;u++){let d=s[u];if((d.route.HydrateFallback||d.route.hydrateFallbackElement)&&(h=u),d.route.id){let{loaderData:p,errors:v}=n,x=d.route.loader&&p[d.route.id]===void 0&&(!v||v[d.route.id]===void 0);if(d.route.lazy||x){l=!0,h>=0?s=s.slice(0,h+1):s=[s[0]];break}}}return s.reduceRight((u,d,p)=>{let v,x=!1,y=null,k=null;n&&(v=c&&d.route.id?c[d.route.id]:void 0,y=d.route.errorElement||ak,l&&(h<0&&p===0?(x=!0,k=null):h===p&&(x=!0,k=d.route.hydrateFallbackElement||null)));let f=t.concat(s.slice(0,p+1)),g=()=>{let b;return v?b=y:x?b=k:d.route.Component?b=m.createElement(d.route.Component,null):d.route.element?b=d.route.element:b=u,m.createElement(sk,{match:d,routeContext:{outlet:u,matches:f,isDataRoute:n!=null},children:b})};return n&&(d.route.ErrorBoundary||d.route.errorElement||p===0)?m.createElement(ok,{location:n.location,revalidation:n.revalidation,component:y,error:v,children:g(),routeContext:{outlet:null,matches:f,isDataRoute:!0}}):g()},null)}var _f=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(_f||{}),bs=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(bs||{});function lk(e){let t=m.useContext(xu);return t||Te(!1),t}function hk(e){let t=m.useContext(Jx);return t||Te(!1),t}function uk(e){let t=m.useContext(ar);return t||Te(!1),t}function Ff(e){let t=uk(),n=t.matches[t.matches.length-1];return n.route.id||Te(!1),n.route.id}function dk(){var e;let t=m.useContext(Mf),n=hk(bs.UseRouteError),r=Ff(bs.UseRouteError);return t!==void 0?t:(e=n.errors)==null?void 0:e[r]}function pk(){let{router:e}=lk(_f.UseNavigateStable),t=Ff(bs.UseNavigateStable),n=m.useRef(!1);return qf(()=>{n.current=!0}),m.useCallback(function(i,a){a===void 0&&(a={}),n.current&&(typeof i=="number"?e.navigate(i):e.navigate(i,Ma({fromRouteId:t},a)))},[e,t])}function gk(e,t){e==null||e.v7_startTransition,e==null||e.v7_relativeSplatPath}function Sn(e){Te(!1)}function mk(e){let{basename:t="/",children:n=null,location:r,navigationType:i=_n.Pop,navigator:a,static:s=!1,future:c}=e;Qa()&&Te(!1);let l=t.replace(/^\/*/,"/"),h=m.useMemo(()=>({basename:l,navigator:a,static:s,future:Ma({v7_relativeSplatPath:!1},c)}),[l,c,a,s]);typeof r=="string"&&(r=Oi(r));let{pathname:u="/",search:d="",hash:p="",state:v=null,key:x="default"}=r,y=m.useMemo(()=>{let k=wu(u,l);return k==null?null:{location:{pathname:k,search:d,hash:p,state:v,key:x},navigationType:i}},[l,u,d,p,v,x,i]);return y==null?null:m.createElement(Dr.Provider,{value:h},m.createElement(Gs.Provider,{children:n,value:y}))}function fk(e){let{children:t,location:n}=e;return nk(th(t),n)}new Promise(()=>{});function th(e,t){t===void 0&&(t=[]);let n=[];return m.Children.forEach(e,(r,i)=>{if(!m.isValidElement(r))return;let a=[...t,i];if(r.type===m.Fragment){n.push.apply(n,th(r.props.children,a));return}r.type!==Sn&&Te(!1),!r.props.index||!r.props.children||Te(!1);let s={id:r.props.id||a.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(s.children=th(r.props.children,a)),n.push(s)}),n}/**
 ...
 *
 * @license MIT
 */function nh(){return nh=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},nh.apply(this,arguments)}function yk(e,t){if(e==null)return{};var n={},r=Object.keys(e),i,a;for(a=0;a<r.length;a++)i=r[a],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}function vk(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function bk(e,t){return e.button===0&&(!t||t==="_self")&&!vk(e)}function rh(e){return e===void 0&&(e=""),new URLSearchParams(typeof e=="string"||Array.isArray(e)||e instanceof URLSearchParams?e:Object.keys(e).reduce((t,n)=>{let r=e[n];return t.concat(Array.isArray(r)?r.map(i=>[n,i]):[[n,r]])},[]))}function wk(e,t){let n=rh(e);return t&&t.forEach((r,i)=>{n.has(i)||t.getAll(i).forEach(a=>{n.append(i,a)})}),n}const xk=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],kk="6";try{window.__reactRouterVersion=kk}catch{}const Tk="startTransition",lp=Ih[Tk];function Ck(e){let{basename:t,children:n,future:r,window:i}=e,a=m.useRef();a.current==null&&(a.current=Ax({window:i,v5Compat:!0}));let s=a.current,[c,l]=m.useState({action:s.action,location:s.location}),{v7_startTransition:h}=r||{},u=m.useCallback(d=>{h&&lp?lp(()=>l(d)):l(d)},[l,h]);return m.useLayoutEffect(()=>s.listen(u),[s,u]),m.useEffect(()=>gk(r),[r]),m.createElement(mk,{basename:t,children:n,location:c.location,navigationType:c.action,navigator:s,future:r})}const Sk=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Pk=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,we=m.forwardRef(function(t,n){let{onClick:r,relative:i,reloadDocument:a,replace:s,state:c,target:l,to:h,preventScrollReset:u,viewTransition:d}=t,p=yk(t,xk),{basename:v}=m.useContext(Dr),x,y=!1;if(typeof h=="string"&&Pk.test(h)&&(x=h,Sk))try{let b=new URL(window.location.href),w=h.startsWith("//")?new URL(b.protocol+h):new URL(h),T=wu(w.pathname,v);w.origin===b.origin&&T!=null?h=T+w.search+w.hash:y=!0}catch{}let k=Zx(h,{relative:i}),f=Ak(h,{replace:s,state:c,target:l,preventScrollReset:u,relative:i,viewTransition:d});function g(b){r&&r(b),b.defaultPrevented||f(b)}return m.createElement("a",nh({},p,{href:x||k,onClick:y||a?r:g,ref:n,target:l}))});var hp;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"})(hp||(hp={}));var up;(function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(up||(up={}));function Ak(e,t){let{target:n,replace:r,state:i,preventScrollReset:a,relative:s,viewTransition:c}=t===void 0?{}:t,l=Of(),h=Ut(),u=Uf(e,{relative:s});return m.useCallback(d=>{if(bk(d,n)){d.preventDefault();let p=r!==void 0?r:vs(h)===vs(u);l(e,{replace:p,state:i,preventScrollReset:a,relative:s,viewTransition:c})}},[h,l,u,r,i,n,e,a,s,c])}function Ik(e){let t=m.useRef(rh(e)),n=m.useRef(!1),r=Ut(),i=m.useMemo(()=>wk(r.search,n.current?null:t.current),[r.search]),a=Of(),s=m.useCallback((c,l)=>{const h=rh(typeof c=="function"?c(i):c);n.current=!0,a("?"+h,l)},[a,i]);return[i,s]}const Nk=3,jk=500;let Fc=0;function Ek(){return Fc=(Fc+1)%Number.MAX_SAFE_INTEGER,Fc.toString()}const Bc=new Map,dp=e=>{if(Bc.has(e))return;const t=setTimeout(()=>{Bc.delete(e),ga({type:"REMOVE_TOAST",toastId:e})},jk);Bc.set(e,t)},Rk=(e,t)=>{switch(t.type){case"ADD_TOAST":return{...e,toasts:[t.toast,...e.toasts].slice(0,Nk)};case"UPDATE_TOAST":return{...e,toasts:e.toasts.map(n=>n.id===t.toast.id?{...n,...t.toast}:n)};case"DISMISS_TOAST":{const{toastId:n}=t;return n?dp(n):e.toasts.forEach(r=>{dp(r.id)}),{...e,toasts:e.toasts.map(r=>r.id===n||n===void 0?{...r,open:!1}:r)}}case"REMOVE_TOAST":return t.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(n=>n.id!==t.toastId)}}},_o=[];let Fo={toasts:[]};function ga(e){Fo=Rk(Fo,e),_o.forEach(t=>{t(Fo)})}function Lk({...e}){const t=Ek(),n=i=>ga({type:"UPDATE_TOAST",toast:{...i,id:t}}),r=()=>ga({type:"DISMISS_TOAST",toastId:t});return ga({type:"ADD_TOAST",toast:{...e,id:t,open:!0,onOpenChange:i=>{i||r()}}}),{id:t,dismiss:r,update:n}}function Ws(){const[e,t]=m.useState(Fo);return m.useEffect(()=>(_o.push(t),()=>{const n=_o.indexOf(t);n>-1&&_o.splice(n,1)}),[e]),{...e,toast:Lk,dismiss:n=>ga({type:"DISMISS_TOAST",toastId:n})}}function pe(e,t,{checkForDefaultPrevented:n=!0}={}){return function(i){if(e==null||e(i),n===!1||!i.defaultPrevented)return t==null?void 0:t(i)}}function pp(e,t){if(typeof e=="function")return e(t);e!=null&&(e.current=t)}function Bf(...e){return t=>{let n=!1;const r=e.map(i=>{const a=pp(i,t);return!n&&typeof a=="function"&&(n=!0),a});if(n)return()=>{for(let i=0;i<r.length;i++){const a=r[i];typeof a=="function"?a():pp(e[i],null)}}}}function it(...e){return m.useCallback(Bf(...e),e)}function Ya(e,t=[]){let n=[];function r(a,s){const c=m.createContext(s),l=n.length;n=[...n,s];const h=d=>{var f;const{scope:p,children:v,...x}=d,y=((f=p==null?void 0:p[e])==null?void 0:f[l])||c,k=m.useMemo(()=>x,Object.values(x));return o.jsx(y.Provider,{value:k,children:v})};h.displayName=a+"Provider";function u(d,p){var y;const v=((y=p==null?void 0:p[e])==null?void 0:y[l])||c,x=m.useContext(v);if(x)return x;if(s!==void 0)return s;throw new Error(`\`${d}\` must be used within \`${a}\``)}return[h,u]}const i=()=>{const a=n.map(s=>m.createContext(s));return function(c){const l=(c==null?void 0:c[e])||a;return m.useMemo(()=>({[`__scope${e}`]:{...c,[e]:l}}),[c,l])}};return i.scopeName=e,[r,Dk(i,...t)]}function Dk(...e){const t=e[0];if(e.length===1)return t;const n=()=>{const r=e.map(i=>({useScope:i(),scopeName:i.scopeName}));return function(a){const s=r.reduce((c,{useScope:l,scopeName:h})=>{const d=l(a)[`__scope${h}`];return{...c,...d}},{});return m.useMemo(()=>({[`__scope${t.scopeName}`]:s}),[s])}};return n.scopeName=t.scopeName,n}function qa(e){const t=qk(e),n=m.forwardRef((r,i)=>{const{children:a,...s}=r,c=m.Children.toArray(a),l=c.find(Uk);if(l){const h=l.props.children,u=c.map(d=>d===l?m.Children.count(h)>1?m.Children.only(null):m.isValidElement(h)?h.props.children:null:d);return o.jsx(t,{...s,ref:i,children:m.isValidElement(h)?m.cloneElement(h,void 0,u):null})}return o.jsx(t,{...s,ref:i,children:a})});return n.displayName=`${e}.Slot`,n}var Mk=qa("Slot");function qk(e){const t=m.forwardRef((n,r)=>{const{children:i,...a}=n;if(m.isValidElement(i)){const s=Fk(i),c=_k(a,i.props);return i.type!==m.Fragment&&(c.ref=r?Bf(r,s):s),m.cloneElement(i,c)}return m.Children.count(i)>1?m.Children.only(null):null});return t.displayName=`${e}.SlotClone`,t}var Vf=Symbol("radix.slottable");function Ok(e){const t=({children:n})=>o.jsx(o.Fragment,{children:n});return t.displayName=`${e}.Slottable`,t.__radixId=Vf,t}function Uk(e){return m.isValidElement(e)&&typeof e.type=="function"&&"__radixId"in e.type&&e.type.__radixId===Vf}function _k(e,t){const n={...t};for(const r in t){const i=e[r],a=t[r];/^on[A-Z]/.test(r)?i&&a?n[r]=(...c)=>{const l=a(...c);return i(...c),l}:i&&(n[r]=i):r==="style"?n[r]={...i,...a}:r==="className"&&(n[r]=[i,a].filter(Boolean).join(" "))}return{...e,...n}}function Fk(e){var r,i;let t=(r=Object.getOwnPropertyDescriptor(e.props,"ref"))==null?void 0:r.get,n=t&&"isReactWarning"in t&&t.isReactWarning;return n?e.ref:(t=(i=Object.getOwnPropertyDescriptor(e,"ref"))==null?void 0:i.get,n=t&&"isReactWarning"in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}function Bk(e){const t=e+"CollectionProvider",[n,r]=Ya(t),[i,a]=n(t,{collectionRef:{current:null},itemMap:new Map}),s=y=>{const{scope:k,children:f}=y,g=sr.useRef(null),b=sr.useRef(new Map).current;return o.jsx(i,{scope:k,itemMap:b,collectionRef:g,children:f})};s.displayName=t;const c=e+"CollectionSlot",l=qa(c),h=sr.forwardRef((y,k)=>{const{scope:f,children:g}=y,b=a(c,f),w=it(k,b.collectionRef);return o.jsx(l,{ref:w,children:g})});h.displayName=c;const u=e+"CollectionItemSlot",d="data-radix-collection-item",p=qa(u),v=sr.forwardRef((y,k)=>{const{scope:f,children:g,...b}=y,w=sr.useRef(null),T=it(k,w),C=a(u,f);return sr.useEffect(()=>(C.itemMap.set(w,{ref:w,...b}),()=>void C.itemMap.delete(w))),o.jsx(p,{[d]:"",ref:T,children:g})});v.displayName=u;function x(y){const k=a(e+"CollectionConsumer",y);return sr.useCallback(()=>{const g=k.collectionRef.current;if(!g)return[];const b=Array.from(g.querySelectorAll(`[${d}]`));return Array.from(k.itemMap.values()).sort((C,P)=>b.indexOf(C.ref.current)-b.indexOf(P.ref.current))},[k.collectionRef,k.itemMap])}return[{Provider:s,Slot:h,ItemSlot:v},x,r]}var Vk=["a","button","div","form","h2","h3","img","input","label","li","nav","ol","p","select","span","svg","ul"],Ue=Vk.reduce((e,t)=>{const n=qa(`Primitive.${t}`),r=m.forwardRef((i,a)=>{const{asChild:s,...c}=i,l=s?n:t;return typeof window<"u"&&(window[Symbol.for("radix-ui")]=!0),o.jsx(l,{...c,ref:a})});return r.displayName=`Primitive.${t}`,{...e,[t]:r}},{});function zf(e,t){e&&Ka.flushSync(()=>e.dispatchEvent(t))}function Jt(e){const t=m.useRef(e);return m.useEffect(()=>{t.current=e}),m.useMemo(()=>(...n)=>{var r;return(r=t.current)==null?void 0:r.call(t,...n)},[])}function zk(e,t=globalThis==null?void 0:globalThis.document){const n=Jt(e);m.useEffect(()=>{const r=i=>{i.key==="Escape"&&n(i)};return t.addEventListener("keydown",r,{capture:!0}),()=>t.removeEventListener("keydown",r,{capture:!0})},[n,t])}var Hk="DismissableLayer",ih="dismissableLayer.update",Gk="dismissableLayer.pointerDownOutside",Wk="dismissableLayer.focusOutside",gp,Hf=m.createContext({layers:new Set,layersWithOutsidePointerEventsDisabled:new Set,branches:new Set}),$s=m.forwardRef((e,t)=>{const{disableOutsidePointerEvents:n=!1,onEscapeKeyDown:r,onPointerDownOutside:i,onFocusOutside:a,onInteractOutside:s,onDismiss:c,...l}=e,h=m.useContext(Hf),[u,d]=m.useState(null),p=(u==null?void 0:u.ownerDocument)??(globalThis==null?void 0:globalThis.document),[,v]=m.useState({}),x=it(t,P=>d(P)),y=Array.from(h.layers),[k]=[...h.layersWithOutsidePointerEventsDisabled].slice(-1),f=y.indexOf(k),g=u?y.indexOf(u):-1,b=h.layersWithOutsidePointerEventsDisabled.size>0,w=g>=f,T=Kk(P=>{const S=P.target,I=[...h.branches].some(j=>j.contains(S));!w||I||(i==null||i(P),s==null||s(P),P.defaultPrevented||c==null||c())},p),C=Qk(P=>{const S=P.target;[...h.branches].some(j=>j.contains(S))||(a==null||a(P),s==null||s(P),P.defaultPrevented||c==null||c())},p);return zk(P=>{g===h.layers.size-1&&(r==null||r(P),!P.defaultPrevented&&c&&(P.preventDefault(),c()))},p),m.useEffect(()=>{if(u)return n&&(h.layersWithOutsidePointerEventsDisabled.size===0&&(gp=p.body.style.pointerEvents,p.body.style.pointerEvents="none"),h.layersWithOutsidePointerEventsDisabled.add(u)),h.layers.add(u),mp(),()=>{n&&h.layersWithOutsidePointerEventsDisabled.size===1&&(p.body.style.pointerEvents=gp)}},[u,p,n,h]),m.useEffect(()=>()=>{u&&(h.layers.delete(u),h.layersWithOutsidePointerEventsDisabled.delete(u),mp())},[u,h]),m.useEffect(()=>{const P=()=>v({});return document.addEventListener(ih,P),()=>document.removeEventListener(ih,P)},[]),o.jsx(Ue.div,{...l,ref:x,style:{pointerEvents:b?w?"auto":"none":void 0,...e.style},onFocusCapture:pe(e.onFocusCapture,C.onFocusCapture),onBlurCapture:pe(e.onBlurCapture,C.onBlurCapture),onPointerDownCapture:pe(e.onPointerDownCapture,T.onPointerDownCapture)})});$s.displayName=Hk;var $k="DismissableLayerBranch",Gf=m.forwardRef((e,t)=>{const n=m.useContext(Hf),r=m.useRef(null),i=it(t,r);return m.useEffect(()=>{const a=r.current;if(a)return n.branches.add(a),()=>{n.branches.delete(a)}},[n.branches]),o.jsx(Ue.div,{...e,ref:i})});Gf.displayName=$k;function Kk(e,t=globalThis==null?void 0:globalThis.document){const n=Jt(e),r=m.useRef(!1),i=m.useRef(()=>{});return m.useEffect(()=>{const a=c=>{if(c.target&&!r.current){let l=function(){Wf(Gk,n,h,{discrete:!0})};const h={originalEvent:c};c.pointerType==="touch"?(t.removeEventListener("click",i.current),i.current=l,t.addEventListener("click",i.current,{once:!0})):l()}else t.removeEventListener("click",i.current);r.current=!1},s=window.setTimeout(()=>{t.addEventListener("pointerdown",a)},0);return()=>{window.clearTimeout(s),t.removeEventListener("pointerdown",a),t.removeEventListener("click",i.current)}},[t,n]),{onPointerDownCapture:()=>r.current=!0}}function Qk(e,t=globalThis==null?void 0:globalThis.document){const n=Jt(e),r=m.useRef(!1);return m.useEffect(()=>{const i=a=>{a.target&&!r.current&&Wf(Wk,n,{originalEvent:a},{discrete:!1})};return t.addEventListener("focusin",i),()=>t.removeEventListener("focusin",i)},[t,n]),{onFocusCapture:()=>r.current=!0,onBlurCapture:()=>r.current=!1}}function mp(){const e=new CustomEvent(ih);document.dispatchEvent(e)}function Wf(e,t,n,{discrete:r}){const i=n.originalEvent.target,a=new CustomEvent(e,{bubbles:!1,cancelable:!0,detail:n});t&&i.addEventListener(e,t,{once:!0}),r?zf(i,a):i.dispatchEvent(a)}var Yk=$s,Xk=Gf,mn=globalThis!=null&&globalThis.document?m.useLayoutEffect:()=>{},Jk="Portal",ku=m.forwardRef((e,t)=>{var c;const{container:n,...r}=e,[i,a]=m.useState(!1);mn(()=>a(!0),[]);const s=n||i&&((c=globalThis==null?void 0:globalThis.document)==null?void 0:c.body);return s?Px.createPortal(o.jsx(Ue.div,{...r,ref:t}),s):null});ku.displayName=Jk;function Zk(e,t){return m.useReducer((n,r)=>t[n][r]??n,e)}var Xa=e=>{const{present:t,children:n}=e,r=e0(t),i=typeof n=="function"?n({present:r.isPresent}):m.Children.only(n),a=it(r.ref,t0(i));return typeof n=="function"||r.isPresent?m.cloneElement(i,{ref:a}):null};Xa.displayName="Presence";function e0(e){const[t,n]=m.useState(),r=m.useRef(null),i=m.useRef(e),a=m.useRef("none"),s=e?"mounted":"unmounted",[c,l]=Zk(s,{mounted:{UNMOUNT:"unmounted",ANIMATION_OUT:"unmountSuspended"},unmountSuspended:{MOUNT:"mounted",ANIMATION_END:"unmounted"},unmounted:{MOUNT:"mounted"}});return m.useEffect(()=>{const h=bo(r.current);a.current=c==="mounted"?h:"none"},[c]),mn(()=>{const h=r.current,u=i.current;if(u!==e){const p=a.current,v=bo(h);e?l("MOUNT"):v==="none"||(h==null?void 0:h.display)==="none"?l("UNMOUNT"):l(u&&p!==v?"ANIMATION_OUT":"UNMOUNT"),i.current=e}},[e,l]),mn(()=>{if(t){let h;const u=t.ownerDocument.defaultView??window,d=v=>{const y=bo(r.current).includes(v.animationName);if(v.target===t&&y&&(l("ANIMATION_END"),!i.current)){const k=t.style.animationFillMode;t.style.animationFillMode="forwards",h=u.setTimeout(()=>{t.style.animationFillMode==="forwards"&&(t.style.animationFillMode=k)})}},p=v=>{v.target===t&&(a.current=bo(r.current))};return t.addEventListener("animationstart",p),t.addEventListener("animationcancel",d),t.addEventListener("animationend",d),()=>{u.clearTimeout(h),t.removeEventListener("animationstart",p),t.removeEventListener("animationcancel",d),t.removeEventListener("animationend",d)}}else l("ANIMATION_END")},[t,l]),{isPresent:["mounted","unmountSuspended"].includes(c),ref:m.useCallback(h=>{r.current=h?getComputedStyle(h):null,n(h)},[])}}function bo(e){return(e==null?void 0:e.animationName)||"none"}function t0(e){var r,i;let t=(r=Object.getOwnPropertyDescriptor(e.props,"ref"))==null?void 0:r.get,n=t&&"isReactWarning"in t&&t.isReactWarning;return n?e.ref:(t=(i=Object.getOwnPropertyDescriptor(e,"ref"))==null?void 0:i.get,n=t&&"isReactWarning"in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}var n0=Ih[" useInsertionEffect ".trim().toString()]||mn;function Tu({prop:e,defaultProp:t,onChange:n=()=>{},caller:r}){const[i,a,s]=r0({defaultProp:t,onChange:n}),c=e!==void 0,l=c?e:i;{const u=m.useRef(e!==void 0);m.useEffect(()=>{const d=u.current;d!==c&&console.warn(`${r} is changing from ${d?"controlled":"uncontrolled"} to ${c?"controlled":"uncontrolled"}. Components should not switch from controlled to uncontrolled (or vice versa). Decide between using a controlled or uncontrolled value for the lifetime of the component.`),u.current=c},[c,r])}const h=m.useCallback(u=>{var d;if(c){const p=i0(u)?u(e):u;p!==e&&((d=s.current)==null||d.call(s,p))}else a(u)},[c,e,a,s]);return[l,h]}function r0({defaultProp:e,onChange:t}){const[n,r]=m.useState(e),i=m.useRef(n),a=m.useRef(t);return n0(()=>{a.current=t},[t]),m.useEffect(()=>{var s;i.current!==n&&((s=a.current)==null||s.call(a,n),i.current=n)},[n,i]),[n,r,a]}function i0(e){return typeof e=="function"}var a0=Object.freeze({position:"absolute",border:0,width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",wordWrap:"normal"}),o0="VisuallyHidden",Ks=m.forwardRef((e,t)=>o.jsx(Ue.span,{...e,ref:t,style:{...a0,...e.style}}));Ks.displayName=o0;var s0=Ks,Cu="ToastProvider",[Su,c0,l0]=Bk("Toast"),[$f,UI]=Ya("Toast",[l0]),[h0,Qs]=$f(Cu),Kf=e=>{const{__scopeToast:t,label:n="Notification",duration:r=5e3,swipeDirection:i="right",swipeThreshold:a=50,children:s}=e,[c,l]=m.useState(null),[h,u]=m.useState(0),d=m.useRef(!1),p=m.useRef(!1);return n.trim()||console.error(`Invalid prop \`label\` supplied to \`${Cu}\`. Expected non-empty \`string\`.`),o.jsx(Su.Provider,{scope:t,children:o.jsx(h0,{scope:t,label:n,duration:r,swipeDirection:i,swipeThreshold:a,toastCount:h,viewport:c,onViewportChange:l,onToastAdd:m.useCallback(()=>u(v=>v+1),[]),onToastRemove:m.useCallback(()=>u(v=>v-1),[]),isFocusedToastEscapeKeyDownRef:d,isClosePausedRef:p,children:s})})};Kf.displayName=Cu;var Qf="ToastViewport",u0=["F8"],ah="toast.viewportPause",oh="toast.viewportResume",Yf=m.forwardRef((e,t)=>{const{__scopeToast:n,hotkey:r=u0,label:i="Notifications ({hotkey})",...a}=e,s=Qs(Qf,n),c=c0(n),l=m.useRef(null),h=m.useRef(null),u=m.useRef(null),d=m.useRef(null),p=it(t,d,s.onViewportChange),v=r.join("+").replace(/Key/g,"").replace(/Digit/g,""),x=s.toastCount>0;m.useEffect(()=>{const k=f=>{var b;r.length!==0&&r.every(w=>f[w]||f.code===w)&&((b=d.current)==null||b.focus())};return document.addEventListener("keydown",k),()=>document.removeEventListener("keydown",k)},[r]),m.useEffect(()=>{const k=l.current,f=d.current;if(x&&k&&f){const g=()=>{if(!s.isClosePausedRef.current){const C=new CustomEvent(ah);f.dispatchEvent(C),s.isClosePausedRef.current=!0}},b=()=>{if(s.isClosePausedRef.current){const C=new CustomEvent(oh);f.dispatchEvent(C),s.isClosePausedRef.current=!1}},w=C=>{!k.contains(C.relatedTarget)&&b()},T=()=>{k.contains(document.activeElement)||b()};return k.addEventListener("focusin",g),k.addEventListener("focusout",w),k.addEventListener("pointermove",g),k.addEventListener("pointerleave",T),window.addEventListener("blur",g),window.addEventListener("focus",b),()=>{k.removeEventListener("focusin",g),k.removeEventListener("focusout",w),k.removeEventListener("pointermove",g),k.removeEventListener("pointerleave",T),window.removeEventListener("blur",g),window.removeEventListener("focus",b)}}},[x,s.isClosePausedRef]);const y=m.useCallback(({tabbingDirection:k})=>{const g=c().map(b=>{const w=b.ref.current,T=[w,...C0(w)];return k==="forwards"?T:T.reverse()});return(k==="forwards"?g.reverse():g).flat()},[c]);return m.useEffect(()=>{const k=d.current;if(k){const f=g=>{var T,C,P;const b=g.altKey||g.ctrlKey||g.metaKey;if(g.key==="Tab"&&!b){const S=document.activeElement,I=g.shiftKey;if(g.target===k&&I){(T=h.current)==null||T.focus();return}const D=y({tabbingDirection:I?"backwards":"forwards"}),J=D.findIndex(O=>O===S);Vc(D.slice(J+1))?g.preventDefault():I?(C=h.current)==null||C.focus():(P=u.current)==null||P.focus()}};return k.addEventListener("keydown",f),()=>k.removeEventListener("keydown",f)}},[c,y]),o.jsxs(Xk,{ref:l,role:"region","aria-label":i.replace("{hotkey}",v),tabIndex:-1,style:{pointerEvents:x?void 0:"none"},children:[x&&o.jsx(sh,{ref:h,onFocusFromOutsideViewport:()=>{const k=y({tabbingDirection:"forwards"});Vc(k)}}),o.jsx(Su.Slot,{scope:n,children:o.jsx(Ue.ol,{tabIndex:-1,...a,ref:p})}),x&&o.jsx(sh,{ref:u,onFocusFromOutsideViewport:()=>{const k=y({tabbingDirection:"backwards"});Vc(k)}})]})});Yf.displayName=Qf;var Xf="ToastFocusProxy",sh=m.forwardRef((e,t)=>{const{__scopeToast:n,onFocusFromOutsideViewport:r,...i}=e,a=Qs(Xf,n);return o.jsx(Ks,{"aria-hidden":!0,tabIndex:0,...i,ref:t,style:{position:"fixed"},onFocus:s=>{var h;const c=s.relatedTarget;!((h=a.viewport)!=null&&h.contains(c))&&r()}})});sh.displayName=Xf;var Ja="Toast",d0="toast.swipeStart",p0="toast.swipeMove",g0="toast.swipeCancel",m0="toast.swipeEnd",Jf=m.forwardRef((e,t)=>{const{forceMount:n,open:r,defaultOpen:i,onOpenChange:a,...s}=e,[c,l]=Tu({prop:r,defaultProp:i??!0,onChange:a,caller:Ja});return o.jsx(Xa,{present:n||c,children:o.jsx(v0,{open:c,...s,ref:t,onClose:()=>l(!1),onPause:Jt(e.onPause),onResume:Jt(e.onResume),onSwipeStart:pe(e.onSwipeStart,h=>{h.currentTarget.setAttribute("data-swipe","start")}),onSwipeMove:pe(e.onSwipeMove,h=>{const{x:u,y:d}=h.detail.delta;h.currentTarget.setAttribute("data-swipe","move"),h.currentTarget.style.setProperty("--radix-toast-swipe-move-x",`${u}px`),h.currentTarget.style.setProperty("--radix-toast-swipe-move-y",`${d}px`)}),onSwipeCancel:pe(e.onSwipeCancel,h=>{h.currentTarget.setAttribute("data-swipe","cancel"),h.currentTarget.style.removeProperty("--radix-toast-swipe-move-x"),h.currentTarget.style.removeProperty("--radix-toast-swipe-move-y"),h.currentTarget.style.removeProperty("--radix-toast-swipe-end-x"),h.currentTarget.style.removeProperty("--radix-toast-swipe-end-y")}),onSwipeEnd:pe(e.onSwipeEnd,h=>{const{x:u,y:d}=h.detail.delta;h.currentTarget.setAttribute("data-swipe","end"),h.currentTarget.style.removeProperty("--radix-toast-swipe-move-x"),h.currentTarget.style.removeProperty("--radix-toast-swipe-move-y"),h.currentTarget.style.setProperty("--radix-toast-swipe-end-x",`${u}px`),h.currentTarget.style.setProperty("--radix-toast-swipe-end-y",`${d}px`),l(!1)})})})});Jf.displayName=Ja;var[f0,y0]=$f(Ja,{onClose(){}}),v0=m.forwardRef((e,t)=>{const{__scopeToast:n,type:r="foreground",duration:i,open:a,onClose:s,onEscapeKeyDown:c,onPause:l,onResume:h,onSwipeStart:u,onSwipeMove:d,onSwipeCancel:p,onSwipeEnd:v,...x}=e,y=Qs(Ja,n),[k,f]=m.useState(null),g=it(t,O=>f(O)),b=m.useRef(null),w=m.useRef(null),T=i||y.duration,C=m.useRef(0),P=m.useRef(T),S=m.useRef(0),{onToastAdd:I,onToastRemove:j}=y,q=Jt(()=>{var Q;(k==null?void 0:k.contains(document.activeElement))&&((Q=y.viewport)==null||Q.focus()),s()}),D=m.useCallback(O=>{!O||O===1/0||(window.clearTimeout(S.current),C.current=new Date().getTime(),S.current=window.setTimeout(q,O))},[q]);m.useEffect(()=>{const O=y.viewport;if(O){const Q=()=>{D(P.current),h==null||h()},G=()=>{const W=new Date().getTime()-C.current;P.current=P.current-W,window.clearTimeout(S.current),l==null||l()};return O.addEventListener(ah,G),O.addEventListener(oh,Q),()=>{O.removeEventListener(ah,G),O.removeEventListener(oh,Q)}}},[y.viewport,T,l,h,D]),m.useEffect(()=>{a&&!y.isClosePausedRef.current&&D(T)},[a,T,y.isClosePausedRef,D]),m.useEffect(()=>(I(),()=>j()),[I,j]);const J=m.useMemo(()=>k?ay(k):null,[k]);return y.viewport?o.jsxs(o.Fragment,{children:[J&&o.jsx(b0,{__scopeToast:n,role:"status","aria-live":r==="foreground"?"assertive":"polite","aria-atomic":!0,children:J}),o.jsx(f0,{scope:n,onClose:q,children:Ka.createPortal(o.jsx(Su.ItemSlot,{scope:n,children:o.jsx(Yk,{asChild:!0,onEscapeKeyDown:pe(c,()=>{y.isFocusedToastEscapeKeyDownRef.current||q(),y.isFocusedToastEscapeKeyDownRef.current=!1}),children:o.jsx(Ue.li,{role:"status","aria-live":"off","aria-atomic":!0,tabIndex:0,"data-state":a?"open":"closed","data-swipe-direction":y.swipeDirection,...x,ref:g,style:{userSelect:"none",touchAction:"none",...e.style},onKeyDown:pe(e.onKeyDown,O=>{O.key==="Escape"&&(c==null||c(O.nativeEvent),O.nativeEvent.defaultPrevented||(y.isFocusedToastEscapeKeyDownRef.current=!0,q()))}),onPointerDown:pe(e.onPointerDown,O=>{O.button===0&&(b.current={x:O.clientX,y:O.clientY})}),onPointerMove:pe(e.onPointerMove,O=>{if(!b.current)return;const Q=O.clientX-b.current.x,G=O.clientY-b.current.y,W=!!w.current,A=["left","right"].includes(y.swipeDirection),M=["left","up"].includes(y.swipeDirection)?Math.min:Math.max,F=A?M(0,Q):0,V=A?0:M(0,G),z=O.pointerType==="touch"?10:2,Ge={x:F,y:V},ge={originalEvent:O,delta:Ge};W?(w.current=Ge,wo(p0,d,ge,{discrete:!1})):fp(Ge,y.swipeDirection,z)?(w.current=Ge,wo(d0,u,ge,{discrete:!1}),O.target.setPointerCapture(O.pointerId)):(Math.abs(Q)>z||Math.abs(G)>z)&&(b.current=null)}),onPointerUp:pe(e.onPointerUp,O=>{const Q=w.current,G=O.target;if(G.hasPointerCapture(O.pointerId)&&G.releasePointerCapture(O.pointerId),w.current=null,b.current=null,Q){const W=O.currentTarget,A={originalEvent:O,delta:Q};fp(Q,y.swipeDirection,y.swipeThreshold)?wo(m0,v,A,{discrete:!0}):wo(g0,p,A,{discrete:!0}),W.addEventListener("click",M=>M.preventDefault(),{once:!0})}})})})}),y.viewport)})]}):null}),b0=e=>{const{__scopeToast:t,children:n,...r}=e,i=Qs(Ja,t),[a,s]=m.useState(!1),[c,l]=m.useState(!1);return k0(()=>s(!0)),m.useEffect(()=>{const h=window.setTimeout(()=>l(!0),1e3);return()=>window.clearTimeout(h)},[]),c?null:o.jsx(ku,{asChild:!0,children:o.jsx(Ks,{...r,children:a&&o.jsxs(o.Fragment,{children:[i.label," ",n]})})})},w0="ToastTitle",Zf=m.forwardRef((e,t)=>{const{__scopeToast:n,...r}=e;return o.jsx(Ue.div,{...r,ref:t})});Zf.displayName=w0;var x0="ToastDescription",ey=m.forwardRef((e,t)=>{const{__scopeToast:n,...r}=e;return o.jsx(Ue.div,{...r,ref:t})});ey.displayName=x0;var ty="ToastAction",ny=m.forwardRef((e,t)=>{const{altText:n,...r}=e;return n.trim()?o.jsx(iy,{altText:n,asChild:!0,children:o.jsx(Pu,{...r,ref:t})}):(console.error(`Invalid prop \`altText\` supplied to \`${ty}\`. Expected non-empty \`string\`.`),null)});ny.displayName=ty;var ry="ToastClose",Pu=m.forwardRef((e,t)=>{const{__scopeToast:n,...r}=e,i=y0(ry,n);return o.jsx(iy,{asChild:!0,children:o.jsx(Ue.button,{type:"button",...r,ref:t,onClick:pe(e.onClick,i.onClose)})})});Pu.displayName=ry;var iy=m.forwardRef((e,t)=>{const{__scopeToast:n,altText:r,...i}=e;return o.jsx(Ue.div,{"data-radix-toast-announce-exclude":"","data-radix-toast-announce-alt":r||void 0,...i,ref:t})});function ay(e){const t=[];return Array.from(e.childNodes).forEach(r=>{if(r.nodeType===r.TEXT_NODE&&r.textContent&&t.push(r.textContent),T0(r)){const i=r.ariaHidden||r.hidden||r.style.display==="none",a=r.dataset.radixToastAnnounceExclude==="";if(!i)if(a){const s=r.dataset.radixToastAnnounceAlt;s&&t.push(s)}else t.push(...ay(r))}}),t}function wo(e,t,n,{discrete:r}){const i=n.originalEvent.currentTarget,a=new CustomEvent(e,{bubbles:!0,cancelable:!0,detail:n});t&&i.addEventListener(e,t,{once:!0}),r?zf(i,a):i.dispatchEvent(a)}var fp=(e,t,n=0)=>{const r=Math.abs(e.x),i=Math.abs(e.y),a=r>i;return t==="left"||t==="right"?a&&r>n:!a&&i>n};function k0(e=()=>{}){const t=Jt(e);mn(()=>{let n=0,r=0;return n=window.requestAnimationFrame(()=>r=window.requestAnimationFrame(t)),()=>{window.cancelAnimationFrame(n),window.cancelAnimationFrame(r)}},[t])}function T0(e){return e.nodeType===e.ELEMENT_NODE}function C0(e){const t=[],n=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT,{acceptNode:r=>{const i=r.tagName==="INPUT"&&r.type==="hidden";return r.disabled||r.hidden||i?NodeFilter.FILTER_SKIP:r.tabIndex>=0?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}});for(;n.nextNode();)t.push(n.currentNode);return t}function Vc(e){const t=document.activeElement;return e.some(n=>n===t?!0:(n.focus(),document.activeElement!==t))}var S0=Kf,oy=Yf,sy=Jf,cy=Zf,ly=ey,hy=ny,uy=Pu;function dy(e){var t,n,r="";if(typeof e=="string"||typeof e=="number")r+=e;else if(typeof e=="object")if(Array.isArray(e)){var i=e.length;for(t=0;t<i;t++)e[t]&&(n=dy(e[t]))&&(r&&(r+=" "),r+=n)}else for(n in e)e[n]&&(r&&(r+=" "),r+=n);return r}function py(){for(var e,t,n=0,r="",i=arguments.length;n<i;n++)(e=arguments[n])&&(t=dy(e))&&(r&&(r+=" "),r+=t);return r}const yp=e=>typeof e=="boolean"?`${e}`:e===0?"0":e,vp=py,Au=(e,t)=>n=>{var r;if((t==null?void 0:t.variants)==null)return vp(e,n==null?void 0:n.class,n==null?void 0:n.className);const{variants:i,defaultVariants:a}=t,s=Object.keys(i).map(h=>{const u=n==null?void 0:n[h],d=a==null?void 0:a[h];if(u===null)return null;const p=yp(u)||yp(d);return i[h][p]}),c=n&&Object.entries(n).reduce((h,u)=>{let[d,p]=u;return p===void 0||(h[d]=p),h},{}),l=t==null||(r=t.compoundVariants)===null||r===void 0?void 0:r.reduce((h,u)=>{let{class:d,className:p,...v}=u;return Object.entries(v).every(x=>{let[y,k]=x;return Array.isArray(k)?k.includes({...a,...c}[y]):{...a,...c}[y]===k})?[...h,d,p]:h},[]);return vp(e,s,l,n==null?void 0:n.class,n==null?void 0:n.className)};/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const I0=m.forwardRef(({color:e="currentColor",size:t=24,strokeWidth:n=2,absoluteStrokeWidth:r,className:i="",children:a,iconNode:s,...c},l)=>m.createElement("svg",{ref:l,...A0,width:t,height:t,stroke:e,strokeWidth:r?Number(n)*24/Number(t):n,className:gy("lucide",i),...c},[...s.map(([h,u])=>m.createElement(h,u)),...Array.isArray(a)?a:[a]]));/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const B=(e,t)=>{const n=m.forwardRef(({className:r,...i},a)=>m.createElement(I0,{ref:a,iconNode:t,className:gy(`lucide-${P0(e)}`,r),...i}));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lh=B("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const N0=B("ArrowUp",[["path",{d:"m5 12 7-7 7 7",key:"hav0vg"}],["path",{d:"M12 19V5",key:"x0mq9r"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bp=B("BookOpenCheck",[["path",{d:"M12 21V7",key:"gj6g52"}],["path",{d:"m16 12 2 2 4-4",key:"mdajum"}],["path",{d:"M22 6V4a1 1 0 0 0-1-1h-5a4 4 0 0 0-4 4 4 4 0 0 0-4-4H3a1 1 0 0 0-1 1v13a1 1 0 0 0 1 1h6a3 3 0 0 1 3 3 3 3 0 0 1 3-3h6a1 1 0 0 0 1-1v-1.3",key:"8arnkb"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bo=B("Check",[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const hh=B("CircleCheck",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const uh=B("Download",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"7 10 12 15 17 10",key:"2ggqvy"}],["line",{x1:"12",x2:"12",y1:"15",y2:"3",key:"1vk2je"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const dh=B("ExternalLink",[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xs=B("Eye",[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zc=B("Folder",[["path",{d:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z",key:"1kt360"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Hc=B("Search",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["path",{d:"m21 21-4.3-4.3",key:"1qie3q"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ys=B("Sparkles",[["path",{d:"M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z",key:"4pj2yx"}],["path",{d:"M20 3v4",key:"1olli1"}],["path",{d:"M22 5h-4",key:"1gvqau"}],["path",{d:"M4 17v2",key:"vumght"}],["path",{d:"M5 18H3",key:"zchphs"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ph=B("Tag",[["path",{d:"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z",key:"vktsd0"}],["circle",{cx:"7.5",cy:"7.5",r:".5",fill:"currentColor",key:"kqv944"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ks=B("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),Iu="-",p1=e=>{const t=m1(e),{conflictingClassGroups:n,conflictingClassGroupModifiers:r}=e;return{getClassGroupId:s=>{const c=s.split(Iu);return c[0]===""&&c.length!==1&&c.shift(),by(c,t)||g1(s)},getConflictingClassGroupIds:(s,c)=>{const l=n[s]||[];return c&&r[s]?[...l,...r[s]]:l}}},by=(e,t)=>{var s;if(e.length===0)return t.classGroupId;const n=e[0],r=t.nextPart.get(n),i=r?by(e.slice(1),r):void 0;if(i)return i;if(t.validators.length===0)return;const a=e.join(Iu);return(s=t.validators.find(({validator:c})=>c(a)))==null?void 0:s.classGroupId},Tp=/^\[(.+)\]$/,g1=e=>{if(Tp.test(e)){const t=Tp.exec(e)[1],n=t==null?void 0:t.substring(0,t.indexOf(":"));if(n)return"arbitrary.."+n}},m1=e=>{const{theme:t,prefix:n}=e,r={nextPart:new Map,validators:[]};return y1(Object.entries(e.classGroups),n).forEach(([a,s])=>{gh(s,r,a,t)}),r},gh=(e,t,n,r)=>{e.forEach(i=>{if(typeof i=="string"){const a=i===""?t:Cp(t,i);a.classGroupId=n;return}if(typeof i=="function"){if(f1(i)){gh(i(r),t,n,r);return}t.validators.push({validator:i,classGroupId:n});return}Object.entries(i).forEach(([a,s])=>{gh(s,Cp(t,a),n,r)})})},Cp=(e,t)=>{let n=e;return t.split(Iu).forEach(r=>{n.nextPart.has(r)||n.nextPart.set(r,{nextPart:new Map,validators:[]}),n=n.nextPart.get(r)}),n},f1=e=>e.isThemeGetter,y1=(e,t)=>t?e.map(([n,r])=>{const i=r.map(a=>typeof a=="string"?t+a:typeof a=="object"?Object.fromEntries(Object.entries(a).map(([s,c])=>[t+s,c])):a);return[n,i]}):e,v1=e=>{if(e<1)return{get:()=>{},set:()=>{}};let t=0,n=new Map,r=new Map;const i=(a,s)=>{n.set(a,s),t++,t>e&&(t=0,r=n,n=new Map)};return{get(a){let s=n.get(a);if(s!==void 0)return s;if((s=r.get(a))!==void 0)return i(a,s),s},set(a,s){n.has(a)?n.set(a,s):i(a,s)}}},wy="!",b1=e=>{const{separator:t,experimentalParseClassName:n}=e,r=t.length===1,i=t[0],a=t.length,s=c=>{const l=[];let h=0,u=0,d;for(let k=0;k<c.length;k++){let f=c[k];if(h===0){if(f===i&&(r||c.slice(k,k+a)===t)){l.push(c.slice(u,k)),u=k+a;continue}if(f==="/"){d=k;continue}}f==="["?h++:f==="]"&&h--}const p=l.length===0?c:c.substring(u),v=p.startsWith(wy),x=v?p.substring(1):p,y=d&&d>u?d-u:void 0;return{modifiers:l,hasImportantModifier:v,baseClassName:x,maybePostfixModifierPosition:y}};return n?c=>n({className:c,parseClassName:s}):s},w1=e=>{if(e.length<=1)return e;const t=[];let n=[];return e.forEach(r=>{r[0]==="["?(t.push(...n.sort(),r),n=[]):n.push(r)}),t.push(...n.sort()),t},x1=e=>({cache:v1(e.cacheSize),parseClassName:b1(e),...p1(e)}),k1=/\s+/,T1=(e,t)=>{const{parseClassName:n,getClassGroupId:r,getConflictingClassGroupIds:i}=t,a=[],s=e.trim().split(k1);let c="";for(let l=s.length-1;l>=0;l-=1){const h=s[l],{modifiers:u,hasImportantModifier:d,baseClassName:p,maybePostfixModifierPosition:v}=n(h);let x=!!v,y=r(x?p.substring(0,v):p);if(!y){if(!x){c=h+(c.length>0?" "+c:c);continue}if(y=r(p),!y){c=h+(c.length>0?" "+c:c);continue}x=!1}const k=w1(u).join(":"),f=d?k+wy:k,g=f+y;if(a.includes(g))continue;a.push(g);const b=i(y,x);for(let w=0;w<b.length;++w){const T=b[w];a.push(f+T)}c=h+(c.length>0?" "+c:c)}return c};function C1(){let e=0,t,n,r="";for(;e<arguments.length;)(t=arguments[e++])&&(n=xy(t))&&(r&&(r+=" "),r+=n);return r}const xy=e=>{if(typeof e=="string")return e;let t,n="";for(let r=0;r<e.length;r++)e[r]&&(t=xy(e[r]))&&(n&&(n+=" "),n+=t);return n};function S1(e,...t){let n,r,i,a=s;function s(l){const h=t.reduce((u,d)=>d(u),e());return n=x1(h),r=n.cache.get,i=n.cache.set,a=c,c(l)}function c(l){const h=r(l);if(h)return h;const u=T1(l,n);return i(l,u),u}return function(){return a(C1.apply(null,arguments))}}const ce=e=>{const t=n=>n[e]||[];return t.isThemeGetter=!0,t},ky=/^\[(?:([a-z-]+):)?(.+)\]$/i,P1=/^\d+\/\d+$/,A1=new Set(["px","full","screen"]),I1=/^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/,N1=/\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/,j1=/^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/,E1=/^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/,R1=/^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/,tn=e=>li(e)||A1.has(e)||P1.test(e),Tn=e=>Ui(e,"length",F1),li=e=>!!e&&!Number.isNaN(Number(e)),Gc=e=>Ui(e,"number",li),Xi=e=>!!e&&Number.isInteger(Number(e)),L1=e=>e.endsWith("%")&&li(e.slice(0,-1)),X=e=>ky.test(e),Cn=e=>I1.test(e),D1=new Set(["length","size","percentage"]),M1=e=>Ui(e,D1,Ty),q1=e=>Ui(e,"position",Ty),O1=new Set(["image","url"]),U1=e=>Ui(e,O1,V1),_1=e=>Ui(e,"",B1),Ji=()=>!0,Ui=(e,t,n)=>{const r=ky.exec(e);return r?r[1]?typeof t=="string"?r[1]===t:t.has(r[1]):n(r[2]):!1},F1=e=>N1.test(e)&&!j1.test(e),Ty=()=>!1,B1=e=>E1.test(e),V1=e=>R1.test(e),z1=()=>{const e=ce("colors"),t=ce("spacing"),n=ce("blur"),r=ce("brightness"),i=ce("borderColor"),a=ce("borderRadius"),s=ce("borderSpacing"),c=ce("borderWidth"),l=ce("contrast"),h=ce("grayscale"),u=ce("hueRotate"),d=ce("invert"),p=ce("gap"),v=ce("gradientColorStops"),x=ce("gradientColorStopPositions"),y=ce("inset"),k=ce("margin"),f=ce("opacity"),g=ce("padding"),b=ce("saturate"),w=ce("scale"),T=ce("sepia"),C=ce("skew"),P=ce("space"),S=ce("translate"),I=()=>["auto","contain","none"],j=()=>["auto","hidden","clip","visible","scroll"],q=()=>["auto",X,t],D=()=>[X,t],J=()=>["",tn,Tn],O=()=>["auto",li,X],Q=()=>["bottom","center","left","left-bottom","left-top","right","right-bottom","right-top","top"],G=()=>["solid","dashed","dotted","double","none"],W=()=>["normal","multiply","screen","overlay","darken","lighten","color-dodge","color-burn","hard-light","soft-light","difference","exclusion","hue","saturation","color","luminosity"],A=()=>["start","end","center","between","around","evenly","stretch"],M=()=>["","0",X],F=()=>["auto","avoid","all","avoid-page","page","left","right","column"],V=()=>[li,X];return{cacheSize:500,separator:":",theme:{colors:[Ji],spacing:[tn,Tn],blur:["none","",Cn,X],brightness:V(),borderColor:[e],borderRadius:["none","","full",Cn,X],borderSpacing:D(),borderWidth:J(),contrast:V(),grayscale:M(),hueRotate:V(),invert:M(),gap:D(),gradientColorStops:[e],gradientColorStopPositions:[L1,Tn],inset:q(),margin:q(),opacity:V(),padding:D(),saturate:V(),scale:V(),sepia:M(),skew:V(),space:D(),translate:D()},classGroups:{aspect:[{aspect:["auto","square","video",X]}],container:["container"],columns:[{columns:[Cn]}],"break-after":[{"break-after":F()}],"break-before":[{"break-before":F()}],"break-inside":[{"break-inside":["auto","avoid","avoid-page","avoid-column"]}],"box-decoration":[{"box-decoration":["slice","clone"]}],box:[{box:["border","content"]}],display:["block","inline-block","inline","flex","inline-flex","table","inline-table","table-caption","table-cell","table-column","table-column-group","table-footer-group","table-header-group","table-row-group","table-row","flow-root","grid","inline-grid","contents","list-item","hidden"],float:[{float:["right","left","none","start","end"]}],clear:[{clear:["left","right","both","none","start","end"]}],isolation:["isolate","isolation-auto"],"object-fit":[{object:["contain","cover","fill","none","scale-down"]}],"object-position":[{object:[...Q(),X]}],overflow:[{overflow:j()}],"overflow-x":[{"overflow-x":j()}],"overflow-y":[{"overflow-y":j()}],overscroll:[{overscroll:I()}],"overscroll-x":[{"overscroll-x":I()}],"overscroll-y":[{"overscroll-y":I()}],position:["static","fixed","absolute","relative","sticky"],inset:[{inset:[y]}],"inset-x":[{"inset-x":[y]}],"inset-y":[{"inset-y":[y]}],start:[{start:[y]}],end:[{end:[y]}],top:[{top:[y]}],right:[{right:[y]}],bottom:[{bottom:[y]}],left:[{left:[y]}],visibility:["visible","invisible","collapse"],z:[{z:["auto",Xi,X]}],basis:[{basis:q()}],"flex-direction":[{flex:["row","row-reverse","col","col-reverse"]}],"flex-wrap":[{flex:["wrap","wrap-reverse","nowrap"]}],flex:[{flex:["1","auto","initial","none",X]}],grow:[{grow:M()}],shrink:[{shrink:M()}],order:[{order:["first","last","none",Xi,X]}],"grid-cols":[{"grid-cols":[Ji]}],"col-start-end":[{col:["auto",{span:["full",Xi,X]},X]}],"col-start":[{"col-start":O()}],"col-end":[{"col-end":O()}],"grid-rows":[{"grid-rows":[Ji]}],"row-start-end":[{row:["auto",{span:[Xi,X]},X]}],"row-start":[{"row-start":O()}],"row-end":[{"row-end":O()}],"grid-flow":[{"grid-flow":["row","col","dense","row-dense","col-dense"]}],"auto-cols":[{"auto-cols":["auto","min","max","fr",X]}],"auto-rows":[{"auto-rows":["auto","min","max","fr",X]}],gap:[{gap:[p]}],"gap-x":[{"gap-x":[p]}],"gap-y":[{"gap-y":[p]}],"justify-content":[{justify:["normal",...A()]}],"justify-items":[{"justify-items":["start","end","center","stretch"]}],"justify-self":[{"justify-self":["auto","start","end","center","stretch"]}],"align-content":[{content:["normal",...A(),"baseline"]}],"align-items":[{items:["start","end","center","baseline","stretch"]}],"align-self":[{self:["auto","start","end","center","stretch","baseline"]}],"place-content":[{"place-content":[...A(),"baseline"]}],"place-items":[{"place-items":["start","end","center","baseline","stretch"]}],"place-self":[{"place-self":["auto","start","end","center","stretch"]}],p:[{p:[g]}],px:[{px:[g]}],py:[{py:[g]}],ps:[{ps:[g]}],pe:[{pe:[g]}],pt:[{pt:[g]}],pr:[{pr:[g]}],pb:[{pb:[g]}],pl:[{pl:[g]}],m:[{m:[k]}],mx:[{mx:[k]}],my:[{my:[k]}],ms:[{ms:[k]}],me:[{me:[k]}],mt:[{mt:[k]}],mr:[{mr:[k]}],mb:[{mb:[k]}],ml:[{ml:[k]}],"space-x":[{"space-x":[P]}],"space-x-reverse":["space-x-reverse"],"space-y":[{"space-y":[P]}],"space-y-reverse":["space-y-reverse"],w:[{w:["auto","min","max","fit","svw","lvw","dvw",X,t]}],"min-w":[{"min-w":[X,t,"min","max","fit"]}],"max-w":[{"max-w":[X,t,"none","full","min","max","fit","prose",{screen:[Cn]},Cn]}],h:[{h:[X,t,"auto","min","max","fit","svh","lvh","dvh"]}],"min-h":[{"min-h":[X,t,"min","max","fit","svh","lvh","dvh"]}],"max-h":[{"max-h":[X,t,"min","max","fit","svh","lvh","dvh"]}],size:[{size:[X,t,"auto","min","max","fit"]}],"font-size":[{text:["base",Cn,Tn]}],"font-smoothing":["antialiased","subpixel-antialiased"],"font-style":["italic","not-italic"],"font-weight":[{font:["thin","extralight","light","normal","medium","semibold","bold","extrabold","black",Gc]}],"font-family":[{font:[Ji]}],"fvn-normal":["normal-nums"],"fvn-ordinal":["ordinal"],"fvn-slashed-zero":["slashed-zero"],"fvn-figure":["lining-nums","oldstyle-nums"],"fvn-spacing":["proportional-nums","tabular-nums"],"fvn-fraction":["diagonal-fractions","stacked-fractions"],tracking:[{tracking:["tighter","tight","normal","wide","wider","widest",X]}],"line-clamp":[{"line-clamp":["none",li,Gc]}],leading:[{leading:["none","tight","snug","normal","relaxed","loose",tn,X]}],"list-image":[{"list-image":["none",X]}],"list-style-type":[{list:["none","disc","decimal",X]}],"list-style-position":[{list:["inside","outside"]}],"placeholder-color":[{placeholder:[e]}],"placeholder-opacity":[{"placeholder-opacity":[f]}],"text-alignment":[{text:["left","center","right","justify","start","end"]}],"text-color":[{text:[e]}],"text-opacity":[{"text-opacity":[f]}],"text-decoration":["underline","overline","line-through","no-underline"],"text-decoration-style":[{decoration:[...G(),"wavy"]}],"text-decoration-thickness":[{decoration:["auto","from-font",tn,Tn]}],"underline-offset":[{"underline-offset":["auto",tn,X]}],"text-decoration-color":[{decoration:[e]}],"text-transform":["uppercase","lowercase","capitalize","normal-case"],"text-overflow":["truncate","text-ellipsis","text-clip"],"text-wrap":[{text:["wrap","nowrap","balance","pretty"]}],indent:[{indent:D()}],"vertical-align":[{align:["baseline","top","middle","bottom","text-top","text-bottom","sub","super",X]}],whitespace:[{whitespace:["normal","nowrap","pre","pre-line","pre-wrap","break-spaces"]}],break:[{break:["normal","words","all","keep"]}],hyphens:[{hyphens:["none","manual","auto"]}],content:[{content:["none",X]}],"bg-attachment":[{bg:["fixed","local","scroll"]}],"bg-clip":[{"bg-clip":["border","padding","content","text"]}],"bg-opacity":[{"bg-opacity":[f]}],"bg-origin":[{"bg-origin":["border","padding","content"]}],"bg-position":[{bg:[...Q(),q1]}],"bg-repeat":[{bg:["no-repeat",{repeat:["","x","y","round","space"]}]}],"bg-size":[{bg:["auto","cover","contain",M1]}],"bg-image":[{bg:["none",{"gradient-to":["t","tr","r","br","b","bl","l","tl"]},U1]}],"bg-color":[{bg:[e]}],"gradient-from-pos":[{from:[x]}],"gradient-via-pos":[{via:[x]}],"gradient-to-pos":[{to:[x]}],"gradient-from":[{from:[v]}],"gradient-via":[{via:[v]}],"gradient-to":[{to:[v]}],rounded:[{rounded:[a]}],"rounded-s":[{"rounded-s":[a]}],"rounded-e":[{"rounded-e":[a]}],"rounded-t":[{"rounded-t":[a]}],"rounded-r":[{"rounded-r":[a]}],"rounded-b":[{"rounded-b":[a]}],"rounded-l":[{"rounded-l":[a]}],"rounded-ss":[{"rounded-ss":[a]}],"rounded-se":[{"rounded-se":[a]}],"rounded-ee":[{"rounded-ee":[a]}],"rounded-es":[{"rounded-es":[a]}],"rounded-tl":[{"rounded-tl":[a]}],"rounded-tr":[{"rounded-tr":[a]}],"rounded-br":[{"rounded-br":[a]}],"rounded-bl":[{"rounded-bl":[a]}],"border-w":[{border:[c]}],"border-w-x":[{"border-x":[c]}],"border-w-y":[{"border-y":[c]}],"border-w-s":[{"border-s":[c]}],"border-w-e":[{"border-e":[c]}],"border-w-t":[{"border-t":[c]}],"border-w-r":[{"border-r":[c]}],"border-w-b":[{"border-b":[c]}],"border-w-l":[{"border-l":[c]}],"border-opacity":[{"border-opacity":[f]}],"border-style":[{border:[...G(),"hidden"]}],"divide-x":[{"divide-x":[c]}],"divide-x-reverse":["divide-x-reverse"],"divide-y":[{"divide-y":[c]}],"divide-y-reverse":["divide-y-reverse"],"divide-opacity":[{"divide-opacity":[f]}],"divide-style":[{divide:G()}],"border-color":[{border:[i]}],"border-color-x":[{"border-x":[i]}],"border-color-y":[{"border-y":[i]}],"border-color-s":[{"border-s":[i]}],"border-color-e":[{"border-e":[i]}],"border-color-t":[{"border-t":[i]}],"border-color-r":[{"border-r":[i]}],"border-color-b":[{"border-b":[i]}],"border-color-l":[{"border-l":[i]}],"divide-color":[{divide:[i]}],"outline-style":[{outline:["",...G()]}],"outline-offset":[{"outline-offset":[tn,X]}],"outline-w":[{outline:[tn,Tn]}],"outline-color":[{outline:[e]}],"ring-w":[{ring:J()}],"ring-w-inset":["ring-inset"],"ring-color":[{ring:[e]}],"ring-opacity":[{"ring-opacity":[f]}],"ring-offset-w":[{"ring-offset":[tn,Tn]}],"ring-offset-color":[{"ring-offset":[e]}],shadow:[{shadow:["","inner","none",Cn,_1]}],"shadow-color":[{shadow:[Ji]}],opacity:[{opacity:[f]}],"mix-blend":[{"mix-blend":[...W(),"plus-lighter","plus-darker"]}],"bg-blend":[{"bg-blend":W()}],filter:[{filter:["","none"]}],blur:[{blur:[n]}],brightness:[{brightness:[r]}],contrast:[{contrast:[l]}],"drop-shadow":[{"drop-shadow":["","none",Cn,X]}],grayscale:[{grayscale:[h]}],"hue-rotate":[{"hue-rotate":[u]}],invert:[{invert:[d]}],saturate:[{saturate:[b]}],sepia:[{sepia:[T]}],"backdrop-filter":[{"backdrop-filter":["","none"]}],"backdrop-blur":[{"backdrop-blur":[n]}],"backdrop-brightness":[{"backdrop-brightness":[r]}],"backdrop-contrast":[{"backdrop-contrast":[l]}],"backdrop-grayscale":[{"backdrop-grayscale":[h]}],"backdrop-hue-rotate":[{"backdrop-hue-rotate":[u]}],"backdrop-invert":[{"backdrop-invert":[d]}],"backdrop-opacity":[{"backdrop-opacity":[f]}],"backdrop-saturate":[{"backdrop-saturate":[b]}],"backdrop-sepia":[{"backdrop-sepia":[T]}],"border-collapse":[{border:["collapse","separate"]}],"border-spacing":[{"border-spacing":[s]}],"border-spacing-x":[{"border-spacing-x":[s]}],"border-spacing-y":[{"border-spacing-y":[s]}],"table-layout":[{table:["auto","fixed"]}],caption:[{caption:["top","bottom"]}],transition:[{transition:["none","all","","colors","opacity","shadow","transform",X]}],duration:[{duration:V()}],ease:[{ease:["linear","in","out","in-out",X]}],delay:[{delay:V()}],animate:[{animate:["none","spin","ping","pulse","bounce",X]}],transform:[{transform:["","gpu","none"]}],scale:[{scale:[w]}],"scale-x":[{"scale-x":[w]}],"scale-y":[{"scale-y":[w]}],rotate:[{rotate:[Xi,X]}],"translate-x":[{"translate-x":[S]}],"translate-y":[{"translate-y":[S]}],"skew-x":[{"skew-x":[C]}],"skew-y":[{"skew-y":[C]}],"transform-origin":[{origin:["center","top","top-right","right","bottom-right","bottom","bottom-left","left","top-left",X]}],accent:[{accent:["auto",e]}],appearance:[{appearance:["none","auto"]}],cursor:[{cursor:["auto","default","pointer","wait","text","move","help","not-allowed","none","context-menu","progress","cell","crosshair","vertical-text","alias","copy","no-drop","grab","grabbing","all-scroll","col-resize","row-resize","n-resize","e-resize","s-resize","w-resize","ne-resize","nw-resize","se-resize","sw-resize","ew-resize","ns-resize","nesw-resize","nwse-resize","zoom-in","zoom-out",X]}],"caret-color":[{caret:[e]}],"pointer-events":[{"pointer-events":["none","auto"]}],resize:[{resize:["none","y","x",""]}],"scroll-behavior":[{scroll:["auto","smooth"]}],"scroll-m":[{"scroll-m":D()}],"scroll-mx":[{"scroll-mx":D()}],"scroll-my":[{"scroll-my":D()}],"scroll-ms":[{"scroll-ms":D()}],"scroll-me":[{"scroll-me":D()}],"scroll-mt":[{"scroll-mt":D()}],"scroll-mr":[{"scroll-mr":D()}],"scroll-mb":[{"scroll-mb":D()}],"scroll-ml":[{"scroll-ml":D()}],"scroll-p":[{"scroll-p":D()}],"scroll-px":[{"scroll-px":D()}],"scroll-py":[{"scroll-py":D()}],"scroll-ps":[{"scroll-ps":D()}],"scroll-pe":[{"scroll-pe":D()}],"scroll-pt":[{"scroll-pt":D()}],"scroll-pr":[{"scroll-pr":D()}],"scroll-pb":[{"scroll-pb":D()}],"scroll-pl":[{"scroll-pl":D()}],"snap-align":[{snap:["start","end","center","align-none"]}],"snap-stop":[{snap:["normal","always"]}],"snap-type":[{snap:["none","x","y","both"]}],"snap-strictness":[{snap:["mandatory","proximity"]}],touch:[{touch:["auto","none","manipulation"]}],"touch-x":[{"touch-pan":["x","left","right"]}],"touch-y":[{"touch-pan":["y","up","down"]}],"touch-pz":["touch-pinch-zoom"],select:[{select:["none","text","all","auto"]}],"will-change":[{"will-change":["auto","scroll","contents","transform",X]}],fill:[{fill:[e,"none"]}],"stroke-w":[{stroke:[tn,Tn,Gc]}],stroke:[{stroke:[e,"none"]}],sr:["sr-only","not-sr-only"],"forced-color-adjust":[{"forced-color-adjust":["auto","none"]}]},conflictingClassGroups:{overflow:["overflow-x","overflow-y"],overscroll:["overscroll-x","overscroll-y"],inset:["inset-x","inset-y","start","end","top","right","bottom","left"],"inset-x":["right","left"],"inset-y":["top","bottom"],flex:["basis","grow","shrink"],gap:["gap-x","gap-y"],p:["px","py","ps","pe","pt","pr","pb","pl"],px:["pr","pl"],py:["pt","pb"],m:["mx","my","ms","me","mt","mr","mb","ml"],mx:["mr","ml"],my:["mt","mb"],size:["w","h"],"font-size":["leading"],"fvn-normal":["fvn-ordinal","fvn-slashed-zero","fvn-figure","fvn-spacing","fvn-fraction"],"fvn-ordinal":["fvn-normal"],"fvn-slashed-zero":["fvn-normal"],"fvn-figure":["fvn-normal"],"fvn-spacing":["fvn-normal"],"fvn-fraction":["fvn-normal"],"line-clamp":["display","overflow"],rounded:["rounded-s","rounded-e","rounded-t","rounded-r","rounded-b","rounded-l","rounded-ss","rounded-se","rounded-ee","rounded-es","rounded-tl","rounded-tr","rounded-br","rounded-bl"],"rounded-s":["rounded-ss","rounded-es"],"rounded-e":["rounded-se","rounded-ee"],"rounded-t":["rounded-tl","rounded-tr"],"rounded-r":["rounded-tr","rounded-br"],"rounded-b":["rounded-br","rounded-bl"],"rounded-l":["rounded-tl","rounded-bl"],"border-spacing":["border-spacing-x","border-spacing-y"],"border-w":["border-w-s","border-w-e","border-w-t","border-w-r","border-w-b","border-w-l"],"border-w-x":["border-w-r","border-w-l"],"border-w-y":["border-w-t","border-w-b"],"border-color":["border-color-s","border-color-e","border-color-t","border-color-r","border-color-b","border-color-l"],"border-color-x":["border-color-r","border-color-l"],"border-color-y":["border-color-t","border-color-b"],"scroll-m":["scroll-mx","scroll-my","scroll-ms","scroll-me","scroll-mt","scroll-mr","scroll-mb","scroll-ml"],"scroll-mx":["scroll-mr","scroll-ml"],"scroll-my":["scroll-mt","scroll-mb"],"scroll-p":["scroll-px","scroll-py","scroll-ps","scroll-pe","scroll-pt","scroll-pr","scroll-pb","scroll-pl"],"scroll-px":["scroll-pr","scroll-pl"],"scroll-py":["scroll-pt","scroll-pb"],touch:["touch-x","touch-y","touch-pz"],"touch-x":["touch"],"touch-y":["touch"],"touch-pz":["touch"]},conflictingClassGroupModifiers:{"font-size":["leading"]}}},H1=S1(z1);function mt(...e){return H1(py(e))}const G1=S0,Cy=m.forwardRef(({className:e,...t},n)=>o.jsx(oy,{ref:n,className:mt("fixed right-0 top-0 z-[100] flex max-h-screen w-full flex-col gap-2.5 p-3 sm:max-w-[360px] sm:p-4",e),...t}));Cy.displayName=oy.displayName;const W1=Au("group pointer-events-auto relative grid w-full cursor-pointer grid-cols-[auto_1fr_auto] items-start gap-2.5 overflow-hidden rounded-lg border p-3 pr-2 text-foreground shadow-[0_14px_42px_hsl(var(--foreground)/0.13)] outline-none backdrop-blur-xl transition-all before:pointer-events-none before:absolute before:inset-0 before:bg-[linear-gradient(135deg,hsl(var(--primary)/0.065),transparent_40%,hsl(var(--accent)/0.045))] after:pointer-events-none after:absolute after:inset-x-0 after:top-0 after:h-px after:bg-[linear-gradient(90deg,transparent,hsl(var(--primary)/0.38),transparent)] hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-ring/45 data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full sm:data-[state=open]:slide-in-from-right-full",{variants:{variant:{default:"border-border/70 bg-popover/92",success:"border-primary/35 bg-[linear-gradient(135deg,hsl(var(--popover)/0.96),hsl(var(--primary)/0.1))]",info:"border-[hsl(var(--category-architecture)/0.38)] bg-[linear-gradient(135deg,hsl(var(--popover)/0.96),hsl(var(--category-architecture)/0.08))]",warning:"border-[hsl(var(--category-practices)/0.42)] bg-[linear-gradient(135deg,hsl(var(--popover)/0.96),hsl(var(--category-practices)/0.1))]",destructive:"destructive border-destructive/45 bg-[linear-gradient(135deg,hsl(var(--popover)/0.96),hsl(var(--destructive)/0.09))]"}},defaultVariants:{variant:"default"}}),Sy=m.forwardRef(({className:e,variant:t,...n},r)=>o.jsx(sy,{ref:r,className:mt(W1({variant:t}),e),...n}));Sy.displayName=sy.displayName;const $1=m.forwardRef(({className:e,...t},n)=>o.jsx(hy,{ref:n,className:mt("inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-border/70 bg-background/50 px-3 text-xs font-semibold ring-offset-background transition-colors hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-ring/50 focus:ring-offset-2 group-[.destructive]:hover:border-destructive/30 group-[.destructive]:hover:bg-destructive group-[.destructive]:hover:text-destructive-foreground disabled:pointer-events-none disabled:opacity-50",e),...t}));$1.displayName=hy.displayName;const Py=m.forwardRef(({className:e,...t},n)=>o.jsx(uy,{ref:n,className:mt("relative z-10 -mr-0.5 -mt-1 rounded-md p-1 text-muted-foreground/60 opacity-70 transition-colors hover:bg-muted hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring/45",e),"toast-close":"",...t,children:o.jsx(ks,{className:"h-3.5 w-3.5"})}));Py.displayName=uy.displayName;const Ay=m.forwardRef(({className:e,...t},n)=>o.jsx(cy,{ref:n,className:mt("line-clamp-1 text-[13px] font-semibold leading-4 tracking-normal",e),...t}));Ay.displayName=cy.displayName;const Iy=m.forwardRef(({className:e,...t},n)=>o.jsx(ly,{ref:n,className:mt("line-clamp-1 text-xs leading-4 text-muted-foreground",e),...t}));Iy.displayName=ly.displayName;const Sp=3600,Pp={default:{icon:Ys,iconClass:"border-border/60 bg-background/70 text-foreground",railClass:"bg-[linear-gradient(180deg,hsl(var(--muted-foreground)/0.55),hsl(var(--primary)/0.55))]",progressClass:"bg-[linear-gradient(90deg,hsl(var(--muted-foreground)/0.45),hsl(var(--primary)/0.75))]"},success:{icon:hh,iconClass:"border-primary/35 bg-primary/10 text-primary",railClass:"bg-[linear-gradient(180deg,hsl(var(--primary)),hsl(var(--accent)/0.82))]",progressClass:"bg-[linear-gradient(90deg,hsl(var(--primary)),hsl(var(--accent)))]"},info:{icon:K0,iconClass:"border-[hsl(var(--category-architecture)/0.35)] bg-[hsl(var(--category-architecture)/0.1)] text-[hsl(var(--category-architecture))]",railClass:"bg-[linear-gradient(180deg,hsl(var(--category-architecture)),hsl(var(--primary)/0.78))]",progressClass:"bg-[linear-gradient(90deg,hsl(var(--category-architecture)),hsl(var(--primary)))]"},warning:{icon:u1,iconClass:"border-[hsl(var(--category-practices)/0.38)] bg-[hsl(var(--category-practices)/0.12)] text-[hsl(var(--category-practices))]",railClass:"bg-[linear-gradient(180deg,hsl(var(--category-practices)),hsl(var(--accent)))]",progressClass:"bg-[linear-gradient(90deg,hsl(var(--category-practices)),hsl(var(--accent)))]"},destructive:{icon:_0,iconClass:"border-destructive/35 bg-destructive/10 text-destructive",railClass:"bg-[linear-gradient(180deg,hsl(var(--destructive)),hsl(var(--accent)/0.82))]",progressClass:"bg-[linear-gradient(90deg,hsl(var(--destructive)),hsl(var(--accent)))]"}};function K1(){const{toasts:e,dismiss:t}=Ws();return o.jsxs(G1,{duration:Sp,children:[e.map(function({id:n,title:r,description:i,action:a,variant:s="default",...c}){const l=Pp[s]??Pp.default,h=l.icon;return o.jsxs(Sy,{variant:s,onClick:()=>t(n),...c,children:[o.jsx("div",{className:`absolute inset-y-2.5 left-2 w-0.5 rounded-full ${l.railClass}`}),o.jsx("div",{className:`relative z-10 ml-1.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-md border shadow-[inset_0_1px_0_hsl(var(--background)/0.45)] ${l.iconClass}`,children:o.jsx(h,{className:"h-3.5 w-3.5"})}),o.jsxs("div",{className:"relative z-10 min-w-0 flex-1",children:[o.jsxs("div",{className:"grid gap-0.5",children:[r&&o.jsx(Ay,{children:r}),i&&o.jsx(Iy,{children:i})]}),a&&o.jsx("div",{className:"mt-2",onClick:u=>u.stopPropagation(),children:a})]}),o.jsx(Py,{onClick:u=>u.stopPropagation()}),o.jsx("div",{className:"absolute inset-x-0 bottom-0 h-0.5 bg-muted/60",children:o.jsx("div",{className:`h-full ${l.progressClass}`,style:{animation:`toast-progress ${Sp}ms linear forwards`,transformOrigin:"left"}})})]},n)}),o.jsx(Cy,{})]})}var Q1=Ih[" useId ".trim().toString()]||(()=>{}),Y1=0;function Ny(e){const[t,n]=m.useState(Q1());return mn(()=>{n(r=>r??String(Y1++))},[e]),t?`radix-${t}`:""}const X1=["top","right","bottom","left"],Zn=Math.min,st=Math.max,Ts=Math.round,xo=Math.floor,Xt=e=>({x:e,y:e}),J1={left:"right",right:"left",bottom:"top",top:"bottom"},Z1={start:"end",end:"start"};function mh(e,t,n){return st(e,Zn(t,n))}function fn(e,t){return typeof e=="function"?e(t):e}function yn(e){return e.split("-")[0]}function _i(e){return e.split("-")[1]}function Nu(e){return e==="x"?"y":"x"}function ju(e){return e==="y"?"height":"width"}const eT=new Set(["top","bottom"]);function $t(e){return eT.has(yn(e))?"y":"x"}function Eu(e){return Nu($t(e))}function tT(e,t,n){n===void 0&&(n=!1);const r=_i(e),i=Eu(e),a=ju(i);let s=i==="x"?r===(n?"end":"start")?"right":"left":r==="start"?"bottom":"top";return t.reference[a]>t.floating[a]&&(s=Cs(s)),[s,Cs(s)]}function nT(e){const t=Cs(e);return[fh(e),t,fh(t)]}function fh(e){return e.replace(/start|end/g,t=>Z1[t])}const Ap=["left","right"],Ip=["right","left"],rT=["top","bottom"],iT=["bottom","top"];function aT(e,t,n){switch(e){case"top":case"bottom":return n?t?Ip:Ap:t?Ap:Ip;case"left":case"right":return t?rT:iT;default:return[]}}function oT(e,t,n,r){const i=_i(e);let a=aT(yn(e),n==="start",r);return i&&(a=a.map(s=>s+"-"+i),t&&(a=a.concat(a.map(fh)))),a}function Cs(e){return e.replace(/left|right|bottom|top/g,t=>J1[t])}function sT(e){return{top:0,right:0,bottom:0,left:0,...e}}function jy(e){return typeof e!="number"?sT(e):{top:e,right:e,bottom:e,left:e}}function Ss(e){const{x:t,y:n,width:r,height:i}=e;return{width:r,height:i,top:n,left:t,right:t+r,bottom:n+i,x:t,y:n}}function Np(e,t,n){let{reference:r,floating:i}=e;const a=$t(t),s=Eu(t),c=ju(s),l=yn(t),h=a==="y",u=r.x+r.width/2-i.width/2,d=r.y+r.height/2-i.height/2,p=r[c]/2-i[c]/2;let v;switch(l){case"top":v={x:u,y:r.y-i.height};break;case"bottom":v={x:u,y:r.y+r.height};break;case"right":v={x:r.x+r.width,y:d};break;case"left":v={x:r.x-i.width,y:d};break;default:v={x:r.x,y:r.y}}switch(_i(t)){case"start":v[s]-=p*(n&&h?-1:1);break;case"end":v[s]+=p*(n&&h?-1:1);break}return v}const cT=async(e,t,n)=>{const{placement:r="bottom",strategy:i="absolute",middleware:a=[],platform:s}=n,c=a.filter(Boolean),l=await(s.isRTL==null?void 0:s.isRTL(t));let h=await s.getElementRects({reference:e,floating:t,strategy:i}),{x:u,y:d}=Np(h,r,l),p=r,v={},x=0;for(let y=0;y<c.length;y++){const{name:k,fn:f}=c[y],{x:g,y:b,data:w,reset:T}=await f({x:u,y:d,initialPlacement:r,placement:p,strategy:i,middlewareData:v,rects:h,platform:s,elements:{reference:e,floating:t}});u=g??u,d=b??d,v={...v,[k]:{...v[k],...w}},T&&x<=50&&(x++,typeof T=="object"&&(T.placement&&(p=T.placement),T.rects&&(h=T.rects===!0?await s.getElementRects({reference:e,floating:t,strategy:i}):T.rects),{x:u,y:d}=Np(h,p,l)),y=-1)}return{x:u,y:d,placement:p,strategy:i,middlewareData:v}};async function Oa(e,t){var n;t===void 0&&(t={});const{x:r,y:i,platform:a,rects:s,elements:c,strategy:l}=e,{boundary:h="clippingAncestors",rootBoundary:u="viewport",elementContext:d="floating",altBoundary:p=!1,padding:v=0}=fn(t,e),x=jy(v),k=c[p?d==="floating"?"reference":"floating":d],f=Ss(await a.getClippingRect({element:(n=await(a.isElement==null?void 0:a.isElement(k)))==null||n?k:k.contextElement||await(a.getDocumentElement==null?void 0:a.getDocumentElement(c.floating)),boundary:h,rootBoundary:u,strategy:l})),g=d==="floating"?{x:r,y:i,width:s.floating.width,height:s.floating.height}:s.reference,b=await(a.getOffsetParent==null?void 0:a.getOffsetParent(c.floating)),w=await(a.isElement==null?void 0:a.isElement(b))?await(a.getScale==null?void 0:a.getScale(b))||{x:1,y:1}:{x:1,y:1},T=Ss(a.convertOffsetParentRelativeRectToViewportRelativeRect?await a.convertOffsetParentRelativeRectToViewportRelativeRect({elements:c,rect:g,offsetParent:b,strategy:l}):g);return{top:(f.top-T.top+x.top)/w.y,bottom:(T.bottom-f.bottom+x.bottom)/w.y,left:(f.left-T.left+x.left)/w.x,right:(T.right-f.right+x.right)/w.x}}const lT=e=>({name:"arrow",options:e,async fn(t){const{x:n,y:r,placement:i,rects:a,platform:s,elements:c,middlewareData:l}=t,{element:h,padding:u=0}=fn(e,t)||{};if(h==null)return{};const d=jy(u),p={x:n,y:r},v=Eu(i),x=ju(v),y=await s.getDimensions(h),k=v==="y",f=k?"top":"left",g=k?"bottom":"right",b=k?"clientHeight":"clientWidth",w=a.reference[x]+a.reference[v]-p[v]-a.floating[x],T=p[v]-a.reference[v],C=await(s.getOffsetParent==null?void 0:s.getOffsetParent(h));let P=C?C[b]:0;(!P||!await(s.isElement==null?void 0:s.isElement(C)))&&(P=c.floating[b]||a.floating[x]);const S=w/2-T/2,I=P/2-y[x]/2-1,j=Zn(d[f],I),q=Zn(d[g],I),D=j,J=P-y[x]-q,O=P/2-y[x]/2+S,Q=mh(D,O,J),G=!l.arrow&&_i(i)!=null&&O!==Q&&a.reference[x]/2-(O<D?j:q)-y[x]/2<0,W=G?O<D?O-D:O-J:0;return{[v]:p[v]+W,data:{[v]:Q,centerOffset:O-Q-W,...G&&{alignmentOffset:W}},reset:G}}}),hT=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var n,r;const{placement:i,middlewareData:a,rects:s,initialPlacement:c,platform:l,elements:h}=t,{mainAxis:u=!0,crossAxis:d=!0,fallbackPlacements:p,fallbackStrategy:v="bestFit",fallbackAxisSideDirection:x="none",flipAlignment:y=!0,...k}=fn(e,t);if((n=a.arrow)!=null&&n.alignmentOffset)return{};const f=yn(i),g=$t(c),b=yn(c)===c,w=await(l.isRTL==null?void 0:l.isRTL(h.floating)),T=p||(b||!y?[Cs(c)]:nT(c)),C=x!=="none";!p&&C&&T.push(...oT(c,y,x,w));const P=[c,...T],S=await Oa(t,k),I=[];let j=((r=a.flip)==null?void 0:r.overflows)||[];if(u&&I.push(S[f]),d){const O=tT(i,s,w);I.push(S[O[0]],S[O[1]])}if(j=[...j,{placement:i,overflows:I}],!I.every(O=>O<=0)){var q,D;const O=(((q=a.flip)==null?void 0:q.index)||0)+1,Q=P[O];if(Q&&(!(d==="alignment"?g!==$t(Q):!1)||j.every(A=>A.overflows[0]>0&&$t(A.placement)===g)))return{data:{index:O,overflows:j},reset:{placement:Q}};let G=(D=j.filter(W=>W.overflows[0]<=0).sort((W,A)=>W.overflows[1]-A.overflows[1])[0])==null?void 0:D.placement;if(!G)switch(v){case"bestFit":{var J;const W=(J=j.filter(A=>{if(C){const M=$t(A.placement);return M===g||M==="y"}return!0}).map(A=>[A.placement,A.overflows.filter(M=>M>0).reduce((M,F)=>M+F,0)]).sort((A,M)=>A[1]-M[1])[0])==null?void 0:J[0];W&&(G=W);break}case"initialPlacement":G=c;break}if(i!==G)return{reset:{placement:G}}}return{}}}};function jp(e,t){return{top:e.top-t.height,right:e.right-t.width,bottom:e.bottom-t.height,left:e.left-t.width}}function Ep(e){return X1.some(t=>e[t]>=0)}const uT=function(e){return e===void 0&&(e={}),{name:"hide",options:e,async fn(t){const{rects:n}=t,{strategy:r="referenceHidden",...i}=fn(e,t);switch(r){case"referenceHidden":{const a=await Oa(t,{...i,elementContext:"reference"}),s=jp(a,n.reference);return{data:{referenceHiddenOffsets:s,referenceHidden:Ep(s)}}}case"escaped":{const a=await Oa(t,{...i,altBoundary:!0}),s=jp(a,n.floating);return{data:{escapedOffsets:s,escaped:Ep(s)}}}default:return{}}}}},Ey=new Set(["left","top"]);async function dT(e,t){const{placement:n,platform:r,elements:i}=e,a=await(r.isRTL==null?void 0:r.isRTL(i.floating)),s=yn(n),c=_i(n),l=$t(n)==="y",h=Ey.has(s)?-1:1,u=a&&l?-1:1,d=fn(t,e);let{mainAxis:p,crossAxis:v,alignmentAxis:x}=typeof d=="number"?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return c&&typeof x=="number"&&(v=c==="end"?x*-1:x),l?{x:v*u,y:p*h}:{x:p*h,y:v*u}}const pT=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(t){var n,r;const{x:i,y:a,placement:s,middlewareData:c}=t,l=await dT(t,e);return s===((n=c.offset)==null?void 0:n.placement)&&(r=c.arrow)!=null&&r.alignmentOffset?{}:{x:i+l.x,y:a+l.y,data:{...l,placement:s}}}}},gT=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:n,y:r,placement:i}=t,{mainAxis:a=!0,crossAxis:s=!1,limiter:c={fn:k=>{let{x:f,y:g}=k;return{x:f,y:g}}},...l}=fn(e,t),h={x:n,y:r},u=await Oa(t,l),d=$t(yn(i)),p=Nu(d);let v=h[p],x=h[d];if(a){const k=p==="y"?"top":"left",f=p==="y"?"bottom":"right",g=v+u[k],b=v-u[f];v=mh(g,v,b)}if(s){const k=d==="y"?"top":"left",f=d==="y"?"bottom":"right",g=x+u[k],b=x-u[f];x=mh(g,x,b)}const y=c.fn({...t,[p]:v,[d]:x});return{...y,data:{x:y.x-n,y:y.y-r,enabled:{[p]:a,[d]:s}}}}}},mT=function(e){return e===void 0&&(e={}),{options:e,fn(t){const{x:n,y:r,placement:i,rects:a,middlewareData:s}=t,{offset:c=0,mainAxis:l=!0,crossAxis:h=!0}=fn(e,t),u={x:n,y:r},d=$t(i),p=Nu(d);let v=u[p],x=u[d];const y=fn(c,t),k=typeof y=="number"?{mainAxis:y,crossAxis:0}:{mainAxis:0,crossAxis:0,...y};if(l){const b=p==="y"?"height":"width",w=a.reference[p]-a.floating[b]+k.mainAxis,T=a.reference[p]+a.reference[b]-k.mainAxis;v<w?v=w:v>T&&(v=T)}if(h){var f,g;const b=p==="y"?"width":"height",w=Ey.has(yn(i)),T=a.reference[d]-a.floating[b]+(w&&((f=s.offset)==null?void 0:f[d])||0)+(w?0:k.crossAxis),C=a.reference[d]+a.reference[b]+(w?0:((g=s.offset)==null?void 0:g[d])||0)-(w?k.crossAxis:0);x<T?x=T:x>C&&(x=C)}return{[p]:v,[d]:x}}}},fT=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var n,r;const{placement:i,rects:a,platform:s,elements:c}=t,{apply:l=()=>{},...h}=fn(e,t),u=await Oa(t,h),d=yn(i),p=_i(i),v=$t(i)==="y",{width:x,height:y}=a.floating;let k,f;d==="top"||d==="bottom"?(k=d,f=p===(await(s.isRTL==null?void 0:s.isRTL(c.floating))?"start":"end")?"left":"right"):(f=d,k=p==="end"?"top":"bottom");const g=y-u.top-u.bottom,b=x-u.left-u.right,w=Zn(y-u[k],g),T=Zn(x-u[f],b),C=!t.middlewareData.shift;let P=w,S=T;if((n=t.middlewareData.shift)!=null&&n.enabled.x&&(S=b),(r=t.middlewareData.shift)!=null&&r.enabled.y&&(P=g),C&&!p){const j=st(u.left,0),q=st(u.right,0),D=st(u.top,0),J=st(u.bottom,0);v?S=x-2*(j!==0||q!==0?j+q:st(u.left,u.right)):P=y-2*(D!==0||J!==0?D+J:st(u.top,u.bottom))}await l({...t,availableWidth:S,availableHeight:P});const I=await s.getDimensions(c.floating);return x!==I.width||y!==I.height?{reset:{rects:!0}}:{}}}};function Xs(){return typeof window<"u"}function Fi(e){return Ry(e)?(e.nodeName||"").toLowerCase():"#document"}function ut(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function en(e){var t;return(t=(Ry(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function Ry(e){return Xs()?e instanceof Node||e instanceof ut(e).Node:!1}function qt(e){return Xs()?e instanceof Element||e instanceof ut(e).Element:!1}function Zt(e){return Xs()?e instanceof HTMLElement||e instanceof ut(e).HTMLElement:!1}function Rp(e){return!Xs()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof ut(e).ShadowRoot}const yT=new Set(["inline","contents"]);function Za(e){const{overflow:t,overflowX:n,overflowY:r,display:i}=Ot(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&!yT.has(i)}const vT=new Set(["table","td","th"]);function bT(e){return vT.has(Fi(e))}const wT=[":popover-open",":modal"];function Js(e){return wT.some(t=>{try{return e.matches(t)}catch{return!1}})}const xT=["transform","translate","scale","rotate","perspective"],kT=["transform","translate","scale","rotate","perspective","filter"],TT=["paint","layout","strict","content"];function Ru(e){const t=Lu(),n=qt(e)?Ot(e):e;return xT.some(r=>n[r]?n[r]!=="none":!1)||(n.containerType?n.containerType!=="normal":!1)||!t&&(n.backdropFilter?n.backdropFilter!=="none":!1)||!t&&(n.filter?n.filter!=="none":!1)||kT.some(r=>(n.willChange||"").includes(r))||TT.some(r=>(n.contain||"").includes(r))}function CT(e){let t=er(e);for(;Zt(t)&&!Ii(t);){if(Ru(t))return t;if(Js(t))return null;t=er(t)}return null}function Lu(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const ST=new Set(["html","body","#document"]);function Ii(e){return ST.has(Fi(e))}function Ot(e){return ut(e).getComputedStyle(e)}function Zs(e){return qt(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function er(e){if(Fi(e)==="html")return e;const t=e.assignedSlot||e.parentNode||Rp(e)&&e.host||en(e);return Rp(t)?t.host:t}function Ly(e){const t=er(e);return Ii(t)?e.ownerDocument?e.ownerDocument.body:e.body:Zt(t)&&Za(t)?t:Ly(t)}function Ua(e,t,n){var r;t===void 0&&(t=[]),n===void 0&&(n=!0);const i=Ly(e),a=i===((r=e.ownerDocument)==null?void 0:r.body),s=ut(i);if(a){const c=yh(s);return t.concat(s,s.visualViewport||[],Za(i)?i:[],c&&n?Ua(c):[])}return t.concat(i,Ua(i,[],n))}function yh(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Dy(e){const t=Ot(e);let n=parseFloat(t.width)||0,r=parseFloat(t.height)||0;const i=Zt(e),a=i?e.offsetWidth:n,s=i?e.offsetHeight:r,c=Ts(n)!==a||Ts(r)!==s;return c&&(n=a,r=s),{width:n,height:r,$:c}}function Du(e){return qt(e)?e:e.contextElement}function hi(e){const t=Du(e);if(!Zt(t))return Xt(1);const n=t.getBoundingClientRect(),{width:r,height:i,$:a}=Dy(t);let s=(a?Ts(n.width):n.width)/r,c=(a?Ts(n.height):n.height)/i;return(!s||!Number.isFinite(s))&&(s=1),(!c||!Number.isFinite(c))&&(c=1),{x:s,y:c}}const PT=Xt(0);function My(e){const t=ut(e);return!Lu()||!t.visualViewport?PT:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function AT(e,t,n){return t===void 0&&(t=!1),!n||t&&n!==ut(e)?!1:t}function Er(e,t,n,r){t===void 0&&(t=!1),n===void 0&&(n=!1);const i=e.getBoundingClientRect(),a=Du(e);let s=Xt(1);t&&(r?qt(r)&&(s=hi(r)):s=hi(e));const c=AT(a,n,r)?My(a):Xt(0);let l=(i.left+c.x)/s.x,h=(i.top+c.y)/s.y,u=i.width/s.x,d=i.height/s.y;if(a){const p=ut(a),v=r&&qt(r)?ut(r):r;let x=p,y=yh(x);for(;y&&r&&v!==x;){const k=hi(y),f=y.getBoundingClientRect(),g=Ot(y),b=f.left+(y.clientLeft+parseFloat(g.paddingLeft))*k.x,w=f.top+(y.clientTop+parseFloat(g.paddingTop))*k.y;l*=k.x,h*=k.y,u*=k.x,d*=k.y,l+=b,h+=w,x=ut(y),y=yh(x)}}return Ss({width:u,height:d,x:l,y:h})}function Mu(e,t){const n=Zs(e).scrollLeft;return t?t.left+n:Er(en(e)).left+n}function qy(e,t,n){n===void 0&&(n=!1);const r=e.getBoundingClientRect(),i=r.left+t.scrollLeft-(n?0:Mu(e,r)),a=r.top+t.scrollTop;return{x:i,y:a}}function IT(e){let{elements:t,rect:n,offsetParent:r,strategy:i}=e;const a=i==="fixed",s=en(r),c=t?Js(t.floating):!1;if(r===s||c&&a)return n;let l={scrollLeft:0,scrollTop:0},h=Xt(1);const u=Xt(0),d=Zt(r);if((d||!d&&!a)&&((Fi(r)!=="body"||Za(s))&&(l=Zs(r)),Zt(r))){const v=Er(r);h=hi(r),u.x=v.x+r.clientLeft,u.y=v.y+r.clientTop}const p=s&&!d&&!a?qy(s,l,!0):Xt(0);return{width:n.width*h.x,height:n.height*h.y,x:n.x*h.x-l.scrollLeft*h.x+u.x+p.x,y:n.y*h.y-l.scrollTop*h.y+u.y+p.y}}function NT(e){return Array.from(e.getClientRects())}function jT(e){const t=en(e),n=Zs(e),r=e.ownerDocument.body,i=st(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),a=st(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight);let s=-n.scrollLeft+Mu(e);const c=-n.scrollTop;return Ot(r).direction==="rtl"&&(s+=st(t.clientWidth,r.clientWidth)-i),{width:i,height:a,x:s,y:c}}function ET(e,t){const n=ut(e),r=en(e),i=n.visualViewport;let a=r.clientWidth,s=r.clientHeight,c=0,l=0;if(i){a=i.width,s=i.height;const h=Lu();(!h||h&&t==="fixed")&&(c=i.offsetLeft,l=i.offsetTop)}return{width:a,height:s,x:c,y:l}}const RT=new Set(["absolute","fixed"]);function LT(e,t){const n=Er(e,!0,t==="fixed"),r=n.top+e.clientTop,i=n.left+e.clientLeft,a=Zt(e)?hi(e):Xt(1),s=e.clientWidth*a.x,c=e.clientHeight*a.y,l=i*a.x,h=r*a.y;return{width:s,height:c,x:l,y:h}}function Lp(e,t,n){let r;if(t==="viewport")r=ET(e,n);else if(t==="document")r=jT(en(e));else if(qt(t))r=LT(t,n);else{const i=My(e);r={x:t.x-i.x,y:t.y-i.y,width:t.width,height:t.height}}return Ss(r)}function Oy(e,t){const n=er(e);return n===t||!qt(n)||Ii(n)?!1:Ot(n).position==="fixed"||Oy(n,t)}function DT(e,t){const n=t.get(e);if(n)return n;let r=Ua(e,[],!1).filter(c=>qt(c)&&Fi(c)!=="body"),i=null;const a=Ot(e).position==="fixed";let s=a?er(e):e;for(;qt(s)&&!Ii(s);){const c=Ot(s),l=Ru(s);!l&&c.position==="fixed"&&(i=null),(a?!l&&!i:!l&&c.position==="static"&&!!i&&RT.has(i.position)||Za(s)&&!l&&Oy(e,s))?r=r.filter(u=>u!==s):i=c,s=er(s)}return t.set(e,r),r}function MT(e){let{element:t,boundary:n,rootBoundary:r,strategy:i}=e;const s=[...n==="clippingAncestors"?Js(t)?[]:DT(t,this._c):[].concat(n),r],c=s[0],l=s.reduce((h,u)=>{const d=Lp(t,u,i);return h.top=st(d.top,h.top),h.right=Zn(d.right,h.right),h.bottom=Zn(d.bottom,h.bottom),h.left=st(d.left,h.left),h},Lp(t,c,i));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function qT(e){const{width:t,height:n}=Dy(e);return{width:t,height:n}}function OT(e,t,n){const r=Zt(t),i=en(t),a=n==="fixed",s=Er(e,!0,a,t);let c={scrollLeft:0,scrollTop:0};const l=Xt(0);function h(){l.x=Mu(i)}if(r||!r&&!a)if((Fi(t)!=="body"||Za(i))&&(c=Zs(t)),r){const v=Er(t,!0,a,t);l.x=v.x+t.clientLeft,l.y=v.y+t.clientTop}else i&&h();a&&!r&&i&&h();const u=i&&!r&&!a?qy(i,c):Xt(0),d=s.left+c.scrollLeft-l.x-u.x,p=s.top+c.scrollTop-l.y-u.y;return{x:d,y:p,width:s.width,height:s.height}}function Wc(e){return Ot(e).position==="static"}function Dp(e,t){if(!Zt(e)||Ot(e).position==="fixed")return null;if(t)return t(e);let n=e.offsetParent;return en(e)===n&&(n=n.ownerDocument.body),n}function Uy(e,t){const n=ut(e);if(Js(e))return n;if(!Zt(e)){let i=er(e);for(;i&&!Ii(i);){if(qt(i)&&!Wc(i))return i;i=er(i)}return n}let r=Dp(e,t);for(;r&&bT(r)&&Wc(r);)r=Dp(r,t);return r&&Ii(r)&&Wc(r)&&!Ru(r)?n:r||CT(e)||n}const UT=async function(e){const t=this.getOffsetParent||Uy,n=this.getDimensions,r=await n(e.floating);return{reference:OT(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function _T(e){return Ot(e).direction==="rtl"}const FT={convertOffsetParentRelativeRectToViewportRelativeRect:IT,getDocumentElement:en,getClippingRect:MT,getOffsetParent:Uy,getElementRects:UT,getClientRects:NT,getDimensions:qT,getScale:hi,isElement:qt,isRTL:_T};function _y(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function BT(e,t){let n=null,r;const i=en(e);function a(){var c;clearTimeout(r),(c=n)==null||c.disconnect(),n=null}function s(c,l){c===void 0&&(c=!1),l===void 0&&(l=1),a();const h=e.getBoundingClientRect(),{left:u,top:d,width:p,height:v}=h;if(c||t(),!p||!v)return;const x=xo(d),y=xo(i.clientWidth-(u+p)),k=xo(i.clientHeight-(d+v)),f=xo(u),b={rootMargin:-x+"px "+-y+"px "+-k+"px "+-f+"px",threshold:st(0,Zn(1,l))||1};let w=!0;function T(C){const P=C[0].intersectionRatio;if(P!==l){if(!w)return s();P?s(!1,P):r=setTimeout(()=>{s(!1,1e-7)},1e3)}P===1&&!_y(h,e.getBoundingClientRect())&&s(),w=!1}try{n=new IntersectionObserver(T,{...b,root:i.ownerDocument})}catch{n=new IntersectionObserver(T,b)}n.observe(e)}return s(!0),a}function VT(e,t,n,r){r===void 0&&(r={});const{ancestorScroll:i=!0,ancestorResize:a=!0,elementResize:s=typeof ResizeObserver=="function",layoutShift:c=typeof IntersectionObserver=="function",animationFrame:l=!1}=r,h=Du(e),u=i||a?[...h?Ua(h):[],...Ua(t)]:[];u.forEach(f=>{i&&f.addEventListener("scroll",n,{passive:!0}),a&&f.addEventListener("resize",n)});const d=h&&c?BT(h,n):null;let p=-1,v=null;s&&(v=new ResizeObserver(f=>{let[g]=f;g&&g.target===h&&v&&(v.unobserve(t),cancelAnimationFrame(p),p=requestAnimationFrame(()=>{var b;(b=v)==null||b.observe(t)})),n()}),h&&!l&&v.observe(h),v.observe(t));let x,y=l?Er(e):null;l&&k();function k(){const f=Er(e);y&&!_y(y,f)&&n(),y=f,x=requestAnimationFrame(k)}return n(),()=>{var f;u.forEach(g=>{i&&g.removeEventListener("scroll",n),a&&g.removeEventListener("resize",n)}),d==null||d(),(f=v)==null||f.disconnect(),v=null,l&&cancelAnimationFrame(x)}}const zT=pT,HT=gT,GT=hT,WT=fT,$T=uT,Mp=lT,KT=mT,QT=(e,t,n)=>{const r=new Map,i={platform:FT,...n},a={...i.platform,_c:r};return cT(e,t,{...i,platform:a})};var YT=typeof document<"u",XT=function(){},Vo=YT?m.useLayoutEffect:XT;function Ps(e,t){if(e===t)return!0;if(typeof e!=typeof t)return!1;if(typeof e=="function"&&e.toString()===t.toString())return!0;let n,r,i;if(e&&t&&typeof e=="object"){if(Array.isArray(e)){if(n=e.length,n!==t.length)return!1;for(r=n;r--!==0;)if(!Ps(e[r],t[r]))return!1;return!0}if(i=Object.keys(e),n=i.length,n!==Object.keys(t).length)return!1;for(r=n;r--!==0;)if(!{}.hasOwnProperty.call(t,i[r]))return!1;for(r=n;r--!==0;){const a=i[r];if(!(a==="_owner"&&e.$$typeof)&&!Ps(e[a],t[a]))return!1}return!0}return e!==e&&t!==t}function Fy(e){return typeof window>"u"?1:(e.ownerDocument.defaultView||window).devicePixelRatio||1}function qp(e,t){const n=Fy(e);return Math.round(t*n)/n}function $c(e){const t=m.useRef(e);return Vo(()=>{t.current=e}),t}function JT(e){e===void 0&&(e={});const{placement:t="bottom",strategy:n="absolute",middleware:r=[],platform:i,elements:{reference:a,floating:s}={},transform:c=!0,whileElementsMounted:l,open:h}=e,[u,d]=m.useState({x:0,y:0,strategy:n,placement:t,middlewareData:{},isPositioned:!1}),[p,v]=m.useState(r);Ps(p,r)||v(r);const[x,y]=m.useState(null),[k,f]=m.useState(null),g=m.useCallback(A=>{A!==C.current&&(C.current=A,y(A))},[]),b=m.useCallback(A=>{A!==P.current&&(P.current=A,f(A))},[]),w=a||x,T=s||k,C=m.useRef(null),P=m.useRef(null),S=m.useRef(u),I=l!=null,j=$c(l),q=$c(i),D=$c(h),J=m.useCallback(()=>{if(!C.current||!P.current)return;const A={placement:t,strategy:n,middleware:p};q.current&&(A.platform=q.current),QT(C.current,P.current,A).then(M=>{const F={...M,isPositioned:D.current!==!1};O.current&&!Ps(S.current,F)&&(S.current=F,Ka.flushSync(()=>{d(F)}))})},[p,t,n,q,D]);Vo(()=>{h===!1&&S.current.isPositioned&&(S.current.isPositioned=!1,d(A=>({...A,isPositioned:!1})))},[h]);const O=m.useRef(!1);Vo(()=>(O.current=!0,()=>{O.current=!1}),[]),Vo(()=>{if(w&&(C.current=w),T&&(P.current=T),w&&T){if(j.current)return j.current(w,T,J);J()}},[w,T,J,j,I]);const Q=m.useMemo(()=>({reference:C,floating:P,setReference:g,setFloating:b}),[g,b]),G=m.useMemo(()=>({reference:w,floating:T}),[w,T]),W=m.useMemo(()=>{const A={position:n,left:0,top:0};if(!G.floating)return A;const M=qp(G.floating,u.x),F=qp(G.floating,u.y);return c?{...A,transform:"translate("+M+"px, "+F+"px)",...Fy(G.floating)>=1.5&&{willChange:"transform"}}:{position:n,left:M,top:F}},[n,c,G.floating,u.x,u.y]);return m.useMemo(()=>({...u,update:J,refs:Q,elements:G,floatingStyles:W}),[u,J,Q,G,W])}const ZT=e=>{function t(n){return{}.hasOwnProperty.call(n,"current")}return{name:"arrow",options:e,fn(n){const{element:r,padding:i}=typeof e=="function"?e(n):e;return r&&t(r)?r.current!=null?Mp({element:r.current,padding:i}).fn(n):{}:r?Mp({element:r,padding:i}).fn(n):{}}}},eC=(e,t)=>({...zT(e),options:[e,t]}),tC=(e,t)=>({...HT(e),options:[e,t]}),nC=(e,t)=>({...KT(e),options:[e,t]}),rC=(e,t)=>({...GT(e),options:[e,t]}),iC=(e,t)=>({...WT(e),options:[e,t]}),aC=(e,t)=>({...$T(e),options:[e,t]}),oC=(e,t)=>({...ZT(e),options:[e,t]});var sC="Arrow",By=m.forwardRef((e,t)=>{const{children:n,width:r=10,height:i=5,...a}=e;return o.jsx(Ue.svg,{...a,ref:t,width:r,height:i,viewBox:"0 0 30 10",preserveAspectRatio:"none",children:e.asChild?n:o.jsx("polygon",{points:"0,0 30,0 15,10"})})});By.displayName=sC;var cC=By;function lC(e){const[t,n]=m.useState(void 0);return mn(()=>{if(e){n({width:e.offsetWidth,height:e.offsetHeight});const r=new ResizeObserver(i=>{if(!Array.isArray(i)||!i.length)return;const a=i[0];let s,c;if("borderBoxSize"in a){const l=a.borderBoxSize,h=Array.isArray(l)?l[0]:l;s=h.inlineSize,c=h.blockSize}else s=e.offsetWidth,c=e.offsetHeight;n({width:s,height:c})});return r.observe(e,{box:"border-box"}),()=>r.unobserve(e)}else n(void 0)},[e]),t}var qu="Popper",[Vy,ec]=Ya(qu),[hC,zy]=Vy(qu),Hy=e=>{const{__scopePopper:t,children:n}=e,[r,i]=m.useState(null);return o.jsx(hC,{scope:t,anchor:r,onAnchorChange:i,children:n})};Hy.displayName=qu;var Gy="PopperAnchor",Wy=m.forwardRef((e,t)=>{const{__scopePopper:n,virtualRef:r,...i}=e,a=zy(Gy,n),s=m.useRef(null),c=it(t,s);return m.useEffect(()=>{a.onAnchorChange((r==null?void 0:r.current)||s.current)}),r?null:o.jsx(Ue.div,{...i,ref:c})});Wy.displayName=Gy;var Ou="PopperContent",[uC,dC]=Vy(Ou),$y=m.forwardRef((e,t)=>{var ft,bn,De,wn,E,_;const{__scopePopper:n,side:r="bottom",sideOffset:i=0,align:a="center",alignOffset:s=0,arrowPadding:c=0,avoidCollisions:l=!0,collisionBoundary:h=[],collisionPadding:u=0,sticky:d="partial",hideWhenDetached:p=!1,updatePositionStrategy:v="optimized",onPlaced:x,...y}=e,k=zy(Ou,n),[f,g]=m.useState(null),b=it(t,ee=>g(ee)),[w,T]=m.useState(null),C=lC(w),P=(C==null?void 0:C.width)??0,S=(C==null?void 0:C.height)??0,I=r+(a!=="center"?"-"+a:""),j=typeof u=="number"?u:{top:0,right:0,bottom:0,left:0,...u},q=Array.isArray(h)?h:[h],D=q.length>0,J={padding:j,boundary:q.filter(gC),altBoundary:D},{refs:O,floatingStyles:Q,placement:G,isPositioned:W,middlewareData:A}=JT({strategy:"fixed",placement:I,whileElementsMounted:(...ee)=>VT(...ee,{animationFrame:v==="always"}),elements:{reference:k.anchor},middleware:[eC({mainAxis:i+S,alignmentAxis:s}),l&&tC({mainAxis:!0,crossAxis:!1,limiter:d==="partial"?nC():void 0,...J}),l&&rC({...J}),iC({...J,apply:({elements:ee,rects:R,availableWidth:H,availableHeight:Y})=>{const{width:te,height:Z}=R.reference,$=ee.floating.style;$.setProperty("--radix-popper-available-width",`${H}px`),$.setProperty("--radix-popper-available-height",`${Y}px`),$.setProperty("--radix-popper-anchor-width",`${te}px`),$.setProperty("--radix-popper-anchor-height",`${Z}px`)}}),w&&oC({element:w,padding:c}),mC({arrowWidth:P,arrowHeight:S}),p&&aC({strategy:"referenceHidden",...J})]}),[M,F]=Yy(G),V=Jt(x);mn(()=>{W&&(V==null||V())},[W,V]);const z=(ft=A.arrow)==null?void 0:ft.x,Ge=(bn=A.arrow)==null?void 0:bn.y,ge=((De=A.arrow)==null?void 0:De.centerOffset)!==0,[Je,We]=m.useState();return mn(()=>{f&&We(window.getComputedStyle(f).zIndex)},[f]),o.jsx("div",{ref:O.setFloating,"data-radix-popper-content-wrapper":"",style:{...Q,transform:W?Q.transform:"translate(0, -200%)",minWidth:"max-content",zIndex:Je,"--radix-popper-transform-origin":[(wn=A.transformOrigin)==null?void 0:wn.x,(E=A.transformOrigin)==null?void 0:E.y].join(" "),...((_=A.hide)==null?void 0:_.referenceHidden)&&{visibility:"hidden",pointerEvents:"none"}},dir:e.dir,children:o.jsx(uC,{scope:n,placedSide:M,onArrowChange:T,arrowX:z,arrowY:Ge,shouldHideArrow:ge,children:o.jsx(Ue.div,{"data-side":M,"data-align":F,...y,ref:b,style:{...y.style,animation:W?void 0:"none"}})})})});$y.displayName=Ou;var Ky="PopperArrow",pC={top:"bottom",right:"left",bottom:"top",left:"right"},Qy=m.forwardRef(function(t,n){const{__scopePopper:r,...i}=t,a=dC(Ky,r),s=pC[a.placedSide];return o.jsx("span",{ref:a.onArrowChange,style:{position:"absolute",left:a.arrowX,top:a.arrowY,[s]:0,transformOrigin:{top:"",right:"0 0",bottom:"center 0",left:"100% 0"}[a.placedSide],transform:{top:"translateY(100%)",right:"translateY(50%) rotate(90deg) translateX(-50%)",bottom:"rotate(180deg)",left:"translateY(50%) rotate(-90deg) translateX(50%)"}[a.placedSide],visibility:a.shouldHideArrow?"hidden":void 0},children:o.jsx(cC,{...i,ref:n,style:{...i.style,display:"block"}})})});Qy.displayName=Ky;function gC(e){return e!==null}var mC=e=>({name:"transformOrigin",options:e,fn(t){var k,f,g;const{placement:n,rects:r,middlewareData:i}=t,s=((k=i.arrow)==null?void 0:k.centerOffset)!==0,c=s?0:e.arrowWidth,l=s?0:e.arrowHeight,[h,u]=Yy(n),d={start:"0%",center:"50%",end:"100%"}[u],p=(((f=i.arrow)==null?void 0:f.x)??0)+c/2,v=(((g=i.arrow)==null?void 0:g.y)??0)+l/2;let x="",y="";return h==="bottom"?(x=s?d:`${p}px`,y=`${-l}px`):h==="top"?(x=s?d:`${p}px`,y=`${r.floating.height+l}px`):h==="right"?(x=`${-l}px`,y=s?d:`${v}px`):h==="left"&&(x=`${r.floating.width+l}px`,y=s?d:`${v}px`),{data:{x,y}}}});function Yy(e){const[t,n="center"]=e.split("-");return[t,n]}var Xy=Hy,Uu=Wy,Jy=$y,Zy=Qy,[tc,_I]=Ya("Tooltip",[ec]),nc=ec(),ev="TooltipProvider",fC=700,vh="tooltip.open",[yC,_u]=tc(ev),tv=e=>{const{__scopeTooltip:t,delayDuration:n=fC,skipDelayDuration:r=300,disableHoverableContent:i=!1,children:a}=e,s=m.useRef(!0),c=m.useRef(!1),l=m.useRef(0);return m.useEffect(()=>{const h=l.current;return()=>window.clearTimeout(h)},[]),o.jsx(yC,{scope:t,isOpenDelayedRef:s,delayDuration:n,onOpen:m.useCallback(()=>{window.clearTimeout(l.current),s.current=!1},[]),onClose:m.useCallback(()=>{window.clearTimeout(l.current),l.current=window.setTimeout(()=>s.current=!0,r)},[r]),isPointerInTransitRef:c,onPointerInTransitChange:m.useCallback(h=>{c.current=h},[]),disableHoverableContent:i,children:a})};tv.displayName=ev;var _a="Tooltip",[vC,rc]=tc(_a),nv=e=>{const{__scopeTooltip:t,children:n,open:r,defaultOpen:i,onOpenChange:a,disableHoverableContent:s,delayDuration:c}=e,l=_u(_a,e.__scopeTooltip),h=nc(t),[u,d]=m.useState(null),p=Ny(),v=m.useRef(0),x=s??l.disableHoverableContent,y=c??l.delayDuration,k=m.useRef(!1),[f,g]=Tu({prop:r,defaultProp:i??!1,onChange:P=>{P?(l.onOpen(),document.dispatchEvent(new CustomEvent(vh))):l.onClose(),a==null||a(P)},caller:_a}),b=m.useMemo(()=>f?k.current?"delayed-open":"instant-open":"closed",[f]),w=m.useCallback(()=>{window.clearTimeout(v.current),v.current=0,k.current=!1,g(!0)},[g]),T=m.useCallback(()=>{window.clearTimeout(v.current),v.current=0,g(!1)},[g]),C=m.useCallback(()=>{window.clearTimeout(v.current),v.current=window.setTimeout(()=>{k.current=!0,g(!0),v.current=0},y)},[y,g]);return m.useEffect(()=>()=>{v.current&&(window.clearTimeout(v.current),v.current=0)},[]),o.jsx(Xy,{...h,children:o.jsx(vC,{scope:t,contentId:p,open:f,stateAttribute:b,trigger:u,onTriggerChange:d,onTriggerEnter:m.useCallback(()=>{l.isOpenDelayedRef.current?C():w()},[l.isOpenDelayedRef,C,w]),onTriggerLeave:m.useCallback(()=>{x?T():(window.clearTimeout(v.current),v.current=0)},[T,x]),onOpen:w,onClose:T,disableHoverableContent:x,children:n})})};nv.displayName=_a;var bh="TooltipTrigger",rv=m.forwardRef((e,t)=>{const{__scopeTooltip:n,...r}=e,i=rc(bh,n),a=_u(bh,n),s=nc(n),c=m.useRef(null),l=it(t,c,i.onTriggerChange),h=m.useRef(!1),u=m.useRef(!1),d=m.useCallback(()=>h.current=!1,[]);return m.useEffect(()=>()=>document.removeEventListener("pointerup",d),[d]),o.jsx(Uu,{asChild:!0,...s,children:o.jsx(Ue.button,{"aria-describedby":i.open?i.contentId:void 0,"data-state":i.stateAttribute,...r,ref:l,onPointerMove:pe(e.onPointerMove,p=>{p.pointerType!=="touch"&&!u.current&&!a.isPointerInTransitRef.current&&(i.onTriggerEnter(),u.current=!0)}),onPointerLeave:pe(e.onPointerLeave,()=>{i.onTriggerLeave(),u.current=!1}),onPointerDown:pe(e.onPointerDown,()=>{i.open&&i.onClose(),h.current=!0,document.addEventListener("pointerup",d,{once:!0})}),onFocus:pe(e.onFocus,()=>{h.current||i.onOpen()}),onBlur:pe(e.onBlur,i.onClose),onClick:pe(e.onClick,i.onClose)})})});rv.displayName=bh;var bC="TooltipPortal",[FI,wC]=tc(bC,{forceMount:void 0}),Ni="TooltipContent",iv=m.forwardRef((e,t)=>{const n=wC(Ni,e.__scopeTooltip),{forceMount:r=n.forceMount,side:i="top",...a}=e,s=rc(Ni,e.__scopeTooltip);return o.jsx(Xa,{present:r||s.open,children:s.disableHoverableContent?o.jsx(av,{side:i,...a,ref:t}):o.jsx(xC,{side:i,...a,ref:t})})}),xC=m.forwardRef((e,t)=>{const n=rc(Ni,e.__scopeTooltip),r=_u(Ni,e.__scopeTooltip),i=m.useRef(null),a=it(t,i),[s,c]=m.useState(null),{trigger:l,onClose:h}=n,u=i.current,{onPointerInTransitChange:d}=r,p=m.useCallback(()=>{c(null),d(!1)},[d]),v=m.useCallback((x,y)=>{const k=x.currentTarget,f={x:x.clientX,y:x.clientY},g=PC(f,k.getBoundingClientRect()),b=AC(f,g),w=IC(y.getBoundingClientRect()),T=jC([...b,...w]);c(T),d(!0)},[d]);return m.useEffect(()=>()=>p(),[p]),m.useEffect(()=>{if(l&&u){const x=k=>v(k,u),y=k=>v(k,l);return l.addEventListener("pointerleave",x),u.addEventListener("pointerleave",y),()=>{l.removeEventListener("pointerleave",x),u.removeEventListener("pointerleave",y)}}},[l,u,v,p]),m.useEffect(()=>{if(s){const x=y=>{const k=y.target,f={x:y.clientX,y:y.clientY},g=(l==null?void 0:l.contains(k))||(u==null?void 0:u.contains(k)),b=!NC(f,s);g?p():b&&(p(),h())};return document.addEventListener("pointermove",x),()=>document.removeEventListener("pointermove",x)}},[l,u,s,h,p]),o.jsx(av,{...e,ref:a})}),[kC,TC]=tc(_a,{isInside:!1}),CC=Ok("TooltipContent"),av=m.forwardRef((e,t)=>{const{__scopeTooltip:n,children:r,"aria-label":i,onEscapeKeyDown:a,onPointerDownOutside:s,...c}=e,l=rc(Ni,n),h=nc(n),{onClose:u}=l;return m.useEffect(()=>(document.addEventListener(vh,u),()=>document.removeEventListener(vh,u)),[u]),m.useEffect(()=>{if(l.trigger){const d=p=>{const v=p.target;v!=null&&v.contains(l.trigger)&&u()};return window.addEventListener("scroll",d,{capture:!0}),()=>window.removeEventListener("scroll",d,{capture:!0})}},[l.trigger,u]),o.jsx($s,{asChild:!0,disableOutsidePointerEvents:!1,onEscapeKeyDown:a,onPointerDownOutside:s,onFocusOutside:d=>d.preventDefault(),onDismiss:u,children:o.jsxs(Jy,{"data-state":l.stateAttribute,...h,...c,ref:t,style:{...c.style,"--radix-tooltip-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-tooltip-content-available-width":"var(--radix-popper-available-width)","--radix-tooltip-content-available-height":"var(--radix-popper-available-height)","--radix-tooltip-trigger-width":"var(--radix-popper-anchor-width)","--radix-tooltip-trigger-height":"var(--radix-popper-anchor-height)"},children:[o.jsx(CC,{children:r}),o.jsx(kC,{scope:n,isInside:!0,children:o.jsx(s0,{id:l.contentId,role:"tooltip",children:i||r})})]})})});iv.displayName=Ni;var ov="TooltipArrow",SC=m.forwardRef((e,t)=>{const{__scopeTooltip:n,...r}=e,i=nc(n);return TC(ov,n).isInside?null:o.jsx(Zy,{...i,...r,ref:t})});SC.displayName=ov;function PC(e,t){const n=Math.abs(t.top-e.y),r=Math.abs(t.bottom-e.y),i=Math.abs(t.right-e.x),a=Math.abs(t.left-e.x);switch(Math.min(n,r,i,a)){case a:return"left";case i:return"right";case n:return"top";case r:return"bottom";default:throw new Error("unreachable")}}function AC(e,t,n=5){const r=[];switch(t){case"top":r.push({x:e.x-n,y:e.y+n},{x:e.x+n,y:e.y+n});break;case"bottom":r.push({x:e.x-n,y:e.y-n},{x:e.x+n,y:e.y-n});break;case"left":r.push({x:e.x+n,y:e.y-n},{x:e.x+n,y:e.y+n});break;case"right":r.push({x:e.x-n,y:e.y-n},{x:e.x-n,y:e.y+n});break}return r}function IC(e){const{top:t,right:n,bottom:r,left:i}=e;return[{x:i,y:t},{x:n,y:t},{x:n,y:r},{x:i,y:r}]}function NC(e,t){const{x:n,y:r}=e;let i=!1;for(let a=0,s=t.length-1;a<t.length;s=a++){const c=t[a],l=t[s],h=c.x,u=c.y,d=l.x,p=l.y;u>r!=p>r&&n<(d-h)*(r-u)/(p-u)+h&&(i=!i)}return i}function jC(e){const t=e.slice();return t.sort((n,r)=>n.x<r.x?-1:n.x>r.x?1:n.y<r.y?-1:n.y>r.y?1:0),EC(t)}function EC(e){if(e.length<=1)return e.slice();const t=[];for(let r=0;r<e.length;r++){const i=e[r];for(;t.length>=2;){const a=t[t.length-1],s=t[t.length-2];if((a.x-s.x)*(i.y-s.y)>=(a.y-s.y)*(i.x-s.x))t.pop();else break}t.push(i)}t.pop();const n=[];for(let r=e.length-1;r>=0;r--){const i=e[r];for(;n.length>=2;){const a=n[n.length-1],s=n[n.length-2];if((a.x-s.x)*(i.y-s.y)>=(a.y-s.y)*(i.x-s.x))n.pop();else break}n.push(i)}return n.pop(),t.length===1&&n.length===1&&t[0].x===n[0].x&&t[0].y===n[0].y?t:t.concat(n)}var RC=tv,LC=nv,DC=rv,sv=iv;const MC=RC,cv=LC,lv=DC,Fu=m.forwardRef(({className:e,sideOffset:t=4,...n},r)=>o.jsx(sv,{ref:r,sideOffset:t,className:mt("z-50 overflow-hidden rounded-md border bg-popover px-3 py-1.5 text-sm text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",e),...n}));Fu.displayName=sv.displayName;var ic=class{constructor(){this.listeners=new Set,this.subscribe=this.subscribe.bind(this)}subscribe(e){return this.listeners.add(e),this.onSubscribe(),()=>{this.listeners.delete(e),this.onUnsubscribe()}}hasListeners(){return this.listeners.size>0}onSubscribe(){}onUnsubscribe(){}},ac=typeof window>"u"||"Deno"in globalThis;function At(){}function qC(e,t){return typeof e=="function"?e(t):e}function OC(e){return typeof e=="number"&&e>=0&&e!==1/0}function UC(e,t){return Math.max(e+(t||0)-Date.now(),0)}function wh(e,t){return typeof e=="function"?e(t):e}function _C(e,t){return typeof e=="function"?e(t):e}function Op(e,t){const{type:n="all",exact:r,fetchStatus:i,predicate:a,queryKey:s,stale:c}=e;if(s){if(r){if(t.queryHash!==Bu(s,t.options))return!1}else if(!Ba(t.queryKey,s))return!1}if(n!=="all"){const l=t.isActive();if(n==="active"&&!l||n==="inactive"&&l)return!1}return!(typeof c=="boolean"&&t.isStale()!==c||i&&i!==t.state.fetchStatus||a&&!a(t))}function Up(e,t){const{exact:n,status:r,predicate:i,mutationKey:a}=e;if(a){if(!t.options.mutationKey)return!1;if(n){if(Fa(t.options.mutationKey)!==Fa(a))return!1}else if(!Ba(t.options.mutationKey,a))return!1}return!(r&&t.state.status!==r||i&&!i(t))}function Bu(e,t){return((t==null?void 0:t.queryKeyHashFn)||Fa)(e)}function Fa(e){return JSON.stringify(e,(t,n)=>xh(n)?Object.keys(n).sort().reduce((r,i)=>(r[i]=n[i],r),{}):n)}function Ba(e,t){return e===t?!0:typeof e!=typeof t?!1:e&&t&&typeof e=="object"&&typeof t=="object"?Object.keys(t).every(n=>Ba(e[n],t[n])):!1}function hv(e,t){if(e===t)return e;const n=_p(e)&&_p(t);if(n||xh(e)&&xh(t)){const r=n?e:Object.keys(e),i=r.length,a=n?t:Object.keys(t),s=a.length,c=n?[]:{},l=new Set(r);let h=0;for(let u=0;u<s;u++){const d=n?u:a[u];(!n&&l.has(d)||n)&&e[d]===void 0&&t[d]===void 0?(c[d]=void 0,h++):(c[d]=hv(e[d],t[d]),c[d]===e[d]&&e[d]!==void 0&&h++)}return i===s&&h===i?e:c}return t}function _p(e){return Array.isArray(e)&&e.length===Object.keys(e).length}function xh(e){if(!Fp(e))return!1;const t=e.constructor;if(t===void 0)return!0;const n=t.prototype;return!(!Fp(n)||!n.hasOwnProperty("isPrototypeOf")||Object.getPrototypeOf(e)!==Object.prototype)}function Fp(e){return Object.prototype.toString.call(e)==="[object Object]"}function FC(e){return new Promise(t=>{setTimeout(t,e)})}function BC(e,t,n){return typeof n.structuralSharing=="function"?n.structuralSharing(e,t):n.structuralSharing!==!1?hv(e,t):t}function VC(e,t,n=0){const r=[...e,t];return n&&r.length>n?r.slice(1):r}function zC(e,t,n=0){const r=[t,...e];return n&&r.length>n?r.slice(0,-1):r}var Vu=Symbol();function uv(e,t){return!e.queryFn&&(t!=null&&t.initialPromise)?()=>t.initialPromise:!e.queryFn||e.queryFn===Vu?()=>Promise.reject(new Error(`Missing queryFn: '${e.queryHash}'`)):e.queryFn}var fr,Rn,di,yg,HC=(yg=class extends ic{constructor(){super();ie(this,fr);ie(this,Rn);ie(this,di);K(this,di,t=>{if(!ac&&window.addEventListener){const n=()=>t();return window.addEventListener("visibilitychange",n,!1),()=>{window.removeEventListener("visibilitychange",n)}}})}onSubscribe(){N(this,Rn)||this.setEventListener(N(this,di))}onUnsubscribe(){var t;this.hasListeners()||((t=N(this,Rn))==null||t.call(this),K(this,Rn,void 0))}setEventListener(t){var n;K(this,di,t),(n=N(this,Rn))==null||n.call(this),K(this,Rn,t(r=>{typeof r=="boolean"?this.setFocused(r):this.onFocus()}))}setFocused(t){N(this,fr)!==t&&(K(this,fr,t),this.onFocus())}onFocus(){const t=this.isFocused();this.listeners.forEach(n=>{n(t)})}isFocused(){var t;return typeof N(this,fr)=="boolean"?N(this,fr):((t=globalThis.document)==null?void 0:t.visibilityState)!=="hidden"}},fr=new WeakMap,Rn=new WeakMap,di=new WeakMap,yg),dv=new HC,pi,Ln,gi,vg,GC=(vg=class extends ic{constructor(){super();ie(this,pi,!0);ie(this,Ln);ie(this,gi);K(this,gi,t=>{if(!ac&&window.addEventListener){const n=()=>t(!0),r=()=>t(!1);return window.addEventListener("online",n,!1),window.addEventListener("offline",r,!1),()=>{window.removeEventListener("online",n),window.removeEventListener("offline",r)}}})}onSubscribe(){N(this,Ln)||this.setEventListener(N(this,gi))}onUnsubscribe(){var t;this.hasListeners()||((t=N(this,Ln))==null||t.call(this),K(this,Ln,void 0))}setEventListener(t){var n;K(this,gi,t),(n=N(this,Ln))==null||n.call(this),K(this,Ln,t(this.setOnline.bind(this)))}setOnline(t){N(this,pi)!==t&&(K(this,pi,t),this.listeners.forEach(r=>{r(t)}))}isOnline(){return N(this,pi)}},pi=new WeakMap,Ln=new WeakMap,gi=new WeakMap,vg),As=new GC;function WC(){let e,t;const n=new Promise((i,a)=>{e=i,t=a});n.status="pending",n.catch(()=>{});function r(i){Object.assign(n,i),delete n.resolve,delete n.reject}return n.resolve=i=>{r({status:"fulfilled",value:i}),e(i)},n.reject=i=>{r({status:"rejected",reason:i}),t(i)},n}function $C(e){return Math.min(1e3*2**e,3e4)}function pv(e){return(e??"online")==="online"?As.isOnline():!0}var gv=class extends Error{constructor(e){super("CancelledError"),this.revert=e==null?void 0:e.revert,this.silent=e==null?void 0:e.silent}};function Kc(e){return e instanceof gv}function mv(e){let t=!1,n=0,r=!1,i;const a=WC(),s=y=>{var k;r||(p(new gv(y)),(k=e.abort)==null||k.call(e))},c=()=>{t=!0},l=()=>{t=!1},h=()=>dv.isFocused()&&(e.networkMode==="always"||As.isOnline())&&e.canRun(),u=()=>pv(e.networkMode)&&e.canRun(),d=y=>{var k;r||(r=!0,(k=e.onSuccess)==null||k.call(e,y),i==null||i(),a.resolve(y))},p=y=>{var k;r||(r=!0,(k=e.onError)==null||k.call(e,y),i==null||i(),a.reject(y))},v=()=>new Promise(y=>{var k;i=f=>{(r||h())&&y(f)},(k=e.onPause)==null||k.call(e)}).then(()=>{var y;i=void 0,r||(y=e.onContinue)==null||y.call(e)}),x=()=>{if(r)return;let y;const k=n===0?e.initialPromise:void 0;try{y=k??e.fn()}catch(f){y=Promise.reject(f)}Promise.resolve(y).then(d).catch(f=>{var C;if(r)return;const g=e.retry??(ac?0:3),b=e.retryDelay??$C,w=typeof b=="function"?b(n,f):b,T=g===!0||typeof g=="number"&&n<g||typeof g=="function"&&g(n,f);if(t||!T){p(f);return}n++,(C=e.onFail)==null||C.call(e,n,f),FC(w).then(()=>h()?void 0:v()).then(()=>{t?p(f):x()})})};return{promise:a,cancel:s,continue:()=>(i==null||i(),a),cancelRetry:c,continueRetry:l,canStart:u,start:()=>(u()?x():v().then(x),a)}}var KC=e=>setTimeout(e,0);function QC(){let e=[],t=0,n=c=>{c()},r=c=>{c()},i=KC;const a=c=>{t?e.push(c):i(()=>{n(c)})},s=()=>{const c=e;e=[],c.length&&i(()=>{r(()=>{c.forEach(l=>{n(l)})})})};return{batch:c=>{let l;t++;try{l=c()}finally{t--,t||s()}return l},batchCalls:c=>(...l)=>{a(()=>{c(...l)})},schedule:a,setNotifyFunction:c=>{n=c},setBatchNotifyFunction:c=>{r=c},setScheduler:c=>{i=c}}}var Qe=QC(),yr,bg,fv=(bg=class{constructor(){ie(this,yr)}destroy(){this.clearGcTimeout()}scheduleGc(){this.clearGcTimeout(),OC(this.gcTime)&&K(this,yr,setTimeout(()=>{this.optionalRemove()},this.gcTime))}updateGcTime(e){this.gcTime=Math.max(this.gcTime||0,e??(ac?1/0:5*60*1e3))}clearGcTimeout(){N(this,yr)&&(clearTimeout(N(this,yr)),K(this,yr,void 0))}},yr=new WeakMap,bg),mi,vr,yt,br,Ve,Va,wr,It,rn,wg,YC=(wg=class extends fv{constructor(t){super();ie(this,It);ie(this,mi);ie(this,vr);ie(this,yt);ie(this,br);ie(this,Ve);ie(this,Va);ie(this,wr);K(this,wr,!1),K(this,Va,t.defaultOptions),this.setOptions(t.options),this.observers=[],K(this,br,t.client),K(this,yt,N(this,br).getQueryCache()),this.queryKey=t.queryKey,this.queryHash=t.queryHash,K(this,mi,JC(this.options)),this.state=t.state??N(this,mi),this.scheduleGc()}get meta(){return this.options.meta}get promise(){var t;return(t=N(this,Ve))==null?void 0:t.promise}setOptions(t){this.options={...N(this,Va),...t},this.updateGcTime(this.options.gcTime)}optionalRemove(){!this.observers.length&&this.state.fetchStatus==="idle"&&N(this,yt).remove(this)}setData(t,n){const r=BC(this.state.data,t,this.options);return _e(this,It,rn).call(this,{data:r,type:"success",dataUpdatedAt:n==null?void 0:n.updatedAt,manual:n==null?void 0:n.manual}),r}setState(t,n){_e(this,It,rn).call(this,{type:"setState",state:t,setStateOptions:n})}cancel(t){var r,i;const n=(r=N(this,Ve))==null?void 0:r.promise;return(i=N(this,Ve))==null||i.cancel(t),n?n.then(At).catch(At):Promise.resolve()}destroy(){super.destroy(),this.cancel({silent:!0})}reset(){this.destroy(),this.setState(N(this,mi))}isActive(){return this.observers.some(t=>_C(t.options.enabled,this)!==!1)}isDisabled(){return this.getObserversCount()>0?!this.isActive():this.options.queryFn===Vu||this.state.dataUpdateCount+this.state.errorUpdateCount===0}isStatic(){return this.getObserversCount()>0?this.observers.some(t=>wh(t.options.staleTime,this)==="static"):!1}isStale(){return this.getObserversCount()>0?this.observers.some(t=>t.getCurrentResult().isStale):this.state.data===void 0||this.state.isInvalidated}isStaleByTime(t=0){return this.state.data===void 0?!0:t==="static"?!1:this.state.isInvalidated?!0:!UC(this.state.dataUpdatedAt,t)}onFocus(){var n;const t=this.observers.find(r=>r.shouldFetchOnWindowFocus());t==null||t.refetch({cancelRefetch:!1}),(n=N(this,Ve))==null||n.continue()}onOnline(){var n;const t=this.observers.find(r=>r.shouldFetchOnReconnect());t==null||t.refetch({cancelRefetch:!1}),(n=N(this,Ve))==null||n.continue()}addObserver(t){this.observers.includes(t)||(this.observers.push(t),this.clearGcTimeout(),N(this,yt).notify({type:"observerAdded",query:this,observer:t}))}removeObserver(t){this.observers.includes(t)&&(this.observers=this.observers.filter(n=>n!==t),this.observers.length||(N(this,Ve)&&(N(this,wr)?N(this,Ve).cancel({revert:!0}):N(this,Ve).cancelRetry()),this.scheduleGc()),N(this,yt).notify({type:"observerRemoved",query:this,observer:t}))}getObserversCount(){return this.observers.length}invalidate(){this.state.isInvalidated||_e(this,It,rn).call(this,{type:"invalidate"})}fetch(t,n){var h,u,d;if(this.state.fetchStatus!=="idle"){if(this.state.data!==void 0&&(n!=null&&n.cancelRefetch))this.cancel({silent:!0});else if(N(this,Ve))return N(this,Ve).continueRetry(),N(this,Ve).promise}if(t&&this.setOptions(t),!this.options.queryFn){const p=this.observers.find(v=>v.options.queryFn);p&&this.setOptions(p.options)}const r=new AbortController,i=p=>{Object.defineProperty(p,"signal",{enumerable:!0,get:()=>(K(this,wr,!0),r.signal)})},a=()=>{const p=uv(this.options,n),x=(()=>{const y={client:N(this,br),queryKey:this.queryKey,meta:this.meta};return i(y),y})();return K(this,wr,!1),this.options.persister?this.options.persister(p,x,this):p(x)},c=(()=>{const p={fetchOptions:n,options:this.options,queryKey:this.queryKey,client:N(this,br),state:this.state,fetchFn:a};return i(p),p})();(h=this.options.behavior)==null||h.onFetch(c,this),K(this,vr,this.state),(this.state.fetchStatus==="idle"||this.state.fetchMeta!==((u=c.fetchOptions)==null?void 0:u.meta))&&_e(this,It,rn).call(this,{type:"fetch",meta:(d=c.fetchOptions)==null?void 0:d.meta});const l=p=>{var v,x,y,k;Kc(p)&&p.silent||_e(this,It,rn).call(this,{type:"error",error:p}),Kc(p)||((x=(v=N(this,yt).config).onError)==null||x.call(v,p,this),(k=(y=N(this,yt).config).onSettled)==null||k.call(y,this.state.data,p,this)),this.scheduleGc()};return K(this,Ve,mv({initialPromise:n==null?void 0:n.initialPromise,fn:c.fetchFn,abort:r.abort.bind(r),onSuccess:p=>{var v,x,y,k;if(p===void 0){l(new Error(`${this.queryHash} data is undefined`));return}try{this.setData(p)}catch(f){l(f);return}(x=(v=N(this,yt).config).onSuccess)==null||x.call(v,p,this),(k=(y=N(this,yt).config).onSettled)==null||k.call(y,p,this.state.error,this),this.scheduleGc()},onError:l,onFail:(p,v)=>{_e(this,It,rn).call(this,{type:"failed",failureCount:p,error:v})},onPause:()=>{_e(this,It,rn).call(this,{type:"pause"})},onContinue:()=>{_e(this,It,rn).call(this,{type:"continue"})},retry:c.options.retry,retryDelay:c.options.retryDelay,networkMode:c.options.networkMode,canRun:()=>!0})),N(this,Ve).start()}},mi=new WeakMap,vr=new WeakMap,yt=new WeakMap,br=new WeakMap,Ve=new WeakMap,Va=new WeakMap,wr=new WeakMap,It=new WeakSet,rn=function(t){const n=r=>{switch(t.type){case"failed":return{...r,fetchFailureCount:t.failureCount,fetchFailureReason:t.error};case"pause":return{...r,fetchStatus:"paused"};case"continue":return{...r,fetchStatus:"fetching"};case"fetch":return{...r,...XC(r.data,this.options),fetchMeta:t.meta??null};case"success":return K(this,vr,void 0),{...r,data:t.data,dataUpdateCount:r.dataUpdateCount+1,dataUpdatedAt:t.dataUpdatedAt??Date.now(),error:null,isInvalidated:!1,status:"success",...!t.manual&&{fetchStatus:"idle",fetchFailureCount:0,fetchFailureReason:null}};case"error":const i=t.error;return Kc(i)&&i.revert&&N(this,vr)?{...N(this,vr),fetchStatus:"idle"}:{...r,error:i,errorUpdateCount:r.errorUpdateCount+1,errorUpdatedAt:Date.now(),fetchFailureCount:r.fetchFailureCount+1,fetchFailureReason:i,fetchStatus:"idle",status:"error"};case"invalidate":return{...r,isInvalidated:!0};case"setState":return{...r,...t.state}}};this.state=n(this.state),Qe.batch(()=>{this.observers.forEach(r=>{r.onQueryUpdate()}),N(this,yt).notify({query:this,type:"updated",action:t})})},wg);function XC(e,t){return{fetchFailureCount:0,fetchFailureReason:null,fetchStatus:pv(t.networkMode)?"fetching":"paused",...e===void 0&&{error:null,status:"pending"}}}function JC(e){const t=typeof e.initialData=="function"?e.initialData():e.initialData,n=t!==void 0,r=n?typeof e.initialDataUpdatedAt=="function"?e.initialDataUpdatedAt():e.initialDataUpdatedAt:0;return{data:t,dataUpdateCount:0,dataUpdatedAt:n?r??Date.now():0,error:null,errorUpdateCount:0,errorUpdatedAt:0,fetchFailureCount:0,fetchFailureReason:null,fetchMeta:null,isInvalidated:!1,status:n?"success":"pending",fetchStatus:"idle"}}var Vt,xg,ZC=(xg=class extends ic{constructor(t={}){super();ie(this,Vt);this.config=t,K(this,Vt,new Map)}build(t,n,r){const i=n.queryKey,a=n.queryHash??Bu(i,n);let s=this.get(a);return s||(s=new YC({client:t,queryKey:i,queryHash:a,options:t.defaultQueryOptions(n),state:r,defaultOptions:t.getQueryDefaults(i)}),this.add(s)),s}add(t){N(this,Vt).has(t.queryHash)||(N(this,Vt).set(t.queryHash,t),this.notify({type:"added",query:t}))}remove(t){const n=N(this,Vt).get(t.queryHash);n&&(t.destroy(),n===t&&N(this,Vt).delete(t.queryHash),this.notify({type:"removed",query:t}))}clear(){Qe.batch(()=>{this.getAll().forEach(t=>{this.remove(t)})})}get(t){return N(this,Vt).get(t)}getAll(){return[...N(this,Vt).values()]}find(t){const n={exact:!0,...t};return this.getAll().find(r=>Op(n,r))}findAll(t={}){const n=this.getAll();return Object.keys(t).length>0?n.filter(r=>Op(t,r)):n}notify(t){Qe.batch(()=>{this.listeners.forEach(n=>{n(t)})})}onFocus(){Qe.batch(()=>{this.getAll().forEach(t=>{t.onFocus()})})}onOnline(){Qe.batch(()=>{this.getAll().forEach(t=>{t.onOnline()})})}},Vt=new WeakMap,xg),zt,$e,xr,Ht,Pn,kg,eS=(kg=class extends fv{constructor(t){super();ie(this,Ht);ie(this,zt);ie(this,$e);ie(this,xr);this.mutationId=t.mutationId,K(this,$e,t.mutationCache),K(this,zt,[]),this.state=t.state||tS(),this.setOptions(t.options),this.scheduleGc()}setOptions(t){this.options=t,this.updateGcTime(this.options.gcTime)}get meta(){return this.options.meta}addObserver(t){N(this,zt).includes(t)||(N(this,zt).push(t),this.clearGcTimeout(),N(this,$e).notify({type:"observerAdded",mutation:this,observer:t}))}removeObserver(t){K(this,zt,N(this,zt).filter(n=>n!==t)),this.scheduleGc(),N(this,$e).notify({type:"observerRemoved",mutation:this,observer:t})}optionalRemove(){N(this,zt).length||(this.state.status==="pending"?this.scheduleGc():N(this,$e).remove(this))}continue(){var t;return((t=N(this,xr))==null?void 0:t.continue())??this.execute(this.state.variables)}async execute(t){var a,s,c,l,h,u,d,p,v,x,y,k,f,g,b,w,T,C,P,S;const n=()=>{_e(this,Ht,Pn).call(this,{type:"continue"})};K(this,xr,mv({fn:()=>this.options.mutationFn?this.options.mutationFn(t):Promise.reject(new Error("No mutationFn found")),onFail:(I,j)=>{_e(this,Ht,Pn).call(this,{type:"failed",failureCount:I,error:j})},onPause:()=>{_e(this,Ht,Pn).call(this,{type:"pause"})},onContinue:n,retry:this.options.retry??0,retryDelay:this.options.retryDelay,networkMode:this.options.networkMode,canRun:()=>N(this,$e).canRun(this)}));const r=this.state.status==="pending",i=!N(this,xr).canStart();try{if(r)n();else{_e(this,Ht,Pn).call(this,{type:"pending",variables:t,isPaused:i}),await((s=(a=N(this,$e).config).onMutate)==null?void 0:s.call(a,t,this));const j=await((l=(c=this.options).onMutate)==null?void 0:l.call(c,t));j!==this.state.context&&_e(this,Ht,Pn).call(this,{type:"pending",context:j,variables:t,isPaused:i})}const I=await N(this,xr).start();return await((u=(h=N(this,$e).config).onSuccess)==null?void 0:u.call(h,I,t,this.state.context,this)),await((p=(d=this.options).onSuccess)==null?void 0:p.call(d,I,t,this.state.context)),await((x=(v=N(this,$e).config).onSettled)==null?void 0:x.call(v,I,null,this.state.variables,this.state.context,this)),await((k=(y=this.options).onSettled)==null?void 0:k.call(y,I,null,t,this.state.context)),_e(this,Ht,Pn).call(this,{type:"success",data:I}),I}catch(I){try{throw await((g=(f=N(this,$e).config).onError)==null?void 0:g.call(f,I,t,this.state.context,this)),await((w=(b=this.options).onError)==null?void 0:w.call(b,I,t,this.state.context)),await((C=(T=N(this,$e).config).onSettled)==null?void 0:C.call(T,void 0,I,this.state.variables,this.state.context,this)),await((S=(P=this.options).onSettled)==null?void 0:S.call(P,void 0,I,t,this.state.context)),I}finally{_e(this,Ht,Pn).call(this,{type:"error",error:I})}}finally{N(this,$e).runNext(this)}}},zt=new WeakMap,$e=new WeakMap,xr=new WeakMap,Ht=new WeakSet,Pn=function(t){const n=r=>{switch(t.type){case"failed":return{...r,failureCount:t.failureCount,failureReason:t.error};case"pause":return{...r,isPaused:!0};case"continue":return{...r,isPaused:!1};case"pending":return{...r,context:t.context,data:void 0,failureCount:0,failureReason:null,error:null,isPaused:t.isPaused,status:"pending",variables:t.variables,submittedAt:Date.now()};case"success":return{...r,data:t.data,failureCount:0,failureReason:null,error:null,status:"success",isPaused:!1};case"error":return{...r,data:void 0,error:t.error,failureCount:r.failureCount+1,failureReason:t.error,isPaused:!1,status:"error"}}};this.state=n(this.state),Qe.batch(()=>{N(this,zt).forEach(r=>{r.onMutationUpdate(t)}),N(this,$e).notify({mutation:this,type:"updated",action:t})})},kg);function tS(){return{context:void 0,data:void 0,error:null,failureCount:0,failureReason:null,isPaused:!1,status:"idle",variables:void 0,submittedAt:0}}var sn,Nt,za,Tg,nS=(Tg=class extends ic{constructor(t={}){super();ie(this,sn);ie(this,Nt);ie(this,za);this.config=t,K(this,sn,new Set),K(this,Nt,new Map),K(this,za,0)}build(t,n,r){const i=new eS({mutationCache:this,mutationId:++to(this,za)._,options:t.defaultMutationOptions(n),state:r});return this.add(i),i}add(t){N(this,sn).add(t);const n=ko(t);if(typeof n=="string"){const r=N(this,Nt).get(n);r?r.push(t):N(this,Nt).set(n,[t])}this.notify({type:"added",mutation:t})}remove(t){if(N(this,sn).delete(t)){const n=ko(t);if(typeof n=="string"){const r=N(this,Nt).get(n);if(r)if(r.length>1){const i=r.indexOf(t);i!==-1&&r.splice(i,1)}else r[0]===t&&N(this,Nt).delete(n)}}this.notify({type:"removed",mutation:t})}canRun(t){const n=ko(t);if(typeof n=="string"){const r=N(this,Nt).get(n),i=r==null?void 0:r.find(a=>a.state.status==="pending");return!i||i===t}else return!0}runNext(t){var r;const n=ko(t);if(typeof n=="string"){const i=(r=N(this,Nt).get(n))==null?void 0:r.find(a=>a!==t&&a.state.isPaused);return(i==null?void 0:i.continue())??Promise.resolve()}else return Promise.resolve()}clear(){Qe.batch(()=>{N(this,sn).forEach(t=>{this.notify({type:"removed",mutation:t})}),N(this,sn).clear(),N(this,Nt).clear()})}getAll(){return Array.from(N(this,sn))}find(t){const n={exact:!0,...t};return this.getAll().find(r=>Up(n,r))}findAll(t={}){return this.getAll().filter(n=>Up(t,n))}notify(t){Qe.batch(()=>{this.listeners.forEach(n=>{n(t)})})}resumePausedMutations(){const t=this.getAll().filter(n=>n.state.isPaused);return Qe.batch(()=>Promise.all(t.map(n=>n.continue().catch(At))))}},sn=new WeakMap,Nt=new WeakMap,za=new WeakMap,Tg);function ko(e){var t;return(t=e.options.scope)==null?void 0:t.id}function Bp(e){return{onFetch:(t,n)=>{var u,d,p,v,x;const r=t.options,i=(p=(d=(u=t.fetchOptions)==null?void 0:u.meta)==null?void 0:d.fetchMore)==null?void 0:p.direction,a=((v=t.state.data)==null?void 0:v.pages)||[],s=((x=t.state.data)==null?void 0:x.pageParams)||[];let c={pages:[],pageParams:[]},l=0;const h=async()=>{let y=!1;const k=b=>{Object.defineProperty(b,"signal",{enumerable:!0,get:()=>(t.signal.aborted?y=!0:t.signal.addEventListener("abort",()=>{y=!0}),t.signal)})},f=uv(t.options,t.fetchOptions),g=async(b,w,T)=>{if(y)return Promise.reject();if(w==null&&b.pages.length)return Promise.resolve(b);const P=(()=>{const q={client:t.client,queryKey:t.queryKey,pageParam:w,direction:T?"backward":"forward",meta:t.options.meta};return k(q),q})(),S=await f(P),{maxPages:I}=t.options,j=T?zC:VC;return{pages:j(b.pages,S,I),pageParams:j(b.pageParams,w,I)}};if(i&&a.length){const b=i==="backward",w=b?rS:Vp,T={pages:a,pageParams:s},C=w(r,T);c=await g(T,C,b)}else{const b=e??a.length;do{const w=l===0?s[0]??r.initialPageParam:Vp(r,c);if(l>0&&w==null)break;c=await g(c,w),l++}while(l<b)}return c};t.options.persister?t.fetchFn=()=>{var y,k;return(k=(y=t.options).persister)==null?void 0:k.call(y,h,{client:t.client,queryKey:t.queryKey,meta:t.options.meta,signal:t.signal},n)}:t.fetchFn=h}}}function Vp(e,{pages:t,pageParams:n}){const r=t.length-1;return t.length>0?e.getNextPageParam(t[r],t,n[r],n):void 0}function rS(e,{pages:t,pageParams:n}){var r;return t.length>0?(r=e.getPreviousPageParam)==null?void 0:r.call(e,t[0],t,n[0],n):void 0}var ve,Dn,Mn,fi,yi,qn,vi,bi,Cg,iS=(Cg=class{constructor(e={}){ie(this,ve);ie(this,Dn);ie(this,Mn);ie(this,fi);ie(this,yi);ie(this,qn);ie(this,vi);ie(this,bi);K(this,ve,e.queryCache||new ZC),K(this,Dn,e.mutationCache||new nS),K(this,Mn,e.defaultOptions||{}),K(this,fi,new Map),K(this,yi,new Map),K(this,qn,0)}mount(){to(this,qn)._++,N(this,qn)===1&&(K(this,vi,dv.subscribe(async e=>{e&&(await this.resumePausedMutations(),N(this,ve).onFocus())})),K(this,bi,As.subscribe(async e=>{e&&(await this.resumePausedMutations(),N(this,ve).onOnline())})))}unmount(){var e,t;to(this,qn)._--,N(this,qn)===0&&((e=N(this,vi))==null||e.call(this),K(this,vi,void 0),(t=N(this,bi))==null||t.call(this),K(this,bi,void 0))}isFetching(e){return N(this,ve).findAll({...e,fetchStatus:"fetching"}).length}isMutating(e){return N(this,Dn).findAll({...e,status:"pending"}).length}getQueryData(e){var n;const t=this.defaultQueryOptions({queryKey:e});return(n=N(this,ve).get(t.queryHash))==null?void 0:n.state.data}ensureQueryData(e){const t=this.defaultQueryOptions(e),n=N(this,ve).build(this,t),r=n.state.data;return r===void 0?this.fetchQuery(e):(e.revalidateIfStale&&n.isStaleByTime(wh(t.staleTime,n))&&this.prefetchQuery(t),Promise.resolve(r))}getQueriesData(e){return N(this,ve).findAll(e).map(({queryKey:t,state:n})=>{const r=n.data;return[t,r]})}setQueryData(e,t,n){const r=this.defaultQueryOptions({queryKey:e}),i=N(this,ve).get(r.queryHash),a=i==null?void 0:i.state.data,s=qC(t,a);if(s!==void 0)return N(this,ve).build(this,r).setData(s,{...n,manual:!0})}setQueriesData(e,t,n){return Qe.batch(()=>N(this,ve).findAll(e).map(({queryKey:r})=>[r,this.setQueryData(r,t,n)]))}getQueryState(e){var n;const t=this.defaultQueryOptions({queryKey:e});return(n=N(this,ve).get(t.queryHash))==null?void 0:n.state}removeQueries(e){const t=N(this,ve);Qe.batch(()=>{t.findAll(e).forEach(n=>{t.remove(n)})})}resetQueries(e,t){const n=N(this,ve);return Qe.batch(()=>(n.findAll(e).forEach(r=>{r.reset()}),this.refetchQueries({type:"active",...e},t)))}cancelQueries(e,t={}){const n={revert:!0,...t},r=Qe.batch(()=>N(this,ve).findAll(e).map(i=>i.cancel(n)));return Promise.all(r).then(At).catch(At)}invalidateQueries(e,t={}){return Qe.batch(()=>(N(this,ve).findAll(e).forEach(n=>{n.invalidate()}),(e==null?void 0:e.refetchType)==="none"?Promise.resolve():this.refetchQueries({...e,type:(e==null?void 0:e.refetchType)??(e==null?void 0:e.type)??"active"},t)))}refetchQueries(e,t={}){const n={...t,cancelRefetch:t.cancelRefetch??!0},r=Qe.batch(()=>N(this,ve).findAll(e).filter(i=>!i.isDisabled()&&!i.isStatic()).map(i=>{let a=i.fetch(void 0,n);return n.throwOnError||(a=a.catch(At)),i.state.fetchStatus==="paused"?Promise.resolve():a}));return Promise.all(r).then(At)}fetchQuery(e){const t=this.defaultQueryOptions(e);t.retry===void 0&&(t.retry=!1);const n=N(this,ve).build(this,t);return n.isStaleByTime(wh(t.staleTime,n))?n.fetch(t):Promise.resolve(n.state.data)}prefetchQuery(e){return this.fetchQuery(e).then(At).catch(At)}fetchInfiniteQuery(e){return e.behavior=Bp(e.pages),this.fetchQuery(e)}prefetchInfiniteQuery(e){return this.fetchInfiniteQuery(e).then(At).catch(At)}ensureInfiniteQueryData(e){return e.behavior=Bp(e.pages),this.ensureQueryData(e)}resumePausedMutations(){return As.isOnline()?N(this,Dn).resumePausedMutations():Promise.resolve()}getQueryCache(){return N(this,ve)}getMutationCache(){return N(this,Dn)}getDefaultOptions(){return N(this,Mn)}setDefaultOptions(e){K(this,Mn,e)}setQueryDefaults(e,t){N(this,fi).set(Fa(e),{queryKey:e,defaultOptions:t})}getQueryDefaults(e){const t=[...N(this,fi).values()],n={};return t.forEach(r=>{Ba(e,r.queryKey)&&Object.assign(n,r.defaultOptions)}),n}setMutationDefaults(e,t){N(this,yi).set(Fa(e),{mutationKey:e,defaultOptions:t})}getMutationDefaults(e){const t=[...N(this,yi).values()],n={};return t.forEach(r=>{Ba(e,r.mutationKey)&&Object.assign(n,r.defaultOptions)}),n}defaultQueryOptions(e){if(e._defaulted)return e;const t={...N(this,Mn).queries,...this.getQueryDefaults(e.queryKey),...e,_defaulted:!0};return t.queryHash||(t.queryHash=Bu(t.queryKey,t)),t.refetchOnReconnect===void 0&&(t.refetchOnReconnect=t.networkMode!=="always"),t.throwOnError===void 0&&(t.throwOnError=!!t.suspense),!t.networkMode&&t.persister&&(t.networkMode="offlineFirst"),t.queryFn===Vu&&(t.enabled=!1),t}defaultMutationOptions(e){return e!=null&&e._defaulted?e:{...N(this,Mn).mutations,...(e==null?void 0:e.mutationKey)&&this.getMutationDefaults(e.mutationKey),...e,_defaulted:!0}}clear(){N(this,ve).clear(),N(this,Dn).clear()}},ve=new WeakMap,Dn=new WeakMap,Mn=new WeakMap,fi=new WeakMap,yi=new WeakMap,qn=new WeakMap,vi=new WeakMap,bi=new WeakMap,Cg),aS=m.createContext(void 0),oS=({client:e,children:t})=>(m.useEffect(()=>(e.mount(),()=>{e.unmount()}),[e]),o.jsx(aS.Provider,{value:e,children:t}));const zp="haiit-preferred-effect",sS=["none","christmas","tet","parallax"],cS=7,lS=e=>e!==null&&sS.includes(e),Pe=e=>Math.floor(e),yv=e=>{var n,r,i;const t=new Intl.DateTimeFormat("en-CA",{timeZone:"Asia/Ho_Chi_Minh",year:"numeric",month:"numeric",day:"numeric"}).formatToParts(e);return{year:Number(((n=t.find(a=>a.type==="year"))==null?void 0:n.value)??0),month:Number(((r=t.find(a=>a.type==="month"))==null?void 0:r.value)??0),day:Number(((i=t.find(a=>a.type==="day"))==null?void 0:i.value)??0)}},vv=(e,t,n)=>{const r=Pe((14-t)/12),i=n+4800-r,a=t+12*r-3;return n>1582||n===1582&&(t>10||t===10&&e>=15)?e+Pe((153*a+2)/5)+365*i+Pe(i/4)-Pe(i/100)+Pe(i/400)-32045:e+Pe((153*a+2)/5)+365*i+Pe(i/4)-32083},ji=e=>{const t=e/1236.85,n=t*t,r=n*t,i=r*t,a=Math.PI/180;let s=241502075933e-5+29.53058868*e+1178e-7*n-155e-9*r;s+=33e-5*Math.sin((166.56+132.87*t-.009173*n)*a);const c=359.2242+29.10535608*e-333e-7*n-347e-8*r,l=306.0253+385.81691806*e+.0107306*n+1236e-8*r-58e-9*i,h=21.2964+390.67050646*e-.0016528*n-239e-8*r+2e-8*i,u=(.1734-393e-6*t)*Math.sin(c*a)+.0021*Math.sin(2*a*c)-.4068*Math.sin(l*a)+.0161*Math.sin(2*a*l)-4e-4*Math.sin(3*a*l)+.0104*Math.sin(2*a*h)-.0051*Math.sin((c+l)*a)-.0074*Math.sin((c-l)*a)+4e-4*Math.sin((2*h+c)*a)-4e-4*Math.sin((2*h-c)*a)-6e-4*Math.sin((2*h+l)*a)+.001*Math.sin((2*h-l)*a)+5e-4*Math.sin((2*l+c)*a);let d;return t<-11?d=.001+839e-6*t+2261e-7*n-845e-8*r-81e-9*i:d=-278e-6+265e-6*t+262e-6*n,s+u-d},kh=(e,t)=>{const n=(e-24515455e-1-t/24)/36525,r=n*n,i=Math.PI/180,a=357.5291+35999.0503*n-1559e-7*r-48e-8*r*n,s=280.46645+36000.76983*n+3032e-7*r,c=(1.9146-.004817*n-14e-6*r)*Math.sin(i*a)+(.019993-101e-6*n)*Math.sin(2*i*a)+29e-5*Math.sin(3*i*a),l=(s+c)*i;return Pe((l-2*Math.PI*Pe(l/(2*Math.PI)))/Math.PI*6)},Qc=(e,t)=>{const n=vv(31,12,e)-2415021,r=Pe(n/29.530588853);let i=ji(r);return kh(Pe(i+.5+t/24),t)>=9&&(i=ji(r-1)),Pe(i+.5+t/24)},hS=(e,t)=>{const n=Pe(.5+(e-2415021076998695e-9)/29.530588853);let r=0,i=1,a=kh(Pe(ji(n+i)+.5+t/24),t);do r=a,i+=1,a=kh(Pe(ji(n+i)+.5+t/24),t);while(a!==r&&i<14);return i-1},uS=(e,t,n,r)=>{const i=vv(e,t,n),a=Pe((i-2415021076998695e-9)/29.530588853);let s=Pe(ji(a+1)+.5+r/24);s>i&&(s=Pe(ji(a)+.5+r/24));let c=Qc(n,r),l=c,h;c>=s?(h=n,c=Qc(n-1,r)):(h=n+1,l=Qc(n+1,r));const u=i-s+1,d=Pe((s-c)/29);let p=0,v=d+11;if(l-c>365){const x=hS(c,r);d>=x&&(v=d+10,d===x&&(p=1))}return v>12&&(v-=12),v>=11&&d<4&&(h-=1),{day:u,month:v,year:h,leap:p}},dS=e=>{const{day:t,month:n,year:r}=yv(e);return uS(t,n,r,cS)},pS=e=>{const t=yv(e);if(t.month===12&&t.day>=24&&t.day<=26)return"christmas";if(t.day===t.month)return"parallax";const n=dS(e);return n.month===1&&n.day>=1&&n.day<=5||n.month===12&&n.day>=29&&n.day<=30?"tet":"none"},bv=m.createContext(void 0),gS=({children:e})=>{const[t,n]=m.useState(()=>{const i=localStorage.getItem(zp);return lS(i)?i:pS(new Date)}),r=i=>{n(i),localStorage.setItem(zp,i)};return o.jsx(bv.Provider,{value:{currentEffect:t,setCurrentEffect:r},children:e})},wv=()=>{const e=m.useContext(bv);if(!e)throw new Error("useEffects must be used within an EffectsProvider");return e},mS=Au("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",{variants:{variant:{default:"bg-primary text-primary-foreground hover:bg-primary/90",destructive:"bg-destructive text-destructive-foreground hover:bg-destructive/90",outline:"border border-input bg-background hover:bg-accent hover:text-accent-foreground",secondary:"bg-secondary text-secondary-foreground hover:bg-secondary/80",ghost:"hover:bg-accent hover:text-accent-foreground",link:"text-primary underline-offset-4 hover:underline"},size:{default:"h-10 px-4 py-2",sm:"h-9 rounded-md px-3",lg:"h-11 rounded-md px-8",icon:"h-10 w-10"}},defaultVariants:{variant:"default",size:"default"}}),ne=m.forwardRef(({className:e,variant:t,size:n,asChild:r=!1,...i},a)=>{const s=r?Mk:"button";return o.jsx(s,{className:mt(mS({variant:t,size:n,className:e})),ref:a,...i})});ne.displayName="Button";const fS={"nav.home":{vi:"Trang chủ",en:"Index"},"nav.projects":{vi:"Dự án",en:"Work"},"nav.blog":{vi:"Bài viết",en:"Notes"},"nav.about":{vi:"Hồ sơ",en:"Profile"},"nav.contact":{vi:"Liên hệ",en:"Contact"},"nav.connect":{vi:"Sẵn sàng kết nối",en:"Available to connect"},"nav.theme":{vi:"Giao diện",en:"Theme"},"nav.language":{vi:"Ngôn ngữ",en:"Language"},"hero.log":{vi:"Portfolio / Nhật ký học tập",en:"Portfolio / Learning log"},"hero.open":{vi:"Sẵn sàng cho cơ hội phù hợp",en:"Open to meaningful work"},"hero.hello":{vi:"Xin chào, tôi là",en:"Hello, I am"},"hero.line1":{vi:"Chế tác mã nguồn",en:"Crafting code"},"hero.line2":{vi:"& đúc kết những",en:"& distilling field"},"hero.line3":{vi:"trải nghiệm thực tế.",en:"experiences."},"hero.bio":{vi:"một Information Systems Developer tập trung vào backend, database và những sản phẩm có giá trị sử dụng thực tế.",en:"an Information Systems Developer focused on backend, databases, and products with practical value."},"hero.work":{vi:"Khám phá dự án",en:"Explore selected work"},"hero.notes":{vi:"Đọc bài viết",en:"Read my notes"},"hero.repositories":{vi:"kho mã nguồn",en:"repositories"},"hero.languages":{vi:"ngôn ngữ",en:"languages"},"hero.journal":{vi:"nhật ký công khai",en:"public journal"},"hero.portrait":{vi:"Chân dung",en:"Portrait"},"home.work.eyebrow":{vi:"01 / Dự án chọn lọc",en:"01 / Selected work"},"home.work.title1":{vi:"Dự án có lý do",en:"Projects with a reason"},"home.work.title2":{vi:"để tồn tại.",en:"to exist."},"home.work.desc":{vi:"Mỗi dự án là một bài thực hành có chủ đích: dữ liệu, thuật toán, kiến trúc hoặc trải nghiệm người dùng.",en:"Each project is a deliberate exercise in data, algorithms, architecture, or user experience."},"home.work.archive":{vi:"Xem kho dự án",en:"View project archive"},"home.work.case":{vi:"Nghiên cứu",en:"Case study"},"home.work.tools":{vi:"Công cụ & bối cảnh",en:"Tools & context"},"home.notes.eyebrow":{vi:"02 / Ghi chép thực tế",en:"02 / Field notes"},"home.notes.title1":{vi:"Học tập công khai.",en:"Learn in public."},"home.notes.title2":{vi:"Giữ lại điều hữu ích.",en:"Keep the useful parts."},"home.notes.all":{vi:"Mở tất cả bài viết",en:"Open all notes"},"home.notes.read":{vi:"Đọc bài",en:"Read note"},"home.map.eyebrow":{vi:"03 / Bản đồ kiến thức",en:"03 / Knowledge map"},"home.map.title1":{vi:"Những điều tôi đang",en:"What I am"},"home.map.title2":{vi:"khám phá.",en:"mapping out."},"home.map.desc":{vi:"Không chỉ là danh mục. Đây là bản đồ những vùng kiến thức tôi đang học, thử nghiệm và kết nối lại với nhau.",en:"More than categories: a map of the knowledge areas I am learning, testing, and connecting."},"home.principle":{vi:"Nguyên tắc cá nhân",en:"Personal principle"},"home.quote":{vi:"“Tôi không cố tỏ ra biết mọi thứ. Tôi xây, ghi chép và biến những điều đã hiểu thành thứ hữu ích cho người tiếp theo.”",en:"“I do not pretend to know everything. I build, document, and turn what I understand into something useful for the next person.”"},"footer.eyebrow":{vi:"Cuối trang / đầu cuộc trò chuyện",en:"End of page / start of conversation"},"footer.title":{vi:"Tôi xây sản phẩm để hiểu hệ thống, rồi viết lại để hiểu sâu hơn.",en:"I build products to understand systems, then write to understand them deeper."},"footer.navigate":{vi:"Điều hướng",en:"Navigate"},"footer.connect":{vi:"Kết nối",en:"Connect"},"footer.work":{vi:"Dự án chọn lọc",en:"Selected work"},"footer.notes":{vi:"Ghi chép học tập",en:"Learning notes"},"footer.profile":{vi:"Hồ sơ & CV",en:"Profile & CV"},"footer.contact":{vi:"Liên hệ",en:"Contact"},"footer.feedback":{vi:"Gửi phản hồi",en:"Send feedback"},"footer.designed":{vi:"Được thiết kế như một nhật ký hệ thống sống",en:"Designed as a living systems journal"},"blog.title":{vi:"Bài viết",en:"Blog"},"blog.desc":{vi:"Kiến thức lập trình, kinh nghiệm thực tế và những bài học từ hành trình phát triển phần mềm.",en:"Programming knowledge, practical experience, and lessons from my software development journey."},"blog.search":{vi:"Tìm kiếm bài viết...",en:"Search articles..."},"blog.all":{vi:"Tất cả",en:"All"},"blog.filterCategory":{vi:"Danh mục",en:"Categories"},"blog.filterTag":{vi:"Thẻ nội dung",en:"Content tags"},"blog.allTags":{vi:"Tất cả thẻ",en:"All tags"},"blog.selectedTags":{vi:"thẻ đã chọn",en:"selected"},"blog.clearFilters":{vi:"Xóa bộ lọc",en:"Clear filters"},"blog.readMore":{vi:"Đọc thêm →",en:"Read more →"},"blog.empty":{vi:"Không tìm thấy bài viết",en:"No articles found"},"blog.emptyDesc":{vi:"Thử thay đổi bộ lọc hoặc từ khóa tìm kiếm.",en:"Try changing the filter or search keyword."},"project.title":{vi:"Dự án",en:"Projects"},"project.desc":{vi:"Các dự án cá nhân từ GitHub của tôi, từ ý tưởng đến sản phẩm hoàn chỉnh.",en:"My personal GitHub projects, from early ideas to finished products."},"project.github":{vi:"Xem thêm trên GitHub",en:"View more on GitHub"},"project.featured":{vi:"Dự án nổi bật",en:"Featured projects"},"project.all":{vi:"Tất cả dự án",en:"All projects"},"project.source":{vi:"Mã nguồn",en:"Source code"},"project.demo":{vi:"Bản chạy thử",en:"Live demo"},"post.back":{vi:"Quay lại Blog",en:"Back to Blog"},"post.notFound":{vi:"Bài viết không tồn tại",en:"Article not found"},"post.notFoundDesc":{vi:"Bài viết bạn đang tìm không tồn tại hoặc đã bị xóa.",en:"The article you are looking for does not exist or has been removed."},"post.views":{vi:"lượt xem",en:"views"},"post.tags":{vi:"Thẻ",en:"Tags"},"post.share":{vi:"Chia sẻ",en:"Share"},"post.copy":{vi:"Sao chép liên kết",en:"Copy link"},"post.sourceNote":{vi:"Ghi chú: Bài viết được tổng hợp từ quá trình học, thực hành và tham khảo nhiều nguồn tài liệu khác nhau.",en:"Note: This article is distilled from my learning, hands-on practice, and references across multiple sources."},"category.languages":{vi:"Ngôn ngữ lập trình",en:"Programming Languages"},"category.frameworks":{vi:"Framework & thư viện",en:"Frameworks & Libraries"},"category.architecture":{vi:"Kiến trúc phần mềm",en:"Software Architecture"},"category.patterns":{vi:"Mẫu thiết kế",en:"Design Patterns"},"category.practices":{vi:"Thực hành tốt",en:"Best Practices"},"category.roadmap":{vi:"Lộ trình học tập",en:"Learning Roadmaps"},"about.cv":{vi:"Xem CV của tôi",en:"View my CV"},"about.me":{vi:"Về tôi",en:"About me"},"about.experience":{vi:"Kinh nghiệm",en:"Experience"},"about.contact":{vi:"Liên hệ",en:"Contact"},"about.collab":{vi:"Muốn hợp tác?",en:"Interested in collaborating?"},"about.collabDesc":{vi:"Tôi luôn sẵn sàng thảo luận về các dự án thú vị.",en:"I am always open to discussing interesting projects."},"about.contactNow":{vi:"Liên hệ ngay",en:"Get in touch"},"about.download":{vi:"Tải PDF",en:"Download PDF"},"about.skills":{vi:"Kỹ năng kỹ thuật",en:"Technical skills"},"about.featured":{vi:"Dự án tiêu biểu (từ GitHub)",en:"Featured projects (from GitHub)"},"about.other":{vi:"Hoạt động khác",en:"Other activities"},"effect.title":{vi:"Hiệu ứng nền",en:"Background effects"}},xv=m.createContext(void 0),yS=({children:e})=>{const[t,n]=m.useState(()=>{const i=localStorage.getItem("haiit-language");return i==="vi"||i==="en"?i:navigator.language.toLowerCase().startsWith("vi")?"vi":"en"});m.useEffect(()=>{localStorage.setItem("haiit-language",t),document.documentElement.lang=t},[t]);const r=i=>{var a;return((a=fS[i])==null?void 0:a[t])??i};return o.jsx(xv.Provider,{value:{language:t,setLanguage:n,toggleLanguage:()=>n(t==="vi"?"en":"vi"),t:r,locale:t==="vi"?"vi-VN":"en-US"},children:e})},Le=()=>{const e=m.useContext(xv);if(!e)throw new Error("useLanguage must be used within LanguageProvider");return e},Yc=["none","parallax","tet","christmas"],vS=()=>{const{currentEffect:e,setCurrentEffect:t}=wv(),{language:n}=Le(),r=Yc.indexOf(e),i=Yc[(r+1)%Yc.length],a=n==="vi"?{none:"Tắt",parallax:"3D",tet:"Tết",christmas:"Giáng sinh"}:{none:"Off",parallax:"3D",tet:"Lunar New Year",christmas:"Christmas"},c={none:Ys,parallax:D0,tet:H0,christmas:c1}[e],l=`${a[e]} → ${a[i]}`;return o.jsxs(cv,{children:[o.jsx(lv,{asChild:!0,children:o.jsx(ne,{variant:"outline",size:"icon",className:`effect-cycle fixed bottom-4 right-4 z-[60] h-12 w-12 rounded-full shadow-xl backdrop-blur-xl ${e==="none"?"bg-background/85":"border-primary/50 bg-primary/15 text-primary"}`,"aria-label":l,onClick:()=>t(i),children:o.jsx(c,{className:"h-4 w-4"})})}),o.jsx(Fu,{side:"left",className:"font-mono text-xs uppercase tracking-[.12em]",children:l})]})},bS=()=>{const e=m.useRef(null),t=m.useRef([]),n=m.useRef();return m.useEffect(()=>{const r=e.current;if(!r)return;const i=r.getContext("2d");if(!i)return;let a=window.innerWidth,s=window.innerHeight,c=performance.now()+5e3+Math.random()*5e3,l=0;const h=()=>{const v=Math.min(190,Math.floor(a/6));t.current=Array.from({length:v},(x,y)=>{const k=Math.random();return{x:Math.random()*a,y:Math.random()*s,depth:k,size:.7+k*2.5,speed:.3+k*1.1,opacity:.12+k*.36,swing:Math.random()*Math.PI*2,swingSpeed:Math.random()*.018+.006,blur:(1-k)*1.8,rotation:Math.random()*Math.PI,rotationSpeed:(Math.random()-.5)*.012,crystal:y%17===0}})},u=()=>{const v=Math.min(window.devicePixelRatio||1,2);a=window.innerWidth,s=window.innerHeight,r.width=a*v,r.height=s*v,r.style.width=`${a}px`,r.style.height=`${s}px`,i.setTransform(v,0,0,v,0,0),h()},d=v=>{i.save(),i.translate(v.x,v.y),i.rotate(v.rotation),i.strokeStyle=`rgba(235, 249, 255, ${v.opacity*.72})`,i.lineWidth=.45;for(let x=0;x<6;x+=1)i.rotate(Math.PI/3),i.beginPath(),i.moveTo(0,0),i.lineTo(0,-v.size*2.4),i.moveTo(0,-v.size*1.3),i.lineTo(v.size*.65,-v.size*1.8),i.moveTo(0,-v.size*1.3),i.lineTo(-v.size*.65,-v.size*1.8),i.stroke();i.restore()};u(),window.addEventListener("resize",u);const p=v=>{if(i.clearRect(0,0,a,s),v>c){const x=v-c;l=x<3500?Math.sin(x/3500*Math.PI)*3.2:0,x>=3500&&(c=v+9e3+Math.random()*9e3)}t.current.forEach(x=>{x.y+=x.speed+l*.08,x.swing+=x.swingSpeed,x.rotation+=x.rotationSpeed,x.x+=Math.sin(x.swing)*(.18+x.depth*.35)+l*(.25+x.depth*.75),x.y>s+12&&(x.y=-12,x.x=Math.random()*a),x.x>a+15&&(x.x=-15),i.shadowBlur=x.blur*5,i.shadowColor="rgba(180, 225, 255, .55)",x.crystal?d(x):(i.beginPath(),i.ellipse(x.x,x.y,x.size*(1+l*.08),x.size,0,0,Math.PI*2),i.fillStyle=`rgba(240, 250, 255, ${x.opacity})`,i.fill()),i.shadowBlur=0}),n.current=requestAnimationFrame(p)};return n.current=requestAnimationFrame(p),()=>{window.removeEventListener("resize",u),n.current&&cancelAnimationFrame(n.current)}},[]),o.jsx("canvas",{ref:e,className:"absolute inset-0 pointer-events-none z-30 opacity-[.72]"})},wS=Array.from({length:18},(e,t)=>{const n=t/17,r=Math.sin(n*Math.PI)*2.5;return{x:`${4+n*92}%`,y:`${8+r}px`,delay:`${t*-.16}s`,hue:35+t*18}}),xS=Array.from({length:42}),kS=Array.from({length:9}),TS=Array.from({length:5}),CS=Array.from({length:18}),SS=Array.from({length:6}),Hp=Array.from({length:14}),Gp=({side:e})=>o.jsxs("div",{className:`christmas-sprig christmas-sprig-${e}`,children:[o.jsx("span",{className:"sprig-stem"}),kS.map((t,n)=>o.jsx("i",{style:{"--i":n}},n)),TS.map((t,n)=>o.jsx("b",{style:{"--i":n}},n))]}),PS=()=>o.jsxs("div",{className:"effect-scene effect-scene-christmas fixed inset-0 z-0 overflow-hidden",children:[o.jsx("div",{className:"christmas-frost"}),o.jsx("div",{className:"christmas-bokeh",children:CS.map((e,t)=>o.jsx("i",{style:{"--i":t}},t))}),o.jsx("div",{className:"nordic-stars",children:xS.map((e,t)=>o.jsx("i",{style:{"--i":t}},t))}),o.jsx("div",{className:"nordic-aurora nordic-aurora-a"}),o.jsx("div",{className:"nordic-aurora nordic-aurora-b"}),o.jsx("div",{className:"nordic-aurora nordic-aurora-c"}),o.jsx("div",{className:"christmas-snowflake-halo"}),o.jsx("div",{className:"christmas-hero-snowflake",children:SS.map((e,t)=>o.jsxs("i",{style:{"--i":t},children:[o.jsx("span",{}),o.jsx("b",{})]},t))}),o.jsx("div",{className:"christmas-wind christmas-wind-a",children:Hp.map((e,t)=>o.jsx("i",{style:{"--i":t}},t))}),o.jsx("div",{className:"christmas-wind christmas-wind-b",children:Hp.slice(0,9).map((e,t)=>o.jsx("i",{style:{"--i":t}},t))}),o.jsxs("div",{className:"christmas-top-garland",children:[o.jsx(Gp,{side:"left"}),o.jsx(Gp,{side:"right"}),o.jsx("div",{className:"garland-bauble garland-bauble-a",children:o.jsx("i",{})}),o.jsx("div",{className:"garland-bauble garland-bauble-b",children:o.jsx("i",{})}),o.jsx("div",{className:"garland-bauble garland-bauble-c",children:o.jsx("i",{})})]}),o.jsxs("div",{className:"christmas-wreath",children:[o.jsx("div",{className:"wreath-bow"}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{})]}),o.jsxs("div",{className:"christmas-corner-gift",children:[o.jsx("i",{}),o.jsx("span",{})]}),o.jsx("div",{className:"christmas-candy-cane"}),o.jsx("div",{className:"nordic-pines nordic-pines-back",children:Array.from({length:9},(e,t)=>o.jsx("i",{style:{"--i":t}},t))}),o.jsx("div",{className:"nordic-pines nordic-pines-front",children:Array.from({length:7},(e,t)=>o.jsx("i",{style:{"--i":t}},t))}),o.jsx("div",{className:"christmas-light-drift",children:wS.map(e=>o.jsx("i",{style:{left:e.x,top:e.y,"--bulb":`hsl(${e.hue} 88% 64%)`,animationDelay:e.delay}},e.x))}),o.jsx("div",{className:"winter-ground"}),o.jsx(bS,{}),o.jsx("div",{className:"effect-label left-5 top-24",children:"CHRISTMAS EVE / WINTER GLOW"})]}),AS=()=>{const e=m.useRef(null);return m.useEffect(()=>{const t=e.current,n=t==null?void 0:t.getContext("2d");if(!t||!n)return;let r=0,i=0,a=[],s=[];const c=()=>{t.width=window.innerWidth*devicePixelRatio,t.height=window.innerHeight*devicePixelRatio,t.style.width=`${window.innerWidth}px`,t.style.height=`${window.innerHeight}px`,n.setTransform(devicePixelRatio,0,0,devicePixelRatio,0,0),a=Array.from({length:Math.min(52,Math.floor(window.innerWidth/24))},(u,d)=>({x:d%2?Math.random()*window.innerWidth*.22:window.innerWidth*(.78+Math.random()*.22),y:Math.random()*window.innerHeight,size:Math.random()*5+2,speed:Math.random()*.6+.25,sway:Math.random()*8,rotation:Math.random()*Math.PI,rotationSpeed:(Math.random()-.5)*.025,opacity:Math.random()*.5+.3}))},l=()=>{const u=Math.random()>.5?window.innerWidth*.12:window.innerWidth*.88,d=window.innerHeight*(.1+Math.random()*.16),p=Math.random()>.5?"#ffd36a":"#ff7b69";s.push(...Array.from({length:28},(v,x)=>({x:u,y:d,angle:x/28*Math.PI*2,radius:0,speed:Math.random()*1.3+.7,alpha:.75,color:p})))},h=()=>{n.clearRect(0,0,window.innerWidth,window.innerHeight),i+=1,i%210===0&&l(),s=s.filter(u=>u.alpha>.01),s.forEach(u=>{u.radius+=u.speed,u.alpha*=.985;const d=u.x+Math.cos(u.angle)*u.radius,p=u.y+Math.sin(u.angle)*u.radius+u.radius*.08;n.beginPath(),n.arc(d,p,1.2,0,Math.PI*2),n.fillStyle=u.color,n.globalAlpha=u.alpha,n.fill()}),a.forEach(u=>{u.y+=u.speed,u.x+=Math.sin(u.y*.012+u.sway)*.38,u.rotation+=u.rotationSpeed,u.y>window.innerHeight+20&&(u.y=-20,u.x=Math.random()>.5?Math.random()*window.innerWidth*.22:window.innerWidth*(.78+Math.random()*.22)),n.save(),n.translate(u.x,u.y),n.rotate(u.rotation),n.globalAlpha=u.opacity;const d=n.createLinearGradient(0,-u.size,0,u.size);d.addColorStop(0,"#fff0a8"),d.addColorStop(.45,"#ffbf5a"),d.addColorStop(1,"#e85a55"),n.fillStyle=d,n.beginPath(),n.ellipse(0,0,u.size*.5,u.size,0,0,Math.PI*2),n.fill(),n.restore()}),n.globalAlpha=1,r=requestAnimationFrame(h)};return c(),l(),h(),window.addEventListener("resize",c),()=>{cancelAnimationFrame(r),window.removeEventListener("resize",c)}},[]),o.jsxs("div",{className:"effect-scene effect-scene-tet fixed inset-0 z-0 overflow-hidden",children:[o.jsx("div",{className:"tet-vietnam-frame"}),o.jsxs("div",{className:"tet-corner tet-corner-dao",children:[o.jsx("div",{className:"tet-border-branch",children:Array.from({length:13},(t,n)=>o.jsx("i",{style:{"--i":n}},n))}),o.jsxs("div",{className:"tet-viet-lantern",children:[o.jsx("span",{children:"An"}),o.jsx("i",{})]})]}),o.jsxs("div",{className:"tet-corner tet-corner-mai",children:[o.jsx("div",{className:"tet-border-branch",children:Array.from({length:13},(t,n)=>o.jsx("i",{style:{"--i":n}},n))}),o.jsxs("div",{className:"tet-viet-lantern",children:[o.jsx("span",{children:"Vui"}),o.jsx("i",{})]})]}),o.jsxs("div",{className:"tet-side-couplet tet-side-couplet-left",children:[o.jsx("i",{}),o.jsxs("span",{children:[o.jsx("em",{children:"Xuân"}),o.jsx("em",{children:"sang"}),o.jsx("em",{children:"phúc"}),o.jsx("em",{children:"lộc"}),o.jsx("em",{children:"tràn"}),o.jsx("em",{children:"muôn"}),o.jsx("em",{children:"ngả"})]}),o.jsx("b",{}),o.jsx("strong",{children:"An"})]}),o.jsxs("div",{className:"tet-side-couplet tet-side-couplet-right",children:[o.jsx("i",{}),o.jsxs("span",{children:[o.jsx("em",{children:"Tết"}),o.jsx("em",{children:"đến"}),o.jsx("em",{children:"an"}),o.jsx("em",{children:"khang"}),o.jsx("em",{children:"rạng"}),o.jsx("em",{children:"khắp"}),o.jsx("em",{children:"nhà"})]}),o.jsx("b",{}),o.jsx("strong",{children:"Xuân"})]}),o.jsxs("div",{className:"tet-bottom tet-bottom-left",children:[o.jsxs("div",{className:"tet-banh-chung",children:[o.jsx("i",{}),o.jsx("span",{}),o.jsx("b",{})]}),o.jsxs("div",{className:"tet-banh-tet",children:[o.jsx("i",{}),o.jsx("span",{}),o.jsx("b",{})]}),o.jsx("div",{className:"tet-watermelon",children:o.jsx("i",{})}),o.jsxs("div",{className:"tet-envelope",children:[o.jsx("i",{}),o.jsx("span",{children:"Lộc"}),o.jsx("b",{})]})]}),o.jsxs("div",{className:"tet-bottom tet-bottom-right",children:[o.jsx("div",{className:"tet-quat",children:Array.from({length:11},(t,n)=>o.jsx("i",{style:{"--i":n}},n))}),o.jsxs("div",{className:"tet-dongson",children:[o.jsx("i",{}),o.jsx("span",{}),o.jsx("b",{})]})]}),o.jsx("div",{className:"tet-top-knot tet-top-knot-a",children:o.jsx("i",{})}),o.jsx("div",{className:"tet-top-knot tet-top-knot-b",children:o.jsx("i",{})}),o.jsx("canvas",{ref:e,className:"absolute inset-0"}),o.jsx("div",{className:"effect-label left-5 top-24",children:"TẾT VIỆT / BÌNH AN"})]})},To=[{base:556958,side:473183,top:6478056,accent:12124016,edge:14154751},{base:5982901,side:2169688,top:10849023,accent:7533823,edge:15196671},{base:11758372,side:5514511,top:15775819,accent:7467007,edge:16770989},{base:6004018,side:2181927,top:11069534,accent:14286722,edge:15597513}],Xc=(e,t)=>{const n=new bb(e*.48,e*.48),r=new Nh({color:t,transparent:!0,opacity:.28,depthWrite:!1,side:wb}),i=new ma(n,r),a=new fa(new Wo(n),new $o({color:t,transparent:!0,opacity:.5}));return i.add(a),i},Jc=(e,t,n=!1)=>{const r=new Sg,i=new Xu(e,e,e),s=[t.side,t.side,t.top,t.side,t.base,t.side].map((d,p)=>new fb({color:d,metalness:.62,roughness:p===2?.14:.23,clearcoat:1,clearcoatRoughness:.12,emissive:new yb(p===2?t.accent:d).multiplyScalar(p===2?.14:.07),transparent:!0,opacity:.38,depthWrite:!1})),c=new ma(i,s),l=new fa(new Wo(i),new $o({color:t.edge,transparent:!0,opacity:.58})),h=new fa(new Wo(new Xu(e*1.13,e*1.13,e*1.13)),new $o({color:t.accent,transparent:!0,opacity:n?.3:.16})),u=new ma(new vb(e*(n?.24:.19),0),new Nh({color:t.accent,transparent:!0,opacity:.48,depthWrite:!1}));if(u.name="cube-energy",h.name="cube-frame",r.add(c,l,h,u),n){const d=Xc(e,t.accent);d.position.z=e*.505;const p=Xc(e*.88,t.edge);p.position.y=e*.505,p.rotation.x=-Math.PI/2;const v=Xc(e*.78,t.top);v.position.x=e*.505,v.rotation.y=Math.PI/2,r.add(d,p,v)}return r},IS=()=>{const e=m.useRef(null);return m.useEffect(()=>{const t=e.current;if(!t)return;const n=new rb,r=new ib(42,1,.1,100);r.position.set(0,1.2,13);const i=new ab({alpha:!0,antialias:!0,powerPreference:"high-performance"});i.setPixelRatio(Math.min(window.devicePixelRatio,2)),i.setClearColor(0,0),i.outputColorSpace=ob,i.toneMapping=sb,i.toneMappingExposure=1.15,t.appendChild(i.domElement),n.add(new cb(10412031,.72));const a=new lb(12449791,4.2);a.position.set(4,6,8),n.add(a);const s=new Qu(12124016,32,20);s.position.set(-5,2,4),n.add(s);const c=new Qu(3723263,26,18);c.position.set(5,-3,2),n.add(c);const l=Jc(2.25,To[0],!0);l.rotation.set(-.35,.65,.08),n.add(l);const h=Jc(.72,To[3]);h.scale.setScalar(.82),l.add(h);const u=Array.from({length:11},(S,I)=>{const j=I%3,q=new Sg;q.rotation.set([.35,1.05,-.62][j],[-.22,.28,-.48][j],I*.71),n.add(q);const D=Jc([.38,.5,.32,.44][I%4],To[I%To.length]);return D.position.x=[3.5,4.35,5.15][j]+I%4*.08,D.rotation.set(I*.41,I*.63,I*.28),q.add(D),{pivot:q,cube:D,speed:[.34,-.24,.18][j],phase:I*.9}}),d=[{radius:3.35,tube:.012,color:6809849,rotation:[1.2,.12,.1]},{radius:4.5,tube:.009,color:10741301,rotation:[.82,.7,-.3]},{radius:5.55,tube:.007,color:5101567,rotation:[1.42,-.42,.5]}].map(({radius:S,tube:I,color:j,rotation:q})=>{const D=new ma(new hb(S,I,8,160),new Nh({color:j,transparent:!0,opacity:.26}));return D.rotation.set(q[0],q[1],q[2]),n.add(D),D}),p=new ub(6.2,1),v=new fa(new Wo(p),new $o({color:5756904,transparent:!0,opacity:.055}));n.add(v);const x=190,y=new Float32Array(x*3);for(let S=0;S<x;S+=1){const I=7+Math.random()*11,j=Math.random()*Math.PI*2,q=Math.acos(2*Math.random()-1);y[S*3]=I*Math.sin(q)*Math.cos(j),y[S*3+1]=I*Math.cos(q),y[S*3+2]=I*Math.sin(q)*Math.sin(j)}const k=new db;k.setAttribute("position",new pb(y,3));const f=new Yu(k,new gb({color:12055551,size:.035,transparent:!0,opacity:.62}));n.add(f);const g=new xb;let b=0;const w=new mb,T=()=>{const{clientWidth:S,clientHeight:I}=t;i.setSize(S,I,!1),r.aspect=S/Math.max(I,1),r.updateProjectionMatrix()},C=S=>{g.x=S.clientX/window.innerWidth-.5,g.y=S.clientY/window.innerHeight-.5},P=()=>{const S=w.getElapsedTime();l.rotation.y=.65+S*.16,l.rotation.x=-.35+Math.sin(S*.45)*.1,l.getObjectByName("cube-frame").rotation.set(S*.18,-S*.24,S*.12),l.getObjectByName("cube-energy").rotation.set(S*.7,S*-.9,S*.45),h.rotation.x=S*-.8,h.rotation.y=S*.65,u.forEach(({pivot:I,cube:j,speed:q,phase:D})=>{I.rotation.z+=q*.008,j.rotation.x+=.006,j.rotation.y+=.009,j.position.y=Math.sin(S*.8+D)*.18,j.scale.setScalar(.88+Math.sin(S*.65+D)*.12),j.getObjectByName("cube-frame").rotation.y=S*-.5+D,j.getObjectByName("cube-energy").rotation.x=S*1.1+D}),d.forEach((I,j)=>{I.rotation.z+=(j%2?-1:1)*8e-4}),v.rotation.y=S*-.025,f.rotation.y=S*.006,r.position.x+=(g.x*1.2-r.position.x)*.025,r.position.y+=(-g.y*.8+1.2-r.position.y)*.025,r.lookAt(0,0,0),i.render(n,r),b=requestAnimationFrame(P)};return T(),P(),window.addEventListener("resize",T),window.addEventListener("pointermove",C,{passive:!0}),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",T),window.removeEventListener("pointermove",C),n.traverse(S=>{(S instanceof ma||S instanceof fa||S instanceof Yu)&&(S.geometry.dispose(),(Array.isArray(S.material)?S.material:[S.material]).forEach(j=>j.dispose()))}),i.dispose(),t.removeChild(i.domElement)}},[]),o.jsx("div",{ref:e,className:"cyber-webgl absolute inset-0"})},NS=()=>{const e=m.useRef(null),t=m.useRef(null);return m.useEffect(()=>{const n=e.current,r=t.current,i=r==null?void 0:r.getContext("2d");if(!n||!r||!i)return;let a=0,s=[],c=[],l=window.innerWidth,h=window.innerHeight,u=0;const d=window.matchMedia("(prefers-reduced-motion: reduce)").matches,p={x:l/2,y:h/2,targetX:l/2,targetY:h/2,active:!1},v=()=>{const w=p.x/l-.5,T=p.y/h-.5;n.style.setProperty("--mx",`${w}`),n.style.setProperty("--my",`${T}`),n.style.setProperty("--back-shift",`${w*-14}px`),n.style.setProperty("--floor-shift",`${w*24}px`),n.style.setProperty("--hud-shift",`${T*22}px`),n.style.setProperty("--core-rx",`${-18+T*-18}deg`),n.style.setProperty("--core-ry",`${35+w*28}deg`),n.style.setProperty("--scene-x",`${w*20}px`),n.style.setProperty("--scene-y",`${T*14}px`),n.style.setProperty("--scene-rx",`${T*-5}deg`),n.style.setProperty("--scene-ry",`${w*7}deg`),n.style.setProperty("--far-x",`${w*34}px`),n.style.setProperty("--far-y",`${T*20}px`),n.style.setProperty("--near-x",`${w*-42}px`),n.style.setProperty("--near-y",`${T*-28}px`),n.style.setProperty("--panel-x",`${w*28}px`),n.style.setProperty("--panel-y",`${T*18}px`),n.style.setProperty("--panel-inverse-x",`${w*-32}px`),n.style.setProperty("--panel-inverse-y",`${T*-20}px`),n.style.setProperty("--px",`${p.x}px`),n.style.setProperty("--py",`${p.y}px`)},x=()=>{const w=Math.min(92,Math.max(42,Math.floor(l/18)));s=Array.from({length:w},()=>({x:Math.random()*l,y:Math.random()*h,vx:(Math.random()-.5)*.12,vy:(Math.random()-.5)*.12,size:Math.random()*1.35+.45,depth:Math.random()*.75+.25,phase:Math.random()*Math.PI*2}))},y=()=>{l=window.innerWidth,h=window.innerHeight;const w=Math.min(window.devicePixelRatio||1,2);r.width=l*w,r.height=h*w,r.style.width=`${l}px`,r.style.height=`${h}px`,i.setTransform(w,0,0,w,0,0),p.x=p.targetX=l/2,p.y=p.targetY=h/2,x(),v()},k=w=>{p.targetX=w.clientX,p.targetY=w.clientY,p.active=!0},f=()=>{p.targetX=l/2,p.targetY=h/2,p.active=!1},g=w=>{c.push({x:w.clientX,y:w.clientY,radius:12,alpha:.38}),c.length>4&&c.shift()},b=()=>{u+=1,p.x+=(p.targetX-p.x)*(d?1:.075),p.y+=(p.targetY-p.y)*(d?1:.075),v(),i.clearRect(0,0,l,h),i.lineWidth=.7,c=c.filter(w=>w.alpha>.012),c.forEach(w=>{w.radius+=1.8,w.alpha*=.975,i.beginPath(),i.arc(w.x,w.y,w.radius,0,Math.PI*2),i.strokeStyle=`rgba(145, 238, 255, ${w.alpha})`,i.stroke()}),s.forEach((w,T)=>{const C=w.x-p.x,P=w.y-p.y,S=Math.max(1,Math.hypot(C,P));if(p.active&&S<175){const j=(1-S/175)*.018*w.depth;w.vx+=C/S*j,w.vy+=P/S*j}w.vx*=.992,w.vy*=.992,d||(w.x+=w.vx+Math.sin(u*.006+w.phase)*.035*w.depth,w.y+=w.vy+Math.cos(u*.005+w.phase)*.025*w.depth),w.x<-10&&(w.x=l+10),w.x>l+10&&(w.x=-10),w.y<-10&&(w.y=h+10),w.y>h+10&&(w.y=-10);const I=.2+w.depth*.32;i.beginPath(),i.arc(w.x,w.y,w.size*w.depth,0,Math.PI*2),i.fillStyle=`rgba(135, 228, 242, ${I})`,i.fill();for(let j=T+1;j<s.length;j+=1){const q=s[j],D=Math.hypot(w.x-q.x,w.y-q.y);D<112&&(i.beginPath(),i.moveTo(w.x,w.y),i.lineTo(q.x,q.y),i.strokeStyle=`rgba(115, 220, 238, ${.07*(1-D/112)*w.depth})`,i.stroke())}S<220&&(i.beginPath(),i.moveTo(w.x,w.y),i.lineTo(p.x,p.y),i.strokeStyle=`rgba(185, 236, 150, ${.16*(1-S/220)*w.depth})`,i.stroke())}),i.beginPath(),i.arc(p.x,p.y,30,0,Math.PI*2),i.strokeStyle="rgba(150, 235, 245, .1)",i.stroke(),a=requestAnimationFrame(b)};return y(),b(),window.addEventListener("resize",y),window.addEventListener("pointermove",k,{passive:!0}),window.addEventListener("pointerleave",f),window.addEventListener("pointerdown",g,{passive:!0}),()=>{cancelAnimationFrame(a),window.removeEventListener("resize",y),window.removeEventListener("pointermove",k),window.removeEventListener("pointerleave",f),window.removeEventListener("pointerdown",g)}},[]),o.jsxs("div",{ref:e,className:"effect-scene effect-scene-3d fixed inset-0 z-0 overflow-hidden",children:[o.jsx("canvas",{ref:t,className:"cyber-network absolute inset-0"}),o.jsx("div",{className:"cyber-atmosphere cyber-atmosphere-a"}),o.jsx("div",{className:"cyber-atmosphere cyber-atmosphere-b"}),o.jsx("div",{className:"cyber-aurora cyber-aurora-a"}),o.jsx("div",{className:"cyber-aurora cyber-aurora-b"}),o.jsx("div",{className:"cyber-depth-lines"}),o.jsxs("div",{className:"cyber-signal-field",children:[o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{})]}),o.jsx("div",{className:"cyber-spotlight"}),o.jsx("div",{className:"cyber-grid cyber-grid-back"}),o.jsx("div",{className:"cyber-grid cyber-grid-floor"}),o.jsx(IS,{}),o.jsxs("div",{className:"cyber-observatory",children:[o.jsxs("div",{className:"cyber-axis",children:[o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{})]}),o.jsxs("div",{className:"cyber-beacons",children:[o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{})]}),o.jsxs("div",{className:"cyber-core-plinth",children:[o.jsx("i",{}),o.jsx("i",{}),o.jsx("i",{})]})]}),o.jsxs("div",{className:"cyber-glass cyber-glass-a",children:[o.jsx("span",{children:"VECTOR"}),o.jsx("b",{children:"12.08"}),o.jsx("i",{})]}),o.jsxs("div",{className:"cyber-glass cyber-glass-b",children:[o.jsx("span",{children:"ORBIT"}),o.jsx("b",{children:"STABLE"}),o.jsx("i",{})]}),o.jsxs("div",{className:"cyber-hud cyber-hud-left",children:[o.jsx("span",{children:"SYS / DEPTH"}),o.jsx("b",{children:"03.24"}),o.jsx("i",{})]}),o.jsxs("div",{className:"cyber-hud cyber-hud-right",children:[o.jsx("span",{children:"FIELD / LIVE"}),o.jsx("b",{children:"97.4%"}),o.jsx("i",{})]}),o.jsx("div",{className:"cyber-cursor-halo"}),o.jsx("div",{className:"cyber-vignette"}),o.jsx("div",{className:"cyber-scanlines"}),o.jsx("div",{className:"effect-label left-5 top-24",children:"CYBER OBSERVATORY / INTERACTIVE"})]})},jS=()=>{const{currentEffect:e}=wv();switch(e){case"christmas":return o.jsx(PS,{});case"tet":return o.jsx(AS,{});case"parallax":return o.jsx(NS,{});default:return null}};var Is=["light","dark"],zu="(prefers-color-scheme: dark)",ES=typeof window>"u",Hu=m.createContext(void 0),RS={setTheme:e=>{},themes:[]},kv=()=>{var e;return(e=m.useContext(Hu))!=null?e:RS},LS=e=>m.useContext(Hu)?e.children:m.createElement(MS,{...e}),DS=["light","dark"],MS=({forcedTheme:e,disableTransitionOnChange:t=!1,enableSystem:n=!0,enableColorScheme:r=!0,storageKey:i="theme",themes:a=DS,defaultTheme:s=n?"system":"light",attribute:c="data-theme",value:l,children:h,nonce:u})=>{let[d,p]=m.useState(()=>Wp(i,s)),[v,x]=m.useState(()=>Wp(i)),y=l?Object.values(l):a,k=m.useCallback(w=>{let T=w;if(!T)return;w==="system"&&n&&(T=$p());let C=l?l[T]:T,P=t?OS():null,S=document.documentElement;if(c==="class"?(S.classList.remove(...y),C&&S.classList.add(C)):C?S.setAttribute(c,C):S.removeAttribute(c),r){let I=Is.includes(s)?s:null,j=Is.includes(T)?T:I;S.style.colorScheme=j}P==null||P()},[]),f=m.useCallback(w=>{let T=typeof w=="function"?w(w):w;p(T);try{localStorage.setItem(i,T)}catch{}},[e]),g=m.useCallback(w=>{let T=$p(w);x(T),d==="system"&&n&&!e&&k("system")},[d,e]);m.useEffect(()=>{let w=window.matchMedia(zu);return w.addListener(g),g(w),()=>w.removeListener(g)},[g]),m.useEffect(()=>{let w=T=>{if(T.key!==i)return;let C=T.newValue||s;f(C)};return window.addEventListener("storage",w),()=>window.removeEventListener("storage",w)},[f]),m.useEffect(()=>{k(e??d)},[e,d]);let b=m.useMemo(()=>({theme:d,setTheme:f,forcedTheme:e,resolvedTheme:d==="system"?v:d,themes:n?[...a,"system"]:a,systemTheme:n?v:void 0}),[d,f,e,v,n,a]);return m.createElement(Hu.Provider,{value:b},m.createElement(qS,{forcedTheme:e,disableTransitionOnChange:t,enableSystem:n,enableColorScheme:r,storageKey:i,themes:a,defaultTheme:s,attribute:c,value:l,children:h,attrs:y,nonce:u}),h)},qS=m.memo(({forcedTheme:e,storageKey:t,attribute:n,enableSystem:r,enableColorScheme:i,defaultTheme:a,value:s,attrs:c,nonce:l})=>{let h=a==="system",u=n==="class"?`var d=document.documentElement,c=d.classList;${`c.remove(${c.map(x=>`'${x}'`).join(",")})`};`:`var d=document.documentElement,n='${n}',s='setAttribute';`,d=i?Is.includes(a)&&a?`if(e==='light'||e==='dark'||!e)d.style.colorScheme=e||'${a}'`:"if(e==='light'||e==='dark')d.style.colorScheme=e":"",p=(x,y=!1,k=!0)=>{let f=s?s[x]:x,g=y?x+"|| ''":`'${f}'`,b="";return i&&k&&!y&&Is.includes(x)&&(b+=`d.style.colorScheme = '${x}';`),n==="class"?y||f?b+=`c.add(${g})`:b+="null":f&&(b+=`d[s](n,${g})`),b},v=e?`!function(){${u}${p(e)}}()`:r?`!function(){try{${u}var e=localStorage.getItem('${t}');if('system'===e||(!e&&${h})){var t='${zu}',m=window.matchMedia(t);if(m.media!==t||m.matches){${p("dark")}}else{${p("light")}}}else if(e){${s?`var x=${JSON.stringify(s)};`:""}${p(s?"x[e]":"e",!0)}}${h?"":"else{"+p(a,!1,!1)+"}"}${d}}catch(e){}}()`:`!function(){try{${u}var e=localStorage.getItem('${t}');if(e){${s?`var x=${JSON.stringify(s)};`:""}${p(s?"x[e]":"e",!0)}}else{${p(a,!1,!1)};}${d}}catch(t){}}();`;return m.createElement("script",{nonce:l,dangerouslySetInnerHTML:{__html:v}})}),Wp=(e,t)=>{if(ES)return;let n;try{n=localStorage.getItem(e)||void 0}catch{}return n||t},OS=()=>{let e=document.createElement("style");return e.appendChild(document.createTextNode("*{-webkit-transition:none!important;-moz-transition:none!important;-o-transition:none!important;-ms-transition:none!important;transition:none!important}")),document.head.appendChild(e),()=>{window.getComputedStyle(document.body),setTimeout(()=>{document.head.removeChild(e)},1)}},$p=e=>(e||(e=window.matchMedia(zu)),e.matches?"dark":"light");const US=()=>{const{resolvedTheme:e}=kv();return m.useEffect(()=>{const t=document.querySelector('meta[name="theme-color"]');t==null||t.setAttribute("content",e==="dark"?"#090c11":"#f7f4eb")},[e]),null},Co=[{value:"system",label:"Hệ thống",icon:X0},{value:"dark",label:"Tối",icon:t1},{value:"light",label:"Sáng",icon:h1}],Kp=()=>{const{language:e}=Le(),{theme:t="system",setTheme:n}=kv(),r=Co.findIndex(h=>h.value===t),i=r===-1?0:r,a=Co[i],s=Co[(i+1)%Co.length],c=a.icon,l=e==="vi"?{system:"Hệ thống",dark:"Tối",light:"Sáng"}:{system:"System",dark:"Dark",light:"Light"};return o.jsx(ne,{variant:"outline",size:"icon",className:"border-border/80 bg-background/50","aria-label":`${l[a.value]} → ${l[s.value]}`,title:`${l[a.value]} → ${l[s.value]}`,onClick:()=>n(s.value),children:o.jsx(c,{className:"h-4 w-4"})})},Qp=()=>{const{language:e,toggleLanguage:t}=Le(),n=e==="vi"?"English":"Tiếng Việt";return o.jsxs(ne,{variant:"outline",size:"sm",className:"h-10 gap-2 border-border/80 bg-background/50 px-3 font-mono text-xs font-semibold tracking-[.1em]","aria-label":`Switch to ${n}`,title:`Switch to ${n}`,onClick:t,children:[o.jsx(Y0,{className:"h-3.5 w-3.5"}),e.toUpperCase()]})},_S=()=>{const{t:e}=Le(),t=Ut(),[n,r]=m.useState(!1),i=[{path:"/",label:e("nav.home"),index:"00"},{path:"/projects",label:e("nav.projects"),index:"01"},{path:"/blog",label:e("nav.blog"),index:"02"},{path:"/about",label:e("nav.about"),index:"03"},{path:"/contact",label:e("nav.contact"),index:"04"}],a=s=>s==="/"?t.pathname==="/":t.pathname.startsWith(s);return m.useEffect(()=>{r(!1)},[t.pathname]),o.jsx("header",{className:"fixed inset-x-0 top-0 z-50 border-b border-border/60 bg-background/85 backdrop-blur-xl",children:o.jsxs("div",{className:"container mx-auto px-4",children:[o.jsxs("nav",{className:"flex h-[72px] items-center justify-between",children:[o.jsxs(we,{to:"/",className:"group flex items-center gap-3",children:[o.jsx("span",{className:"brand-logo flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl border border-primary/35 bg-primary/[.07] p-1 shadow-sm transition-all duration-300 group-hover:border-primary/70 group-hover:bg-primary/10",children:o.jsx("img",{src:"/logo-rm-khongvien.png",alt:"",className:"h-full w-full object-contain transition-transform duration-300 group-hover:scale-110"})}),o.jsxs("span",{children:[o.jsx("span",{className:"block font-mono text-sm font-semibold leading-none",children:"HAI IT"}),o.jsx("span",{className:"mt-1 block font-mono text-[11px] uppercase tracking-[0.16em] text-muted-foreground",children:"systems journal"})]})]}),o.jsx("ul",{className:"hidden items-center gap-1 md:flex",children:i.map(s=>o.jsx("li",{children:o.jsxs(we,{to:s.path,className:`flex items-baseline gap-2 rounded-md px-3 py-2 font-mono text-xs transition-colors ${a(s.path)?"bg-primary/10 text-primary":"text-muted-foreground hover:bg-muted hover:text-foreground"}`,children:[o.jsx("span",{className:"text-[11px] opacity-65",children:s.index}),s.label]})},s.path))}),o.jsxs("div",{className:"hidden items-center gap-2 md:flex",children:[o.jsx(Qp,{}),o.jsx(Kp,{}),o.jsx(ne,{asChild:!0,variant:"outline",size:"sm",className:"border-primary/30 font-mono text-xs",children:o.jsxs(we,{to:"/contact",children:[e("nav.connect")," ",o.jsx(kt,{className:"ml-2 h-3.5 w-3.5"})]})})]}),o.jsx(ne,{variant:"ghost",size:"icon",className:"md:hidden","aria-label":"Mở menu",onClick:()=>r(!n),children:n?o.jsx(ks,{className:"h-5 w-5"}):o.jsx(Z0,{className:"h-5 w-5"})})]}),n&&o.jsxs("div",{className:"border-t border-border/60 py-4 md:hidden",children:[i.map(s=>o.jsxs(we,{to:s.path,onClick:()=>r(!1),className:`flex items-center justify-between rounded-lg px-4 py-3 font-mono text-sm ${a(s.path)?"bg-primary/10 text-primary":"text-muted-foreground"}`,children:[s.label,o.jsxs("span",{className:"text-xs opacity-65",children:["/",s.index]})]},s.path)),o.jsxs("div",{className:"mt-3 flex items-center justify-between gap-3 border-t border-border/60 px-4 pt-4",children:[o.jsxs("span",{className:"font-mono text-xs uppercase tracking-[.14em] text-muted-foreground",children:[e("nav.language")," / ",e("nav.theme")]}),o.jsxs("div",{className:"flex gap-2",children:[o.jsx(Qp,{}),o.jsx(Kp,{})]})]})]})]})})},oc=[{id:"languages",name:"Programming Languages",description:"Deep dives into various programming languages, syntax, paradigms, and best use cases",icon:"Code2",color:"category-languages"},{id:"frameworks",name:"Frameworks & Libraries",description:"Comprehensive guides on modern frameworks and libraries for web, mobile, and backend development",icon:"Layers",color:"category-frameworks"},{id:"architecture",name:"Software Architecture",description:"System design principles, architectural patterns, and scalability strategies",icon:"Building2",color:"category-architecture"},{id:"patterns",name:"Design Patterns",description:"Classic and modern design patterns with practical implementations",icon:"Shapes",color:"category-patterns"},{id:"practices",name:"Best Practices",description:"Coding standards, clean code principles, and industry best practices",icon:"CheckCircle",color:"category-practices"},{id:"roadmap",name:"Learning Roadmaps",description:"Structured learning paths for different programming domains and skill levels",icon:"Map",color:"category-roadmap"}],Th=[{id:"capital-weather-tracker",title:"Capital Weather Tracker",description:"Hệ thống xử lý dữ liệu thời tiết thời gian thực cho các thủ đô trên thế giới.",longDescription:"Ứng dụng thu thập và hiển thị dữ liệu thời tiết real-time từ OpenWeatherMap API, xử lý và visualize dữ liệu cho tất cả các thủ đô trên thế giới với cập nhật liên tục.",technologies:["Python","OpenWeatherMap API","Data Processing"],github:"https://github.com/haihttt974/capital-weather-tracker",image:"/placeholder.svg",featured:!0},{id:"sorting-visualizer",title:"Sorting Visualizer",description:"Ứng dụng trực quan hóa các thuật toán sắp xếp với animation mượt mà.",longDescription:"Công cụ giáo dục giúp hiểu rõ cách hoạt động của các thuật toán sắp xếp như Bubble Sort, Quick Sort, Merge Sort thông qua visualization trực quan.",technologies:["TypeScript","Algorithms","Visualization"],github:"https://github.com/haihttt974/sorting-visualizer",image:"/placeholder.svg",featured:!0},{id:"bookstore-aspnet",title:"BookStore ASP.NET",description:"Website quản lý hiệu sách hoàn chỉnh với ASP.NET Core.",longDescription:"Hệ thống quản lý hiệu sách full-stack với chức năng CRUD, quản lý kho, đơn hàng và báo cáo doanh thu. Xây dựng trên ASP.NET Core và SQL Server.",technologies:["C#","ASP.NET Core","SQL Server","Entity Framework"],github:"https://github.com/haihttt974/thltweb-BookStore-asp.net",image:"/placeholder.svg",featured:!0},{id:"gplx-mobile-app",title:"Ôn thi GPLX Mobile",description:"Ứng dụng di động ôn thi giấy phép lái xe với Flutter.",longDescription:"Ứng dụng mobile cross-platform giúp người dùng ôn luyện lý thuyết thi bằng lái xe với bộ câu hỏi đầy đủ, thi thử và theo dõi tiến độ học tập.",technologies:["Dart","Flutter","Mobile Development"],github:"https://github.com/haihttt974/ltmobile_gplx",image:"/placeholder.svg"},{id:"temperature-influxdb",title:"Temperature VN InfluxDB",description:"Hệ thống thu thập và lưu trữ dữ liệu nhiệt độ vào InfluxDB.",longDescription:"Pipeline dữ liệu IoT thu thập nhiệt độ từ các nguồn khác nhau tại Việt Nam, lưu trữ vào InfluxDB cho phân tích time-series và visualization.",technologies:["Python","InfluxDB","IoT","Time Series"],github:"https://github.com/haihttt974/send-temperature-vn-influxdb",image:"/placeholder.svg"},{id:"christmas-tree",title:"Christmas Tree Effect",description:"Hiệu ứng cây thông Noel tương tác với HTML/CSS/JS.",longDescription:"Trang web hiệu ứng Giáng Sinh với cây thông 3D tương tác, tuyết rơi và ánh sáng lung linh. Hoàn toàn viết bằng vanilla HTML, CSS và JavaScript.",technologies:["HTML5","CSS3","JavaScript","Animation"],github:"https://github.com/haihttt974/christmas_tree.github.io",demo:"https://haihttt974.github.io/christmas_tree.github.io/",image:"/placeholder.svg"},{id:"countdown-newyear",title:"Countdown New Year",description:"Đồng hồ đếm ngược năm mới với hiệu ứng đẹp mắt.",longDescription:"Trang countdown đón năm mới với thiết kế hiện đại, hiệu ứng confetti và animation mượt mà khi đồng hồ điểm 0.",technologies:["HTML5","CSS3","JavaScript"],github:"https://github.com/haihttt974/CountdownNewYear.github.io",demo:"https://haihttt974.github.io/CountdownNewYear.github.io/",image:"/placeholder.svg"},{id:"firework-effect",title:"Firework Effect",description:"Hiệu ứng pháo hoa sống động cho các dịp lễ hội.",longDescription:"Mô phỏng pháo hoa với hiệu ứng particle system, màu sắc rực rỡ và âm thanh. Phù hợp cho các trang countdown và lễ hội.",technologies:["HTML5","Canvas","JavaScript","Animation"],github:"https://github.com/haihttt974/Hfirework.github.io",demo:"https://haihttt974.github.io/Hfirework.github.io/",image:"/placeholder.svg"}],ue={name:"Lê Duy Hải",nickname:"Hai IT",username:"haihttt974",title:"Information Systems Developer",subtitle:"Database • Server-side • DevOps",avatar:"https://avatars.githubusercontent.com/u/202379592?v=4",address:"Đông Hưng Thuận, Ho Chi Minh City",bio:`Tôi là một chuyên gia về Hệ thống thông tin (Information Systems), tập trung vào việc xây dựng các giải pháp có khả năng mở rộng (Scalable) và tin cậy (Reliable).
...
- Chọn Oracle khi bài toán dữ liệu xứng đáng với một database platform nghiêm túc.`,category:"practices",tags:["Oracle","Database","SQL","PL/SQL","Performance"],date:"2026-06-23",readTime:"11 min",readTimeVi:"9 phút",featured:!0},Tv=(e,t)=>({...e,title:t==="vi"?e.titleVi??e.title:e.title,excerpt:t==="vi"?e.excerptVi??e.excerpt:e.excerpt,content:t==="vi"?e.contentVi??e.content:e.content,readTime:t==="vi"?e.readTimeVi??e.readTime:e.readTime}),cc=[CP,TP,ZS,eP,tP,nP,rP,iP,aP,oP,sP,cP,lP,hP,uP,dP,pP,gP,mP,fP,yP,vP,bP,wP,xP,kP,HS,GS,WS,$S,KS,QS,YS,XS,JS],SP="https://script.google.com/macros/s/AKfycbyREb0-NhaBcMrhp6CXtA2OsKcXFJalYhvlvhN7MxmXkjU-gA1F0Wd4h3J3bLF2M-ZO8w/exec";function Cv(e){const t=new URL(SP);return Object.entries(e).forEach(([n,r])=>t.searchParams.set(n,r)),t.searchParams.set("t",String(Date.now())),t.toString()}function PP(e){return typeof Image>"u"?Promise.resolve():new Promise(t=>{const n=new Image;n.onload=()=>t(),n.onerror=()=>t(),n.src=Cv({action:"collect",slug:e})})}function Sv(e){return typeof window>"u"||typeof document>"u"?Promise.resolve(0):new Promise(t=>{const n=`__views_cb_${Math.random().toString(36).slice(2)}`,r=Cv({action:"views",slug:e,callback:n}),i=window;i[n]=s=>{try{t(Number((s==null?void 0:s.views)??0))}finally{delete i[n],a.remove()}};const a=document.createElement("script");a.src=r,a.onerror=()=>{delete i[n],a.remove(),t(0)},document.body.appendChild(a)})}const AP=3e4;let mr=null,Ch=0;const Yp=e=>e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/đ/g,"d").replace(/Đ/g,"d").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""),Xp=async(e=!1)=>{const t=Date.now();if(!e&&mr&&t-Ch<AP)return mr;const n=await Promise.all(cc.map(async r=>[r.id,await Sv(r.id)]));return mr=Object.fromEntries(n),Ch=t,mr},IP=(e,t)=>Number(e[t]??0),Sh=(e={})=>cc.map(t=>({...t,viewCount:IP(e,t.id)})),NP=(e,t)=>{const n=cc.filter(r=>r.category===e.id).length;return{id:e.id,name:e.name,slug:e.id,description:e.description,color:e.color,sortOrder:t+1,isActive:!0,postCount:n}},jP=()=>{const e=new Map;return cc.forEach(t=>{t.tags.forEach(n=>e.set(n,(e.get(n)??0)+1))}),Array.from(e.entries()).sort(([t],[n])=>t.localeCompare(n)).map(([t,n])=>({id:Yp(t),name:t,slug:Yp(t),postCount:n}))},Pv=(e,t)=>{var n;return{id:e.id,title:t==="vi"?e.titleVi??e.title:e.title,titleVi:e.titleVi??void 0,slug:e.id,date:e.date,category:e.category,excerpt:t==="vi"?e.excerptVi??e.excerpt:e.excerpt,excerptVi:e.excerptVi??void 0,categorySlug:e.category,categoryName:((n=oc.find(r=>r.id===e.category))==null?void 0:n.name)??e.category,tags:e.tags,coverImageUrl:void 0,featured:!!e.featured,readTime:t==="vi"?e.readTimeVi??e.readTime:e.readTime,readTimeVi:e.readTimeVi??void 0,readTimeMinutes:Number.parseInt(e.readTime,10)||Number.parseInt(e.readTimeVi??e.readTime,10)||5,viewCount:e.viewCount,publishedAt:e.date,createdAt:e.date,updatedAt:e.date,status:"Published"}},EP=(e,t)=>({...Pv(e,t),content:t==="vi"?e.contentVi??e.content:e.content,contentVi:e.contentVi??void 0}),RP=(e,t)=>Sh(t).map(n=>Pv(n,e)),Fn={hasBackend:!1,getCachedPost(e){const t=Sh(mr??{}).find(n=>n.id===e);return t?{...t,...Tv(t,"en")}:void 0},async getPosts(e,t={}){const n=await Xp(),r=RP(e,n).filter(i=>t.featured===void 0?!0:i.featured===t.featured);return r.slice(0,t.pageSize??r.length)},async getPost(e,t){const n=await Xp(),r=Sh(n).find(i=>i.id===e);return r?EP(r,t):null},async incrementView(e){await PP(e);const t=await Sv(e);return mr={...mr??{},[e]:t},Ch=Date.now(),{slug:e,viewCount:t}},async getCategories(){return oc.map(NP)},async getTags(){return jP()}},Gu=({className:e,label:t="Loading"})=>o.jsx("div",{className:mt("flex min-h-56 items-center justify-center rounded-2xl border border-border/60 bg-card/70",e),"aria-busy":"true","aria-live":"polite",children:o.jsxs("div",{className:"flex items-center gap-3 text-sm text-muted-foreground",children:[o.jsx(yy,{className:"h-5 w-5 animate-spin text-primary"}),o.jsx("span",{children:t})]})}),LP=()=>{const{t:e,locale:t,language:n}=Le(),r=tr(),[i,a]=m.useState([]),[s,c]=m.useState(!0),l=h=>oc.some(u=>u.id===h)?e(`category.${h}`):h;return m.useEffect(()=>{let h=!1;return(async()=>{c(!0);const d=await Fn.getPosts(n,{featured:!0,pageSize:3});h||(a(d.slice(0,3)),c(!1))})().catch(()=>{h||c(!1)}),()=>{h=!0}},[n]),o.jsx(Ee.section,{className:"border-b border-border/70 py-20 md:py-28",variants:r?void 0:sc,initial:r?!1:"hidden",whileInView:"visible",viewport:Li,children:o.jsxs("div",{className:"container mx-auto px-4",children:[o.jsxs("div",{className:"mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end",children:[o.jsxs("div",{children:[o.jsx("p",{className:"eyebrow mb-4",children:e("home.notes.eyebrow")}),o.jsxs("h2",{className:"text-4xl md:text-6xl",children:[e("home.notes.title1"),o.jsx("br",{}),o.jsx("span",{className:"text-muted-foreground",children:e("home.notes.title2")})]})]}),o.jsxs(we,{to:"/blog",className:"inline-flex items-center gap-2 font-mono text-xs text-primary",children:[e("home.notes.all")," ",o.jsx(lh,{className:"h-4 w-4"})]})]}),s?o.jsx(Gu,{className:"min-h-[28rem]",label:n==="vi"?"Đang tải":"Loading"}):o.jsx(Ee.div,{className:"grid gap-4 lg:grid-cols-[1.2fr_.8fr]",variants:r?void 0:Ei,children:i.map((h,u)=>o.jsxs(Ee.article,{variants:r?void 0:Ri,className:`group journal-card p-6 md:p-8 ${u===0?"lg:row-span-2":""}`,children:[o.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3 border-b border-border/70 pb-5 font-mono text-xs uppercase tracking-[.14em] text-muted-foreground",children:[o.jsxs("span",{className:"text-primary",children:["Note / 0",u+1]}),o.jsx("span",{children:l(h.category)})]}),o.jsx(we,{to:`/blog/${h.id}`,className:"block",children:o.jsx("h3",{className:`mt-8 transition-colors group-hover:text-primary ${u===0?"max-w-2xl text-3xl md:text-5xl":"text-2xl"}`,children:h.title})}),o.jsx("p",{className:`mt-4 leading-relaxed text-muted-foreground ${u===0?"max-w-2xl text-base":"text-sm"}`,children:h.excerpt}),o.jsxs("div",{className:"mt-8 flex flex-wrap items-center gap-5 border-t border-border/70 pt-5 font-mono text-xs text-muted-foreground",children:[o.jsx("span",{children:new Date(h.date).toLocaleDateString(t)}),o.jsxs("span",{className:"flex items-center gap-1.5",children:[o.jsx(ws,{className:"h-3 w-3"}),h.readTime]}),o.jsxs("span",{className:"flex items-center gap-1.5",children:[o.jsx(xs,{className:"h-3 w-3"}),(h.viewCount??0).toLocaleString(t)]}),o.jsxs(we,{to:`/blog/${h.id}`,className:"ml-auto flex items-center gap-1.5 text-primary",children:[e("home.notes.read")," ",o.jsx(lh,{className:"h-3 w-3"})]})]})]},h.id))})]})})},DP=Au("inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",{variants:{variant:{default:"border-transparent bg-primary text-primary-foreground hover:bg-primary/80",secondary:"border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80",destructive:"border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80",outline:"text-foreground"}},defaultVariants:{variant:"default"}});function lt({className:e,variant:t,...n}){return o.jsx("div",{className:mt(DP({variant:t}),e),...n})}const MP=()=>{const{t:e}=Le(),t=tr(),n=Th.filter(r=>r.featured).slice(0,3);return o.jsx(Ee.section,{className:"border-b border-border/70 py-20 md:py-28",variants:t?void 0:sc,initial:t?!1:"hidden",whileInView:"visible",viewport:Li,children:o.jsxs("div",{className:"container mx-auto px-4",children:[o.jsxs("div",{className:"mb-12 grid gap-6 md:grid-cols-[1fr_.7fr] md:items-end",children:[o.jsxs("div",{children:[o.jsx("p",{className:"eyebrow mb-4",children:e("home.work.eyebrow")}),o.jsxs("h2",{className:"text-4xl md:text-6xl",children:[e("home.work.title1"),o.jsx("br",{}),o.jsx("span",{className:"text-muted-foreground",children:e("home.work.title2")})]})]}),o.jsxs("div",{className:"md:justify-self-end",children:[o.jsx("p",{className:"mb-4 max-w-md text-sm leading-relaxed text-muted-foreground",children:e("home.work.desc")}),o.jsxs(we,{to:"/projects",className:"inline-flex items-center gap-2 font-mono text-xs text-primary",children:[e("home.work.archive")," ",o.jsx(lh,{className:"h-4 w-4"})]})]})]}),o.jsx(Ee.div,{className:"space-y-4",variants:t?void 0:Ei,children:n.map((r,i)=>o.jsxs(Ee.article,{variants:t?void 0:Ri,className:"group journal-card grid gap-0 transition-transform duration-300 hover:-translate-y-1 md:grid-cols-[110px_1fr_1fr_auto]",children:[o.jsxs("div",{className:"flex items-center border-b border-border/70 p-5 font-mono text-4xl text-primary/70 md:border-b-0 md:border-r",children:["0",i+1]}),o.jsxs("div",{className:"border-b border-border/70 p-5 md:border-b-0 md:border-r md:p-7",children:[o.jsxs("p",{className:"mb-2 font-mono text-xs uppercase tracking-[.16em] text-muted-foreground",children:[e("home.work.case")," / ",r.id]}),o.jsx("h3",{className:"text-xl transition-colors group-hover:text-primary md:text-2xl",children:r.title}),o.jsx("p",{className:"mt-3 text-sm leading-relaxed text-muted-foreground",children:r.description})]}),o.jsxs("div",{className:"border-b border-border/70 p-5 md:border-b-0 md:border-r md:p-7",children:[o.jsx("p",{className:"mb-4 font-mono text-xs uppercase tracking-[.16em] text-muted-foreground",children:e("home.work.tools")}),o.jsx("div",{className:"flex flex-wrap gap-2.5",children:r.technologies.map(a=>o.jsx(lt,{variant:"secondary",className:"min-h-8 rounded-md border border-primary/25 bg-primary/[.08] px-3 py-1.5 font-mono text-[11px] font-semibold tracking-[.04em] text-foreground shadow-sm",children:a},a))})]}),o.jsxs("div",{className:"flex items-center gap-2 p-5 md:flex-col md:justify-center",children:[r.github&&o.jsx("a",{href:r.github,target:"_blank",rel:"noreferrer","aria-label":"Source code",className:"rounded-lg border border-border p-3 text-muted-foreground transition-colors hover:border-primary hover:text-primary",children:o.jsx(Cr,{className:"h-4 w-4"})}),r.demo&&o.jsx("a",{href:r.demo,target:"_blank",rel:"noreferrer","aria-label":"Live demo",className:"rounded-lg border border-border p-3 text-muted-foreground transition-colors hover:border-primary hover:text-primary",children:o.jsx(kt,{className:"h-4 w-4"})})]})]},r.id))})]})})},qP=()=>{const{t:e}=Le(),t=tr();return o.jsxs(Yn,{children:[o.jsx(BS,{}),o.jsx(MP,{}),o.jsx(LP,{}),o.jsx(zS,{}),o.jsx(Ee.section,{className:"py-20 md:py-28",variants:t?void 0:sc,initial:t?!1:"hidden",whileInView:"visible",viewport:Li,children:o.jsx("div",{className:"container mx-auto px-4",children:o.jsxs("div",{className:"journal-card grid gap-8 p-7 md:grid-cols-[.45fr_1fr] md:p-12",children:[o.jsxs("div",{children:[o.jsx("p",{className:"eyebrow mb-4",children:e("home.principle")}),o.jsx("p",{className:"font-mono text-xs leading-relaxed text-muted-foreground",children:"build → observe → explain → improve"})]}),o.jsx("blockquote",{className:"text-2xl leading-tight md:text-4xl",children:e("home.quote")})]})})})]})},Sr=m.forwardRef(({className:e,type:t,...n},r)=>o.jsx("input",{type:t,className:mt("flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",e),ref:r,...n}));Sr.displayName="Input";var Zc=0;function OP(){m.useEffect(()=>{const e=document.querySelectorAll("[data-radix-focus-guard]");return document.body.insertAdjacentElement("afterbegin",e[0]??Jp()),document.body.insertAdjacentElement("beforeend",e[1]??Jp()),Zc++,()=>{Zc===1&&document.querySelectorAll("[data-radix-focus-guard]").forEach(t=>t.remove()),Zc--}},[])}function Jp(){const e=document.createElement("span");return e.setAttribute("data-radix-focus-guard",""),e.tabIndex=0,e.style.outline="none",e.style.opacity="0",e.style.position="fixed",e.style.pointerEvents="none",e}var el="focusScope.autoFocusOnMount",tl="focusScope.autoFocusOnUnmount",Zp={bubbles:!1,cancelable:!0},UP="FocusScope",Av=m.forwardRef((e,t)=>{const{loop:n=!1,trapped:r=!1,onMountAutoFocus:i,onUnmountAutoFocus:a,...s}=e,[c,l]=m.useState(null),h=Jt(i),u=Jt(a),d=m.useRef(null),p=it(t,y=>l(y)),v=m.useRef({paused:!1,pause(){this.paused=!0},resume(){this.paused=!1}}).current;m.useEffect(()=>{if(r){let y=function(b){if(v.paused||!c)return;const w=b.target;c.contains(w)?d.current=w:An(d.current,{select:!0})},k=function(b){if(v.paused||!c)return;const w=b.relatedTarget;w!==null&&(c.contains(w)||An(d.current,{select:!0}))},f=function(b){if(document.activeElement===document.body)for(const T of b)T.removedNodes.length>0&&An(c)};document.addEventListener("focusin",y),document.addEventListener("focusout",k);const g=new MutationObserver(f);return c&&g.observe(c,{childList:!0,subtree:!0}),()=>{document.removeEventListener("focusin",y),document.removeEventListener("focusout",k),g.disconnect()}}},[r,c,v.paused]),m.useEffect(()=>{if(c){tg.add(v);const y=document.activeElement;if(!c.contains(y)){const f=new CustomEvent(el,Zp);c.addEventListener(el,h),c.dispatchEvent(f),f.defaultPrevented||(_P(HP(Iv(c)),{select:!0}),document.activeElement===y&&An(c))}return()=>{c.removeEventListener(el,h),setTimeout(()=>{const f=new CustomEvent(tl,Zp);c.addEventListener(tl,u),c.dispatchEvent(f),f.defaultPrevented||An(y??document.body,{select:!0}),c.removeEventListener(tl,u),tg.remove(v)},0)}}},[c,h,u,v]);const x=m.useCallback(y=>{if(!n&&!r||v.paused)return;const k=y.key==="Tab"&&!y.altKey&&!y.ctrlKey&&!y.metaKey,f=document.activeElement;if(k&&f){const g=y.currentTarget,[b,w]=FP(g);b&&w?!y.shiftKey&&f===w?(y.preventDefault(),n&&An(b,{select:!0})):y.shiftKey&&f===b&&(y.preventDefault(),n&&An(w,{select:!0})):f===g&&y.preventDefault()}},[n,r,v.paused]);return o.jsx(Ue.div,{tabIndex:-1,...s,ref:p,onKeyDown:x})});Av.displayName=UP;function _P(e,{select:t=!1}={}){const n=document.activeElement;for(const r of e)if(An(r,{select:t}),document.activeElement!==n)return}function FP(e){const t=Iv(e),n=eg(t,e),r=eg(t.reverse(),e);return[n,r]}function Iv(e){const t=[],n=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT,{acceptNode:r=>{const i=r.tagName==="INPUT"&&r.type==="hidden";return r.disabled||r.hidden||i?NodeFilter.FILTER_SKIP:r.tabIndex>=0?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}});for(;n.nextNode();)t.push(n.currentNode);return t}function eg(e,t){for(const n of e)if(!BP(n,{upTo:t}))return n}function BP(e,{upTo:t}){if(getComputedStyle(e).visibility==="hidden")return!0;for(;e;){if(t!==void 0&&e===t)return!1;if(getComputedStyle(e).display==="none")return!0;e=e.parentElement}return!1}function VP(e){return e instanceof HTMLInputElement&&"select"in e}function An(e,{select:t=!1}={}){if(e&&e.focus){const n=document.activeElement;e.focus({preventScroll:!0}),e!==n&&VP(e)&&t&&e.select()}}var tg=zP();function zP(){let e=[];return{add(t){const n=e[0];t!==n&&(n==null||n.pause()),e=ng(e,t),e.unshift(t)},remove(t){var n;e=ng(e,t),(n=e[0])==null||n.resume()}}}function ng(e,t){const n=[...e],r=n.indexOf(t);return r!==-1&&n.splice(r,1),n}function HP(e){return e.filter(t=>t.tagName!=="A")}var GP=function(e){if(typeof document>"u")return null;var t=Array.isArray(e)?e[0]:e;return t.ownerDocument.body},_r=new WeakMap,So=new WeakMap,Po={},nl=0,Nv=function(e){return e&&(e.host||Nv(e.parentNode))},WP=function(e,t){return t.map(function(n){if(e.contains(n))return n;var r=Nv(n);return r&&e.contains(r)?r:(console.error("aria-hidden",n,"in not contained inside",e,". Doing nothing"),null)}).filter(function(n){return!!n})},$P=function(e,t,n,r){var i=WP(t,Array.isArray(e)?e:[e]);Po[n]||(Po[n]=new WeakMap);var a=Po[n],s=[],c=new Set,l=new Set(i),h=function(d){!d||c.has(d)||(c.add(d),h(d.parentNode))};i.forEach(h);var u=function(d){!d||l.has(d)||Array.prototype.forEach.call(d.children,function(p){if(c.has(p))u(p);else try{var v=p.getAttribute(r),x=v!==null&&v!=="false",y=(_r.get(p)||0)+1,k=(a.get(p)||0)+1;_r.set(p,y),a.set(p,k),s.push(p),y===1&&x&&So.set(p,!0),k===1&&p.setAttribute(n,"true"),x||p.setAttribute(r,"true")}catch(f){console.error("aria-hidden: cannot operate on ",p,f)}})};return u(t),c.clear(),nl++,function(){s.forEach(function(d){var p=_r.get(d)-1,v=a.get(d)-1;_r.set(d,p),a.set(d,v),p||(So.has(d)||d.removeAttribute(r),So.delete(d)),v||d.removeAttribute(n)}),nl--,nl||(_r=new WeakMap,_r=new WeakMap,So=new WeakMap,Po={})}},KP=function(e,t,n){n===void 0&&(n="data-aria-hidden");var r=Array.from(Array.isArray(e)?e:[e]),i=GP(e);return i?(r.push.apply(r,Array.from(i.querySelectorAll("[aria-live]"))),$P(r,i,n,"aria-hidden")):function(){return null}},Wt=function(){return Wt=Object.assign||function(t){for(var n,r=1,i=arguments.length;r<i;r++){n=arguments[r];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(t[a]=n[a])}return t},Wt.apply(this,arguments)};function jv(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]]);return n}function QP(e,t,n){if(n||arguments.length===2)for(var r=0,i=t.length,a;r<i;r++)(a||!(r in t))&&(a||(a=Array.prototype.slice.call(t,0,r)),a[r]=t[r]);return e.concat(a||Array.prototype.slice.call(t))}var zo="right-scroll-bar-position",Ho="width-before-scroll-bar",YP="with-scroll-bars-hidden",XP="--removed-body-scroll-bar-size";function rl(e,t){return typeof e=="function"?e(t):e&&(e.current=t),e}function JP(e,t){var n=m.useState(function(){return{value:e,callback:t,facade:{get current(){return n.value},set current(r){var i=n.value;i!==r&&(n.value=r,n.callback(r,i))}}}})[0];return n.callback=t,n.facade}var ZP=typeof window<"u"?m.useLayoutEffect:m.useEffect,rg=new WeakMap;function eA(e,t){var n=JP(null,function(r){return e.forEach(function(i){return rl(i,r)})});return ZP(function(){var r=rg.get(n);if(r){var i=new Set(r),a=new Set(e),s=n.current;i.forEach(function(c){a.has(c)||rl(c,null)}),a.forEach(function(c){i.has(c)||rl(c,s)})}rg.set(n,e)},[e]),n}function tA(e){return e}function nA(e,t){t===void 0&&(t=tA);var n=[],r=!1,i={read:function(){if(r)throw new Error("Sidecar: could not `read` from an `assigned` medium. `read` could be used only with `useMedium`.");return n.length?n[n.length-1]:e},useMedium:function(a){var s=t(a,r);return n.push(s),function(){n=n.filter(function(c){return c!==s})}},assignSyncMedium:function(a){for(r=!0;n.length;){var s=n;n=[],s.forEach(a)}n={push:function(c){return a(c)},filter:function(){return n}}},assignMedium:function(a){r=!0;var s=[];if(n.length){var c=n;n=[],c.forEach(a),s=n}var l=function(){var u=s;s=[],u.forEach(a)},h=function(){return Promise.resolve().then(l)};h(),n={push:function(u){s.push(u),h()},filter:function(u){return s=s.filter(u),n}}}};return i}function rA(e){e===void 0&&(e={});var t=nA(null);return t.options=Wt({async:!0,ssr:!1},e),t}var Ev=function(e){var t=e.sideCar,n=jv(e,["sideCar"]);if(!t)throw new Error("Sidecar: please provide `sideCar` property to import the right car");var r=t.read();if(!r)throw new Error("Sidecar medium not found");return m.createElement(r,Wt({},n))};Ev.isSideCarExport=!0;function iA(e,t){return e.useMedium(t),Ev}var Rv=rA(),il=function(){},lc=m.forwardRef(function(e,t){var n=m.useRef(null),r=m.useState({onScrollCapture:il,onWheelCapture:il,onTouchMoveCapture:il}),i=r[0],a=r[1],s=e.forwardProps,c=e.children,l=e.className,h=e.removeScrollBar,u=e.enabled,d=e.shards,p=e.sideCar,v=e.noRelative,x=e.noIsolation,y=e.inert,k=e.allowPinchZoom,f=e.as,g=f===void 0?"div":f,b=e.gapMode,w=jv(e,["forwardProps","children","className","removeScrollBar","enabled","shards","sideCar","noRelative","noIsolation","inert","allowPinchZoom","as","gapMode"]),T=p,C=eA([n,t]),P=Wt(Wt({},w),i);return m.createElement(m.Fragment,null,u&&m.createElement(T,{sideCar:Rv,removeScrollBar:h,shards:d,noRelative:v,noIsolation:x,inert:y,setCallbacks:a,allowPinchZoom:!!k,lockRef:n,gapMode:b}),s?m.cloneElement(m.Children.only(c),Wt(Wt({},P),{ref:C})):m.createElement(g,Wt({},P,{className:l,ref:C}),c))});lc.defaultProps={enabled:!0,removeScrollBar:!0,inert:!1};lc.classNames={fullWidth:Ho,zeroRight:zo};var aA=function(){if(typeof __webpack_nonce__<"u")return __webpack_nonce__};function oA(){if(!document)return null;var e=document.createElement("style");e.type="text/css";var t=aA();return t&&e.setAttribute("nonce",t),e}function sA(e,t){e.styleSheet?e.styleSheet.cssText=t:e.appendChild(document.createTextNode(t))}function cA(e){var t=document.head||document.getElementsByTagName("head")[0];t.appendChild(e)}var lA=function(){var e=0,t=null;return{add:function(n){e==0&&(t=oA())&&(sA(t,n),cA(t)),e++},remove:function(){e--,!e&&t&&(t.parentNode&&t.parentNode.removeChild(t),t=null)}}},hA=function(){var e=lA();return function(t,n){m.useEffect(function(){return e.add(t),function(){e.remove()}},[t&&n])}},Lv=function(){var e=hA(),t=function(n){var r=n.styles,i=n.dynamic;return e(r,i),null};return t},uA={left:0,top:0,right:0,gap:0},al=function(e){return parseInt(e||"",10)||0},dA=function(e){var t=window.getComputedStyle(document.body),n=t[e==="padding"?"paddingLeft":"marginLeft"],r=t[e==="padding"?"paddingTop":"marginTop"],i=t[e==="padding"?"paddingRight":"marginRight"];return[al(n),al(r),al(i)]},pA=function(e){if(e===void 0&&(e="margin"),typeof window>"u")return uA;var t=dA(e),n=document.documentElement.clientWidth,r=window.innerWidth;return{left:t[0],top:t[1],right:t[2],gap:Math.max(0,r-n+t[2]-t[0])}},gA=Lv(),ui="data-scroll-locked",mA=function(e,t,n,r){var i=e.left,a=e.top,s=e.right,c=e.gap;return n===void 0&&(n="margin"),`
  .`.concat(YP,` {
...
`)},ig=function(){var e=parseInt(document.body.getAttribute(ui)||"0",10);return isFinite(e)?e:0},fA=function(){m.useEffect(function(){return document.body.setAttribute(ui,(ig()+1).toString()),function(){var e=ig()-1;e<=0?document.body.removeAttribute(ui):document.body.setAttribute(ui,e.toString())}},[])},yA=function(e){var t=e.noRelative,n=e.noImportant,r=e.gapMode,i=r===void 0?"margin":r;fA();var a=m.useMemo(function(){return pA(i)},[i]);return m.createElement(gA,{styles:mA(a,!t,i,n?"":"!important")})},Ph=!1;if(typeof window<"u")try{var Ao=Object.defineProperty({},"passive",{get:function(){return Ph=!0,!0}});window.addEventListener("test",Ao,Ao),window.removeEventListener("test",Ao,Ao)}catch{Ph=!1}var Fr=Ph?{passive:!1}:!1,vA=function(e){return e.tagName==="TEXTAREA"},Dv=function(e,t){if(!(e instanceof Element))return!1;var n=window.getComputedStyle(e);return n[t]!=="hidden"&&!(n.overflowY===n.overflowX&&!vA(e)&&n[t]==="visible")},bA=function(e){return Dv(e,"overflowY")},wA=function(e){return Dv(e,"overflowX")},ag=function(e,t){var n=t.ownerDocument,r=t;do{typeof ShadowRoot<"u"&&r instanceof ShadowRoot&&(r=r.host);var i=Mv(e,r);if(i){var a=qv(e,r),s=a[1],c=a[2];if(s>c)return!0}r=r.parentNode}while(r&&r!==n.body);return!1},xA=function(e){var t=e.scrollTop,n=e.scrollHeight,r=e.clientHeight;return[t,n,r]},kA=function(e){var t=e.scrollLeft,n=e.scrollWidth,r=e.clientWidth;return[t,n,r]},Mv=function(e,t){return e==="v"?bA(t):wA(t)},qv=function(e,t){return e==="v"?xA(t):kA(t)},TA=function(e,t){return e==="h"&&t==="rtl"?-1:1},CA=function(e,t,n,r,i){var a=TA(e,window.getComputedStyle(t).direction),s=a*r,c=n.target,l=t.contains(c),h=!1,u=s>0,d=0,p=0;do{if(!c)break;var v=qv(e,c),x=v[0],y=v[1],k=v[2],f=y-k-a*x;(x||f)&&Mv(e,c)&&(d+=f,p+=x);var g=c.parentNode;c=g&&g.nodeType===Node.DOCUMENT_FRAGMENT_NODE?g.host:g}while(!l&&c!==document.body||l&&(t.contains(c)||t===c));return(u&&(Math.abs(d)<1||!i)||!u&&(Math.abs(p)<1||!i))&&(h=!0),h},Io=function(e){return"changedTouches"in e?[e.changedTouches[0].clientX,e.changedTouches[0].clientY]:[0,0]},og=function(e){return[e.deltaX,e.deltaY]},sg=function(e){return e&&"current"in e?e.current:e},SA=function(e,t){return e[0]===t[0]&&e[1]===t[1]},PA=function(e){return`
  .block-interactivity-`.concat(e,` {pointer-events: none;}
  .allow-interactivity-`).concat(e,` {pointer-events: all;}
`)},AA=0,Br=[];function IA(e){var t=m.useRef([]),n=m.useRef([0,0]),r=m.useRef(),i=m.useState(AA++)[0],a=m.useState(Lv)[0],s=m.useRef(e);m.useEffect(function(){s.current=e},[e]),m.useEffect(function(){if(e.inert){document.body.classList.add("block-interactivity-".concat(i));var y=QP([e.lockRef.current],(e.shards||[]).map(sg),!0).filter(Boolean);return y.forEach(function(k){return k.classList.add("allow-interactivity-".concat(i))}),function(){document.body.classList.remove("block-interactivity-".concat(i)),y.forEach(function(k){return k.classList.remove("allow-interactivity-".concat(i))})}}},[e.inert,e.lockRef.current,e.shards]);var c=m.useCallback(function(y,k){if("touches"in y&&y.touches.length===2||y.type==="wheel"&&y.ctrlKey)return!s.current.allowPinchZoom;var f=Io(y),g=n.current,b="deltaX"in y?y.deltaX:g[0]-f[0],w="deltaY"in y?y.deltaY:g[1]-f[1],T,C=y.target,P=Math.abs(b)>Math.abs(w)?"h":"v";if("touches"in y&&P==="h"&&C.type==="range")return!1;var S=ag(P,C);if(!S)return!0;if(S?T=P:(T=P==="v"?"h":"v",S=ag(P,C)),!S)return!1;if(!r.current&&"changedTouches"in y&&(b||w)&&(r.current=T),!T)return!0;var I=r.current||T;return CA(I,k,y,I==="h"?b:w,!0)},[]),l=m.useCallback(function(y){var k=y;if(!(!Br.length||Br[Br.length-1]!==a)){var f="deltaY"in k?og(k):Io(k),g=t.current.filter(function(T){return T.name===k.type&&(T.target===k.target||k.target===T.shadowParent)&&SA(T.delta,f)})[0];if(g&&g.should){k.cancelable&&k.preventDefault();return}if(!g){var b=(s.current.shards||[]).map(sg).filter(Boolean).filter(function(T){return T.contains(k.target)}),w=b.length>0?c(k,b[0]):!s.current.noIsolation;w&&k.cancelable&&k.preventDefault()}}},[]),h=m.useCallback(function(y,k,f,g){var b={name:y,delta:k,target:f,should:g,shadowParent:NA(f)};t.current.push(b),setTimeout(function(){t.current=t.current.filter(function(w){return w!==b})},1)},[]),u=m.useCallback(function(y){n.current=Io(y),r.current=void 0},[]),d=m.useCallback(function(y){h(y.type,og(y),y.target,c(y,e.lockRef.current))},[]),p=m.useCallback(function(y){h(y.type,Io(y),y.target,c(y,e.lockRef.current))},[]);m.useEffect(function(){return Br.push(a),e.setCallbacks({onScrollCapture:d,onWheelCapture:d,onTouchMoveCapture:p}),document.addEventListener("wheel",l,Fr),document.addEventListener("touchmove",l,Fr),document.addEventListener("touchstart",u,Fr),function(){Br=Br.filter(function(y){return y!==a}),document.removeEventListener("wheel",l,Fr),document.removeEventListener("touchmove",l,Fr),document.removeEventListener("touchstart",u,Fr)}},[]);var v=e.removeScrollBar,x=e.inert;return m.createElement(m.Fragment,null,x?m.createElement(a,{styles:PA(i)}):null,v?m.createElement(yA,{noRelative:e.noRelative,gapMode:e.gapMode}):null)}function NA(e){for(var t=null;e!==null;)e instanceof ShadowRoot&&(t=e.host,e=e.host),e=e.parentNode;return t}const jA=iA(Rv,IA);var Ov=m.forwardRef(function(e,t){return m.createElement(lc,Wt({},e,{ref:t,sideCar:jA}))});Ov.classNames=lc.classNames;var hc="Popover",[Uv,BI]=Ya(hc,[ec]),eo=ec(),[EA,or]=Uv(hc),_v=e=>{const{__scopePopover:t,children:n,open:r,defaultOpen:i,onOpenChange:a,modal:s=!1}=e,c=eo(t),l=m.useRef(null),[h,u]=m.useState(!1),[d,p]=Tu({prop:r,defaultProp:i??!1,onChange:a,caller:hc});return o.jsx(Xy,{...c,children:o.jsx(EA,{scope:t,contentId:Ny(),triggerRef:l,open:d,onOpenChange:p,onOpenToggle:m.useCallback(()=>p(v=>!v),[p]),hasCustomAnchor:h,onCustomAnchorAdd:m.useCallback(()=>u(!0),[]),onCustomAnchorRemove:m.useCallback(()=>u(!1),[]),modal:s,children:n})})};_v.displayName=hc;var Fv="PopoverAnchor",RA=m.forwardRef((e,t)=>{const{__scopePopover:n,...r}=e,i=or(Fv,n),a=eo(n),{onCustomAnchorAdd:s,onCustomAnchorRemove:c}=i;return m.useEffect(()=>(s(),()=>c()),[s,c]),o.jsx(Uu,{...a,...r,ref:t})});RA.displayName=Fv;var Bv="PopoverTrigger",Vv=m.forwardRef((e,t)=>{const{__scopePopover:n,...r}=e,i=or(Bv,n),a=eo(n),s=it(t,i.triggerRef),c=o.jsx(Ue.button,{type:"button","aria-haspopup":"dialog","aria-expanded":i.open,"aria-controls":i.contentId,"data-state":$v(i.open),...r,ref:s,onClick:pe(e.onClick,i.onOpenToggle)});return i.hasCustomAnchor?c:o.jsx(Uu,{asChild:!0,...a,children:c})});Vv.displayName=Bv;var Wu="PopoverPortal",[LA,DA]=Uv(Wu,{forceMount:void 0}),zv=e=>{const{__scopePopover:t,forceMount:n,children:r,container:i}=e,a=or(Wu,t);return o.jsx(LA,{scope:t,forceMount:n,children:o.jsx(Xa,{present:n||a.open,children:o.jsx(ku,{asChild:!0,container:i,children:r})})})};zv.displayName=Wu;var Di="PopoverContent",Hv=m.forwardRef((e,t)=>{const n=DA(Di,e.__scopePopover),{forceMount:r=n.forceMount,...i}=e,a=or(Di,e.__scopePopover);return o.jsx(Xa,{present:r||a.open,children:a.modal?o.jsx(qA,{...i,ref:t}):o.jsx(OA,{...i,ref:t})})});Hv.displayName=Di;var MA=qa("PopoverContent.RemoveScroll"),qA=m.forwardRef((e,t)=>{const n=or(Di,e.__scopePopover),r=m.useRef(null),i=it(t,r),a=m.useRef(!1);return m.useEffect(()=>{const s=r.current;if(s)return KP(s)},[]),o.jsx(Ov,{as:MA,allowPinchZoom:!0,children:o.jsx(Gv,{...e,ref:i,trapFocus:n.open,disableOutsidePointerEvents:!0,onCloseAutoFocus:pe(e.onCloseAutoFocus,s=>{var c;s.preventDefault(),a.current||(c=n.triggerRef.current)==null||c.focus()}),onPointerDownOutside:pe(e.onPointerDownOutside,s=>{const c=s.detail.originalEvent,l=c.button===0&&c.ctrlKey===!0,h=c.button===2||l;a.current=h},{checkForDefaultPrevented:!1}),onFocusOutside:pe(e.onFocusOutside,s=>s.preventDefault(),{checkForDefaultPrevented:!1})})})}),OA=m.forwardRef((e,t)=>{const n=or(Di,e.__scopePopover),r=m.useRef(!1),i=m.useRef(!1);return o.jsx(Gv,{...e,ref:t,trapFocus:!1,disableOutsidePointerEvents:!1,onCloseAutoFocus:a=>{var s,c;(s=e.onCloseAutoFocus)==null||s.call(e,a),a.defaultPrevented||(r.current||(c=n.triggerRef.current)==null||c.focus(),a.preventDefault()),r.current=!1,i.current=!1},onInteractOutside:a=>{var l,h;(l=e.onInteractOutside)==null||l.call(e,a),a.defaultPrevented||(r.current=!0,a.detail.originalEvent.type==="pointerdown"&&(i.current=!0));const s=a.target;((h=n.triggerRef.current)==null?void 0:h.contains(s))&&a.preventDefault(),a.detail.originalEvent.type==="focusin"&&i.current&&a.preventDefault()}})}),Gv=m.forwardRef((e,t)=>{const{__scopePopover:n,trapFocus:r,onOpenAutoFocus:i,onCloseAutoFocus:a,disableOutsidePointerEvents:s,onEscapeKeyDown:c,onPointerDownOutside:l,onFocusOutside:h,onInteractOutside:u,...d}=e,p=or(Di,n),v=eo(n);return OP(),o.jsx(Av,{asChild:!0,loop:!0,trapped:r,onMountAutoFocus:i,onUnmountAutoFocus:a,children:o.jsx($s,{asChild:!0,disableOutsidePointerEvents:s,onInteractOutside:u,onEscapeKeyDown:c,onPointerDownOutside:l,onFocusOutside:h,onDismiss:()=>p.onOpenChange(!1),children:o.jsx(Jy,{"data-state":$v(p.open),role:"dialog",id:p.contentId,...v,...d,ref:t,style:{...d.style,"--radix-popover-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-popover-content-available-width":"var(--radix-popper-available-width)","--radix-popover-content-available-height":"var(--radix-popper-available-height)","--radix-popover-trigger-width":"var(--radix-popper-anchor-width)","--radix-popover-trigger-height":"var(--radix-popper-anchor-height)"}})})})}),Wv="PopoverClose",UA=m.forwardRef((e,t)=>{const{__scopePopover:n,...r}=e,i=or(Wv,n);return o.jsx(Ue.button,{type:"button",...r,ref:t,onClick:pe(e.onClick,()=>i.onOpenChange(!1))})});UA.displayName=Wv;var _A="PopoverArrow",FA=m.forwardRef((e,t)=>{const{__scopePopover:n,...r}=e,i=eo(n);return o.jsx(Zy,{...i,...r,ref:t})});FA.displayName=_A;function $v(e){return e?"open":"closed"}var BA=_v,VA=Vv,zA=zv,Kv=Hv;const cg=BA,lg=VA,Ah=m.forwardRef(({className:e,align:t="center",sideOffset:n=4,...r},i)=>o.jsx(zA,{children:o.jsx(Kv,{ref:i,align:t,sideOffset:n,className:mt("z-50 w-72 rounded-md border bg-popover p-4 text-popover-foreground shadow-md outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",e),...r})}));Ah.displayName=Kv.displayName;const HA=()=>{const{t:e,locale:t,language:n}=Le(),r=tr(),i=Ut(),[a,s]=Ik(),c=m.useRef(!1),[l,h]=m.useState(""),[u,d]=m.useState([]),[p,v]=m.useState([]),[x,y]=m.useState([]),[k,f]=m.useState(""),[g,b]=m.useState(""),[w,T]=m.useState(!0),C=a.get("category")||"all",P=a.get("tag")||"",S=9,I=Math.max(1,Number(a.get("page"))||1),j=`${i.pathname}${i.search}`,q=`blog-scroll:${j}`,D=m.useMemo(()=>P.split(",").map(E=>E.trim()).filter(Boolean),[P]),J=m.useMemo(()=>x.map(E=>({name:E.name,count:E.postCount})),[x]),O=m.useMemo(()=>{const E=u.reduce((ee,R)=>ee+(R.viewCount??0),0),_=u.reduce((ee,R)=>ee+(R.readTimeMinutes||0),0);return{totalViews:E,totalReadMinutes:_}},[u]),Q=m.useMemo(()=>{const E=k.trim().toLowerCase();return E?p.filter(_=>[_.name,_.slug,_.description??""].some(ee=>ee.toLowerCase().includes(E))):p},[p,k]),G=m.useMemo(()=>{const E=g.trim().toLowerCase();return E?J.filter(_=>_.name.toLowerCase().includes(E)):J},[J,g]),W=m.useMemo(()=>{const E=new Map;return p.forEach(_=>E.set(_.slug,_.postCount)),E},[p]),A=m.useMemo(()=>u.filter(E=>{const _=C==="all"||E.category===C,ee=D.length===0||D.every(H=>E.tags.some(Y=>Y.toLowerCase()===H.toLowerCase())),R=E.title.toLowerCase().includes(l.toLowerCase())||E.excerpt.toLowerCase().includes(l.toLowerCase())||E.tags.some(H=>H.toLowerCase().includes(l.toLowerCase()));return _&&ee&&R}).sort((E,_)=>new Date(_.date).getTime()-new Date(E.date).getTime()),[u,C,D,l]),M=Math.max(1,Math.ceil(A.length/S)),F=m.useMemo(()=>A.slice((I-1)*S,I*S),[I,A]),V=m.useMemo(()=>{const E=Math.max(1,Math.min(I-2,M-4)),_=Math.min(M,E+4);return Array.from({length:_-E+1},(ee,R)=>E+R)},[I,M]),z=E=>{var _;return((_=p.find(ee=>ee.slug===E))==null?void 0:_.name)||e(`category.${E}`)||E},Ge=E=>{const _=`${E.slug} ${E.name}`.toLowerCase();return _.includes("language")?F0:_.includes("framework")||_.includes("librar")?R0:_.includes("architecture")?r1:_.includes("pattern")?a1:_.includes("practice")?E0:_.includes("roadmap")?J0:_.includes("learning")?bp:zc},ge=E=>{const _=new URLSearchParams(a);E==="all"?_.delete("category"):_.set("category",E),_.delete("page"),s(_)},Je=E=>{const _=new URLSearchParams(a);E.length===0?_.delete("tag"):_.set("tag",E.join(",")),_.delete("page"),s(_)},We=E=>{const ee=D.some(R=>R.toLowerCase()===E.toLowerCase())?D.filter(R=>R.toLowerCase()!==E.toLowerCase()):[...D,E];Je(ee)},ft=()=>{s({}),h("")},bn=E=>{h(E);const _=new URLSearchParams(a);_.delete("page"),s(_)},De=E=>{const _=Math.min(Math.max(1,E),M),ee=new URLSearchParams(a);_===1?ee.delete("page"):ee.set("page",String(_)),s(ee),window.scrollTo({top:0,behavior:"smooth"})},wn=()=>{const E=window.scrollY;window.sessionStorage.setItem(q,String(E))};return m.useEffect(()=>{let E=!1;return(async()=>{T(!0);const[ee,R,H]=await Promise.all([Fn.getPosts(n,{pageSize:100}),Fn.getCategories(),Fn.getTags()]);E||(d(ee),v(R),y(H),T(!1))})().catch(()=>{E||T(!1)}),()=>{E=!0}},[n]),m.useEffect(()=>{w||A.length===0||I>M&&De(M)},[I,A.length,w,M]),m.useEffect(()=>{c.current=!1},[j]),m.useEffect(()=>{if(w||c.current)return;const E=window.sessionStorage.getItem(q);if(!E)return;const _=Number(E)||0;c.current=!0,window.sessionStorage.removeItem(q);const ee=()=>window.scrollTo({top:_,behavior:"instant"});window.requestAnimationFrame(()=>{ee(),window.requestAnimationFrame(ee)});const R=[80,180,360].map(H=>window.setTimeout(ee,H));return()=>R.forEach(H=>window.clearTimeout(H))},[q,w,F.length]),o.jsx(Yn,{children:o.jsxs("div",{className:"container mx-auto px-4 py-12",children:[o.jsxs("div",{className:"mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between",children:[o.jsxs("div",{className:"max-w-3xl",children:[o.jsx("h1",{className:"mb-4 text-4xl font-bold md:text-5xl",children:o.jsx("span",{className:"text-gradient",children:e("blog.title")})}),o.jsx("p",{className:"text-lg text-muted-foreground md:text-xl",children:e("blog.desc")})]}),!w&&o.jsxs("div",{className:"grid grid-cols-2 gap-2 sm:grid-cols-4 lg:w-[30rem]",children:[o.jsxs("div",{className:"rounded-lg border border-border/70 bg-background/75 px-3 py-2.5 shadow-sm",children:[o.jsxs("div",{className:"flex items-center gap-1.5 text-xs text-muted-foreground",children:[o.jsx(xs,{className:"h-3.5 w-3.5 text-primary"}),n==="vi"?"Lượt xem":"Views"]}),o.jsx("div",{className:"mt-1 text-lg font-semibold",children:O.totalViews.toLocaleString(t)})]}),o.jsxs("div",{className:"rounded-lg border border-border/70 bg-background/75 px-3 py-2.5 shadow-sm",children:[o.jsxs("div",{className:"flex items-center gap-1.5 text-xs text-muted-foreground",children:[o.jsx(bp,{className:"h-3.5 w-3.5 text-primary"}),n==="vi"?"Bài":"Posts"]}),o.jsx("div",{className:"mt-1 text-lg font-semibold",children:u.length.toLocaleString(t)})]}),o.jsxs("div",{className:"rounded-lg border border-border/70 bg-background/75 px-3 py-2.5 shadow-sm",children:[o.jsxs("div",{className:"flex items-center gap-1.5 text-xs text-muted-foreground",children:[o.jsx(ws,{className:"h-3.5 w-3.5 text-primary"}),n==="vi"?"Phút":"Minutes"]}),o.jsx("div",{className:"mt-1 text-lg font-semibold",children:O.totalReadMinutes.toLocaleString(t)})]}),o.jsxs("div",{className:"rounded-lg border border-border/70 bg-background/75 px-3 py-2.5 shadow-sm",children:[o.jsxs("div",{className:"flex items-center gap-1.5 text-xs text-muted-foreground",children:[o.jsx(zc,{className:"h-3.5 w-3.5 text-primary"}),n==="vi"?"Mục":"Topics"]}),o.jsx("div",{className:"mt-1 text-lg font-semibold",children:p.length.toLocaleString(t)})]})]})]}),o.jsxs("div",{className:"mb-8 rounded-xl border border-border/70 bg-background/75 p-2.5 shadow-sm backdrop-blur md:p-3",children:[o.jsxs("div",{className:"flex flex-col gap-2.5 lg:flex-row lg:items-center",children:[o.jsxs("div",{className:"relative w-full lg:max-w-sm",children:[o.jsx(Hc,{className:"absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground"}),o.jsx(Sr,{type:"search",placeholder:e("blog.search"),value:l,onChange:E=>bn(E.target.value),className:"h-10 rounded-lg border-border/70 bg-background/85 pl-9 text-sm shadow-sm"})]}),o.jsxs("div",{className:"flex flex-wrap items-center gap-2 lg:ml-auto",children:[o.jsxs(cg,{children:[o.jsx(lg,{asChild:!0,children:o.jsxs(ne,{variant:"outline",size:"sm",className:`h-10 min-w-[170px] justify-between rounded-full border-border/70 bg-background/85 px-3 shadow-sm ${C!=="all"?"border-primary/40 ring-1 ring-primary/15":""}`,children:[o.jsxs("span",{className:"flex min-w-0 items-center gap-2",children:[o.jsx(xp,{className:"h-4 w-4 shrink-0 text-muted-foreground"}),o.jsxs("span",{className:"min-w-0 truncate text-sm",children:[o.jsxs("span",{className:"text-muted-foreground",children:[e("blog.filterCategory"),": "]}),o.jsx("span",{className:"font-medium text-foreground",children:C==="all"?e("blog.all"):z(C)})]})]}),o.jsx(wp,{className:"h-4 w-4 shrink-0 opacity-70"})]})}),o.jsxs(Ah,{align:"end",className:"w-[min(22rem,calc(100vw-2rem))] rounded-xl p-2",children:[o.jsx("div",{className:"px-2 pb-2 pt-1 text-xs font-medium uppercase text-muted-foreground",children:e("blog.filterCategory")}),o.jsxs("div",{className:"relative mb-2",children:[o.jsx(Hc,{className:"absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground"}),o.jsx(Sr,{type:"search",value:k,onChange:E=>f(E.target.value),onKeyDown:E=>E.stopPropagation(),placeholder:n==="vi"?"Tìm danh mục":"Search categories",className:"h-9 rounded-lg border-border/70 bg-background/85 pl-9 text-sm"})]}),o.jsxs("div",{className:"space-y-1",children:[o.jsxs("button",{type:"button",onClick:()=>ge("all"),className:`flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm transition-colors ${C==="all"?"bg-primary/10 text-primary ring-1 ring-primary/20":"text-foreground hover:bg-muted"}`,children:[o.jsx(zc,{className:"h-4 w-4 shrink-0 opacity-75"}),o.jsx("span",{className:"min-w-0 flex-1 truncate",children:e("blog.all")}),o.jsx("span",{className:"rounded-full bg-muted px-2 py-0.5 text-xs text-muted-foreground",children:u.length}),C==="all"&&o.jsx(Bo,{className:"h-4 w-4"})]}),Q.map(E=>{const _=C===E.slug,ee=Ge(E);return o.jsxs("button",{type:"button",onClick:()=>ge(E.slug),className:`flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm transition-colors ${_?"bg-primary/10 text-primary ring-1 ring-primary/20":"text-foreground hover:bg-muted"}`,children:[o.jsx(ee,{className:"h-4 w-4 shrink-0 opacity-75"}),o.jsx("span",{className:"min-w-0 flex-1 truncate",children:E.name}),o.jsx("span",{className:"rounded-full bg-muted px-2 py-0.5 text-xs text-muted-foreground",children:W.get(E.slug)??0}),_&&o.jsx(Bo,{className:"h-4 w-4"})]},E.id)}),Q.length===0&&o.jsx("div",{className:"px-3 py-6 text-center text-sm text-muted-foreground",children:n==="vi"?"Không tìm thấy danh mục":"No categories found"})]})]})]}),o.jsxs(cg,{children:[o.jsx(lg,{asChild:!0,children:o.jsxs(ne,{variant:"outline",size:"sm",className:`h-10 min-w-[145px] justify-between rounded-full border-border/70 bg-background/85 px-3 shadow-sm ${D.length>0?"border-primary/40 ring-1 ring-primary/15":""}`,children:[o.jsxs("span",{className:"flex min-w-0 items-center gap-2",children:[o.jsx(ph,{className:"h-4 w-4 shrink-0 text-muted-foreground"}),o.jsxs("span",{className:"min-w-0 truncate text-sm",children:[o.jsxs("span",{className:"text-muted-foreground",children:[e("blog.filterTag"),": "]}),o.jsx("span",{className:"font-medium text-foreground",children:D.length>0?`${D.length} ${e("blog.selectedTags")}`:e("blog.allTags")})]})]}),o.jsx(wp,{className:"h-4 w-4 opacity-70"})]})}),o.jsxs(Ah,{align:"end",className:"w-[min(22rem,calc(100vw-2rem))] rounded-xl p-3",children:[o.jsxs("div",{className:"mb-3 flex items-center justify-between gap-3",children:[o.jsx("div",{className:"text-sm font-medium",children:e("blog.filterTag")}),D.length>0&&o.jsx(ne,{variant:"ghost",size:"sm",onClick:()=>Je([]),className:"h-8 px-2 text-xs",children:e("blog.clearFilters")})]}),o.jsxs("div",{className:"relative mb-3",children:[o.jsx(Hc,{className:"absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground"}),o.jsx(Sr,{type:"search",value:g,onChange:E=>b(E.target.value),onKeyDown:E=>E.stopPropagation(),placeholder:n==="vi"?"Tìm thẻ":"Search tags",className:"h-9 rounded-lg border-border/70 bg-background/85 pl-9 text-sm"})]}),o.jsxs("div",{className:"flex max-h-72 flex-wrap gap-2 overflow-y-auto pr-1",children:[G.map(E=>{const _=D.some(ee=>ee.toLowerCase()===E.name.toLowerCase());return o.jsxs(ne,{variant:_?"default":"outline",size:"sm",onClick:()=>We(E.name),className:"h-8 gap-1.5 rounded-full px-2.5 text-xs",children:[_&&o.jsx(Bo,{className:"h-3.5 w-3.5"}),E.name,o.jsx("span",{className:"rounded-full bg-background/40 px-1.5 py-0.5 text-[10px] text-current",children:E.count})]},E.name)}),G.length===0&&o.jsx("div",{className:"w-full px-3 py-6 text-center text-sm text-muted-foreground",children:n==="vi"?"Không tìm thấy thẻ":"No tags found"})]})]})]}),(C!=="all"||D.length>0||l)&&o.jsxs(ne,{variant:"ghost",size:"sm",onClick:ft,className:"h-10 gap-2 rounded-full px-3",children:[o.jsx(ks,{className:"h-4 w-4"}),e("blog.clearFilters")]})]})]}),D.length>0&&o.jsx("div",{className:"mt-2 flex flex-wrap items-center gap-1.5 border-t border-border/60 pt-2",children:D.map(E=>o.jsxs("button",{type:"button",onClick:()=>We(E),className:"inline-flex h-6 items-center gap-1 rounded-full border border-primary/25 bg-primary/10 px-2 text-[11px] font-medium text-primary transition-colors hover:bg-primary/15",children:[E,o.jsx(ks,{className:"h-3 w-3"})]},E))})]}),w?o.jsx(Gu,{className:"min-h-[36rem]",label:n==="vi"?"Đang tải":"Loading"}):A.length>0?o.jsxs(o.Fragment,{children:[o.jsx(Ee.div,{className:"grid grid-cols-1 items-start gap-6 md:grid-cols-2 lg:grid-cols-3",variants:r?void 0:Ei,initial:r?!1:"hidden",animate:"visible",children:F.map(E=>o.jsx(Ee.article,{variants:r?void 0:Ri,className:"group card-gradient flex h-full flex-col overflow-hidden rounded-xl border border-border/50 transition-all duration-300 hover:border-primary/50",children:o.jsxs("div",{className:"flex h-full flex-col p-6",children:[o.jsxs("div",{className:"mb-4 flex min-h-7 flex-wrap items-center gap-2.5",children:[o.jsx(lt,{variant:"secondary",className:"max-w-full truncate text-xs",children:z(E.category)}),o.jsxs("div",{className:"flex items-center text-xs text-muted-foreground",children:[o.jsx(ws,{className:"mr-1 h-4 w-4"}),E.readTime]}),o.jsxs("div",{className:"flex items-center text-xs text-muted-foreground",children:[o.jsx(xs,{className:"mr-1 h-4 w-4"}),(E.viewCount??0).toLocaleString(t)]})]}),o.jsx(we,{to:`/blog/${E.id}`,state:{from:j},onClick:wn,children:o.jsx("h2",{className:"mb-3 min-h-[3.5rem] text-xl font-semibold leading-7 line-clamp-2 transition-colors group-hover:text-primary",children:E.title})}),o.jsx("p",{className:"mb-4 min-h-[4.5rem] line-clamp-3 text-sm leading-6 text-muted-foreground",children:E.excerpt}),o.jsx("div",{className:"mb-5 flex h-7 gap-2 overflow-hidden",children:E.tags.slice(0,3).map(_=>{const ee=D.some(R=>R.toLowerCase()===_.toLowerCase());return o.jsxs("button",{type:"button",onClick:()=>We(_),className:`inline-flex h-7 max-w-[8.75rem] shrink-0 items-center rounded px-2.5 py-1 text-xs transition-colors ${ee?"bg-primary text-primary-foreground":"bg-muted text-muted-foreground hover:text-foreground"}`,children:[o.jsx(ph,{className:"mr-1 h-3 w-3 shrink-0"}),o.jsx("span",{className:"truncate",children:_})]},_)})}),o.jsxs("div",{className:"flex items-center justify-between gap-4 border-t border-border/50 pt-4",children:[o.jsx("span",{className:"min-w-0 truncate text-sm text-muted-foreground",children:new Date(E.date).toLocaleDateString(t)}),o.jsx(we,{to:`/blog/${E.id}`,state:{from:j},onClick:wn,className:"shrink-0 text-sm font-medium text-primary",children:e("blog.readMore")})]})]})},E.id))},`${C}-${P}-${l}-${n}-${I}`),M>1&&o.jsxs("nav",{className:"mt-10 flex flex-col items-center justify-between gap-4 rounded-xl border border-border/70 bg-background/75 p-3 shadow-sm backdrop-blur sm:flex-row",children:[o.jsx("p",{className:"text-sm text-muted-foreground",children:n==="vi"?`Hiển thị ${(I-1)*S+1}-${Math.min(I*S,A.length)} / ${A.length} bài`:`Showing ${(I-1)*S+1}-${Math.min(I*S,A.length)} of ${A.length} posts`}),o.jsxs("div",{className:"flex items-center gap-1.5",children:[o.jsxs(ne,{type:"button",variant:"outline",size:"sm",className:"h-9 rounded-full px-3",disabled:I===1,onClick:()=>De(I-1),children:[o.jsx(O0,{className:"h-4 w-4"}),o.jsx("span",{className:"hidden sm:inline",children:n==="vi"?"Trước":"Prev"})]}),V.map(E=>o.jsx(ne,{type:"button",variant:E===I?"default":"outline",size:"sm",className:"h-9 w-9 rounded-full p-0",onClick:()=>De(E),children:E},E)),o.jsxs(ne,{type:"button",variant:"outline",size:"sm",className:"h-9 rounded-full px-3",disabled:I===M,onClick:()=>De(I+1),children:[o.jsx("span",{className:"hidden sm:inline",children:n==="vi"?"Sau":"Next"}),o.jsx(U0,{className:"h-4 w-4"})]})]})]})]}):o.jsxs("div",{className:"text-center py-20",children:[o.jsx(xp,{className:"h-12 w-12 text-muted-foreground mx-auto mb-4"}),o.jsx("h3",{className:"text-xl font-semibold mb-2",children:e("blog.empty")}),o.jsx("p",{className:"text-muted-foreground",children:e("blog.emptyDesc")})]})]})})},Qv=async e=>{var a;if((a=navigator.clipboard)!=null&&a.writeText&&window.isSecureContext)try{await navigator.clipboard.writeText(e);return}catch{}const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.left="-9999px",t.style.top="0",t.style.opacity="0",document.body.appendChild(t);const n=document.getSelection(),r=n&&n.rangeCount>0?n.getRangeAt(0):null;t.focus(),t.select();const i=document.execCommand("copy");if(t.remove(),r&&n&&(n.removeAllRanges(),n.addRange(r)),!i)throw new Error("Unable to copy to clipboard")},GA={javascript:"js",jsx:"js",typescript:"ts",tsx:"ts",py:"python",cs:"csharp","c#":"csharp"},hg={js:new Set(["async","await","break","case","catch","class","const","continue","default","do","else","export","extends","finally","for","from","function","if","import","in","instanceof","let","new","of","return","switch","throw","try","typeof","var","void","while","yield"]),ts:new Set(["abstract","as","async","await","break","case","catch","class","const","continue","default","do","else","enum","export","extends","finally","for","from","function","if","implements","import","in","infer","interface","keyof","let","namespace","new","of","private","protected","public","readonly","return","satisfies","switch","throw","try","type","typeof","var","void","while"]),python:new Set(["and","as","assert","async","await","break","class","continue","def","del","elif","else","except","False","finally","for","from","global","if","import","in","is","lambda","None","nonlocal","not","or","pass","raise","return","True","try","while","with","yield"]),csharp:new Set(["abstract","async","await","base","break","case","catch","class","const","decimal","default","else","enum","false","finally","for","foreach","from","get","if","in","interface","internal","is","namespace","new","null","private","protected","public","readonly","record","return","sealed","set","static","string","switch","this","throw","true","try","using","var","void","when","where"])},WA=new Set(["true","false","null","undefined","True","False","None"]),$A=new Set(["Array","Boolean","Date","Decimal","Error","Guid","Iterable","List","Map","Number","Promise","Record","Set","String","Task","ValueError","dict","list","str","int","float","bool"]),KA=e=>{const t=e.trim().toLowerCase();return GA[t]??t},QA=/(\/\*[\s\S]*?\*\/|\/\/.*|#.*|`(?:\\.|[^`])*`|"(?:\\.|[^"])*"|'(?:\\.|[^'])*'|@[A-Za-z_]\w*|\b\d+(?:\.\d+)?\b|\b[A-Za-z_]\w*\b|=>|==={0,1}|!==?|\+\+|--|&&|\|\||[{}[\]().,;:<>+\-*/%=!?|&])/g,YA=e=>{const t=[];let n=0;return e.replace(QA,(r,i,a)=>(a>n&&t.push(e.slice(n,a)),t.push(r),n=a+r.length,r)),n<e.length&&t.push(e.slice(n)),t},XA=(e,t)=>e.slice(t+1).find(n=>n.trim().length>0),JA=(e,t,n)=>{const r=KA(t),i=hg[r]??hg.js;return/^\s+$/.test(e)?"":/^(\/\/|#|\/\*)/.test(e)?"text-slate-500 italic":/^(`|"|')/.test(e)?"text-emerald-300":/^@\w+/.test(e)?"text-amber-300":/^\d/.test(e)?"text-orange-300":WA.has(e)?"text-purple-300":i.has(e)?"text-sky-300 font-medium":$A.has(e)||/^[A-Z][A-Za-z0-9_]*$/.test(e)?"text-cyan-200":n==="("?"text-yellow-200":/^[{}[\]().,;:<>+\-*/%=!?|&]+$/.test(e)?"text-slate-300":"text-slate-100"},ZA=(e,t,n)=>{const r=YA(e);return r.map((i,a)=>{const s=JA(i,t,XA(r,a));return o.jsx("span",{className:s||void 0,children:i},`${n}-${a}`)})},eI=({code:e,language:t})=>{const{language:n}=Le(),{toast:r}=Ws(),[i,a]=m.useState(!1),s=m.useRef(),c=n==="vi"?"Sao chép mã":"Copy code",l=n==="vi"?"Đã sao chép":"Copied",h=t||"code",u=e.split(`
`);m.useEffect(()=>()=>window.clearTimeout(s.current),[]);const d=async()=>{try{await Qv(e),a(!0),window.clearTimeout(s.current),s.current=window.setTimeout(()=>a(!1),2e3),r({variant:"success",title:n==="vi"?"Đã sao chép mã":"Code copied"})}catch(p){console.error("Unable to copy code:",p),r({variant:"destructive",title:n==="vi"?"Không thể sao chép mã":"Unable to copy code"})}};return o.jsxs("div",{className:"my-8 overflow-hidden rounded-xl border border-slate-700/80 bg-slate-950 shadow-sm",children:[o.jsxs("div",{className:"flex items-center justify-between gap-3 border-b border-slate-800 bg-slate-900/95 px-4 py-2.5 font-mono text-xs uppercase tracking-[.14em] text-slate-400",children:[o.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[o.jsxs("span",{className:"flex items-center gap-1.5",children:[o.jsx("span",{className:"h-2.5 w-2.5 rounded-full bg-red-400"}),o.jsx("span",{className:"h-2.5 w-2.5 rounded-full bg-amber-300"}),o.jsx("span",{className:"h-2.5 w-2.5 rounded-full bg-emerald-400"})]}),o.jsx("span",{className:"min-w-0 truncate",children:h})]}),o.jsxs("div",{className:"flex items-center gap-3",children:[o.jsx("span",{className:"hidden text-slate-500 sm:inline",children:"haiit.dev"}),o.jsxs("button",{type:"button",onClick:d,className:"inline-flex h-9 w-9 items-center justify-center rounded-md border border-slate-700 bg-slate-900 text-slate-200 transition-colors hover:border-primary/70 hover:bg-primary/15 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary","aria-label":i?l:c,title:i?l:c,children:[i?o.jsx(Bo,{className:"h-4 w-4 text-primary"}):o.jsx(V0,{className:"h-4 w-4"}),o.jsx("span",{className:"sr-only","aria-live":"polite",children:i?l:c})]})]})]}),o.jsx("pre",{className:"overflow-x-auto p-0 text-sm leading-7",children:o.jsx("code",{className:"block min-w-max py-4 font-mono",children:u.map((p,v)=>o.jsxs("span",{className:"grid grid-cols-[3.25rem_1fr]",children:[o.jsx("span",{className:"select-none border-r border-slate-800 px-4 text-right text-slate-600",children:v+1}),o.jsx("span",{className:"whitespace-pre px-4",children:p?ZA(p,t,v):" "})]},v))})})]})},Vr=e=>e.split(/(`[^`]+`|\*\*[^*]+\*\*)/g).filter(Boolean).map((t,n)=>t.startsWith("`")&&t.endsWith("`")?o.jsx("code",{className:"rounded bg-primary/10 px-1.5 py-0.5 font-mono text-[.88em] text-primary",children:t.slice(1,-1)},n):t.startsWith("**")&&t.endsWith("**")?o.jsx("strong",{className:"font-semibold text-foreground",children:t.slice(2,-2)},n):o.jsx(m.Fragment,{children:t},n)),tI=({content:e})=>{const t=e.trim().split(`
`),n=[];let r=0;for(;r<t.length;){const i=t[r].trim();if(!i){r+=1;continue}if(i.startsWith("```")){const s=i.slice(3).trim(),c=[];for(r+=1;r<t.length&&!t[r].trim().startsWith("```");)c.push(t[r]),r+=1;n.push(o.jsx(eI,{language:s,code:c.join(`
`)},`code-${r}`)),r+=1;continue}if(i.startsWith("# ")){n.push(o.jsx("h2",{className:"mb-6 mt-2 text-3xl md:text-4xl",children:Vr(i.slice(2))},r)),r+=1;continue}if(i.startsWith("## ")){n.push(o.jsx("h3",{className:"mb-4 mt-12 border-l-2 border-primary pl-4 text-2xl",children:Vr(i.slice(3))},r)),r+=1;continue}if(i.startsWith("### ")){n.push(o.jsx("h4",{className:"mb-3 mt-8 text-xl",children:Vr(i.slice(4))},r)),r+=1;continue}if(i.startsWith("- ")){const s=[];for(;r<t.length&&t[r].trim().startsWith("- ");)s.push(t[r].trim().slice(2)),r+=1;n.push(o.jsx("ul",{className:"my-6 space-y-3",children:s.map(c=>o.jsxs("li",{className:"flex gap-3 leading-7 text-muted-foreground",children:[o.jsx("span",{className:"mt-3 h-1.5 w-1.5 shrink-0 rounded-full bg-primary"}),o.jsx("span",{children:Vr(c)})]},c))},`list-${r}`));continue}if(i.startsWith("> ")){n.push(o.jsx("blockquote",{className:"my-8 border-l-2 border-primary bg-primary/[.04] px-5 py-4 text-lg italic leading-8 text-muted-foreground",children:Vr(i.slice(2))},r)),r+=1;continue}const a=[i];for(r+=1;r<t.length&&t[r].trim()&&!/^(#{1,3} |```|- |> )/.test(t[r].trim());)a.push(t[r].trim()),r+=1;n.push(o.jsx("p",{className:"my-5 text-[1.02rem] leading-8 text-muted-foreground",children:Vr(a.join(" "))},`p-${r}`))}return o.jsx("div",{className:"article-content",children:n})},Kt=595,Rt=842,ni=4,Ne=52,nI=64,ug=66,at=Kt-Ne*2,Go="HAIIT.DEV",rI="haihttt974.github.io",Ns="Segoe UI, Inter, Arial, sans-serif",Zi="Cascadia Code, Consolas, SFMono-Regular, monospace",iI={javascript:"js",jsx:"js",typescript:"ts",tsx:"ts",py:"python",cs:"csharp","c#":"csharp"},dg={js:new Set(["async","await","break","case","catch","class","const","continue","default","do","else","export","extends","finally","for","from","function","if","import","in","instanceof","let","new","of","return","switch","throw","try","typeof","var","void","while","yield"]),ts:new Set(["abstract","as","async","await","break","case","catch","class","const","continue","default","do","else","enum","export","extends","finally","for","from","function","if","implements","import","in","infer","interface","keyof","let","namespace","new","of","private","protected","public","readonly","return","satisfies","switch","throw","try","type","typeof","var","void","while"]),python:new Set(["and","as","assert","async","await","break","class","continue","def","del","elif","else","except","False","finally","for","from","global","if","import","in","is","lambda","None","nonlocal","not","or","pass","raise","return","True","try","while","with","yield"]),csharp:new Set(["abstract","async","await","base","break","case","catch","class","const","decimal","default","else","enum","false","finally","for","foreach","from","get","if","in","interface","internal","is","namespace","new","null","private","protected","public","readonly","record","return","sealed","set","static","string","switch","this","throw","true","try","using","var","void","when","where"])},aI=new Set(["true","false","null","undefined","True","False","None"]),oI=new Set(["Array","Boolean","Date","Decimal","Error","Guid","Iterable","List","Map","Number","Promise","Record","Set","String","Task","ValueError","dict","list","str","int","float","bool"]),sI=/(\/\*[\s\S]*?\*\/|\/\/.*|#.*|`(?:\\.|[^`])*`|"(?:\\.|[^"])*"|'(?:\\.|[^'])*'|@[A-Za-z_]\w*|\b\d+(?:\.\d+)?\b|\b[A-Za-z_]\w*\b|=>|==={0,1}|!==?|\+\+|--|&&|\|\||[{}[\]().,;:<>+\-*/%=!?|&])/g,cI=e=>e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^\x20-\x7e]/g,"").replace(/\\/g,"\\\\").replace(/\(/g,"\\(").replace(/\)/g,"\\)"),lI=e=>e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,"").slice(0,80)||"blog-post",ur=({size:e,weight:t="400",family:n=Ns,italic:r})=>`${r?"italic ":""}${t} ${e}px ${n}`,hI=e=>iI[e.trim().toLowerCase()]??e.trim().toLowerCase(),uI=e=>{const t=[];let n=0;return e.replace(sI,(r,i,a)=>(a>n&&t.push(e.slice(n,a)),t.push(r),n=a+r.length,r)),n<e.length&&t.push(e.slice(n)),t},dI=(e,t)=>e.slice(t+1).find(n=>n.trim().length>0),pI=(e,t,n)=>{const r=dg[hI(t)]??dg.js;return/^\s+$/.test(e)?"#e2e8f0":/^(\/\/|#|\/\*)/.test(e)?"#64748b":/^(`|"|')/.test(e)?"#6ee7b7":/^@\w+/.test(e)?"#fcd34d":/^\d/.test(e)?"#fdba74":aI.has(e)?"#c4b5fd":r.has(e)?"#7dd3fc":oI.has(e)||/^[A-Z][A-Za-z0-9_]*$/.test(e)?"#a5f3fc":n==="("?"#fde68a":/^[{}[\]().,;:<>+\-*/%=!?|&]+$/.test(e)?"#cbd5e1":"#f8fafc"},ol=e=>e.replace(/`([^`]+)`/g,"$1").replace(/\*\*([^*]+)\*\*/g,"$1"),ea=(e,t,n,r)=>{e.font=ur(r);const i=t.replace(/\s+/g," ").trim().split(" ").filter(Boolean),a=[];let s="";return i.forEach(c=>{const l=s?`${s} ${c}`:c;if(e.measureText(l).width<=n){s=l;return}if(s&&a.push(s),e.measureText(c).width<=n){s=c;return}let h="";Array.from(c).forEach(u=>{const d=`${h}${u}`;e.measureText(d).width>n&&h?(a.push(h),h=u):h=d}),s=h}),s&&a.push(s),a},pg=()=>{const e=document.createElement("canvas");e.width=Kt*ni,e.height=Rt*ni;const t=e.getContext("2d");if(!t)throw new Error("Canvas is not available");return t.scale(ni,ni),t.fillStyle="#fbfaf7",t.fillRect(0,0,Kt,Rt),{canvas:e,context:t,y:nI}},Yv=(e,t,n,r,i,a)=>{e.beginPath(),e.moveTo(t+a,n),e.arcTo(t+r,n,t+r,n+i,a),e.arcTo(t+r,n+i,t,n+i,a),e.arcTo(t,n+i,t,n,a),e.arcTo(t,n,t+r,n,a),e.closePath()},zr=(e,t,n,r,i,a,s)=>{e.save(),Yv(e,t,n,r,i,a),e.fillStyle=s,e.fill(),e.restore()},sl=(e,t,n,r,i,a,s)=>{e.save(),Yv(e,t,n,r,i,a),e.strokeStyle=s,e.lineWidth=1,e.stroke(),e.restore()},nn=(e,t,n,r,i)=>{e.font=ur(i),e.fillStyle=i.color??"#334155",e.textAlign="left",e.textBaseline="alphabetic",e.fillText(t,n,r)},gI=(e,t)=>{e.save(),e.translate(Kt/2,Rt/2),e.rotate(-28*Math.PI/180),e.globalAlpha=.035,e.fillStyle="#0f172a",e.textAlign="center",e.font=`850 42px ${Ns}`,e.fillText("HAIIT.DEV · PROFESSIONAL LEARNING NOTES",0,0),e.restore()},mI=(e,t,n,r)=>{const{context:i}=e;gI(i),i.fillStyle="#0f172a",i.font=`800 10px ${Ns}`,i.textAlign="left",i.fillText(Go,Ne,30),i.fillStyle="#64748b",i.font=`500 9px ${Ns}`,i.fillText("Learning notes / PDF edition",Ne+70,30),i.textAlign="right",i.fillText(`${rI}  ·  ${t}/${n}`,Kt-Ne,Rt-30),i.strokeStyle="#e2e8f0",i.lineWidth=1,i.beginPath(),i.moveTo(Ne,Rt-50),i.lineTo(Kt-Ne,Rt-50),i.stroke()},fI=(e,t)=>{const n=URL.createObjectURL(e),r=document.createElement("a");r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),window.setTimeout(()=>URL.revokeObjectURL(n),1e3)},yI=async(e,t)=>{var ee;await((ee=document.fonts)==null?void 0:ee.ready);const n=[pg()],r=()=>n[n.length-1],i=()=>(n.push(pg()),r()),a=R=>{r().y+R<=Rt-ug||i()},s=(R,H,Y)=>{const te=(Y==null?void 0:Y.x)??Ne,Z=(Y==null?void 0:Y.width)??at,$=H.lineHeight??H.size*1.55;ea(r().context,ol(R),Z,H).forEach(Ie=>{a($+2);const xn=r();nn(xn.context,Ie,te,xn.y,H),xn.y+=$}),r().y+=(Y==null?void 0:Y.gapAfter)??8},c=()=>{a(24);const R=r();R.context.strokeStyle="#dbe4ef",R.context.lineWidth=1,R.context.beginPath(),R.context.moveTo(Ne,R.y),R.context.lineTo(Kt-Ne,R.y),R.context.stroke(),R.y+=24},l=(R,H,Y,te)=>{if(R.font=ur(te),R.measureText(H).width<=Y)return H;let Z=H;for(;Z.length>1&&R.measureText(`${Z}...`).width>Y;)Z=Z.slice(0,-1);return`${Z}...`},h=(R,H,Y,te,Z)=>{const $=r();zr($.context,Y,te,Z,34,8,"#f8fafc"),sl($.context,Y,te,Z,34,8,"#dbe4ef"),nn($.context,R.toUpperCase(),Y+10,te+12,{size:6.7,weight:"800",color:"#64748b"}),nn($.context,l($.context,H,Z-20,{size:8.8,weight:"800"}),Y+10,te+26,{size:8.8,weight:"800",color:"#0f172a"})},u=(R,H)=>(R.font=ur({size:8.2,family:Zi}),R.measureText(H).width),d=(R,H,Y)=>{const te=[];let Z="";return Array.from(H).forEach($=>{const Ce=`${Z}${$}`;Z&&u(R,Ce)>Y?(te.push(Z),Z=$):Z=Ce}),Z&&te.push(Z),te},p=(R,H,Y,te)=>{const Z=uI(H||" ").flatMap(Ie=>u(R,Ie)>te?d(R,Ie,te):[Ie]),$=[[]];let Ce=0;return Z.forEach(Ie=>{const xn=u(R,Ie);$[$.length-1].length>0&&Ce+xn>te&&($.push([]),Ce=0),$[$.length-1].push(Ie),Ce+=xn}),$.map(Ie=>({tokens:Ie,language:Y}))},v=(R,H,Y,te)=>{let Z=Y;R.font=ur({size:8.2,family:Zi}),H.tokens.forEach(($,Ce)=>{R.fillStyle=pI($,H.language,dI(H.tokens,Ce)),R.fillText($,Z,te),Z+=R.measureText($).width})},x=(R,H)=>{const $=Ne,Ce=at,Ie=42,xn=$+Ie+12,Jv=Ce-Ie-24,uc=R.flatMap((ae,dc)=>p(r().context,ae,H,Jv).map((Vi,Mr)=>({...Vi,sourceLine:dc+1,continued:Mr>0})));let Bi=0;for(;Bi<uc.length;){a(30+15.5+13+12);const ae=r(),dc=Rt-ug-ae.y-30-13,Vi=Math.max(1,Math.min(uc.length-Bi,Math.floor(dc/15.5))),Mr=30+Vi*15.5+13,_t=ae.y;zr(ae.context,$,_t,Ce,Mr,8,"#020617"),sl(ae.context,$,_t,Ce,Mr,8,"#334155"),zr(ae.context,$,_t,Ce,30,8,"#0f172a"),ae.context.fillStyle="#0f172a",ae.context.fillRect($,_t+17,Ce,14),[["#f87171",16],["#fbbf24",30],["#34d399",44]].forEach(([qr,Or])=>{ae.context.fillStyle=String(qr),ae.context.beginPath(),ae.context.arc($+Number(Or),_t+15,4,0,Math.PI*2),ae.context.fill()}),nn(ae.context,`${H||"code"}${Bi>0?" · continued":""}`.toUpperCase(),$+62,_t+19,{size:8,weight:"800",color:"#94a3b8",family:Zi}),ae.context.font=ur({size:8,weight:"600",color:"#64748b",family:Zi}),ae.context.fillStyle="#64748b",ae.context.textAlign="right",ae.context.fillText(Go.toLowerCase(),$+Ce-12,_t+19),ae.context.textAlign="left",ae.context.strokeStyle="#1e293b",ae.context.beginPath(),ae.context.moveTo($+Ie,_t+30),ae.context.lineTo($+Ie,_t+Mr-13+3),ae.context.stroke();for(let qr=0;qr<Vi;qr+=1){const Or=uc[Bi+qr],$u=_t+30+14+qr*15.5;ae.context.font=ur({size:8,family:Zi}),ae.context.fillStyle=Or.continued?"#334155":"#475569",ae.context.textAlign="right",ae.context.fillText(Or.continued?"↳":String(Or.sourceLine),$+Ie-10,$u),ae.context.textAlign="left",v(ae.context,Or,xn,$u)}ae.y+=Mr+14,Bi+=Vi}},y=new Date(e.date).toLocaleDateString(t.locale,{year:"numeric",month:"long",day:"numeric"}),k=new Date().toLocaleDateString(t.locale,{year:"numeric",month:"long",day:"numeric"}),f=r(),g=Ne,b=52,w=24,T=g+w,C=at-w*2,P={size:8.5,weight:"850",color:"#2563eb",lineHeight:12},S={size:24,weight:"850",color:"#0f172a",lineHeight:30},I={size:11.2,color:"#475569",lineHeight:17.5},j=ea(f.context,t.categoryName.toUpperCase(),C-116,P),q=ea(f.context,e.title,C,S),D=ea(f.context,e.excerpt,C,I),J=18,Q=Math.max(214,30+j.length*12+14+q.length*30+10+D.length*17.5+J+34+24);zr(f.context,g+5,b+7,at,Q,14,"rgba(15, 23, 42, 0.08)"),zr(f.context,g,b,at,Q,14,"#ffffff"),sl(f.context,g,b,at,Q,14,"#d7e2ee");const G=f.context.createLinearGradient(g,b,g,b+Q);G.addColorStop(0,"#2563eb"),G.addColorStop(1,"#14b8a6"),f.context.fillStyle=G,f.context.fillRect(g,b,5,Q),f.context.fillStyle="#eff6ff",f.context.beginPath(),f.context.arc(g+at-42,b+42,26,0,Math.PI*2),f.context.fill(),f.context.fillStyle="#dbeafe",f.context.beginPath(),f.context.arc(g+at-74,b+72,12,0,Math.PI*2),f.context.fill();let W=b+34;j.forEach(R=>{nn(f.context,R,T,W,P),W+=12}),nn(f.context,"PDF EDITION",g+at-104,b+34,{size:7.5,weight:"850",color:"#1d4ed8"}),W+=14,q.forEach(R=>{nn(f.context,R,T,W,S),W+=30}),W+=8,D.forEach(R=>{nn(f.context,R,T,W,I),W+=17.5});const A=W+J,M=10,F=(C-M*2)/3;h(t.language==="vi"?"Ngày đăng":"Published",y,T,A,F),h(t.language==="vi"?"Thời lượng":"Read time",e.readTime,T+F+M,A,F),h(t.language==="vi"?"Nguồn":"Source",Go,T+(F+M)*2,A,F),f.y=b+Q+28,s(`${t.language==="vi"?"Thẻ nội dung":"Tags"}: ${e.tags.join(", ")}`,{size:9.5,weight:"600",color:"#64748b",lineHeight:14},{gapAfter:16}),c();const V=e.content.trim().split(`
`);let z=0;for(;z<V.length;){const R=V[z].trim();if(!R){z+=1;continue}if(R.startsWith("```")){const Y=R.slice(3).trim()||"code",te=[];for(z+=1;z<V.length&&!V[z].trim().startsWith("```");)te.push(V[z]),z+=1;x(te,Y),z+=1;continue}if(R.startsWith("# ")){r().y+=4,s(R.slice(2),{size:19,weight:"850",color:"#0f172a",lineHeight:25},{gapAfter:8}),z+=1;continue}if(R.startsWith("## ")){a(42);const Y=r();Y.y+=10,Y.context.fillStyle="#2563eb",Y.context.fillRect(Ne,Y.y-17,3,22),s(R.slice(3),{size:15.5,weight:"800",color:"#1e293b",lineHeight:21},{x:Ne+14,width:at-14,gapAfter:8}),z+=1;continue}if(R.startsWith("### ")){s(R.slice(4),{size:13,weight:"800",color:"#1e293b",lineHeight:18},{gapAfter:5}),z+=1;continue}if(R.startsWith("- ")){for(;z<V.length&&V[z].trim().startsWith("- ");){const Y=ol(V[z].trim().slice(2));a(22);const te=r();te.context.fillStyle="#2563eb",te.context.beginPath(),te.context.arc(Ne+5,te.y-5,2.2,0,Math.PI*2),te.context.fill(),s(Y,{size:10.5,color:"#334155",lineHeight:17},{x:Ne+16,width:at-16,gapAfter:2}),z+=1}r().y+=6;continue}if(R.startsWith("> ")){const Y=ol(R.slice(2)),te=ea(r().context,Y,at-36,{size:11.5,weight:"600",italic:!0,lineHeight:18});a(te.length*18+26);const Z=r(),$=Z.y-8,Ce=te.length*18+22;zr(Z.context,Ne,$,at,Ce,8,"#eff6ff"),Z.context.fillStyle="#2563eb",Z.context.fillRect(Ne,$,3,Ce),Z.y+=10,te.forEach(Ie=>{nn(Z.context,Ie,Ne+18,Z.y,{size:11.5,weight:"600",italic:!0,color:"#475569",lineHeight:18}),Z.y+=18}),Z.y+=12,z+=1;continue}const H=[R];for(z+=1;z<V.length&&V[z].trim()&&!/^(#{1,3} |```|- |> )/.test(V[z].trim());)H.push(V[z].trim()),z+=1;s(H.join(" "),{size:10.6,color:"#334155",lineHeight:17.5},{gapAfter:8})}c(),s(t.sourceNote,{size:8.8,color:"#64748b",lineHeight:13.5},{gapAfter:8}),s(`${t.language==="vi"?"Bản PDF được xuất ngày":"PDF exported on"} ${k}. ${t.language==="vi"?"Vui lòng giữ nguyên nguồn HAIIT.DEV khi chia sẻ hoặc trích dẫn.":"Please keep HAIIT.DEV attribution when sharing or quoting."}`,{size:9,weight:"700",color:"#334155",lineHeight:14},{gapAfter:0}),n.forEach((R,H)=>mI(R,H+1,n.length,t.language));const Ge=n.map(R=>{const H=R.canvas.toDataURL("image/jpeg",.98);return atob(H.split(",")[1])}),ge=[],Je=R=>(ge.push(R),ge.length),We=Je("<< /Type /Catalog /Pages 2 0 R >>"),ft=Je(""),bn=[];Ge.forEach((R,H)=>{const Y=Je(`<< /Type /XObject /Subtype /Image /Width ${Kt*ni} /Height ${Rt*ni} /ColorSpace /DeviceRGB /BitsPerComponent 8 /Filter /DCTDecode /Length ${R.length} >>
stream
${R}
endstream`),te=`q
${Kt} 0 0 ${Rt} 0 0 cm
