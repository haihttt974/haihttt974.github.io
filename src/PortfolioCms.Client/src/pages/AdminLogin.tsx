    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="grid min-h-screen lg:grid-cols-[1.05fr_.95fr]">
        <section className="relative hidden overflow-hidden border-r border-white/10 lg:flex">
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-between p-10">
            ...
            <div className="max-w-xl">
              <p className="mb-4 text-xs uppercase tracking-[0.2em] text-slate-400">Admin login</p>
              <h1 className="text-5xl font-semibold leading-tight">Quản trị hệ thống theo cách rõ ràng và chuyên nghiệp</h1>
        ...
        <section className="flex items-center justify-center px-4 py-10 sm:px-8">
          <form onSubmit={login} className="w-full max-w-md rounded-[1.35rem] border border-slate-200 bg-white p-6 text-slate-950 shadow-[0_24px_80px_rgba(15,23,42,0.18)]">
