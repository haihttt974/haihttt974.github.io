...
export function InvitationStatement({ data }: { data: GraduationData }) {
  return <section className="grad-section grad-statement" aria-labelledby="statement-title"><ChapterMarker number="01" label="THE INVITATION" /><Reveal><h2 id="statement-title">Lời mời cho một ngày đáng nhớ.</h2><p>{data.introduction}</p><small>WITH GRATITUDE / {data.classYear}</small></Reveal></section>;
}
