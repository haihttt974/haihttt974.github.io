...
export function GraduationExperience() {
  ...
  const readingPercentRef = useRef(0);
  ...
  return <>
    <div className="grad-reading-progress grad-print-hide" role="progressbar" aria-label="Tiến độ đọc trang" aria-valuemin={0} aria-valuemax={100} aria-valuenow={readingPercent}>
      <div className="grad-reading-meta">
        <span><i aria-hidden="true" /> READING PROGRESS</span>
        <strong>{String(readingPercent).padStart(2, "0")}<small>%</small></strong>
      </div>
